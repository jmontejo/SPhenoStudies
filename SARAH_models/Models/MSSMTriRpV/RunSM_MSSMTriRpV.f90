...
& M3,vd,vu,CKMout,sinW2_out,Alpha_out,AlphaS_out,realCKM)
...
Real(dp) :: scale_save, Qin, tz, dt, g1D(539), g62_SM(62) 
 
 
! Run SUSY RGEs from M_SUSY to Qin 
Qin=sqrt(getRenormalizationScale()) 
scale_save = Qin 
Call ParametersToG539(g1input,g2input,g3input,Ydinput,Yeinput,L1input,L2input,        & 
& L3input,Yuinput,Muinput,Tdinput,Teinput,T1input,T2input,T3input,Tuinput,               & 
& Bmuinput,mq2input,ml2input,mHd2input,mHu2input,md2input,mu2input,me2input,             & 
& M1input,M2input,M3input,vdinput,vuinput,g1D)
