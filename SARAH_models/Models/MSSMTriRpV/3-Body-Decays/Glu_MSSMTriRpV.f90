...
& T1,T2,T3,Tu,Bmu,mq2,ml2,mHd2,mHu2,md2,mu2,me2,M1,M2,M3,vd,vu,gTSd,gTSu,gGluFdcFdChi,   & 
...
Real(dp),Intent(inout) :: gGluFdcFdChi(1,3,3,4),gGluFdFuFd(1,3,3,3),gGluFdcFdFv(1,3,3,3),gGluFdcFucCha(1,3,3,2),& 
& gGluFdcFucFe(1,3,3,3),gGluFucFuChi(1,3,3,4)

Real(dp),Intent(in) :: gTSd(6),gTSu(6)

Real(dp) :: gGluFdcFdChii(3,3,4),gGluFdFuFdi(3,3,3),gGluFdcFdFvi(3,3,3),gGluFdcFucChai(3,3,2),    & 
& gGluFdcFucFei(3,3,3),gGluFucFuChii(3,3,4)
...
& ZER,ZH,ZN,ZP,ZU,ZUL,ZUR,ZV,ZW,ZZ,alphaH,betaH,g1,g2,g3,Yd,Ye,L1,L2,L3,Yu,              & 
& Mu,Td,Te,T1,T2,T3,Tu,Bmu,mq2,ml2,mHd2,mHu2,md2,mu2,me2,M1,M2,M3,vd,vu,cplcChacFuSdL,   & 
...
& cplFdFuSdR,cplFdFvcSdL,cplFdFvcSdR,cplGluFdcSdL,cplGluFdcSdR,cplGluFucSuL,             & 
& cplGluFucSuR,deltaM)
...
gGluFdFuFdi = 0._dp 
Call GluToFdFuFd(i_run,MFd,MFu,MSd,MSu,MGlu,cplFdFdSuL,cplFdFdSuR,cplFdFuSdL,         & 
& cplFdFuSdR,cplGluFdcSdL,cplGluFdcSdR,cplGluFucSuL,cplGluFucSuR,IntegralSs,             & 
& IntegralSSss,IntegralSSst,NSs,NSSss,NSSst,gTSdtemp,gTSutemp,deltaM,epsI,               & 
& check,gGluFdFuFdi)

gGluFdFuFd(i_run,:,:,:) = gGluFdFuFdi 
gT = gT + 2._dp*Sum(gGluFdFuFdi) 
 
gGluFdcFdFvi = 0._dp 
Call GluToFdcFdFv(i_run,MFd,MSd,MGlu,cplcFdFvSdL,cplcFdFvSdR,cplcFdGluSdL,            & 
& cplcFdGluSdR,cplFdFvcSdL,cplFdFvcSdR,cplGluFdcSdL,cplGluFdcSdR,IntegralSs,             & 
& IntegralSSss,IntegralSSst,NSs,NSSss,NSSst,gTSdtemp,deltaM,epsI,check,gGluFdcFdFvi)

gGluFdcFdFv(i_run,:,:,:) = gGluFdcFdFvi 
gT = gT + 2._dp*Sum(gGluFdcFdFvi) 
...
Do gt1=1,3
  Do gt2=1,3
    Do gt3=gt1,3
gPartial(i1,n_length)= 2._dp*gGluFdFuFd(i1,gt1,gt2,gt3)
n_length=n_length+1
     End Do 
  End Do 
End Do 
Do gt1=1,3
  Do gt2=1,3
    Do gt3=1,3
gPartial(i1,n_length)= 2._dp*gGluFdcFdFv(i1,gt1,gt2,gt3)
n_length=n_length+1
     End Do 
  End Do 
End Do 
...
Subroutine GluToFdFuFd(iIN,MFd,MFu,MSd,MSu,MGlu,cplFdFdSuL,cplFdFdSuR,cplFdFuSdL,     & 
& cplFdFuSdR,cplGluFdcSdL,cplGluFdcSdR,cplGluFucSuL,cplGluFucSuR,IntegralSs,             & 
...
Real(dp),Intent(in) :: MFd(3),MFu(3),MSd(6),MSu(6),MGlu

Complex(dp),Intent(in) :: cplFdFdSuL(3,3,6),cplFdFdSuR(3,3,6),cplFdFuSdL(3,3,6),cplFdFuSdR(3,3,6),              & 
& cplGluFdcSdL(3,6),cplGluFdcSdR(3,6),cplGluFucSuL(3,6),cplGluFucSuR(3,6)
...
If(Abs(MGlu).gt.(Abs(MFd(gt3))+Abs(MFu(gt2))+Abs(MFd(gt1)))) Then 
!-------------- 
!  conj[Sd] 
!-------------- 
Do i1=1,6
...
coup(2) = Conjg(cplGluFdcSdL(gt3,i1)) 
coup(1) = Conjg(cplGluFdcSdR(gt3,i1)) 
...
coup2(1) = cplGluFdcSdL(gt3,i1) 
coup2(2) = cplGluFdcSdR(gt3,i1) 
coup2(3) = Conjg(cplGluFdcSdL(gt1,i1)) 
coup2(4) = Conjg(cplGluFdcSdR(gt1,i1))  
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Glu->Fd Fu Fd Propagator: conj[Sd]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
coup(2) = Conjg(cplGluFucSuL(gt2,i1)) 
coup(1) = Conjg(cplGluFucSuR(gt2,i1)) 
...
coup2(1) = cplGluFucSuL(gt2,i1) 
coup2(2) = cplGluFucSuR(gt2,i1) 
coup2(3) = Conjg(cplGluFucSuL(gt2,i1)) 
coup2(4) = Conjg(cplGluFucSuR(gt2,i1))  
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Glu->Fd Fu Fd Propagator: conj[Su]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
coup2(1) = cplGluFdcSdL(gt3,i1) 
coup2(2) = cplGluFdcSdR(gt3,i1) 
coup2(3) = Conjg(cplGluFdcSdL(gt3,i2)) 
coup2(4) = Conjg(cplGluFdcSdR(gt3,i2))  
coup2(5) = cplFdFuSdL(gt1,gt2,i1) 
coup2(6) = cplFdFuSdR(gt1,gt2,i1) 
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Glu->Fd Fu Fd Propagator: conj[Sd],conj[Sd]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
coup2(1) = cplGluFdcSdL(gt1,i1) 
coup2(2) = cplGluFdcSdR(gt1,i1) 
coup2(3) = Conjg(cplGluFucSuL(gt2,i2)) 
coup2(4) = Conjg(cplGluFucSuR(gt2,i2))  
coup2(5) = cplFdFuSdL(gt3,gt2,i1) 
coup2(6) = cplFdFuSdR(gt3,gt2,i1) 
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Glu->Fd Fu Fd Propagator: conj[Sd],conj[Su]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Glu->Fd Fu Fd Propagator: conj[Su],conj[Su]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
End Module Glu3Decays_MSSMTriRpV 
