...
& gTSd,gTSe,gTSu,gTSv,gTVWm,gTVZ,gChiChicChaCha,gChiChiChiChi,gChiChicFdFd,              & 
& gChiChicFeFe,gChiChicFuFu,gChiChacFdFu,gChiChacFeFv,gChiChicFvFv,gChiFdFuFd,           & 
& gChiFdcFdFv,gChiFdcFdGlu,gChiFdcFucFe,gChiFecFeFv,gChiFucFuGlu,epsI,deltaM,            & 
...
& gChiFdFuFd(4,3,3,3),gChiFdcFdFv(4,3,3,3),gChiFdcFdGlu(4,3,3,1),gChiFdcFucFe(4,3,3,3),  & 
& gChiFecFeFv(4,3,3,3),gChiFucFuGlu(4,3,3,1)
...
& gChiFdFuFdi(3,3,3),gChiFdcFdFvi(3,3,3),gChiFdcFdGlui(3,3,1),gChiFdcFucFei(3,3,3),      & 
& gChiFecFeFvi(3,3,3),gChiFucFuGlui(3,3,1)
...
& vu,cplcChaChaAhL,cplcChaChaAhR,cplcChaChahhL,cplcChaChahhR,cplcChaChaVZL,              & 
...
& cplcFdFuHpmL,cplcFdFuHpmR,cplcFdFuVWmL,cplcFdFuVWmR,cplcFdFvSdL,cplcFdFvSdR,           & 
...
& cplcFuChiSuL,cplcFuChiSuR,cplcFuFdcSeL,cplcFuFdcSeR,cplcFuFuAhL,cplcFuFuAhR,           & 
...
& cplFdFvcSdR,cplFeFvcSeL,cplFeFvcSeR,cplGluFdcSdL,cplGluFdcSdR,cplGluFucSuL,            & 
& cplGluFucSuR,deltaM)
...
gChiFdFuFdi = 0._dp 
Call ChiToFdFuFd(i_run,MFd,MFu,MSd,MSu,MChi,cplChiFdcSdL,cplChiFdcSdR,cplChiFucSuL,   & 
& cplChiFucSuR,cplFdFdSuL,cplFdFdSuR,cplFdFuSdL,cplFdFuSdR,IntegralSs,IntegralSSss,      & 
& IntegralSSst,NSs,NSSss,NSSst,gTSdtemp,gTSutemp,deltaM,epsI,check,gChiFdFuFdi)

gChiFdFuFd(i_run,:,:,:) = gChiFdFuFdi 
gT(i_run) = gT(i_run) + 2._dp*Sum(gChiFdFuFdi) 
 
gChiFdcFdFvi = 0._dp 
Call ChiToFdcFdFv(i_run,MFd,MSd,MSv,MChi,cplcFdChiSdL,cplcFdChiSdR,cplcFdFdSvL,       & 
& cplcFdFdSvR,cplcFdFvSdL,cplcFdFvSdR,cplChiFdcSdL,cplChiFdcSdR,cplChiFvcSvL,            & 
& cplChiFvcSvR,cplFdFvcSdL,cplFdFvcSdR,IntegralSs,IntegralSSss,IntegralSSst,             & 
& NSs,NSSss,NSSst,gTSdtemp,gTSvtemp,deltaM,epsI,check,gChiFdcFdFvi)

gChiFdcFdFv(i_run,:,:,:) = gChiFdcFdFvi 
gT(i_run) = gT(i_run) + 2._dp*Sum(gChiFdcFdFvi) 
...
gChiFecFeFvi = 0._dp 
Call ChiToFecFeFv(i_run,MFe,MSe,MSv,MChi,cplcFeChiSeL,cplcFeChiSeR,cplcFeFeSvL,       & 
& cplcFeFeSvR,cplcFeFvSeL,cplcFeFvSeR,cplChiFecSeL,cplChiFecSeR,cplChiFvcSvL,            & 
& cplChiFvcSvR,cplFeFvcSeL,cplFeFvcSeR,IntegralSs,IntegralSSss,IntegralSSst,             & 
& NSs,NSSss,NSSst,gTSetemp,gTSvtemp,deltaM,epsI,check,gChiFecFeFvi)

gChiFecFeFv(i_run,:,:,:) = gChiFecFeFvi 
gT(i_run) = gT(i_run) + 2._dp*Sum(gChiFecFeFvi) 
...
Do gt1=1,3
  Do gt2=1,3
    Do gt3=gt1,3
gPartial(i1,n_length)= 2._dp*gChiFdFuFd(i1,gt1,gt2,gt3)
n_length=n_length+1
     End Do 
  End Do 
End Do 
Do gt1=1,3
  Do gt2=1,3
    Do gt3=1,3
gPartial(i1,n_length)= 2._dp*gChiFdcFdFv(i1,gt1,gt2,gt3)
n_length=n_length+1
     End Do 
  End Do 
End Do 
...
Do gt1=1,3
  Do gt2=1,3
    Do gt3=1,3
gPartial(i1,n_length)= 2._dp*gChiFecFeFv(i1,gt1,gt2,gt3)
n_length=n_length+1
     End Do 
  End Do 
End Do 
...
Subroutine ChiToFdFuFd(iIN,MFd,MFu,MSd,MSu,MChi,cplChiFdcSdL,cplChiFdcSdR,            & 
& cplChiFucSuL,cplChiFucSuR,cplFdFdSuL,cplFdFdSuR,cplFdFuSdL,cplFdFuSdR,IntegralSs,      & 
& IntegralSSss,IntegralSSst,NSs,NSSss,NSSst,gTSd,gTSu,deltaM,epsI,check,g,               & 
& WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MFd(3),MFu(3),MSd(6),MSu(6),MChi(4)
...
If(Abs(MChi(iIN)).gt.(Abs(MFd(gt3))+Abs(MFu(gt2))+Abs(MFd(gt1)))) Then 
!-------------- 
!  conj[Sd] 
!-------------- 
Do i1=1,6
...
coup(4) = Conjg(cplFdFuSdL(gt3,gt2,i1)) 
coup(3) = Conjg(cplFdFuSdR(gt3,gt2,i1))
Call IntegrateScalarSS(Boson2,mass,coup,deltaM,epsI,IntegralSs,NSs,resR, check) 
If (gt1.Eq.gt3) Then 
resR=resR/2._dp 
End If
...
coup(2) = Conjg(cplChiFdcSdL(iIN,gt3,i1)) 
coup(1) = Conjg(cplChiFdcSdR(iIN,gt3,i1)) 
coup(4) = Conjg(cplFdFuSdL(gt1,gt2,i1)) 
coup(3) = Conjg(cplFdFuSdR(gt1,gt2,i1))
Call IntegrateScalarSS(Boson2,mass,coup,deltaM,epsI,IntegralSs,NSs,resR, check) 
If (gt1.Eq.gt3) Then 
resR=resR/2._dp 
End If
...
coup2(1) = cplChiFdcSdL(iIN,gt3,i1) 
coup2(2) = cplChiFdcSdR(iIN,gt3,i1) 
coup2(3) = Conjg(cplChiFdcSdL(iIN,gt1,i1)) 
coup2(4) = Conjg(cplChiFdcSdR(iIN,gt1,i1))  
coup2(5) = cplFdFuSdL(gt1,gt2,i1) 
coup2(6) = cplFdFuSdR(gt1,gt2,i1) 
coup2(7) = Conjg(cplFdFuSdL(gt3,gt2,i1)) 
coup2(8) = Conjg(cplFdFuSdR(gt3,gt2,i1)) 
Call IntegrateScalarST(Boson4, mass, coup2, deltaM, epsI,IntegralSSst,NSSst, resC, check) 
If (resC.ne.resC) resC = 0._dp
resC = -2._dp*resC 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Chi->Fd Fu Fd Propagator: conj[Sd]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
coup(2) = Conjg(cplChiFucSuL(iIN,gt2,i1)) 
coup(1) = Conjg(cplChiFucSuR(iIN,gt2,i1)) 
...
coup2(1) = cplChiFucSuL(iIN,gt2,i1) 
coup2(2) = cplChiFucSuR(iIN,gt2,i1) 
coup2(3) = Conjg(cplChiFucSuL(iIN,gt2,i1)) 
coup2(4) = Conjg(cplChiFucSuR(iIN,gt2,i1))  
coup2(5) = cplFdFdSuL(gt3,gt1,i1) 
coup2(6) = cplFdFdSuR(gt3,gt1,i1) 
coup2(7) = Conjg(cplFdFdSuL(gt1,gt3,i1)) 
coup2(8) = Conjg(cplFdFdSuR(gt1,gt3,i1)) 
Call IntegrateScalarS1S2(Boson4, mass, coup2, deltaM, epsI,IntegralSSss,NSSss, resC, check) 
If (resC.ne.resC) resC = 0._dp
resC = -2._dp*resC 
resC= 6*resC ! color factor 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Chi->Fd Fu Fd Propagator: conj[Su]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
coup2(5) = cplFdFuSdL(gt3,gt2,i1) 
coup2(6) = cplFdFuSdR(gt3,gt2,i1) 
coup2(7) = Conjg(cplFdFuSdL(gt3,gt2,i2)) 
coup2(8) = Conjg(cplFdFuSdR(gt3,gt2,i2)) 
Call IntegrateScalarS1S2(Boson4, mass, coup2, deltaM, epsI,IntegralSSss,NSSss, resC, check) 
If (resC.ne.resC) resC = 0._dp
resC = 2._dp*resC 
resC= 6*resC ! color factor 
...
coup2(5) = cplFdFuSdL(gt1,gt2,i1) 
coup2(6) = cplFdFuSdR(gt1,gt2,i1) 
coup2(7) = Conjg(cplFdFuSdL(gt1,gt2,i2)) 
coup2(8) = Conjg(cplFdFuSdR(gt1,gt2,i2)) 
Call IntegrateScalarS1S2(Boson4, mass, coup2, deltaM, epsI,IntegralSSss,NSSss, resC, check) 
If (resC.ne.resC) resC = 0._dp
resC = 2._dp*resC 
resC= 6*resC ! color factor 
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Chi->Fd Fu Fd Propagator: conj[Sd],conj[Sd]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
coup2(1) = cplChiFdcSdL(iIN,gt1,i1) 
coup2(2) = cplChiFdcSdR(iIN,gt1,i1) 
coup2(3) = Conjg(cplChiFucSuL(iIN,gt2,i2)) 
coup2(4) = Conjg(cplChiFucSuR(iIN,gt2,i2))  
coup2(5) = cplFdFuSdL(gt3,gt2,i1) 
coup2(6) = cplFdFuSdR(gt3,gt2,i1) 
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Chi->Fd Fu Fd Propagator: conj[Sd],conj[Su]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
gSum(gt1,gt2,gt3,Isum)= resS  
End If 
Contribution(gt1,gt2,gt3,Isum)='conj[Sd],conj[Su]'
        End Do 
      End Do 
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Chi->Fd Fu Fd Propagator: conj[Su],conj[Su]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
End If
   ...
   End Do 
  g = oo512pi3 / Abs(MChi(iIN))**3*g
End Subroutine ChiToFdFuFd 
 
 
Subroutine ChiToFdcFdFv(iIN,MFd,MSd,MSv,MChi,cplcFdChiSdL,cplcFdChiSdR,               & 
& cplcFdFdSvL,cplcFdFdSvR,cplcFdFvSdL,cplcFdFvSdR,cplChiFdcSdL,cplChiFdcSdR,             & 
& cplChiFvcSvL,cplChiFvcSvR,cplFdFvcSdL,cplFdFvcSdR,IntegralSs,IntegralSSss,             & 
& IntegralSSst,NSs,NSSss,NSSst,gTSd,gTSv,deltaM,epsI,check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MFd(3),MSd(6),MSv(3),MChi(4)

Complex(dp),Intent(in) :: cplcFdChiSdL(3,4,6),cplcFdChiSdR(3,4,6),cplcFdFdSvL(3,3,3),cplcFdFdSvR(3,3,3),        & 
& cplcFdFvSdL(3,3,6),cplcFdFvSdR(3,3,6),cplChiFdcSdL(4,3,6),cplChiFdcSdR(4,3,6),         & 
& cplChiFvcSvL(4,3,3),cplChiFvcSvR(4,3,3),cplFdFvcSdL(3,3,6),cplFdFvcSdR(3,3,6)
...
coup(2) = Conjg(cplcFdChiSdL(gt2,iIN,i1)) 
coup(1) = Conjg(cplcFdChiSdR(gt2,iIN,i1)) 
coup(4) = Conjg(cplFdFvcSdL(gt1,gt3,i1)) 
coup(3) = Conjg(cplFdFvcSdR(gt1,gt3,i1))
Call IntegrateScalarSS(Boson2,mass,coup,deltaM,epsI,IntegralSs,NSs,resR, check) 
resR= 3*resR ! color factor 
resS = resS + resR 
...
coup2(5) = cplcFdFvSdL(gt2,gt3,i1) 
coup2(6) = cplcFdFvSdR(gt2,gt3,i1) 
coup2(7) = Conjg(cplFdFvcSdL(gt1,gt3,i2)) 
coup2(8) = Conjg(cplFdFvcSdR(gt1,gt3,i2)) 
Call IntegrateScalarST(Boson4, mass, coup2, deltaM, epsI,IntegralSSst,NSSst, resC, check) 
If (resC.ne.resC) resC = 0._dp
resC = -2._dp*resC 
resC= 3*resC ! color factor 
...
coup2(3) = Conjg(cplcFdChiSdL(gt2,iIN,i2)) 
coup2(4) = Conjg(cplcFdChiSdR(gt2,iIN,i2))  
coup2(5) = cplFdFvcSdL(gt1,gt3,i1) 
coup2(6) = cplFdFvcSdR(gt1,gt3,i1) 
coup2(7) = Conjg(cplFdFvcSdL(gt1,gt3,i2)) 
coup2(8) = Conjg(cplFdFvcSdR(gt1,gt3,i2)) 
Call IntegrateScalarS1S2(Boson4, mass, coup2, deltaM, epsI,IntegralSSss,NSSss, resC, check) 
If (resC.ne.resC) resC = 0._dp
...
& cplcFeFeSvL,cplcFeFeSvR,cplcFeFvSeL,cplcFeFvSeR,cplChiFecSeL,cplChiFecSeR,             & 
& cplChiFvcSvL,cplChiFvcSvR,cplFeFvcSeL,cplFeFvcSeR,IntegralSs,IntegralSSss,             & 
& IntegralSSst,NSs,NSSss,NSSst,gTSe,gTSv,deltaM,epsI,check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MFe(3),MSe(6),MSv(3),MChi(4)

Complex(dp),Intent(in) :: cplcFeChiSeL(3,4,6),cplcFeChiSeR(3,4,6),cplcFeFeSvL(3,3,3),cplcFeFeSvR(3,3,3),        & 
& cplcFeFvSeL(3,3,6),cplcFeFvSeR(3,3,6),cplChiFecSeL(4,3,6),cplChiFecSeR(4,3,6),         & 
& cplChiFvcSvL(4,3,3),cplChiFvcSvR(4,3,3),cplFeFvcSeL(3,3,6),cplFeFvcSeR(3,3,6)
...
coup(2) = Conjg(cplcFeChiSeL(gt2,iIN,i1)) 
coup(1) = Conjg(cplcFeChiSeR(gt2,iIN,i1)) 
coup(4) = Conjg(cplFeFvcSeL(gt1,gt3,i1)) 
coup(3) = Conjg(cplFeFvcSeR(gt1,gt3,i1))
Call IntegrateScalarSS(Boson2,mass,coup,deltaM,epsI,IntegralSs,NSs,resR, check) 
resR= 1*resR ! color factor 
resS = resS + resR 
...
coup2(5) = cplcFeFvSeL(gt2,gt3,i1) 
coup2(6) = cplcFeFvSeR(gt2,gt3,i1) 
coup2(7) = Conjg(cplFeFvcSeL(gt1,gt3,i2)) 
coup2(8) = Conjg(cplFeFvcSeR(gt1,gt3,i2)) 
Call IntegrateScalarST(Boson4, mass, coup2, deltaM, epsI,IntegralSSst,NSSst, resC, check) 
If (resC.ne.resC) resC = 0._dp
resC = -2._dp*resC 
resC= 1*resC ! color factor 
...
coup2(3) = Conjg(cplcFeChiSeL(gt2,iIN,i2)) 
coup2(4) = Conjg(cplcFeChiSeR(gt2,iIN,i2))  
coup2(5) = cplFeFvcSeL(gt1,gt3,i1) 
coup2(6) = cplFeFvcSeR(gt1,gt3,i1) 
coup2(7) = Conjg(cplFeFvcSeL(gt1,gt3,i2)) 
coup2(8) = Conjg(cplFeFvcSeR(gt1,gt3,i2)) 
Call IntegrateScalarS1S2(Boson4, mass, coup2, deltaM, epsI,IntegralSSss,NSSss, resC, check) 
If (resC.ne.resC) resC = 0._dp
...
End Module Chi3Decays_MSSMTriRpV 
