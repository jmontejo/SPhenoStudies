...
& T1,T2,T3,Tu,Bmu,mq2,ml2,mHd2,mHu2,md2,mu2,me2,M1,M2,M3,vd,vu,gTAh,gThh,gTHpm,          & 
& gTSd,gTSe,gTSu,gTSv,gTVWm,gTVZ,gChaChacChaCha,gChaChaChiChi,gChaChacFdFd,              & 
& gChaChacFeFe,gChaChacFuFu,gChaChacFvFv,gChaChicFuFd,gChaChicFvFe,gChaFdFdFd,           & 
& gChaFdcFdFe,gChaFdcFuGlu,gChaFecFeFe,gChacFuFvFd,gChacFucFvFd,gChacFuFuFe,             & 
& gChacFucFucFd,gChacFvFvFe,gChacFvcFvFe,epsI,deltaM,CheckRealStates,gT,gPartial,BR)
...
& gChacFvFvFe(2,3,3,3),gChacFvcFvFe(2,3,3,3)
...
& gChaFdFdFdi(3,3,3),gChaFdcFdFei(3,3,3),gChaFdcFuGlui(3,3,1),gChaFecFeFei(3,3,3),       & 
& gChacFuFvFdi(3,3,3),gChacFucFvFdi(3,3,3),gChacFuFuFei(3,3,3),gChacFucFucFdi(3,3,3),    & 
& gChacFvFvFei(3,3,3),gChacFvcFvFei(3,3,3)
...
& cplcChaFecSvL,cplcChaFecSvR,cplcFdcFucSdL,cplcFdcFucSdR,cplcFdChaSuL,cplcFdChaSuR,     & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdSvL,cplcFdFdSvR,               & 
& cplcFdFdVZL,cplcFdFdVZR,cplcFdFeSuL,cplcFdFeSuR,cplcFeChaSvL,cplcFeChaSvR,             & 
& cplcFeFeAhL,cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,cplcFeFeSvL,cplcFeFeSvR,               & 
...
& cplFdFdSuL,cplFdFdSuR,cplFdFvcSdL,cplFdFvcSdR,cplFeFucSdL,cplFeFucSdR,cplFeFvcSeL,     & 
& cplFeFvcSeR,cplGluFdcSdL,cplGluFdcSdR,deltaM)
...
gChaFdFdFdi = 0._dp 
Call ChaToFdFdFd(i_run,MFd,MSu,MCha,cplcChaFdcSuL,cplcChaFdcSuR,cplFdFdSuL,           & 
& cplFdFdSuR,IntegralSs,IntegralSSss,IntegralSSst,NSs,NSSss,NSSst,gTSutemp,              & 
& deltaM,epsI,check,gChaFdFdFdi)

gChaFdFdFd(i_run,:,:,:) = gChaFdFdFdi 
gT(i_run) = gT(i_run) + Sum(gChaFdFdFdi) 
...
gChacFuFvFdi = 0._dp 
Call ChaTocFuFvFd(i_run,MFu,MFd,MSd,MCha,cplcChacFuSdL,cplcChacFuSdR,cplFdFvcSdL,     & 
& cplFdFvcSdR,IntegralSs,IntegralSSss,NSs,NSSss,gTSdtemp,deltaM,epsI,check,              & 
& gChacFuFvFdi)

gChacFuFvFd(i_run,:,:,:) = gChacFuFvFdi 
gT(i_run) = gT(i_run) + Sum(gChacFuFvFdi) 
 
gChacFucFvFdi = 0._dp 
Call ChaTocFucFvFd(i_run,MFu,MFd,MSd,MSe,MCha,cplcChacFuSdL,cplcChacFuSdR,            & 
& cplcChacFvSeL,cplcChacFvSeR,cplcFuFdcSeL,cplcFuFdcSeR,cplcFvFdcSdL,cplcFvFdcSdR,       & 
& IntegralSs,IntegralSSss,IntegralSSst,NSs,NSSss,NSSst,gTSdtemp,gTSetemp,deltaM,         & 
& epsI,check,gChacFucFvFdi)

gChacFucFvFd(i_run,:,:,:) = gChacFucFvFdi 
gT(i_run) = gT(i_run) + Sum(gChacFucFvFdi) 
...
gChacFucFucFdi = 0._dp 
Call ChaTocFucFucFd(i_run,MFu,MFd,MSd,MCha,cplcChacFuSdL,cplcChacFuSdR,               & 
& cplcFdcFucSdL,cplcFdcFucSdR,IntegralSs,IntegralSSss,IntegralSSst,NSs,NSSss,            & 
& NSSst,gTSdtemp,deltaM,epsI,check,gChacFucFucFdi)

gChacFucFucFd(i_run,:,:,:) = gChacFucFucFdi 
gT(i_run) = gT(i_run) + Sum(gChacFucFucFdi) 
 
gChacFvFvFei = 0._dp 
Call ChaTocFvFvFe(i_run,MFe,MSe,MCha,cplcChacFvSeL,cplcChacFvSeR,cplFeFvcSeL,         & 
& cplFeFvcSeR,IntegralSs,IntegralSSss,NSs,NSSss,gTSetemp,deltaM,epsI,check,              & 
& gChacFvFvFei)

gChacFvFvFe(i_run,:,:,:) = gChacFvFvFei 
gT(i_run) = gT(i_run) + Sum(gChacFvFvFei) 
 
gChacFvcFvFei = 0._dp 
Call ChaTocFvcFvFe(i_run,MFe,MSe,MCha,cplcChacFvSeL,cplcChacFvSeR,cplcFvFecSeL,       & 
& cplcFvFecSeR,IntegralSs,IntegralSSss,IntegralSSst,NSs,NSSss,NSSst,gTSetemp,            & 
& deltaM,epsI,check,gChacFvcFvFei)

gChacFvcFvFe(i_run,:,:,:) = gChacFvcFvFei 
gT(i_run) = gT(i_run) + Sum(gChacFvcFvFei) 
...
Do gt1=1,3
  Do gt2=gt1,3
    Do gt3=gt2,3
gPartial(i1,n_length)= gChaFdFdFd(i1,gt1,gt2,gt3)
n_length=n_length+1
     End Do 
  End Do 
End Do 
...
Do gt1=1,3
  Do gt2=1,3
    Do gt3=1,3
gPartial(i1,n_length)= gChacFuFvFd(i1,gt1,gt2,gt3)
n_length=n_length+1
     End Do 
  End Do 
End Do 
Do gt1=1,3
  Do gt2=1,3
    Do gt3=1,3
gPartial(i1,n_length)= gChacFucFvFd(i1,gt1,gt2,gt3)
n_length=n_length+1
     End Do 
  End Do 
End Do 
...
Do gt1=1,3
  Do gt2=gt1,3
    Do gt3=1,3
gPartial(i1,n_length)= gChacFucFucFd(i1,gt1,gt2,gt3)
n_length=n_length+1
     End Do 
  End Do 
End Do 
Do gt1=1,3
  Do gt2=1,3
    Do gt3=1,3
gPartial(i1,n_length)= gChacFvFvFe(i1,gt1,gt2,gt3)
n_length=n_length+1
     End Do 
  End Do 
End Do 
Do gt1=1,3
  Do gt2=gt1,3
    Do gt3=1,3
gPartial(i1,n_length)= gChacFvcFvFe(i1,gt1,gt2,gt3)
n_length=n_length+1
     End Do 
  End Do 
End Do 
...
Subroutine ChaToFdFdFd(iIN,MFd,MSu,MCha,cplcChaFdcSuL,cplcChaFdcSuR,cplFdFdSuL,       & 
& cplFdFdSuR,IntegralSs,IntegralSSss,IntegralSSst,NSs,NSSss,NSSst,gTSu,deltaM,           & 
& epsI,check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MFd(3),MSu(6),MCha(2)

Complex(dp),Intent(in) :: cplcChaFdcSuL(2,3,6),cplcChaFdcSuR(2,3,6),cplFdFdSuL(3,3,6),cplFdFdSuR(3,3,6)
...
If(Abs(MCha(iIN)).gt.(Abs(MFd(gt3))+Abs(MFd(gt2))+Abs(MFd(gt1)))) Then 
!-------------- 
!  conj[Su] 
!-------------- 
Do i1=1,6
...
coup(4) = Conjg(cplFdFdSuL(gt2,gt3,i1)) 
coup(3) = Conjg(cplFdFdSuR(gt2,gt3,i1))
Call IntegrateScalarSS(Boson2,mass,coup,deltaM,epsI,IntegralSs,NSs,resR, check) 
If (gt1.Eq.gt2) Then 
resR=resR/2._dp 
End If
resR= 6*resR ! color factor 
resS = resS + resR 
...
coup(2) = Conjg(cplcChaFdcSuL(iIN,gt2,i1)) 
coup(1) = Conjg(cplcChaFdcSuR(iIN,gt2,i1)) 
coup(4) = Conjg(cplFdFdSuL(gt1,gt3,i1)) 
coup(3) = Conjg(cplFdFdSuR(gt1,gt3,i1))
Call IntegrateScalarSS(Boson2,mass,coup,deltaM,epsI,IntegralSs,NSs,resR, check) 
If (gt1.Eq.gt2) Then 
resR=resR/2._dp 
End If
...
coup2(3) = Conjg(cplcChaFdcSuL(iIN,gt1,i1)) 
coup2(4) = Conjg(cplcChaFdcSuR(iIN,gt1,i1))  
coup2(5) = cplFdFdSuL(gt2,gt3,i1) 
coup2(6) = cplFdFdSuR(gt2,gt3,i1) 
coup2(7) = Conjg(cplFdFdSuL(gt2,gt3,i1)) 
coup2(8) = Conjg(cplFdFdSuR(gt2,gt3,i1)) 
Call IntegrateScalarS1S2(Boson4, mass, coup2, deltaM, epsI,IntegralSSss,NSSss, resC, check) 
If (resC.ne.resC) resC = 0._dp
resC = -2._dp*resC 
...
coup2(3) = Conjg(cplcChaFdcSuL(iIN,gt1,i1)) 
coup2(4) = Conjg(cplcChaFdcSuR(iIN,gt1,i1))  
coup2(5) = cplFdFdSuL(gt1,gt2,i1) 
coup2(6) = cplFdFdSuR(gt1,gt2,i1) 
coup2(7) = Conjg(cplFdFdSuL(gt2,gt3,i1)) 
coup2(8) = Conjg(cplFdFdSuR(gt2,gt3,i1)) 
Call IntegrateScalarST(Boson4, mass, coup2, deltaM, epsI,IntegralSSst,NSSst, resC, check) 
If (resC.ne.resC) resC = 0._dp
...
coup2(1) = cplcChaFdcSuL(iIN,gt2,i1) 
coup2(2) = cplcChaFdcSuR(iIN,gt2,i1) 
coup2(3) = Conjg(cplcChaFdcSuL(iIN,gt1,i1)) 
coup2(4) = Conjg(cplcChaFdcSuR(iIN,gt1,i1))  
coup2(5) = cplFdFdSuL(gt1,gt3,i1) 
coup2(6) = cplFdFdSuR(gt1,gt3,i1) 
coup2(7) = Conjg(cplFdFdSuL(gt2,gt3,i1)) 
coup2(8) = Conjg(cplFdFdSuR(gt2,gt3,i1)) 
Call IntegrateScalarST(Boson4, mass, coup2, deltaM, epsI,IntegralSSst,NSSst, resC, check) 
If (resC.ne.resC) resC = 0._dp
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Cha->Fd Fd Fd Propagator: conj[Su]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
coup2(5) = cplFdFdSuL(gt2,gt3,i1) 
coup2(6) = cplFdFdSuR(gt2,gt3,i1) 
coup2(7) = Conjg(cplFdFdSuL(gt2,gt3,i2)) 
coup2(8) = Conjg(cplFdFdSuR(gt2,gt3,i2)) 
Call IntegrateScalarS1S2(Boson4, mass, coup2, deltaM, epsI,IntegralSSss,NSSss, resC, check) 
If (resC.ne.resC) resC = 0._dp
resC = -2._dp*resC 
resC= 6*resC ! color factor 
...
coup2(1) = cplcChaFdcSuL(iIN,gt1,i1) 
coup2(2) = cplcChaFdcSuR(iIN,gt1,i1) 
coup2(3) = Conjg(cplcChaFdcSuL(iIN,gt2,i2)) 
coup2(4) = Conjg(cplcChaFdcSuR(iIN,gt2,i2))  
coup2(5) = cplFdFdSuL(gt2,gt3,i1) 
coup2(6) = cplFdFdSuR(gt2,gt3,i1) 
coup2(7) = Conjg(cplFdFdSuL(gt1,gt3,i2)) 
coup2(8) = Conjg(cplFdFdSuR(gt1,gt3,i2)) 
Call IntegrateScalarST(Boson4, mass, coup2, deltaM, epsI,IntegralSSst,NSSst, resC, check) 
If (resC.ne.resC) resC = 0._dp
resC = -2._dp*resC 
resC= -6*resC ! color factor 
...
coup2(5) = cplFdFdSuL(gt2,gt3,i1) 
coup2(6) = cplFdFdSuR(gt2,gt3,i1) 
coup2(7) = Conjg(cplFdFdSuL(gt2,gt1,i2)) 
coup2(8) = Conjg(cplFdFdSuR(gt2,gt1,i2)) 
Call IntegrateScalarST(Boson4, mass, coup2, deltaM, epsI,IntegralSSst,NSSst, resC, check) 
If (resC.ne.resC) resC = 0._dp
resC = -2._dp*resC 
resC= -6*resC ! color factor 
...
coup2(5) = cplFdFdSuL(gt2,gt3,i1) 
coup2(6) = cplFdFdSuR(gt2,gt3,i1) 
coup2(7) = Conjg(cplFdFdSuL(gt1,gt2,i2)) 
coup2(8) = Conjg(cplFdFdSuR(gt1,gt2,i2)) 
Call IntegrateScalarST(Boson4, mass, coup2, deltaM, epsI,IntegralSSst,NSSst, resC, check) 
If (resC.ne.resC) resC = 0._dp
resC = -2._dp*resC 
resC= -6*resC ! color factor 
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Cha->Fd Fd Fd Propagator: conj[Su],conj[Su]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
Subroutine ChaTocFuFvFd(iIN,MFu,MFd,MSd,MCha,cplcChacFuSdL,cplcChacFuSdR,             & 
& cplFdFvcSdL,cplFdFvcSdR,IntegralSs,IntegralSSss,NSs,NSSss,gTSd,deltaM,epsI,            & 
& check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MFu(3),MFd(3),MSd(6),MCha(2)

Complex(dp),Intent(in) :: cplcChacFuSdL(2,3,6),cplcChacFuSdR(2,3,6),cplFdFvcSdL(3,3,6),cplFdFvcSdR(3,3,6)
...
If(Abs(MCha(iIN)).gt.(Abs(MFd(gt3))+Abs(0.)+Abs(MFu(gt1)))) Then 
!-------------- 
!  Sd 
!-------------- 
Do i1=1,6
...
coup(4) = Conjg(cplFdFvcSdL(gt3,gt2,i1)) 
coup(3) = Conjg(cplFdFvcSdR(gt3,gt2,i1))
Call IntegrateScalarSS(Boson2,mass,coup,deltaM,epsI,IntegralSs,NSs,resR, check) 
resR= 3*resR ! color factor 
resS = resS + resR 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Cha->cFu Fv Fd Propagator: Sd" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
coup2(5) = cplFdFvcSdL(gt3,gt2,i1) 
coup2(6) = cplFdFvcSdR(gt3,gt2,i1) 
coup2(7) = Conjg(cplFdFvcSdL(gt3,gt2,i2)) 
coup2(8) = Conjg(cplFdFvcSdR(gt3,gt2,i2)) 
Call IntegrateScalarS1S2(Boson4, mass, coup2, deltaM, epsI,IntegralSSss,NSSss, resC, check) 
If (resC.ne.resC) resC = 0._dp
resC = 2._dp*resC 
resC= 3*resC ! color factor 
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Cha->cFu Fv Fd Propagator: Sd,Sd" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
End If
   ...
   End Do 
  g = oo512pi3 / Abs(MCha(iIN))**3*g
End Subroutine ChaTocFuFvFd 
 
 
Subroutine ChaTocFucFvFd(iIN,MFu,MFd,MSd,MSe,MCha,cplcChacFuSdL,cplcChacFuSdR,        & 
& cplcChacFvSeL,cplcChacFvSeR,cplcFuFdcSeL,cplcFuFdcSeR,cplcFvFdcSdL,cplcFvFdcSdR,       & 
& IntegralSs,IntegralSSss,IntegralSSst,NSs,NSSss,NSSst,gTSd,gTSe,deltaM,epsI,            & 
& check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MFu(3),MFd(3),MSd(6),MSe(6),MCha(2)

Complex(dp),Intent(in) :: cplcChacFuSdL(2,3,6),cplcChacFuSdR(2,3,6),cplcChacFvSeL(2,3,6),cplcChacFvSeR(2,3,6),  & 
& cplcFuFdcSeL(3,3,6),cplcFuFdcSeR(3,3,6),cplcFvFdcSdL(3,3,6),cplcFvFdcSdR(3,3,6)

Real(dp),Intent(inout) :: IntegralSs(500000,10)

Complex(dp),Intent(inout) :: IntegralSSss(500000,12),IntegralSSst(500000,16)

Real(dp),Intent(inout) :: gTSd(6),gTSe(6)
...
coup(2) = Conjg(cplcChacFuSdL(iIN,gt1,i1)) 
coup(1) = Conjg(cplcChacFuSdR(iIN,gt1,i1)) 
coup(4) = Conjg(cplcFvFdcSdL(gt2,gt3,i1)) 
coup(3) = Conjg(cplcFvFdcSdR(gt2,gt3,i1))
Call IntegrateScalarSS(Boson2,mass,coup,deltaM,epsI,IntegralSs,NSs,resR, check) 
resR= 3*resR ! color factor 
resS = resS + resR 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Cha->cFu cFv Fd Propagator: Sd" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
coup(2) = Conjg(cplcChacFvSeL(iIN,gt2,i1)) 
coup(1) = Conjg(cplcChacFvSeR(iIN,gt2,i1)) 
coup(4) = Conjg(cplcFuFdcSeL(gt1,gt3,i1)) 
coup(3) = Conjg(cplcFuFdcSeR(gt1,gt3,i1))
Call IntegrateScalarSS(Boson2,mass,coup,deltaM,epsI,IntegralSs,NSs,resR, check) 
resR= 3*resR ! color factor 
resS = resS + resR 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Cha->cFu cFv Fd Propagator: Se" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
coup2(3) = Conjg(cplcChacFuSdL(iIN,gt1,i2)) 
coup2(4) = Conjg(cplcChacFuSdR(iIN,gt1,i2))  
coup2(5) = cplcFvFdcSdL(gt2,gt3,i1) 
coup2(6) = cplcFvFdcSdR(gt2,gt3,i1) 
coup2(7) = Conjg(cplcFvFdcSdL(gt2,gt3,i2)) 
coup2(8) = Conjg(cplcFvFdcSdR(gt2,gt3,i2)) 
Call IntegrateScalarS1S2(Boson4, mass, coup2, deltaM, epsI,IntegralSSss,NSSss, resC, check) 
If (resC.ne.resC) resC = 0._dp
resC = 2._dp*resC 
resC= 3*resC ! color factor 
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Cha->cFu cFv Fd Propagator: Sd,Sd" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
coup2(5) = cplcFvFdcSdL(gt2,gt3,i1) 
coup2(6) = cplcFvFdcSdR(gt2,gt3,i1) 
coup2(7) = Conjg(cplcFuFdcSeL(gt1,gt3,i2)) 
coup2(8) = Conjg(cplcFuFdcSeR(gt1,gt3,i2)) 
Call IntegrateScalarST(Boson4, mass, coup2, deltaM, epsI,IntegralSSst,NSSst, resC, check) 
If (resC.ne.resC) resC = 0._dp
resC = -2._dp*resC 
resC= 3*resC ! color factor 
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Cha->cFu cFv Fd Propagator: Sd,Se" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
gSum(gt1,gt2,gt3,Isum)= resS  
End If 
Contribution(gt1,gt2,gt3,Isum)='Sd,Se'
        End Do 
      End Do 
...
coup2(3) = Conjg(cplcChacFvSeL(iIN,gt2,i2)) 
coup2(4) = Conjg(cplcChacFvSeR(iIN,gt2,i2))  
coup2(5) = cplcFuFdcSeL(gt1,gt3,i1) 
coup2(6) = cplcFuFdcSeR(gt1,gt3,i1) 
coup2(7) = Conjg(cplcFuFdcSeL(gt1,gt3,i2)) 
coup2(8) = Conjg(cplcFuFdcSeR(gt1,gt3,i2)) 
Call IntegrateScalarS1S2(Boson4, mass, coup2, deltaM, epsI,IntegralSSss,NSSss, resC, check) 
If (resC.ne.resC) resC = 0._dp
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Cha->cFu cFv Fd Propagator: Se,Se" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
Subroutine ChaTocFucFucFd(iIN,MFu,MFd,MSd,MCha,cplcChacFuSdL,cplcChacFuSdR,           & 
& cplcFdcFucSdL,cplcFdcFucSdR,IntegralSs,IntegralSSss,IntegralSSst,NSs,NSSss,            & 
& NSSst,gTSd,deltaM,epsI,check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MFu(3),MFd(3),MSd(6),MCha(2)

Complex(dp),Intent(in) :: cplcChacFuSdL(2,3,6),cplcChacFuSdR(2,3,6),cplcFdcFucSdL(3,3,6),cplcFdcFucSdR(3,3,6)
...
If(Abs(MCha(iIN)).gt.(Abs(MFd(gt3))+Abs(MFu(gt2))+Abs(MFu(gt1)))) Then 
!-------------- 
!  Sd 
!-------------- 
Do i1=1,6
...
coup(2) = Conjg(cplcChacFuSdL(iIN,gt1,i1)) 
coup(1) = Conjg(cplcChacFuSdR(iIN,gt1,i1)) 
coup(4) = Conjg(cplcFdcFucSdL(gt3,gt2,i1)) 
coup(3) = Conjg(cplcFdcFucSdR(gt3,gt2,i1))
Call IntegrateScalarSS(Boson2,mass,coup,deltaM,epsI,IntegralSs,NSs,resR, check) 
If (gt1.Eq.gt2) Then 
resR=resR/2._dp 
End If
...
coup(2) = Conjg(cplcChacFuSdL(iIN,gt2,i1)) 
coup(1) = Conjg(cplcChacFuSdR(iIN,gt2,i1)) 
coup(4) = Conjg(cplcFdcFucSdL(gt3,gt1,i1)) 
coup(3) = Conjg(cplcFdcFucSdR(gt3,gt1,i1))
Call IntegrateScalarSS(Boson2,mass,coup,deltaM,epsI,IntegralSs,NSs,resR, check) 
If (gt1.Eq.gt2) Then 
resR=resR/2._dp 
End If
...
coup2(1) = cplcChacFuSdL(iIN,gt2,i1) 
coup2(2) = cplcChacFuSdR(iIN,gt2,i1) 
coup2(3) = Conjg(cplcChacFuSdL(iIN,gt1,i1)) 
coup2(4) = Conjg(cplcChacFuSdR(iIN,gt1,i1))  
coup2(5) = cplcFdcFucSdL(gt3,gt1,i1) 
coup2(6) = cplcFdcFucSdR(gt3,gt1,i1) 
coup2(7) = Conjg(cplcFdcFucSdL(gt3,gt2,i1)) 
coup2(8) = Conjg(cplcFdcFucSdR(gt3,gt2,i1)) 
Call IntegrateScalarST(Boson4, mass, coup2, deltaM, epsI,IntegralSSst,NSSst, resC, check) 
If (resC.ne.resC) resC = 0._dp
resC = -2._dp*resC 
resC= 6*resC ! color factor 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Cha->cFu cFu cFd Propagator: Sd" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
coup2(3) = Conjg(cplcChacFuSdL(iIN,gt1,i2)) 
coup2(4) = Conjg(cplcChacFuSdR(iIN,gt1,i2))  
coup2(5) = cplcFdcFucSdL(gt3,gt2,i1) 
coup2(6) = cplcFdcFucSdR(gt3,gt2,i1) 
coup2(7) = Conjg(cplcFdcFucSdL(gt3,gt2,i2)) 
coup2(8) = Conjg(cplcFdcFucSdR(gt3,gt2,i2)) 
Call IntegrateScalarS1S2(Boson4, mass, coup2, deltaM, epsI,IntegralSSss,NSSss, resC, check) 
If (resC.ne.resC) resC = 0._dp
resC = 2._dp*resC 
resC= 6*resC ! color factor 
...
coup2(5) = cplcFdcFucSdL(gt3,gt1,i1) 
coup2(6) = cplcFdcFucSdR(gt3,gt1,i1) 
coup2(7) = Conjg(cplcFdcFucSdL(gt3,gt1,i2)) 
coup2(8) = Conjg(cplcFdcFucSdR(gt3,gt1,i2)) 
Call IntegrateScalarS1S2(Boson4, mass, coup2, deltaM, epsI,IntegralSSss,NSSss, resC, check) 
If (resC.ne.resC) resC = 0._dp
resC = 2._dp*resC 
resC= 6*resC ! color factor 
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Cha->cFu cFu cFd Propagator: Sd,Sd" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
End If
   ...
   End Do 
  g = oo512pi3 / Abs(MCha(iIN))**3*g
End Subroutine ChaTocFucFucFd 
 
 
Subroutine ChaTocFvFvFe(iIN,MFe,MSe,MCha,cplcChacFvSeL,cplcChacFvSeR,cplFeFvcSeL,     & 
& cplFeFvcSeR,IntegralSs,IntegralSSss,NSs,NSSss,gTSe,deltaM,epsI,check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MFe(3),MSe(6),MCha(2)

Complex(dp),Intent(in) :: cplcChacFvSeL(2,3,6),cplcChacFvSeR(2,3,6),cplFeFvcSeL(3,3,6),cplFeFvcSeR(3,3,6)
...
coup(2) = Conjg(cplcChacFvSeL(iIN,gt1,i1)) 
coup(1) = Conjg(cplcChacFvSeR(iIN,gt1,i1)) 
coup(4) = Conjg(cplFeFvcSeL(gt3,gt2,i1)) 
coup(3) = Conjg(cplFeFvcSeR(gt3,gt2,i1))
Call IntegrateScalarSS(Boson2,mass,coup,deltaM,epsI,IntegralSs,NSs,resR, check) 
resR= 1*resR ! color factor 
resS = resS + resR 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Cha->cFv Fv Fe Propagator: Se" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
coup2(1) = cplcChacFvSeL(iIN,gt1,i1) 
coup2(2) = cplcChacFvSeR(iIN,gt1,i1) 
coup2(3) = Conjg(cplcChacFvSeL(iIN,gt1,i2)) 
coup2(4) = Conjg(cplcChacFvSeR(iIN,gt1,i2))  
coup2(5) = cplFeFvcSeL(gt3,gt2,i1) 
coup2(6) = cplFeFvcSeR(gt3,gt2,i1) 
coup2(7) = Conjg(cplFeFvcSeL(gt3,gt2,i2)) 
coup2(8) = Conjg(cplFeFvcSeR(gt3,gt2,i2)) 
Call IntegrateScalarS1S2(Boson4, mass, coup2, deltaM, epsI,IntegralSSss,NSSss, resC, check) 
If (resC.ne.resC) resC = 0._dp
resC = 2._dp*resC 
resC= 1*resC ! color factor 
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Cha->cFv Fv Fe Propagator: Se,Se" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
End If
   ...
   End Do 
  g = oo512pi3 / Abs(MCha(iIN))**3*g
End Subroutine ChaTocFvFvFe 
 
 
Subroutine ChaTocFvcFvFe(iIN,MFe,MSe,MCha,cplcChacFvSeL,cplcChacFvSeR,cplcFvFecSeL,   & 
& cplcFvFecSeR,IntegralSs,IntegralSSss,IntegralSSst,NSs,NSSss,NSSst,gTSe,deltaM,         & 
& epsI,check,g,WriteContributions)
...
Complex(dp),Intent(in) :: cplcChacFvSeL(2,3,6),cplcChacFvSeR(2,3,6),cplcFvFecSeL(3,3,6),cplcFvFecSeR(3,3,6)
...
coup(2) = Conjg(cplcChacFvSeL(iIN,gt1,i1)) 
coup(1) = Conjg(cplcChacFvSeR(iIN,gt1,i1)) 
coup(4) = Conjg(cplcFvFecSeL(gt2,gt3,i1)) 
coup(3) = Conjg(cplcFvFecSeR(gt2,gt3,i1))
Call IntegrateScalarSS(Boson2,mass,coup,deltaM,epsI,IntegralSs,NSs,resR, check) 
If (gt1.Eq.gt2) Then 
resR=resR/2._dp 
End If
...
coup(2) = Conjg(cplcChacFvSeL(iIN,gt2,i1)) 
coup(1) = Conjg(cplcChacFvSeR(iIN,gt2,i1)) 
coup(4) = Conjg(cplcFvFecSeL(gt1,gt3,i1)) 
coup(3) = Conjg(cplcFvFecSeR(gt1,gt3,i1))
Call IntegrateScalarSS(Boson2,mass,coup,deltaM,epsI,IntegralSs,NSs,resR, check) 
If (gt1.Eq.gt2) Then 
resR=resR/2._dp 
End If
...
coup2(1) = cplcChacFvSeL(iIN,gt2,i1) 
coup2(2) = cplcChacFvSeR(iIN,gt2,i1) 
coup2(3) = Conjg(cplcChacFvSeL(iIN,gt1,i1)) 
coup2(4) = Conjg(cplcChacFvSeR(iIN,gt1,i1))  
coup2(5) = cplcFvFecSeL(gt1,gt3,i1) 
coup2(6) = cplcFvFecSeR(gt1,gt3,i1) 
coup2(7) = Conjg(cplcFvFecSeL(gt2,gt3,i1)) 
coup2(8) = Conjg(cplcFvFecSeR(gt2,gt3,i1)) 
Call IntegrateScalarST(Boson4, mass, coup2, deltaM, epsI,IntegralSSst,NSSst, resC, check) 
If (resC.ne.resC) resC = 0._dp
resC = -2._dp*resC 
resC= 1*resC ! color factor 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Cha->cFv cFv Fe Propagator: Se" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
coup2(3) = Conjg(cplcChacFvSeL(iIN,gt1,i2)) 
coup2(4) = Conjg(cplcChacFvSeR(iIN,gt1,i2))  
coup2(5) = cplcFvFecSeL(gt2,gt3,i1) 
coup2(6) = cplcFvFecSeR(gt2,gt3,i1) 
coup2(7) = Conjg(cplcFvFecSeL(gt2,gt3,i2)) 
coup2(8) = Conjg(cplcFvFecSeR(gt2,gt3,i2)) 
Call IntegrateScalarS1S2(Boson4, mass, coup2, deltaM, epsI,IntegralSSss,NSSss, resC, check) 
If (resC.ne.resC) resC = 0._dp
resC = 2._dp*resC 
resC= 1*resC ! color factor 
...
coup2(5) = cplcFvFecSeL(gt1,gt3,i1) 
coup2(6) = cplcFvFecSeR(gt1,gt3,i1) 
coup2(7) = Conjg(cplcFvFecSeL(gt1,gt3,i2)) 
coup2(8) = Conjg(cplcFvFecSeR(gt1,gt3,i2)) 
Call IntegrateScalarS1S2(Boson4, mass, coup2, deltaM, epsI,IntegralSSss,NSSss, resC, check) 
If (resC.ne.resC) resC = 0._dp
resC = 2._dp*resC 
resC= 1*resC ! color factor 
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Cha->cFv cFv Fe Propagator: Se,Se" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
End If
   ...
   End Do 
  g = oo512pi3 / Abs(MCha(iIN))**3*g
End Subroutine ChaTocFvcFvFe 
 
 
End Module Cha3Decays_MSSMTriRpV 
