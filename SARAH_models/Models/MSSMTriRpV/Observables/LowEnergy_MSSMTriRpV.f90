...
& cplcFeFdcSuR,cplFeFucSdL,cplFeFucSdR,cplFeFvcSeL,cplFeFvcSeR,cplcFeFehhL,              & 
& cplcFeFehhR,cplcFdFeSuL,cplcFdFeSuR,cplcFeFeSvL,cplcFeFeSvR,cplcFeFeVPL,               & 
& cplcFeFeVPR,cplcChaFecSvL,cplcChaFecSvR,cplcFeFecSvL,cplcFeFecSvR,cplcFvFecHpmL,       & 
& cplcFvFecHpmR,cplcFvFecSeL,cplcFvFecSeR,cplcFuFuVPL,cplcFuFuVPR,cplcFeFvHpmL,          & 
& cplcFeFvHpmR,cplcFeFvSeL,cplcFeFvSeR,cplHpmcHpmVP,cplSdcSdVP,cplcFecFuSdL,             & 
& cplcFecFuSdR,cplSecSeVP,cplcFecFvSeL,cplcFecFvSeR,cplSucSuVP,a_mu)
...
& cplcFeFecSvL(3,3,3),cplcFeFecSvR(3,3,3),cplcFvFecHpmL(3,3,2),cplcFvFecHpmR(3,3,2),     & 
& cplcFvFecSeL(3,3,6),cplcFvFecSeR(3,3,6),cplcFuFuVPL(3,3),cplcFuFuVPR(3,3),             & 
& cplcFeFvHpmL(3,3,2),cplcFeFvHpmR(3,3,2),cplcFeFvSeL(3,3,6),cplcFeFvSeR(3,3,6),         & 
& cplHpmcHpmVP(2,2),cplSdcSdVP(6,6),cplcFecFuSdL(3,3,6),cplcFecFuSdR(3,3,6),             & 
& cplSecSeVP(6,6),cplcFecFvSeL(3,3,6),cplcFecFvSeR(3,3,6),cplSucSuVP(6,6)
...
coup2L = cplcFvFecSeL(i1,gt2,i3)
coup2R = cplcFvFecSeR(i1,gt2,i3)
ratio = MSe2(i2)/0._dp
 If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
a_mu = a_mu - 2._dp*Real(coup1L*Conjg(coup1R),dp)*F4(ratio)/0.& 
      & - 2._dp*MFe(Ifermion)*(Abs(coup1L)**2 + Abs(coup1R)**2)*F1(ratio)/0._dp 
...
Do i1= 1,3
  Do i2= 1,6
   i3 = i2
  If ((0._dp.gt.mz2).Or.(MSe2(i2).gt.mz2).Or.(MSe2(i3).gt.mz2)) Then
coup1L = cplcFecFvSeL(gt1,i1,i2)
coup1R = cplcFecFvSeR(gt1,i1,i2)
coup2L = cplFeFvcSeL(gt2,i1,i3)
coup2R = cplFeFvcSeR(gt2,i1,i3)
ratio = MSe2(i2)/0._dp
 If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
a_mu = a_mu - 2._dp*Real(coup1L*Conjg(coup1R),dp)*F4(ratio)/0.& 
      & - 2._dp*MFe(Ifermion)*(Abs(coup1L)**2 + Abs(coup1R)**2)*F1(ratio)/0._dp 
...
& cplcFdFdVPR,cplcFeFdcSuL,cplcFeFdcSuR,cplFeFucSdL,cplFeFucSdR,cplFeFvcSeL,             & 
...
& cplcFvFecSeR,cplcFvFecVWmL,cplcFvFecVWmR,cplcFuFuVPL,cplcFuFuVPR,cplcFeFvHpmL,         & 
& cplcFeFvHpmR,cplcFeFvSeL,cplcFeFvSeR,cplcFeFvVWmL,cplcFeFvVWmR,cplHpmcHpmVP,           & 
& cplSdcSdVP,cplcFecFuSdL,cplcFecFuSdR,cplSecSeVP,cplcFecFvSeL,cplcFecFvSeR,             & 
...
& cplcChaFecSvR(2,3,3),cplcFeFecSvL(3,3,3),cplcFeFecSvR(3,3,3),cplcFvFecHpmL(3,3,2),     & 
& cplcFvFecHpmR(3,3,2),cplcFvFecSeL(3,3,6),cplcFvFecSeR(3,3,6),cplcFvFecVWmL(3,3),       & 
& cplcFvFecVWmR(3,3),cplcFuFuVPL(3,3),cplcFuFuVPR(3,3),cplcFeFvHpmL(3,3,2),              & 
& cplcFeFvHpmR(3,3,2),cplcFeFvSeL(3,3,6),cplcFeFvSeR(3,3,6),cplcFeFvVWmL(3,3),           & 
& cplcFeFvVWmR(3,3),cplHpmcHpmVP(2,2),cplSdcSdVP(6,6),cplcFecFuSdL(3,3,6),               & 
& cplcFecFuSdR(3,3,6),cplSecSeVP(6,6),cplcFecFvSeL(3,3,6),cplcFecFvSeR(3,3,6),           & 
...
End Function C1C2 
End Module LowEnergy_MSSMTriRpV 
