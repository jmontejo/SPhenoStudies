...
Complex(dp) :: YdIN(3,3),YeIN(3,3),L1IN(3,3,3),L2IN(3,3,3),L3IN(3,3,3),YuIN(3,3)

Real(dp) :: g1MZ,g2MZ,g3MZ

Complex(dp) :: YdMZ(3,3),YeMZ(3,3),L1MZ(3,3,3),L2MZ(3,3,3),L3MZ(3,3,3),YuMZ(3,3)

Real(dp) :: g1GUT,g2GUT,g3GUT

Complex(dp) :: YdGUT(3,3),YeGUT(3,3),L1GUT(3,3,3),L2GUT(3,3,3),L3GUT(3,3,3),YuGUT(3,3)

Real(dp) :: mHd2IN,mHu2IN

Complex(dp) :: MuIN,TdIN(3,3),TeIN(3,3),T1IN(3,3,3),T2IN(3,3,3),T3IN(3,3,3),TuIN(3,3),               & 
& BmuIN,mq2IN(3,3),ml2IN(3,3),md2IN(3,3),mu2IN(3,3),me2IN(3,3),M1IN,M2IN,M3IN

Real(dp) :: mHd2MZ,mHu2MZ

Complex(dp) :: MuMZ,TdMZ(3,3),TeMZ(3,3),T1MZ(3,3,3),T2MZ(3,3,3),T3MZ(3,3,3),TuMZ(3,3),               & 
& BmuMZ,mq2MZ(3,3),ml2MZ(3,3),md2MZ(3,3),mu2MZ(3,3),me2MZ(3,3),M1MZ,M2MZ,M3MZ

Real(dp) :: mHd2GUT,mHu2GUT

Complex(dp) :: MuGUT,TdGUT(3,3),TeGUT(3,3),T1GUT(3,3,3),T2GUT(3,3,3),T3GUT(3,3,3),TuGUT(3,3),        & 
& BmuGUT,mq2GUT(3,3),ml2GUT(3,3),md2GUT(3,3),mu2GUT(3,3),me2GUT(3,3),M1GUT,              & 
& M2GUT,M3GUT
...
Real(dp) :: gPSd(6,3213),gTSd(6),BRSd(6,3213),gPSu(6,2367),gTSu(6),BRSu(6,2367),gPSe(6,2463),     & 
...
Real(dp) :: gP1LSd(6,201),gT1LSd(6),BR1LSd(6,201),gP1LSu(6,129),gT1LSu(6),BR1LSu(6,129),          & 
& gP1LSe(6,147),gT1LSe(6),BR1LSe(6,147),gP1LSv(3,129),gT1LSv(3),BR1LSv(3,129),           & 
...
& gP1LFu(3,114),gT1LFu(3),BR1LFu(3,114)
...
Logical, save :: InputValueforT3 =.False. 
...
& g1,g2,g3,Yd,Ye,L1,L2,L3,Yu,Mu,Td,Te,T1,T2,T3,Tu,Bmu,mq2,ml2,mHd2,mHu2,md2,             & 
& mu2,me2,M1,M2,M3,MZsuffix)
...
End Module Model_Data_MSSMTriRpV