...
! ------------------------------------------------------------------------------  
! File created at 21:38 on 24.8.2021   
! ----------------------------------------------------------------------  
 
 
Module LoopMasses_MSSMTriRpV 
...
Use Tadpoles_MSSMTriRpV 
 Use EffectivePotential_MSSMTriRpV 
 Use Pole2L_MSSMTriRpV 
...
& cplcFdcUFvSdL(3,3,6),cplcFdcUFvSdR(3,3,6),cplcFdFdcUSvL(3,3,3),cplcFdFdcUSvR(3,3,3),   & 
...
& cplcFdUChiSdR(3,4,6),cplcFecUFuSdL(3,3,6),cplcFecUFuSdR(3,3,6),cplcFecUFvSeL(3,3,6),   & 
& cplcFecUFvSeR(3,3,6),cplcFeFdcUSuL(3,3,6),cplcFeFdcUSuR(3,3,6),cplcFeFecUSvL(3,3,3),   & 
...
& cplcFuFdcUSeL(3,3,6),cplcFuFdcUSeR(3,3,6),cplcFuFdcVWmL(3,3),cplcFuFdcVWmR(3,3),       & 
& cplcFuFuUAhL(3,3,2),cplcFuFuUAhR(3,3,2),cplcFuFuUhhL(3,3,2),cplcFuFuUhhR(3,3,2),       & 
& cplcFuFuVGL(3,3),cplcFuFuVGR(3,3),cplcFuFuVPL(3,3),cplcFuFuVPR(3,3),cplcFuFuVZL(3,3),  & 
& cplcFuFuVZR(3,3),cplcFuGluSuL(3,6),cplcFuGluSuR(3,6),cplcFuUChiSuL(3,4,6),             & 
& cplcFuUChiSuR(3,4,6),cplcFvFdcUSdL(3,3,6),cplcFvFdcUSdR(3,3,6),cplcFvFecUHpmL(3,3,2),  & 
& cplcFvFecUHpmR(3,3,2),cplcFvFecUSeL(3,3,6),cplcFvFecUSeR(3,3,6),cplcFvFecVWmL(3,3),    & 
& cplcFvFecVWmR(3,3),cplcFvFvVZL(3,3),cplcFvFvVZR(3,3),cplcFvUChiSvL(3,4,3),             & 
& cplcFvUChiSvR(3,4,3),cplcgAgWmcVWm,cplcgGgGVG,cplcgWmgWmUAh(2),cplcgWmgWmUhh(2),       & 
& cplcgWmgWmVP,cplcgWmgWmVZ,cplcgWmgZUHpm(2),cplcgWpCgAcVWm,cplcgWpCgWpCUAh(2),          & 
& cplcgWpCgWpCUhh(2),cplcgWpCgWpCVP,cplcgWpCgWpCVZ,cplcgWpCgZcUHpm(2),cplcgWpCgZcVWm,    & 
& cplcgZgWmcUHpm(2),cplcgZgWmcVWm,cplcgZgWpCUHpm(2),cplcgZgZUhh(2),cplChaFucUSdL(2,3,6), & 
& cplChaFucUSdR(2,3,6),cplChaFvcUSeL(2,3,6),cplChaFvcUSeR(2,3,6),cplChiChacUHpmL(4,2,2), & 
...
& cplChiFvcUSvR(4,3,3),cplcSdcSdcUSu(6,6,6),cplcUChacFuSdL(2,3,6),cplcUChacFuSdR(2,3,6)

Complex(dp) :: cplcUChacFvSeL(2,3,6),cplcUChacFvSeR(2,3,6),cplcUChaChaAhL(2,2,2),cplcUChaChaAhR(2,2,2),& 
& cplcUChaChahhL(2,2,2),cplcUChaChahhR(2,2,2),cplcUChaChaVPL(2,2),cplcUChaChaVPR(2,2),   & 
& cplcUChaChaVZL(2,2),cplcUChaChaVZR(2,2),cplcUChaChiHpmL(2,4,2),cplcUChaChiHpmR(2,4,2), & 
& cplcUChaChiVWmL(2,4),cplcUChaChiVWmR(2,4),cplcUChaFdcSuL(2,3,6),cplcUChaFdcSuR(2,3,6), & 
& cplcUChaFecSvL(2,3,3),cplcUChaFecSvR(2,3,3),cplcUFdcFdcSuL(3,3,6),cplcUFdcFdcSuR(3,3,6),& 
& cplcUFdcFucSdL(3,3,6),cplcUFdcFucSdR(3,3,6),cplcUFdcFvSdL(3,3,6),cplcUFdcFvSdR(3,3,6), & 
& cplcUFdChaSuL(3,2,6),cplcUFdChaSuR(3,2,6),cplcUFdChiSdL(3,4,6),cplcUFdChiSdR(3,4,6),   & 
& cplcUFdFdAhL(3,3,2),cplcUFdFdAhR(3,3,2),cplcUFdFdcSvL(3,3,3),cplcUFdFdcSvR(3,3,3),     & 
...
& cplcUFecFuSdL(3,3,6),cplcUFecFuSdR(3,3,6),cplcUFecFvSeL(3,3,6),cplcUFecFvSeR(3,3,6),   & 
& cplcUFeChaSvL(3,2,3),cplcUFeChaSvR(3,2,3),cplcUFeChiSeL(3,4,6),cplcUFeChiSeR(3,4,6),   & 
& cplcUFeFdcSuL(3,3,6),cplcUFeFdcSuR(3,3,6),cplcUFeFeAhL(3,3,2),cplcUFeFeAhR(3,3,2),     & 
& cplcUFeFecSvL(3,3,3),cplcUFeFecSvR(3,3,3),cplcUFeFehhL(3,3,2),cplcUFeFehhR(3,3,2),     & 
...
& cplcUFeFvVWmL(3,3),cplcUFeFvVWmR(3,3),cplcUFuChiSuL(3,4,6),cplcUFuChiSuR(3,4,6),       & 
...
& cplcUFvFdcSdL(3,3,6),cplcUFvFdcSdR(3,3,6),cplcUFvFecHpmL(3,3,2),cplcUFvFecHpmR(3,3,2), & 
& cplcUFvFecSeL(3,3,6),cplcUFvFecSeR(3,3,6),cplcUFvFecVWmL(3,3),cplcUFvFecVWmR(3,3),     & 
...
& cplcVWmVWmVZVZ2,cplcVWmVWmVZVZ3,cplFdFvcUSdL(3,3,6),cplFdFvcUSdR(3,3,6),               & 
& cplFeFucUSdL(3,3,6),cplFeFucUSdR(3,3,6),cplFeFvcUSeL(3,3,6),cplFeFvcUSeR(3,3,6),       & 
...
Complex(dp) :: cplhhHpmcVWm(2,2),cplhhSdcUSd(2,6,6),cplhhSecUSe(2,6,6),cplhhSucUSu(2,6,6),            & 
...
& cplUhhUhhcVWmVWm(2,2),cplUhhUhhhhhh(2,2,2,2),cplUhhUhhHpmcHpm(2,2,2,2),cplUhhUhhSdcSd(2,2,6,6),& 
...
Complex(dp) :: cplUSucUSucVWmVWm(6,6),cplUSucUSuVGVG(6,6),cplUSucUSuVPVP(6,6),cplUSucUSuVZVZ(6,6),    & 
...
& ZDR,L2,g3,pG,ZEL,vd,vu,ZH,Tu,ZU,ZP,T2,ZV,TW,Ye,ZE,L3,T3,L1,ZER,Te,T1,cplAhSdcUSd,      & 
& cplChaFucUSdL,cplChaFucUSdR,cplChiFdcUSdL,cplChiFdcUSdR,cplcFvFdcUSdL,cplcFvFdcUSdR,   & 
& cplGluFdcUSdL,cplGluFdcUSdR,cplFdFvcUSdL,cplFdFvcUSdR,cplFeFucUSdL,cplFeFucUSdR,       & 
& cplhhSdcUSd,cplHpmSucUSd,cplSdcUSdcSv,cplSdcUSdVG,cplSdcUSdVP,cplSdcUSdVZ,             & 
& cplSeSucUSd,cplSucUSdVWm,cplcFdcFucUSdL,cplcFdcFucUSdR,cplcUSdcSdcSu,cplAhAhUSdcUSd,   & 
...
& cplSdcSecUSu,cplSdcUSucVWm,cplSucUSuVG,cplSucUSuVP,cplSucUSuVZ,cplcFdcFdcUSuL,         & 
& cplcFdcFdcUSuR,cplcSdcSdcUSu,cplAhAhUSucUSu,cplhhhhUSucUSu,cplHpmUSucHpmcUSu,          & 
...
& cplChaFvcUSeR,cplChiFecUSeL,cplChiFecUSeR,cplcFuFdcUSeL,cplcFuFdcUSeR,cplcFvFecUSeL,   & 
& cplcFvFecUSeR,cplFeFvcUSeL,cplFeFvcUSeR,cplhhSecUSe,cplHpmSvcUSe,cplSdcUSecSu,         & 
...
& cplcUFeFeAhR,cplcUFeChaSvL,cplcUFeChaSvR,cplcUFeChiSeL,cplcUFeChiSeR,cplcUFeFdcSuL,    & 
& cplcUFeFdcSuR,cplcUFeFehhL,cplcUFeFehhR,cplcUFeFecSvL,cplcUFeFecSvR,cplcUFeFeVPL,      & 
& cplcUFeFeVPR,cplcUFeFeVZL,cplcUFeFeVZR,cplcUFeFvHpmL,cplcUFeFvHpmR,cplcUFeFvSeL,       & 
& cplcUFeFvSeR,cplcUFeFvVWmL,cplcUFeFvVWmR,cplcUFecFuSdL,cplcUFecFuSdR,cplcUFecFvSeL,    & 
& cplcUFecFvSeR,cplcUFdFdAhL,cplcUFdFdAhR,cplcUFdChaSuL,cplcUFdChaSuR,cplcUFdChiSdL,     & 
...
& cplcUFdFuVWmR,cplcUFdFvSdL,cplcUFdFvSdR,cplcUFdGluSdL,cplcUFdGluSdR,cplcUFdcFvSdL,     & 
& cplcUFdcFvSdR,cplcUFdcFdcSuL,cplcUFdcFdcSuR,cplcUFdcFucSdL,cplcUFdcFucSdR,             & 
& cplcUFuFuAhL,cplcUFuFuAhR,cplcUFuChiSuL,cplcUFuChiSuR,cplcUFuFdcHpmL,cplcUFuFdcHpmR,   & 
& cplcUFuFdcSeL,cplcUFuFdcSeR,cplcUFuFdcVWmL,cplcUFuFdcVWmR,cplcUFuFuhhL,cplcUFuFuhhR,   & 
& cplcUFuFuVGL,cplcUFuFuVGR,cplcUFuFuVPL,cplcUFuFuVPR,cplcUFuFuVZL,cplcUFuFuVZR,         & 
& cplcUFuGluSuL,cplcUFuGluSuR,cplcChacUFuSdL,cplcChacUFuSdR,cplcFecUFuSdL,               & 
& cplcFecUFuSdR,cplcFdcUFucSdL,cplcFdcUFucSdR,cplGluFdcSdL,cplGluFdcSdR,cplGluFucSuL,    & 
& cplGluFucSuR,cplGluGluVGL,cplGluGluVGR,cplcFdGluSdL,cplcFdGluSdR,cplcFuGluSuL,         & 
& cplcFuGluSuR,cplcUFvChiSvL,cplcUFvChiSvR,cplcUFvFdcSdL,cplcUFvFdcSdR,cplcUFvFecHpmL,   & 
& cplcUFvFecHpmR,cplcUFvFecSeL,cplcUFvFecSeR,cplcUFvFecVWmL,cplcUFvFecVWmR,              & 
& cplcUFvFvVZL,cplcUFvFvVZR,cplcFdcUFvSdL,cplcFdcUFvSdR,cplcChacUFvSeL,cplcChacUFvSeR,   & 
& cplcFecUFvSeL,cplcFecUFvSeR,cplcFdFdVGL,cplcFdFdVGR,cplcFuFuVGL,cplcFuFuVGR,           & 
& cplcgGgGVG,cplSdcSdVG,cplSucSuVG,cplVGVGVG,cplSdcSdVGVG,cplSucSuVGVG,cplVGVGVGVG1,     & 
& cplVGVGVGVG2,cplVGVGVGVG3,cplcChaChaVPL,cplcChaChaVPR,cplcFdFdVPL,cplcFdFdVPR,         & 
...
& L2,L3,Yu,Mu,Td,Te,T1,T2,T3,Tu,Bmu,mq2,ml2,mHd2,mHu2,md2,mu2,me2,M1,M2,M3,kont)
...
If (NewGBC) Then 
Call CalculatePi2S(125._dp**2,vd,vu,g1,g2,g3,Yd,Ye,L1,L2,L3,Yu,Mu,Td,Te,              & 
& T1,T2,T3,Tu,Bmu,mq2,ml2,mHd2,mHu2,md2,mu2,me2,M1,M2,M3,kont,ti_ep2L,Pi2S_EffPot,       & 
& PiP2S_EffPot)

Else 
Call CalculatePi2S(0._dp,vd,vu,g1,g2,g3,Yd,Ye,L1,L2,L3,Yu,Mu,Td,Te,T1,T2,             & 
& T3,Tu,Bmu,mq2,ml2,mHd2,mHu2,md2,mu2,me2,M1,M2,M3,kont,ti_ep2L,Pi2S_EffPot,             & 
& PiP2S_EffPot)
...
& cplChiFdcUSdL,cplChiFdcUSdR,cplcFvFdcUSdL,cplcFvFdcUSdR,cplGluFdcUSdL,cplGluFdcUSdR,   & 
& cplFdFvcUSdL,cplFdFvcUSdR,cplFeFucUSdL,cplFeFucUSdR,cplhhSdcUSd,cplHpmSucUSd,          & 
& cplSdcUSdcSv,cplSdcUSdVG,cplSdcUSdVP,cplSdcUSdVZ,cplSeSucUSd,cplSucUSdVWm,             & 
& cplcFdcFucUSdL,cplcFdcFucUSdR,cplcUSdcSdcSu,cplAhAhUSdcUSd,cplhhhhUSdcUSd,             & 
...
& cplSucUSuVP,cplSucUSuVZ,cplcFdcFdcUSuL,cplcFdcFdcUSuR,cplcSdcSdcUSu,cplAhAhUSucUSu,    & 
...
& MSd,MSd2,MVZ,MVZ2,MVWm,MVWm2,cplAhSecUSe,cplChaFvcUSeL,cplChaFvcUSeR,cplChiFecUSeL,    & 
& cplChiFecUSeR,cplcFuFdcUSeL,cplcFuFdcUSeR,cplcFvFecUSeL,cplcFvFecUSeR,cplFeFvcUSeL,    & 
& cplFeFvcUSeR,cplhhSecUSe,cplHpmSvcUSe,cplSdcUSecSu,cplSecUSecSv,cplSecUSeVP,           & 
...
& cplUSecUSecVWmVWm,cplUSecUSeVZVZ,0.1_dp*delta_mass,MSe_1L,MSe2_1L,ZE_1L,kont)
...
& cplChaFucUSdR,cplChiFdcUSdL,cplChiFdcUSdR,cplcFvFdcUSdL,cplcFvFdcUSdR,cplGluFdcUSdL,   & 
& cplGluFdcUSdR,cplFdFvcUSdL,cplFdFvcUSdR,cplFeFucUSdL,cplFeFucUSdR,cplhhSdcUSd,         & 
& cplHpmSucUSd,cplSdcUSdcSv,cplSdcUSdVG,cplSdcUSdVP,cplSdcUSdVZ,cplSeSucUSd,             & 
& cplSucUSdVWm,cplcFdcFucUSdL,cplcFdcFucUSdR,cplcUSdcSdcSu,cplAhAhUSdcUSd,               & 
& cplhhhhUSdcUSd,cplHpmUSdcHpmcUSd,cplUSdSdcUSdcSd,cplUSdSecUSdcSe,cplUSdSucUSdcSu,      & 
& cplUSdSvcUSdcSv,cplUSdcUSdVGVG,cplUSdcUSdVPVP,cplUSdcUSdcVWmVWm,cplUSdcUSdVZVZ,        & 
...
& cplChiFdcUSdR(4,3,6),cplcFvFdcUSdL(3,3,6),cplcFvFdcUSdR(3,3,6),cplGluFdcUSdL(3,6),     & 
& cplGluFdcUSdR(3,6),cplFdFvcUSdL(3,3,6),cplFdFvcUSdR(3,3,6),cplFeFucUSdL(3,3,6),        & 
& cplFeFucUSdR(3,3,6),cplhhSdcUSd(2,6,6),cplHpmSucUSd(2,6,6),cplSdcUSdcSv(6,6,3),        & 
& cplSdcUSdVG(6,6),cplSdcUSdVP(6,6),cplSdcUSdVZ(6,6),cplSeSucUSd(6,6,6),cplSucUSdVWm(6,6),& 
& cplcFdcFucUSdL(3,3,6),cplcFdcFucUSdR(3,3,6),cplcUSdcSdcSu(6,6,6),cplAhAhUSdcUSd(2,2,6,6),& 
...
& cplcFvFdcUSdL,cplcFvFdcUSdR,cplGluFdcUSdL,cplGluFdcUSdR,cplFdFvcUSdL,cplFdFvcUSdR,     & 
& cplFeFucUSdL,cplFeFucUSdR,cplhhSdcUSd,cplHpmSucUSd,cplSdcUSdcSv,cplSdcUSdVG,           & 
& cplSdcUSdVP,cplSdcUSdVZ,cplSeSucUSd,cplSucUSdVWm,cplcFdcFucUSdL,cplcFdcFucUSdR,        & 
& cplcUSdcSdcSu,cplAhAhUSdcUSd,cplhhhhUSdcUSd,cplHpmUSdcHpmcUSd,cplUSdSdcUSdcSd,         & 
& cplUSdSecUSdcSe,cplUSdSucUSdcSu,cplUSdSvcUSdcSv,cplUSdcUSdVGVG,cplUSdcUSdVPVP,         & 
& cplUSdcUSdcVWmVWm,cplUSdcUSdVZVZ,kont,PiSf(1,:,:))
...
& cplcUSdcSdcSu,cplAhAhUSdcUSd,cplhhhhUSdcUSd,cplHpmUSdcHpmcUSd,cplUSdSdcUSdcSd,         & 
& cplUSdSecUSdcSe,cplUSdSucUSdcSu,cplUSdSvcUSdcSv,cplUSdcUSdVGVG,cplUSdcUSdVPVP,         & 
& cplUSdcUSdcVWmVWm,cplUSdcUSdVZVZ,kont,PiSf(i1,:,:))
...
& cplChiFdcUSdR,cplcFvFdcUSdL,cplcFvFdcUSdR,cplGluFdcUSdL,cplGluFdcUSdR,cplFdFvcUSdL,    & 
& cplFdFvcUSdR,cplFeFucUSdL,cplFeFucUSdR,cplhhSdcUSd,cplHpmSucUSd,cplSdcUSdcSv,          & 
& cplSdcUSdVG,cplSdcUSdVP,cplSdcUSdVZ,cplSeSucUSd,cplSucUSdVWm,cplcFdcFucUSdL,           & 
...
Do gO1 = 1, 6
  Do gO2 = gO1, 6
coupL1 = cplcFvFdcUSdL(i1,i2,gO1)
coupR1 = cplcFvFdcUSdR(i1,i2,gO1)
coupL2 =  Conjg(cplcFvFdcUSdL(i1,i2,gO2))
coupR2 =  Conjg(cplcFvFdcUSdR(i1,i2,gO2))
    SumI(gO1,gO2) = (coupL1*coupL2+coupR1*coupR2)*G0m2 & 
                & + (coupL1*coupR2+coupR1*coupL2)*B0m2 
   End Do 
End Do 
...
Do gO1 = 1, 6
  Do gO2 = gO1, 6
coupL1 = cplFdFvcUSdL(i2,i1,gO1)
coupR1 = cplFdFvcUSdR(i2,i1,gO1)
coupL2 =  Conjg(cplFdFvcUSdL(i2,i1,gO2))
coupR2 =  Conjg(cplFdFvcUSdR(i2,i1,gO2))
    SumI(gO1,gO2) = (coupL1*coupL2+coupR1*coupR2)*G0m2 & 
                & + (coupL1*coupR2+coupR1*coupL2)*B0m2 
   End Do 
End Do 
...
Do gO1 = 1, 6
  Do gO2 = gO1, 6
coupL1 = cplcFdcFucUSdL(i2,i1,gO1)
coupR1 = cplcFdcFucUSdR(i2,i1,gO1)
coupL2 =  Conjg(cplcFdcFucUSdL(i2,i1,gO2))
coupR2 =  Conjg(cplcFdcFucUSdR(i2,i1,gO2))
    SumI(gO1,gO2) = (coupL1*coupL2+coupR1*coupR2)*G0m2 & 
                & + (coupL1*coupR2+coupR1*coupL2)*B0m2 
   End Do 
End Do 
...
Do gO1 = 1, 6
  Do gO2 = gO1, 6
coup1 = cplcUSdcSdcSu(gO1,i2,i1)
coup2 = Conjg(cplcUSdcSdcSu(gO2,i2,i1))
    SumI(gO1,gO2) = coup1*coup2*B0m2 
   End Do 
End Do 
res = res +2._dp* SumI  
...
& cplSucUSuVG,cplSucUSuVP,cplSucUSuVZ,cplcFdcFdcUSuL,cplcFdcFdcUSuR,cplcSdcSdcUSu,       & 
...
& cplSdcUSucVWm(6,6),cplSucUSuVG(6,6),cplSucUSuVP(6,6),cplSucUSuVZ(6,6),cplcFdcFdcUSuL(3,3,6),& 
& cplcFdcFdcUSuR(3,3,6),cplcSdcSdcUSu(6,6,6),cplAhAhUSucUSu(2,2,6,6),cplhhhhUSucUSu(2,2,6,6),& 
...
& cplcFdcFdcUSuL,cplcFdcFdcUSuR,cplcSdcSdcUSu,cplAhAhUSucUSu,cplhhhhUSucUSu,             & 
...
Do gO1 = 1, 6
  Do gO2 = gO1, 6
coupL1 = cplcFdcFdcUSuL(i1,i2,gO1)
coupR1 = cplcFdcFdcUSuR(i1,i2,gO1)
coupL2 =  Conjg(cplcFdcFdcUSuL(i1,i2,gO2))
coupR2 =  Conjg(cplcFdcFdcUSuR(i1,i2,gO2))
    SumI(gO1,gO2) = (coupL1*coupL2+coupR1*coupR2)*G0m2 & 
                & + (coupL1*coupR2+coupR1*coupL2)*B0m2 
   End Do 
End Do 
...
Do gO1 = 1, 6
  Do gO2 = gO1, 6
coup1 = cplcSdcSdcUSu(i1,i2,gO1)
coup2 = Conjg(cplcSdcSdcUSu(i1,i2,gO2))
    SumI(gO1,gO2) = coup1*coup2*B0m2 
   End Do 
End Do 
res = res +1._dp* SumI  
...
& MSu,MSu2,MSd,MSd2,MVZ,MVZ2,MVWm,MVWm2,cplAhSecUSe,cplChaFvcUSeL,cplChaFvcUSeR,         & 
& cplChiFecUSeL,cplChiFecUSeR,cplcFuFdcUSeL,cplcFuFdcUSeR,cplcFvFecUSeL,cplcFvFecUSeR,   & 
& cplFeFvcUSeL,cplFeFvcUSeR,cplhhSecUSe,cplHpmSvcUSe,cplSdcUSecSu,cplSecUSecSv,          & 
& cplSecUSeVP,cplSecUSeVZ,cplSvcUSeVWm,cplAhAhUSecUSe,cplhhhhUSecUSe,cplHpmUSecHpmcUSe,  & 
& cplSdUSecSdcUSe,cplUSeSecUSecSe,cplUSeSucUSecSu,cplUSeSvcUSecSv,cplUSecUSeVPVP,        & 
& cplUSecUSecVWmVWm,cplUSecUSeVZVZ,delta,mass,mass2,RS,kont)
...
& cplChiFecUSeR(4,3,6),cplcFuFdcUSeL(3,3,6),cplcFuFdcUSeR(3,3,6),cplcFvFecUSeL(3,3,6),   & 
& cplcFvFecUSeR(3,3,6),cplFeFvcUSeL(3,3,6),cplFeFvcUSeR(3,3,6),cplhhSecUSe(2,6,6),       & 
& cplHpmSvcUSe(2,3,6),cplSdcUSecSu(6,6,6),cplSecUSecSv(6,6,3),cplSecUSeVP(6,6),          & 
...
& MVWm2,cplAhSecUSe,cplChaFvcUSeL,cplChaFvcUSeR,cplChiFecUSeL,cplChiFecUSeR,             & 
& cplcFuFdcUSeL,cplcFuFdcUSeR,cplcFvFecUSeL,cplcFvFecUSeR,cplFeFvcUSeL,cplFeFvcUSeR,     & 
...
& MVWm,MVWm2,cplAhSecUSe,cplChaFvcUSeL,cplChaFvcUSeR,cplChiFecUSeL,cplChiFecUSeR,        & 
& cplcFuFdcUSeL,cplcFuFdcUSeR,cplcFvFecUSeL,cplcFvFecUSeR,cplFeFvcUSeL,cplFeFvcUSeR,     & 
& cplhhSecUSe,cplHpmSvcUSe,cplSdcUSecSu,cplSecUSecSv,cplSecUSeVP,cplSecUSeVZ,            & 
& cplSvcUSeVWm,cplAhAhUSecUSe,cplhhhhUSecUSe,cplHpmUSecHpmcUSe,cplSdUSecSdcUSe,          & 
& cplUSeSecUSecSe,cplUSeSucUSecSu,cplUSeSvcUSecSv,cplUSecUSeVPVP,cplUSecUSecVWmVWm,      & 
& cplUSecUSeVZVZ,kont,res)
...
Do gO1 = 1, 6
  Do gO2 = gO1, 6
coupL1 = cplcFvFecUSeL(i1,i2,gO1)
coupR1 = cplcFvFecUSeR(i1,i2,gO1)
coupL2 =  Conjg(cplcFvFecUSeL(i1,i2,gO2))
coupR2 =  Conjg(cplcFvFecUSeR(i1,i2,gO2))
    SumI(gO1,gO2) = (coupL1*coupL2+coupR1*coupR2)*G0m2 & 
                & + (coupL1*coupR2+coupR1*coupL2)*B0m2 
   End Do 
End Do 
...
Do gO1 = 1, 6
  Do gO2 = gO1, 6
coupL1 = cplFeFvcUSeL(i2,i1,gO1)
coupR1 = cplFeFvcUSeR(i2,i1,gO1)
coupL2 =  Conjg(cplFeFvcUSeL(i2,i1,gO2))
coupR2 =  Conjg(cplFeFvcUSeR(i2,i1,gO2))
    SumI(gO1,gO2) = (coupL1*coupL2+coupR1*coupR2)*G0m2 & 
                & + (coupL1*coupR2+coupR1*coupL2)*B0m2 
   End Do 
End Do 
...
& cplUChiFucSuR,cplUChiFvcSvL,cplUChiFvcSvR,cplcChaUChiHpmL,cplcChaUChiHpmR,             & 
& cplcFdUChiSdL,cplcFdUChiSdR,cplcFeUChiSeL,cplcFeUChiSeR,cplcFuUChiSuL,cplcFuUChiSuR,   & 
& cplcFvUChiSvL,cplcFvUChiSvR,cplcChaUChiVWmL,cplcChaUChiVWmR,delta,MChi_1L,             & 
& MChi2_1L,ZN_1L,ierr)
...
& cplUChiFvcSvL(4,3,3),cplUChiFvcSvR(4,3,3),cplcChaUChiHpmL(2,4,2),cplcChaUChiHpmR(2,4,2),& 
& cplcFdUChiSdL(3,4,6),cplcFdUChiSdR(3,4,6),cplcFeUChiSeL(3,4,6),cplcFeUChiSeR(3,4,6),   & 
& cplcFuUChiSuL(3,4,6),cplcFuUChiSuR(3,4,6),cplcFvUChiSvL(3,4,3),cplcFvUChiSvR(3,4,3),   & 
...
& cplcUFecFuSdR,cplcUFecFvSeL,cplcUFecFvSeR,delta,MFe_1L,MFe2_1L,ZEL_1L,ZER_1L,ierr)
...
& cplcUFecFvSeL(3,3,6),cplcUFecFvSeR(3,3,6)
...
& cplcUFeFecSvR,cplcUFeFeVPL,cplcUFeFeVPR,cplcUFeFeVZL,cplcUFeFeVZR,cplcUFeFvHpmL,       & 
& cplcUFeFvHpmR,cplcUFeFvSeL,cplcUFeFvSeR,cplcUFeFvVWmL,cplcUFeFvVWmR,cplcUFecFuSdL,     & 
& cplcUFecFuSdR,cplcUFecFvSeL,cplcUFecFvSeR,sigL,sigR,sigSL,sigSR)
...
B1m2 = -Real(SA_B1(p2,0._dp,MSe2(i2)),dp) 
B0m2 = 0.*Real(SA_B0(p2,0._dp,MSe2(i2)),dp) 
coupL1 = cplcUFecFvSeL(gO1,i1,i2)
coupR1 = cplcUFecFvSeR(gO1,i1,i2)
coupL2 =  Conjg(cplcUFecFvSeL(gO2,i1,i2))
coupR2 =  Conjg(cplcUFecFvSeR(gO2,i1,i2))
SumSL(gO1,gO2) = coupR1*coupL2*B0m2 
SumSR(gO1,gO2) = coupL1*coupR2*B0m2 
sumR(gO1,gO2) = coupR1*coupR2*B1m2 
sumL(gO1,gO2) = coupL1*coupL2*B1m2 
...
& cplcUFdcFvSdL,cplcUFdcFvSdR,cplcUFdcFdcSuL,cplcUFdcFdcSuR,cplcUFdcFucSdL,              & 
& cplcUFdcFucSdR,delta,MFd_1L,MFd2_1L,ZDL_1L,ZDR_1L,ierr)
...
& cplcUFdFuSeL(3,3,6),cplcUFdFuSeR(3,3,6),cplcUFdFuVWmL(3,3),cplcUFdFuVWmR(3,3),         & 
& cplcUFdFvSdL(3,3,6),cplcUFdFvSdR(3,3,6),cplcUFdGluSdL(3,6),cplcUFdGluSdR(3,6),         & 
& cplcUFdcFvSdL(3,3,6),cplcUFdcFvSdR(3,3,6),cplcUFdcFdcSuL(3,3,6),cplcUFdcFdcSuR(3,3,6), & 
& cplcUFdcFucSdL(3,3,6),cplcUFdcFucSdR(3,3,6)
...
& cplcUFdFuVWmL,cplcUFdFuVWmR,cplcUFdFvSdL,cplcUFdFvSdR,cplcUFdGluSdL,cplcUFdGluSdR,     & 
& cplcUFdcFvSdL,cplcUFdcFvSdR,cplcUFdcFdcSuL,cplcUFdcFdcSuR,cplcUFdcFucSdL,              & 
& cplcUFdcFucSdR,sigL,sigR,sigSL,sigSR)
...
Do gO1 = 1, 3
  Do gO2 = 1, 3
B1m2 = -Real(SA_B1(p2,0._dp,MSd2(i2)),dp) 
B0m2 = 0.*Real(SA_B0(p2,0._dp,MSd2(i2)),dp) 
coupL1 = cplcUFdcFvSdL(gO1,i1,i2)
coupR1 = cplcUFdcFvSdR(gO1,i1,i2)
coupL2 =  Conjg(cplcUFdcFvSdL(gO2,i1,i2))
coupR2 =  Conjg(cplcUFdcFvSdR(gO2,i1,i2))
SumSL(gO1,gO2) = coupR1*coupL2*B0m2 
SumSR(gO1,gO2) = coupL1*coupR2*B0m2 
sumR(gO1,gO2) = coupR1*coupR2*B1m2 
sumL(gO1,gO2) = coupL1*coupL2*B1m2 
...
B1m2 = -Real(SA_B1(p2,MFd2(i2),MSu2(i1)),dp) 
B0m2 = MFd(i2)*Real(SA_B0(p2,MFd2(i2),MSu2(i1)),dp) 
coupL1 = cplcUFdcFdcSuL(gO1,i2,i1)
coupR1 = cplcUFdcFdcSuR(gO1,i2,i1)
coupL2 =  Conjg(cplcUFdcFdcSuL(gO2,i2,i1))
coupR2 =  Conjg(cplcUFdcFdcSuR(gO2,i2,i1))
SumSL(gO1,gO2) = coupR1*coupL2*B0m2 
SumSR(gO1,gO2) = coupL1*coupR2*B0m2 
sumR(gO1,gO2) = coupR1*coupR2*B1m2 
sumL(gO1,gO2) = coupL1*coupL2*B1m2 
   End Do 
End Do 
SigL = SigL +2._dp* sumL
SigR = SigR +2._dp* sumR 
SigSL = SigSL +2._dp* sumSL 
SigSR = SigSR +2._dp* sumSR 
      End Do 
     End Do 
 !------------------------ 
! conj[Sd], bar[Fu] 
...
Do gO1 = 1, 3
  Do gO2 = 1, 3
B1m2 = -Real(SA_B1(p2,MFu2(i2),MSd2(i1)),dp) 
B0m2 = MFu(i2)*Real(SA_B0(p2,MFu2(i2),MSd2(i1)),dp) 
coupL1 = cplcUFdcFucSdL(gO1,i2,i1)
coupR1 = cplcUFdcFucSdR(gO1,i2,i1)
coupL2 =  Conjg(cplcUFdcFucSdL(gO2,i2,i1))
coupR2 =  Conjg(cplcUFdcFucSdR(gO2,i2,i1))
SumSL(gO1,gO2) = coupR1*coupL2*B0m2 
SumSR(gO1,gO2) = coupL1*coupR2*B0m2 
sumR(gO1,gO2) = coupR1*coupR2*B1m2 
sumL(gO1,gO2) = coupL1*coupL2*B1m2 
...
& cplcFecUFuSdL,cplcFecUFuSdR,cplcFdcUFucSdL,cplcFdcUFucSdR,delta,MFu_1L,MFu2_1L,        & 
& ZUL_1L,ZUR_1L,ierr)
...
& cplcFdcUFucSdL(3,3,6),cplcFdcUFucSdR(3,3,6)
...
& cplcUFuFuhhL,cplcUFuFuhhR,cplcUFuFuVGL,cplcUFuFuVGR,cplcUFuFuVPL,cplcUFuFuVPR,         & 
& cplcUFuFuVZL,cplcUFuFuVZR,cplcUFuGluSuL,cplcUFuGluSuR,cplcChacUFuSdL,cplcChacUFuSdR,   & 
& cplcFecUFuSdL,cplcFecUFuSdR,cplcFdcUFucSdL,cplcFdcUFucSdR,sigL,sigR,sigSL,sigSR)
...
Do gO1 = 1, 3
  Do gO2 = 1, 3
B1m2 = -Real(SA_B1(p2,MFd2(i2),MSd2(i1)),dp) 
B0m2 = MFd(i2)*Real(SA_B0(p2,MFd2(i2),MSd2(i1)),dp) 
coupL1 = cplcFdcUFucSdL(i2,gO1,i1)
coupR1 = cplcFdcUFucSdR(i2,gO1,i1)
coupL2 =  Conjg(cplcFdcUFucSdL(i2,gO2,i1))
coupR2 =  Conjg(cplcFdcUFucSdR(i2,gO2,i1))
SumSL(gO1,gO2) = coupR1*coupL2*B0m2 
SumSR(gO1,gO2) = coupL1*coupR2*B0m2 
sumR(gO1,gO2) = coupR1*coupR2*B1m2 
sumL(gO1,gO2) = coupL1*coupL2*B1m2 
...
Subroutine Sigma1LoopFv(p2,MSv,MSv2,MChi,MChi2,MSd,MSd2,MFd,MFd2,MHpm,MHpm2,          & 
& MFe,MFe2,MSe,MSe2,MVWm,MVWm2,MVZ,MVZ2,MCha,MCha2,cplcUFvChiSvL,cplcUFvChiSvR,          & 
& cplcUFvFdcSdL,cplcUFvFdcSdR,cplcUFvFecHpmL,cplcUFvFecHpmR,cplcUFvFecSeL,               & 
& cplcUFvFecSeR,cplcUFvFecVWmL,cplcUFvFecVWmR,cplcUFvFvVZL,cplcUFvFvVZR,cplcFdcUFvSdL,   & 
& cplcFdcUFvSdR,cplcChacUFvSeL,cplcChacUFvSeR,cplcFecUFvSeL,cplcFecUFvSeR,               & 
& sigL,sigR,sigSL,sigSR)

Implicit None 
Real(dp), Intent(in) :: MSv(3),MSv2(3),MChi(4),MChi2(4),MSd(6),MSd2(6),MFd(3),MFd2(3),MHpm(2),MHpm2(2),       & 
& MFe(3),MFe2(3),MSe(6),MSe2(6),MVWm,MVWm2,MVZ,MVZ2,MCha(2),MCha2(2)

Complex(dp), Intent(in) :: cplcUFvChiSvL(3,4,3),cplcUFvChiSvR(3,4,3),cplcUFvFdcSdL(3,3,6),cplcUFvFdcSdR(3,3,6),  & 
& cplcUFvFecHpmL(3,3,2),cplcUFvFecHpmR(3,3,2),cplcUFvFecSeL(3,3,6),cplcUFvFecSeR(3,3,6), & 
& cplcUFvFecVWmL(3,3),cplcUFvFecVWmR(3,3),cplcUFvFvVZL(3,3),cplcUFvFvVZR(3,3),           & 
& cplcFdcUFvSdL(3,3,6),cplcFdcUFvSdR(3,3,6),cplcChacUFvSeL(2,3,6),cplcChacUFvSeR(2,3,6), & 
& cplcFecUFvSeL(3,3,6),cplcFecUFvSeR(3,3,6)
...
B1m2 = -Real(SA_B1(p2,MFd2(i2),MSd2(i1)),dp) 
B0m2 = MFd(i2)*Real(SA_B0(p2,MFd2(i2),MSd2(i1)),dp) 
coupL1 = cplcUFvFdcSdL(gO1,i2,i1)
coupR1 = cplcUFvFdcSdR(gO1,i2,i1)
coupL2 =  Conjg(cplcUFvFdcSdL(gO2,i2,i1))
coupR2 =  Conjg(cplcUFvFdcSdR(gO2,i2,i1))
SumSL(gO1,gO2) = coupR1*coupL2*B0m2 
SumSR(gO1,gO2) = coupL1*coupR2*B0m2 
sumR(gO1,gO2) = coupR1*coupR2*B1m2 
sumL(gO1,gO2) = coupL1*coupL2*B1m2 
...
Do gO1 = 1, 3
  Do gO2 = 1, 3
B1m2 = -Real(SA_B1(p2,MFe2(i2),MSe2(i1)),dp) 
B0m2 = MFe(i2)*Real(SA_B0(p2,MFe2(i2),MSe2(i1)),dp) 
coupL1 = cplcUFvFecSeL(gO1,i2,i1)
coupR1 = cplcUFvFecSeR(gO1,i2,i1)
coupL2 =  Conjg(cplcUFvFecSeL(gO2,i2,i1))
coupR2 =  Conjg(cplcUFvFecSeR(gO2,i2,i1))
SumSL(gO1,gO2) = coupR1*coupL2*B0m2 
SumSR(gO1,gO2) = coupL1*coupR2*B0m2 
sumR(gO1,gO2) = coupR1*coupR2*B1m2 
sumL(gO1,gO2) = coupL1*coupL2*B1m2 
...
Do gO1 = 1, 3
  Do gO2 = 1, 3
B1m2 = -Real(SA_B1(p2,MFd2(i1),MSd2(i2)),dp) 
B0m2 = MFd(i1)*Real(SA_B0(p2,MFd2(i1),MSd2(i2)),dp) 
coupL1 = cplcFdcUFvSdL(i1,gO1,i2)
coupR1 = cplcFdcUFvSdR(i1,gO1,i2)
coupL2 =  Conjg(cplcFdcUFvSdL(i1,gO2,i2))
coupR2 =  Conjg(cplcFdcUFvSdR(i1,gO2,i2))
SumSL(gO1,gO2) = coupR1*coupL2*B0m2 
SumSR(gO1,gO2) = coupL1*coupR2*B0m2 
sumR(gO1,gO2) = coupR1*coupR2*B1m2 
sumL(gO1,gO2) = coupL1*coupL2*B1m2 
...
Do gO1 = 1, 3
  Do gO2 = 1, 3
B1m2 = -Real(SA_B1(p2,MFe2(i1),MSe2(i2)),dp) 
B0m2 = MFe(i1)*Real(SA_B0(p2,MFe2(i1),MSe2(i2)),dp) 
coupL1 = cplcFecUFvSeL(i1,gO1,i2)
coupR1 = cplcFecUFvSeR(i1,gO1,i2)
coupL2 =  Conjg(cplcFecUFvSeL(i1,gO2,i2))
coupR2 =  Conjg(cplcFecUFvSeR(i1,gO2,i2))
SumSL(gO1,gO2) = coupR1*coupL2*B0m2 
SumSR(gO1,gO2) = coupL1*coupR2*B0m2 
sumR(gO1,gO2) = coupR1*coupR2*B1m2 
sumL(gO1,gO2) = coupL1*coupL2*B1m2 
...
& cplcUFecFuSdL,cplcUFecFuSdR,cplcUFecFvSeL,cplcUFecFvSeR,sigL,sigR,sigSL,sigSR)
...
Do gO1 = 1, 3
  Do gO2 = 1, 3
If(gO1.eq.gO2) Then 
B1m2 = -Real(SA_B1(MFe2(gO1),0._dp,MSe2(i2)),dp) 
B0m2 = 0.*Real(SA_B0(MFe2(gO1),0._dp,MSe2(i2)),dp) 
Else 
B1m2 = -Real(SA_B1(p2,0._dp,MSe2(i2)),dp) 
B0m2 = 0.*Real(SA_B0(p2,0._dp,MSe2(i2)),dp) 
End If 
...
Do gO1 = 1, 3
  Do gO2 = 1, 3
If(gO1.eq.gO2) Then 
B1m2 = -Real(SA_B1(MFd2(gO1),0._dp,MSd2(i2)),dp) 
B0m2 = 0.*Real(SA_B0(MFd2(gO1),0._dp,MSd2(i2)),dp) 
Else 
B1m2 = -Real(SA_B1(p2,0._dp,MSd2(i2)),dp) 
B0m2 = 0.*Real(SA_B0(p2,0._dp,MSd2(i2)),dp) 
End If 
...
Do gO1 = 1, 3
  Do gO2 = 1, 3
If(gO1.eq.gO2) Then 
B1m2 = -Real(SA_B1(MFd2(gO1),MFd2(i2),MSu2(i1)),dp) 
B0m2 = MFd(i2)*Real(SA_B0(MFd2(gO1),MFd2(i2),MSu2(i1)),dp) 
Else 
B1m2 = -Real(SA_B1(p2,MFd2(i2),MSu2(i1)),dp) 
B0m2 = MFd(i2)*Real(SA_B0(p2,MFd2(i2),MSu2(i1)),dp) 
End If 
...
Do gO1 = 1, 3
  Do gO2 = 1, 3
If(gO1.eq.gO2) Then 
B1m2 = -Real(SA_B1(MFd2(gO1),MFu2(i2),MSd2(i1)),dp) 
B0m2 = MFu(i2)*Real(SA_B0(MFd2(gO1),MFu2(i2),MSd2(i1)),dp) 
Else 
B1m2 = -Real(SA_B1(p2,MFu2(i2),MSd2(i1)),dp) 
B0m2 = MFu(i2)*Real(SA_B0(p2,MFu2(i2),MSd2(i1)),dp) 
End If 
...
& cplcChacUFuSdR,cplcFecUFuSdL,cplcFecUFuSdR,cplcFdcUFucSdL,cplcFdcUFucSdR,              & 
& sigL,sigR,sigSL,sigSR)
...
Do gO1 = 1, 3
  Do gO2 = 1, 3
If(gO1.eq.gO2) Then 
B1m2 = -Real(SA_B1(MFu2(gO1),MFd2(i2),MSd2(i1)),dp) 
B0m2 = MFd(i2)*Real(SA_B0(MFu2(gO1),MFd2(i2),MSd2(i1)),dp) 
Else 
B1m2 = -Real(SA_B1(p2,MFd2(i2),MSd2(i1)),dp) 
B0m2 = MFd(i2)*Real(SA_B0(p2,MFd2(i2),MSd2(i1)),dp) 
End If 
...
End Module LoopMasses_MSSMTriRpV 
