...
! ------------------------------------------------------------------------------  
! File created at 21:37 on 24.8.2021   
! ----------------------------------------------------------------------  
 
 
Module LoopCouplings_MSSMTriRpV 
...
& cplcChaChiVWmR(2,4),cplcChaFecSvL(2,3,3),cplcChaFecSvR(2,3,3),cplcFdcFvSdL(3,3,6),     & 
& cplcFdcFvSdR(3,3,6),cplcFdFeSuL(3,3,6),cplcFdFeSuR(3,3,6),cplcFdFuVWmL(3,3),           & 
& cplcFdFuVWmR(3,3),cplcFdFvSdL(3,3,6),cplcFdFvSdR(3,3,6),cplcFecFuSdL(3,3,6),           & 
...
& cplcFeFvSeR(3,3,6),cplcFeFvVWmL(3,3),cplcFeFvVWmR(3,3),cplcFvChiSvL(3,4,3),            & 
& cplcFvChiSvR(3,4,3),cplcFvFecHpmL(3,3,2),cplcFvFecHpmR(3,3,2),cplcFvFecSeL(3,3,6),     & 
& cplcFvFecSeR(3,3,6),cplChaFvcSeL(2,3,6),cplChaFvcSeR(2,3,6),cplChiFecSeL(4,3,6),       & 
& cplChiFecSeR(4,3,6),cplChiFvcSvL(4,3,3),cplChiFvcSvR(4,3,3),cplFdFvcSdL(3,3,6),        & 
& cplFdFvcSdR(3,3,6),cplFeFucSdL(3,3,6),cplFeFucSdR(3,3,6),cplFeFvcSeL(3,3,6),           & 
& cplFeFvcSeR(3,3,6),cplhhcHpmVWm(2,2),cplhhcVWmVWm(2),cplSucSdVWm(6,6),cplSvcSeVWm(3,6)
...
coup1L = cplFdFvcSdL(i1,gt1,i2)
coup1R = cplFdFvcSdR(i1,gt1,i2)
coup2R = Conjg(cplFdFvcSdL(i1,gt2,i2))
coup2L = Conjg(cplFdFvcSdR(i1,gt2,i2))
...
coup1L = cplFeFvcSeL(i1,gt1,i2)
coup1R = cplFeFvcSeR(i1,gt1,i2)
coup2R = Conjg(cplFeFvcSeL(i1,gt2,i2))
coup2L = Conjg(cplFeFvcSeR(i1,gt2,i2))
...
coup1L = cplFeFvcSeL(gt1,i1,i2)
coup1R = cplFeFvcSeR(gt1,i1,i2)
coup2R = Conjg(cplFeFvcSeL(gt2,i1,i2))
coup2L = Conjg(cplFeFvcSeR(gt2,i1,i2))
...
Do i1=1,3
  Do i2=1,6
If ((0._dp.gt.mf_l2(2)).Or.(MSe2(i2).gt.mf_l2(2))) Then
coup1L = cplcFvFecSeL(i1,gt1,i2)
coup1R = cplcFvFecSeR(i1,gt1,i2)
coup2R = Conjg(cplcFvFecSeL(i1,gt2,i2))
coup2L = Conjg(cplcFvFecSeR(i1,gt2,i2))
sumI = sumI + chargefactor*0.5_dp*coup1L*coup2R*B1(0._dp,0._dp,MSe2(i2))  
End if 
   End Do
  End Do
...
coup1L = cplFdFvcSdL(i2,gt1,i1)
coup1R = cplFdFvcSdR(i2,gt1,i1)
...
coup1L = cplFeFvcSeL(i2,gt1,i1)
coup1R = cplFeFvcSeR(i2,gt1,i1)
coup2L = cplcFecFvSeL(gt2,i3,i1)
coup2R = cplcFecFvSeR(gt2,i3,i1)
...
coup2L = cplcChacFvSeL(i1,gt2,i2)
coup2R = cplcChacFvSeR(i1,gt2,i2)
coup3L = cplFeFvcSeL(gt3,i3,i2)
coup3R = cplFeFvcSeR(gt3,i3,i2)
coup4L = cplcFecFvSeL(gt4,i3,i4)
coup4R = cplcFecFvSeR(gt4,i3,i4)
...
coup2L = cplcChacFvSeL(i1,gt2,i2)
coup2R = cplcChacFvSeR(i1,gt2,i2)
coup3L = cplcFvFecSeL(i3,gt3,i2)
coup3R = cplcFvFecSeR(i3,gt3,i2)
...
coup1L = cplFdFvcSdL(i1,gt1,i4)
coup1R = cplFdFvcSdR(i1,gt1,i4)
coup2L = cplcFdcFvSdL(i1,gt2,i2)
coup2R = cplcFdcFvSdR(i1,gt2,i2)
...
coup1L = cplFeFvcSeL(i1,gt1,i4)
coup1R = cplFeFvcSeR(i1,gt1,i4)
coup2L = cplcFecFvSeL(i1,gt2,i2)
coup2R = cplcFecFvSeR(i1,gt2,i2)
coup3L = cplChiFecSeL(i3,gt3,i2)
coup3R = cplChiFecSeR(i3,gt3,i2)
coup4L = cplcFeChiSeL(gt4,i3,i4)
coup4R = cplcFeChiSeR(gt4,i3,i4)
...
coup1L = cplFdFvcSdL(i4,gt1,i1)
coup1R = cplFdFvcSdR(i4,gt1,i1)
coup2L = cplcFdcFvSdL(i2,gt2,i1)
coup2R = cplcFdcFvSdR(i2,gt2,i1)
...
coup1L = cplFeFvcSeL(i4,gt1,i1)
coup1R = cplFeFvcSeR(i4,gt1,i1)
coup2L = cplcChacFvSeL(i2,gt2,i1)
coup2R = cplcChacFvSeR(i2,gt2,i1)
coup3L = cplcFeChaSvL(gt4,i2,i3)
coup3R = cplcFeChaSvR(gt4,i2,i3)
...
coup1L = cplFeFvcSeL(i4,gt1,i1)
coup1R = cplFeFvcSeR(i4,gt1,i1)
coup2L = cplcFecFvSeL(i2,gt2,i1)
coup2R = cplcFecFvSeR(i2,gt2,i1)
...
coup3L = cplcFecFvSeL(i2,gt2,i3)
coup3R = cplcFecFvSeR(i2,gt2,i3)
coup4L = cplChiFecSeL(i4,gt3,i3)
coup4R = cplChiFecSeR(i4,gt3,i3)
...
End Module LoopCouplings_MSSMTriRpV 
