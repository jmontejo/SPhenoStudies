...
Subroutine Amplitude_Tree_MSSMLV_FuToFuAh(cplcFuFuAhL,cplcFuFuAhR,MAh,MFu,            & 
& MAh2,MFu2,Amp)
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_MSSMLV_FuToFuAh


Subroutine Gamma_Real_MSSMLV_FuToFuAh(MLambda,em,gs,cplcFuFuAhL,cplcFuFuAhR,          & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_MSSMLV_FuToFuAh


Subroutine Amplitude_WAVE_MSSMLV_FuToFuAh(cplcFuFuAhL,cplcFuFuAhR,ctcplcFuFuAhL,      & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_MSSMLV_FuToFuAh


Subroutine Amplitude_VERTEX_MSSMLV_FuToFuAh(MAh,MCha,MChi,MFd,MFu,MGlu,               & 
...
Amp(:,gt1, gt2, gt3) = Amp(:,gt1, gt2, gt3) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_MSSMLV_FuToFuAh


Subroutine Amplitude_IR_VERTEX_MSSMLV_FuToFuAh(MAh,MCha,MChi,MFd,MFu,MGlu,            & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,               & 
& MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,cplAhAhhh,cplcChaChaAhL,cplcChaChaAhR,            & 
& cplChiChiAhL,cplChiChiAhR,cplcFdFdAhL,cplcFdFdAhR,cplcFuFuAhL,cplcFuFuAhR,             & 
& cplAhhhVZ,cplAhHpmcHpm,cplAhHpmcVWm,cplAhSdcSd,cplAhSucSu,cplAhcHpmVWm,cplChaFucSdL,   & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_MSSMLV_FuToFuAh


Subroutine Amplitude_Tree_MSSMLV_FuToChiSu(cplcFuChiSuL,cplcFuChiSuR,MChi,            & 
...
Complex(dp), Intent(in) :: cplcFuChiSuL(3,7,6),cplcFuChiSuR(3,7,6)

Complex(dp) :: Amp(2,3,7,6) 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_MSSMLV_FuToChiSu


Subroutine Gamma_Real_MSSMLV_FuToChiSu(MLambda,em,gs,cplcFuChiSuL,cplcFuChiSuR,       & 
...
Real(dp), Intent(out) :: GammarealPhoton(3,7,6), GammarealGluon(3,7,6) 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_MSSMLV_FuToChiSu


Subroutine Amplitude_WAVE_MSSMLV_FuToChiSu(cplcFuChiSuL,cplcFuChiSuR,ctcplcFuChiSuL,  & 
...
Complex(dp), Intent(in) :: ctcplcFuChiSuL(3,7,6),ctcplcFuChiSuR(3,7,6)

Complex(dp), Intent(in) :: ZfFUL(3,3),ZfFUR(3,3),ZfL0(7,7),ZfSu(6,6)

Complex(dp), Intent(out) :: Amp(2,3,7,6) 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_MSSMLV_FuToChiSu


Subroutine Amplitude_VERTEX_MSSMLV_FuToChiSu(MAh,MCha,MChi,MFd,MFu,MGlu,              & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,               & 
...
& cplChiChacVWmR(7,5),cplcFdChaSuL(3,5,6),cplcFdChaSuR(3,5,6),cplChiChihhL(7,7,5),       & 
...
& cplcFuChiSuR(3,7,6),cplcChaChiVWmL(5,7),cplcChaChiVWmR(5,7),cplcFuFdcHpmL(3,3,8),      & 
...
& cplcFuFuVZL(3,3),cplcFuFuVZR(3,3),cplcFuGluSuL(3,6),cplcFuGluSuR(3,6),cplhhSucSu(5,6,6),& 
& cplHpmSucSd(8,6,6),cplcChacFuSdL(5,3,6),cplcChacFuSdR(5,3,6),cplSucSuVG(6,6),          & 
...
Amp(:,gt1, gt2, gt3) = Amp(:,gt1, gt2, gt3) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_MSSMLV_FuToChiSu


Subroutine Amplitude_IR_VERTEX_MSSMLV_FuToChiSu(MAh,MCha,MChi,MFd,MFu,MGlu,           & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,               & 
& MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,cplChiChiAhL,cplChiChiAhR,cplcFuFuAhL,            & 
& cplcFuFuAhR,cplAhSucSu,cplChiChacHpmL,cplChiChacHpmR,cplChiChacVWmL,cplChiChacVWmR,    & 
& cplcFdChaSuL,cplcFdChaSuR,cplChiChihhL,cplChiChihhR,cplChiChiVZL,cplChiChiVZR,         & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_MSSMLV_FuToChiSu


Subroutine Amplitude_Tree_MSSMLV_FuToFdcHpm(cplcFuFdcHpmL,cplcFuFdcHpmR,              & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_MSSMLV_FuToFdcHpm


Subroutine Gamma_Real_MSSMLV_FuToFdcHpm(MLambda,em,gs,cplcFuFdcHpmL,cplcFuFdcHpmR,    & 
...
Real(dp), Intent(out) :: GammarealPhoton(3,3,8), GammarealGluon(3,3,8) 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_MSSMLV_FuToFdcHpm


Subroutine Amplitude_WAVE_MSSMLV_FuToFdcHpm(cplcFuFdcHpmL,cplcFuFdcHpmR,              & 
...
Complex(dp), Intent(out) :: Amp(2,3,3,8) 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_MSSMLV_FuToFdcHpm


Subroutine Amplitude_VERTEX_MSSMLV_FuToFdcHpm(MAh,MCha,MChi,MFd,MFu,MGlu,             & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,               & 
...
Amp(:,gt1, gt2, gt3) = Amp(:,gt1, gt2, gt3) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_MSSMLV_FuToFdcHpm


Subroutine Amplitude_IR_VERTEX_MSSMLV_FuToFdcHpm(MAh,MCha,MChi,MFd,MFu,               & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_MSSMLV_FuToFdcHpm


Subroutine Amplitude_Tree_MSSMLV_FuToFdcVWm(cplcFuFdcVWmL,cplcFuFdcVWmR,              & 
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_Tree_MSSMLV_FuToFdcVWm


Subroutine Gamma_Real_MSSMLV_FuToFdcVWm(MLambda,em,gs,cplcFuFdcVWmL,cplcFuFdcVWmR,    & 
...
End if 
  End Do
End Do
End Subroutine Gamma_Real_MSSMLV_FuToFdcVWm


Subroutine Amplitude_WAVE_MSSMLV_FuToFdcVWm(cplcFuFdcVWmL,cplcFuFdcVWmR,              & 
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_MSSMLV_FuToFdcVWm


Subroutine Amplitude_VERTEX_MSSMLV_FuToFdcVWm(MAh,MCha,MChi,MFd,MFu,MGlu,             & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,               & 
& MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdAhL,cplcFdFdAhR,cplcFuFuAhL,              & 
...
Complex(dp), Intent(in) :: cplcFdFdAhL(3,3,5),cplcFdFdAhR(3,3,5),cplcFuFuAhL(3,3,5),cplcFuFuAhR(3,3,5),          & 
& cplAhHpmcVWm(5,8),cplChiChacVWmL(7,5),cplChiChacVWmR(7,5),cplChiFdcSdL(7,3,6),         & 
& cplChiFdcSdR(7,3,6),cplcFuChiSuL(3,7,6),cplcFuChiSuR(3,7,6),cplGluFdcSdL(3,6),         & 
...
& cplcFuFdcVWmL(3,3),cplcFuFdcVWmR(3,3),cplcFuFuhhL(3,3,5),cplcFuFuhhR(3,3,5),           & 
& cplcFuFuVGL(3,3),cplcFuFuVGR(3,3),cplcFuFuVPL(3,3),cplcFuFuVPR(3,3),cplcFuFuVZL(3,3),  & 
& cplcFuFuVZR(3,3),cplcFuGluSuL(3,6),cplcFuGluSuR(3,6),cplhhHpmcVWm(5,8),cplhhcVWmVWm(5),& 
& cplHpmcVWmVP(8),cplHpmcVWmVZ(8),cplcChacFuSdL(5,3,6),cplcChacFuSdR(5,3,6),             & 
...
Amp(:,gt1, gt2) = Amp(:,gt1, gt2) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_MSSMLV_FuToFdcVWm


Subroutine Amplitude_IR_VERTEX_MSSMLV_FuToFdcVWm(MAh,MCha,MChi,MFd,MFu,               & 
& MGlu,Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,               & 
& Mhh2,MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdAhL,cplcFdFdAhR,cplcFuFuAhL,         & 
& cplcFuFuAhR,cplAhHpmcVWm,cplChiChacVWmL,cplChiChacVWmR,cplChiFdcSdL,cplChiFdcSdR,      & 
& cplcFuChiSuL,cplcFuChiSuR,cplGluFdcSdL,cplGluFdcSdR,cplcFdFdhhL,cplcFdFdhhR,           & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_MSSMLV_FuToFdcVWm


Subroutine Amplitude_Tree_MSSMLV_FuToFuhh(cplcFuFuhhL,cplcFuFuhhR,MFu,Mhh,            & 
& MFu2,Mhh2,Amp)
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_MSSMLV_FuToFuhh


Subroutine Gamma_Real_MSSMLV_FuToFuhh(MLambda,em,gs,cplcFuFuhhL,cplcFuFuhhR,          & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_MSSMLV_FuToFuhh


Subroutine Amplitude_WAVE_MSSMLV_FuToFuhh(cplcFuFuhhL,cplcFuFuhhR,ctcplcFuFuhhL,      & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_MSSMLV_FuToFuhh


Subroutine Amplitude_VERTEX_MSSMLV_FuToFuhh(MAh,MCha,MChi,MFd,MFu,MGlu,               & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,               & 
...
Amp(:,gt1, gt2, gt3) = Amp(:,gt1, gt2, gt3) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_MSSMLV_FuToFuhh


Subroutine Amplitude_IR_VERTEX_MSSMLV_FuToFuhh(MAh,MCha,MChi,MFd,MFu,MGlu,            & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,               & 
& MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,cplAhAhhh,cplcFuFuAhL,cplcFuFuAhR,cplAhhhVZ,      & 
& cplChaFucSdL,cplChaFucSdR,cplcChaChahhL,cplcChaChahhR,cplChiChihhL,cplChiChihhR,       & 
& cplChiFucSuL,cplChiFucSuR,cplcFuChiSuL,cplcFuChiSuR,cplcFdFdhhL,cplcFdFdhhR,           & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_MSSMLV_FuToFuhh


Subroutine Amplitude_Tree_MSSMLV_FuToFuVZ(cplcFuFuVZL,cplcFuFuVZR,MFu,MVZ,            & 
& MFu2,MVZ2,Amp)
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_Tree_MSSMLV_FuToFuVZ


Subroutine Gamma_Real_MSSMLV_FuToFuVZ(MLambda,em,gs,cplcFuFuVZL,cplcFuFuVZR,          & 
...
End if 
  End Do
End Do
End Subroutine Gamma_Real_MSSMLV_FuToFuVZ


Subroutine Amplitude_WAVE_MSSMLV_FuToFuVZ(cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,        & 
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_MSSMLV_FuToFuVZ


Subroutine Amplitude_VERTEX_MSSMLV_FuToFuVZ(MAh,MCha,MChi,MFd,MFu,MGlu,               & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,               & 
...
Complex(dp), Intent(in) :: cplcFuFuAhL(3,3,5),cplcFuFuAhR(3,3,5),cplAhhhVZ(5,5),cplChaFucSdL(5,3,6),             & 
& cplChaFucSdR(5,3,6),cplcChaChaVZL(5,5),cplcChaChaVZR(5,5),cplChiChiVZL(7,7),           & 
& cplChiChiVZR(7,7),cplChiFucSuL(7,3,6),cplChiFucSuR(7,3,6),cplcFuChiSuL(3,7,6),         & 
& cplcFuChiSuR(3,7,6),cplcFdFdVZL(3,3),cplcFdFdVZR(3,3),cplcFuFdcHpmL(3,3,8),            & 
& cplcFuFdcHpmR(3,3,8),cplcFuFdcVWmL(3,3),cplcFuFdcVWmR(3,3),cplGluFucSuL(3,6),          & 
& cplGluFucSuR(3,6),cplcFuFuhhL(3,3,5),cplcFuFuhhR(3,3,5),cplcFdFuHpmL(3,3,8),           & 
& cplcFdFuHpmR(3,3,8),cplcFuFuVGL(3,3),cplcFuFuVGR(3,3),cplcFuFuVPL(3,3),cplcFuFuVPR(3,3),& 
& cplcFdFuVWmL(3,3),cplcFdFuVWmR(3,3),cplcFuFuVZL(3,3),cplcFuFuVZR(3,3),cplcFuGluSuL(3,6),& 
& cplcFuGluSuR(3,6),cplhhVZVZ(5),cplHpmcHpmVZ(8,8),cplHpmcVWmVZ(8),cplSdcSdVZ(6,6),      & 
...
Amp(:,gt1, gt2) = Amp(:,gt1, gt2) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_MSSMLV_FuToFuVZ


Subroutine Amplitude_IR_VERTEX_MSSMLV_FuToFuVZ(MAh,MCha,MChi,MFd,MFu,MGlu,            & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,               & 
& MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,cplcFuFuAhL,cplcFuFuAhR,cplAhhhVZ,cplChaFucSdL,   & 
& cplChaFucSdR,cplcChaChaVZL,cplcChaChaVZR,cplChiChiVZL,cplChiChiVZR,cplChiFucSuL,       & 
& cplChiFucSuR,cplcFuChiSuL,cplcFuChiSuR,cplcFdFdVZL,cplcFdFdVZR,cplcFuFdcHpmL,          & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_MSSMLV_FuToFuVZ


Subroutine Amplitude_Tree_MSSMLV_FuToGluSu(cplcFuGluSuL,cplcFuGluSuR,MFu,             & 
...
Amp(:,gt1, gt3) = AmpC 
    End Do
End Do
End Subroutine Amplitude_Tree_MSSMLV_FuToGluSu


Subroutine Gamma_Real_MSSMLV_FuToGluSu(MLambda,em,gs,cplcFuGluSuL,cplcFuGluSuR,       & 
...
End if 
    End Do
End Do
End Subroutine Gamma_Real_MSSMLV_FuToGluSu


Subroutine Amplitude_WAVE_MSSMLV_FuToGluSu(cplcFuGluSuL,cplcFuGluSuR,ctcplcFuGluSuL,  & 
...
Amp(:,gt1, gt3) = AmpC 
    End Do
End Do
End Subroutine Amplitude_WAVE_MSSMLV_FuToGluSu


Subroutine Amplitude_VERTEX_MSSMLV_FuToGluSu(MAh,MCha,MChi,MFd,MFu,MGlu,              & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,               & 
...
Complex(dp), Intent(in) :: cplcFuFuAhL(3,3,5),cplcFuFuAhR(3,3,5),cplAhSucSu(5,6,6),cplcFdChaSuL(3,5,6),          & 
& cplcFdChaSuR(3,5,6),cplcFuChiSuL(3,7,6),cplcFuChiSuR(3,7,6),cplGluFdcSdL(3,6),         & 
& cplGluFdcSdR(3,6),cplcFuFdcHpmL(3,3,8),cplcFuFdcHpmR(3,3,8),cplcFuFdcVWmL(3,3),        & 
& cplcFuFdcVWmR(3,3),cplGluFucSuL(3,6),cplGluFucSuR(3,6),cplcFuFuhhL(3,3,5),             & 
& cplcFuFuhhR(3,3,5),cplcFuFuVGL(3,3),cplcFuFuVGR(3,3),cplcFuFuVPL(3,3),cplcFuFuVPR(3,3),& 
& cplcFuFuVZL(3,3),cplcFuFuVZR(3,3),cplGluGluVGL,cplGluGluVGR,cplcFdGluSdL(3,6),         & 
& cplcFdGluSdR(3,6),cplcFuGluSuL(3,6),cplcFuGluSuR(3,6),cplhhSucSu(5,6,6),               & 
& cplHpmSucSd(8,6,6),cplcChacFuSdL(5,3,6),cplcChacFuSdR(5,3,6),cplSucSuVG(6,6),          & 
& cplSucSuVP(6,6),cplSucSdVWm(6,6),cplSucSuVZ(6,6)
...
Amp(:,gt1, gt3) = Amp(:,gt1, gt3) + oo16pi2*(-3._dp/2._dp*(0.,1._dp))*AmpC 
  End Do
    End Do
End Do
End Subroutine Amplitude_VERTEX_MSSMLV_FuToGluSu


Subroutine Amplitude_IR_VERTEX_MSSMLV_FuToGluSu(MAh,MCha,MChi,MFd,MFu,MGlu,           & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,               & 
& MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,cplcFuFuAhL,cplcFuFuAhR,cplAhSucSu,               & 
& cplcFdChaSuL,cplcFdChaSuR,cplcFuChiSuL,cplcFuChiSuR,cplGluFdcSdL,cplGluFdcSdR,         & 
& cplcFuFdcHpmL,cplcFuFdcHpmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplGluFucSuL,cplGluFucSuR,     & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_MSSMLV_FuToGluSu


Subroutine Amplitude_Tree_MSSMLV_FuTocChaSd(cplcChacFuSdL,cplcChacFuSdR,              & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_MSSMLV_FuTocChaSd


Subroutine Gamma_Real_MSSMLV_FuTocChaSd(MLambda,em,gs,cplcChacFuSdL,cplcChacFuSdR,    & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_MSSMLV_FuTocChaSd


Subroutine Amplitude_WAVE_MSSMLV_FuTocChaSd(cplcChacFuSdL,cplcChacFuSdR,              & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_MSSMLV_FuTocChaSd


Subroutine Amplitude_VERTEX_MSSMLV_FuTocChaSd(MAh,MCha,MChi,MFd,MFu,MGlu,             & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,               & 
...
Amp(:,gt1, gt2, gt3) = Amp(:,gt1, gt2, gt3) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_MSSMLV_FuTocChaSd


Subroutine Amplitude_IR_VERTEX_MSSMLV_FuTocChaSd(MAh,MCha,MChi,MFd,MFu,               & 
& MGlu,Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,               & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_MSSMLV_FuTocChaSd


Subroutine Amplitude_WAVE_MSSMLV_FuToFuVG(cplcFuFuVGL,cplcFuFuVGR,ctcplcFuFuVGL,      & 
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_MSSMLV_FuToFuVG


Subroutine Amplitude_VERTEX_MSSMLV_FuToFuVG(MAh,MCha,MChi,MFd,MFu,MGlu,               & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,               & 
...
Complex(dp), Intent(in) :: cplcFuFuAhL(3,3,5),cplcFuFuAhR(3,3,5),cplChaFucSdL(5,3,6),cplChaFucSdR(5,3,6),        & 
& cplChiFucSuL(7,3,6),cplChiFucSuR(7,3,6),cplcFuChiSuL(3,7,6),cplcFuChiSuR(3,7,6),       & 
& cplcFdFdVGL(3,3),cplcFdFdVGR(3,3),cplcFuFdcHpmL(3,3,8),cplcFuFdcHpmR(3,3,8),           & 
...
& cplcFuGluSuL(3,6),cplcFuGluSuR(3,6),cplSdcSdVG(6,6),cplcChacFuSdL(5,3,6),              & 
& cplcChacFuSdR(5,3,6),cplSucSuVG(6,6),cplVGVGVG
...
Amp(:,gt1, gt2) = Amp(:,gt1, gt2) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_MSSMLV_FuToFuVG


Subroutine Amplitude_IR_VERTEX_MSSMLV_FuToFuVG(MAh,MCha,MChi,MFd,MFu,MGlu,            & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,               & 
& MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,cplcFuFuAhL,cplcFuFuAhR,cplChaFucSdL,             & 
& cplChaFucSdR,cplChiFucSuL,cplChiFucSuR,cplcFuChiSuL,cplcFuChiSuR,cplcFdFdVGL,          & 
& cplcFdFdVGR,cplcFuFdcHpmL,cplcFuFdcHpmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplGluFucSuL,      & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_MSSMLV_FuToFuVG


Subroutine Amplitude_WAVE_MSSMLV_FuToFuVP(cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,        & 
& cplcFuFuVZR,ctcplcFuFuVPL,ctcplcFuFuVPR,ctcplcFuFuVZL,ctcplcFuFuVZR,MFu,               & 
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_MSSMLV_FuToFuVP


Subroutine Amplitude_VERTEX_MSSMLV_FuToFuVP(MAh,MCha,MChi,MFd,MFu,MGlu,               & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,               & 
& MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,cplcFuFuAhL,cplcFuFuAhR,cplChaFucSdL,             & 
...
Complex(dp), Intent(in) :: cplcFuFuAhL(3,3,5),cplcFuFuAhR(3,3,5),cplChaFucSdL(5,3,6),cplChaFucSdR(5,3,6),        & 
& cplcChaChaVPL(5,5),cplcChaChaVPR(5,5),cplChiFucSuL(7,3,6),cplChiFucSuR(7,3,6),         & 
& cplcFuChiSuL(3,7,6),cplcFuChiSuR(3,7,6),cplcFdFdVPL(3,3),cplcFdFdVPR(3,3),             & 
...
& cplcFdFuHpmL(3,3,8),cplcFdFuHpmR(3,3,8),cplcFuFuVGL(3,3),cplcFuFuVGR(3,3),             & 
& cplcFuFuVPL(3,3),cplcFuFuVPR(3,3),cplcFdFuVWmL(3,3),cplcFdFuVWmR(3,3),cplcFuFuVZL(3,3),& 
& cplcFuFuVZR(3,3),cplcFuGluSuL(3,6),cplcFuGluSuR(3,6),cplHpmcHpmVP(8,8),cplHpmcVWmVP(8),& 
& cplSdcSdVP(6,6),cplcChacFuSdL(5,3,6),cplcChacFuSdR(5,3,6),cplSucSuVP(6,6),             & 
& cplcHpmVPVWm(8),cplcVWmVPVWm
...
Amp(:,gt1, gt2) = Amp(:,gt1, gt2) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_MSSMLV_FuToFuVP


Subroutine Amplitude_IR_VERTEX_MSSMLV_FuToFuVP(MAh,MCha,MChi,MFd,MFu,MGlu,            & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,               & 
& MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,cplcFuFuAhL,cplcFuFuAhR,cplChaFucSdL,             & 
& cplChaFucSdR,cplcChaChaVPL,cplcChaChaVPR,cplChiFucSuL,cplChiFucSuR,cplcFuChiSuL,       & 
& cplcFuChiSuR,cplcFdFdVPL,cplcFdFdVPR,cplcFuFdcHpmL,cplcFuFdcHpmR,cplcFuFdcVWmL,        & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_MSSMLV_FuToFuVP



End Module OneLoopDecay_Fu_MSSMLV
