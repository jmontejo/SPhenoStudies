...
& M1,M2,M3,vd,vu,vL,gTAh,gThh,gTHpm,gTSd,gTSu,gTVWm,gTVZ,gChaChacChaCha,gChaChaChiChi,   & 
& gChaChacFdFd,gChaChacFuFu,gChaChicFuFd,gChaFdcFuGlu,epsI,deltaM,CheckRealStates,       & 
& gT,gPartial,BR)
...
Complex(dp) :: cplcChacFuSdL(5,3,6),cplcChacFuSdR(5,3,6),cplcChaChaAhL(5,5,5),cplcChaChaAhR(5,5,5),  & 
...
Real(dp),Intent(inout) :: gChaChacChaCha(5,5,5,5),gChaChaChiChi(5,5,7,7),gChaChacFdFd(5,5,3,3),gChaChacFuFu(5,5,3,3),& 
& gChaChicFuFd(5,7,3,3),gChaFdcFuGlu(5,3,3,1)

Real(dp),Intent(in) :: gTAh(5),gThh(5),gTHpm(8),gTSd(6),gTSu(6),gTVWm,gTVZ

Real(dp) :: gChaChacChaChai(5,5,5),gChaChaChiChii(5,7,7),gChaChacFdFdi(5,3,3),gChaChacFuFui(5,3,3),& 
& gChaChicFuFdi(7,3,3),gChaFdcFuGlui(3,3,1)
...
& md2,mu2,me2,mlHd2,M1,M2,M3,vd,vu,vL,cplcChacFuSdL,cplcChacFuSdR,cplcChaChaAhL,         & 
...
Real(dp),Intent(in) :: MCha(5),MVZ,MAh(5),Mhh(5)
...
Real(dp),Intent(in) :: MCha(5),MChi(7),MVZ,MVWm,MHpm(8),MAh(5),Mhh(5)
...
Isum = 400 
Allocate( gSum(5,7,7, Isum) ) 
Allocate( Contribution(5,7,7, Isum) ) 
gSum = 0._dp  
Contribution = ' ' 
...
Real(dp),Intent(in) :: MCha(5),MFd(3),MVZ,MSu(6),MAh(5),Mhh(5)

Complex(dp),Intent(in) :: cplcChaChaAhL(5,5,5),cplcChaChaAhR(5,5,5),cplcChaChahhL(5,5,5),cplcChaChahhR(5,5,5),  & 
& cplcChaChaVZL(5,5),cplcChaChaVZR(5,5),cplcChaFdcSuL(5,3,6),cplcChaFdcSuR(5,3,6),       & 
& cplcFdChaSuL(3,5,6),cplcFdChaSuR(3,5,6),cplcFdFdAhL(3,3,5),cplcFdFdAhR(3,3,5),         & 
...
Real(dp),Intent(in) :: MCha(5),MFu(3),MVZ,MSd(6),MAh(5),Mhh(5)

Complex(dp),Intent(in) :: cplcChacFuSdL(5,3,6),cplcChacFuSdR(5,3,6),cplcChaChaAhL(5,5,5),cplcChaChaAhR(5,5,5),  & 
& cplcChaChahhL(5,5,5),cplcChaChahhR(5,5,5),cplcChaChaVZL(5,5),cplcChaChaVZR(5,5),       & 
& cplcFuFuAhL(3,3,5),cplcFuFuAhR(3,3,5),cplcFuFuhhL(3,3,5),cplcFuFuhhR(3,3,5),           & 
...
Real(dp),Intent(in) :: MChi(7),MFu(3),MFd(3),MVWm,MHpm(8),MSu(6),MSd(6),MCha(5)

Complex(dp),Intent(in) :: cplcChacFuSdL(5,3,6),cplcChacFuSdR(5,3,6),cplcChaChiHpmL(5,7,8),cplcChaChiHpmR(5,7,8),& 
