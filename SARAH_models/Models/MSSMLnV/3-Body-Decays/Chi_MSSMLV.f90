...
& M1,M2,M3,vd,vu,vL,gTAh,gThh,gTHpm,gTSd,gTSu,gTVWm,gTVZ,gChiChicChaCha,gChiChiChiChi,   & 
...
Complex(dp) :: cplcChaChaAhL(5,5,5),cplcChaChaAhR(5,5,5),cplcChaChahhL(5,5,5),cplcChaChahhR(5,5,5),  & 
...
Real(dp),Intent(inout) :: gChiChicChaCha(7,7,5,5),gChiChiChiChi(7,7,7,7),gChiChicFdFd(7,7,3,3),gChiChicFuFu(7,7,3,3),& 
& gChiChacFdFu(7,5,3,3),gChiFdcFdGlu(7,3,3,1),gChiFucFuGlu(7,3,3,1)

Real(dp),Intent(in) :: gTAh(5),gThh(5),gTHpm(8),gTSd(6),gTSu(6),gTVWm,gTVZ

Real(dp) :: gChiChicChaChai(7,5,5),gChiChiChiChii(7,7,7),gChiChicFdFdi(7,3,3),gChiChicFuFui(7,3,3),& 
& gChiChacFdFui(5,3,3),gChiFdcFdGlui(3,3,1),gChiFucFuGlui(3,3,1)

Real(dp) :: gTAhtemp(5),gThhtemp(5),gTHpmtemp(8),gTSdtemp(6),gTSutemp(6),gTVWmtemp,gTVZtemp
...
& md2,mu2,me2,mlHd2,M1,M2,M3,vd,vu,vL,cplcChaChaAhL,cplcChaChaAhR,cplcChaChahhL,         & 
...
Real(dp),Intent(in) :: MChi(7),MCha(5),MVZ,MVWm,MHpm(8),MAh(5),Mhh(5)

Complex(dp),Intent(in) :: cplcChaChaAhL(5,5,5),cplcChaChaAhR(5,5,5),cplcChaChahhL(5,5,5),cplcChaChahhR(5,5,5),  & 
& cplcChaChaVZL(5,5),cplcChaChaVZR(5,5),cplcChaChiHpmL(5,7,8),cplcChaChiHpmR(5,7,8),     & 
& cplcChaChiVWmL(5,7),cplcChaChiVWmR(5,7),cplChiChacHpmL(7,5,8),cplChiChacHpmR(7,5,8),   & 
...
Real(dp),Intent(inout) :: gTVZ,gTVWm,gTHpm(8),gTAh(5),gThh(5)
...
Isum = 841 
Allocate( gSum(7,5,5, Isum) ) 
Allocate( Contribution(7,5,5, Isum) ) 
gSum = 0._dp  
Contribution = ' ' 
...
Real(dp),Intent(in) :: MChi(7),MVZ,MAh(5),Mhh(5)

Complex(dp),Intent(in) :: cplChiChiAhL(7,7,5),cplChiChiAhR(7,7,5),cplChiChihhL(7,7,5),cplChiChihhR(7,7,5),      & 
& cplChiChiVZL(7,7),cplChiChiVZR(7,7)
...
Real(dp),Intent(inout) :: gTVZ,gTAh(5),gThh(5)
...
Real(dp),Intent(in) :: MChi(7),MFd(3),MVZ,MSd(6),MAh(5),Mhh(5)

Complex(dp),Intent(in) :: cplcFdChiSdL(3,7,6),cplcFdChiSdR(3,7,6),cplcFdFdAhL(3,3,5),cplcFdFdAhR(3,3,5),        & 
& cplcFdFdhhL(3,3,5),cplcFdFdhhR(3,3,5),cplcFdFdVZL(3,3),cplcFdFdVZR(3,3),               & 
...
Real(dp),Intent(inout) :: gTVZ,gTSd(6),gTAh(5),gThh(5)
...
Real(dp),Intent(in) :: MChi(7),MFu(3),MVZ,MSu(6),MAh(5),Mhh(5)

Complex(dp),Intent(in) :: cplcFuChiSuL(3,7,6),cplcFuChiSuR(3,7,6),cplcFuFuAhL(3,3,5),cplcFuFuAhR(3,3,5),        & 
& cplcFuFuhhL(3,3,5),cplcFuFuhhR(3,3,5),cplcFuFuVZL(3,3),cplcFuFuVZR(3,3),               & 
& cplChiChiAhL(7,7,5),cplChiChiAhR(7,7,5),cplChiChihhL(7,7,5),cplChiChihhR(7,7,5),       & 
& cplChiChiVZL(7,7),cplChiChiVZR(7,7),cplChiFucSuL(7,3,6),cplChiFucSuR(7,3,6)
...
Real(dp),Intent(inout) :: gTVZ,gTSu(6),gTAh(5),gThh(5)
...
Real(dp),Intent(in) :: MCha(5),MFd(3),MFu(3),MVWm,MHpm(8),MSu(6),MSd(6),MChi(7)

Complex(dp),Intent(in) :: cplcFdChaSuL(3,5,6),cplcFdChaSuR(3,5,6),cplcFdChiSdL(3,7,6),cplcFdChiSdR(3,7,6),      & 
& cplcFdFuHpmL(3,3,8),cplcFdFuHpmR(3,3,8),cplcFdFuVWmL(3,3),cplcFdFuVWmR(3,3),           & 
& cplChaFucSdL(5,3,6),cplChaFucSdR(5,3,6),cplChiChacHpmL(7,5,8),cplChiChacHpmR(7,5,8),   & 
& cplChiChacVWmL(7,5),cplChiChacVWmR(7,5),cplChiFucSuL(7,3,6),cplChiFucSuR(7,3,6)
