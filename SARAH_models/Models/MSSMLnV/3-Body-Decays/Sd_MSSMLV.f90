...
& M1,M2,M3,vd,vu,vL,gSdAhChaFu,gSdAhChiFd,gSdAhFdGlu,gSdSuChaChi,gSdChaFdcHpm,           & 
...
Complex(dp) :: cplAhSdcSd(5,6,6),cplcChacFuSdL(5,3,6),cplcChacFuSdR(5,3,6),cplcChaChaAhL(5,5,5),     & 
...
Real(dp),Intent(inout) :: gSdAhChaFu(6,5,5,3),gSdAhChiFd(6,5,7,3),gSdAhFdGlu(6,5,3,1),gSdSuChaChi(6,6,5,7),     & 
& gSdChaFdcHpm(6,5,3,8),gSdhhChaFu(6,5,5,3),gSdChaGluSu(6,5,1,6),gSdSdChacCha(6,6,5,5),  & 
& gSdSdChiChi(6,6,7,7),gSdhhChiFd(6,5,7,3),gSdHpmChiFu(6,8,7,3),gSdChiGluSd(6,7,1,6),    & 
& gSdFdFdcSd(6,3,3,6),gSdFuFdcSu(6,3,3,6),gSdHpmFdcCha(6,8,3,5),gSdSdFdcFd(6,6,3,3),     & 
& gSdSuFdcFu(6,6,3,3),gSdSdFucFu(6,6,3,3),gSdhhFdGlu(6,5,3,1),gSdHpmFuGlu(6,8,3,1),      & 
& gSdGluGluSd(6,1,1,6)

Real(dp) :: gSdAhChaFui(5,5,3),gSdAhChiFdi(5,7,3),gSdAhFdGlui(5,3,1),gSdSuChaChii(6,5,7),         & 
& gSdChaFdcHpmi(5,3,8),gSdhhChaFui(5,5,3),gSdChaGluSui(5,1,6),gSdSdChacChai(6,5,5),      & 
& gSdSdChiChii(6,7,7),gSdhhChiFdi(5,7,3),gSdHpmChiFui(8,7,3),gSdChiGluSdi(7,1,6),        & 
& gSdFdFdcSdi(3,3,6),gSdFuFdcSui(3,3,6),gSdHpmFdcChai(8,3,5),gSdSdFdcFdi(6,3,3),         & 
& gSdSuFdcFui(6,3,3),gSdSdFucFui(6,3,3),gSdhhFdGlui(5,3,1),gSdHpmFuGlui(8,3,1),          & 
& gSdGluGluSdi(1,1,6)
...
& md2,mu2,me2,mlHd2,M1,M2,M3,vd,vu,vL,cplAhSdcSd,cplcChacFuSdL,cplcChacFuSdR,            & 
...
Real(dp),Intent(in) :: MAh(5),MCha(5),MFu(3),MSd(6)

Complex(dp),Intent(in) :: cplAhSdcSd(5,6,6),cplcChaChaAhL(5,5,5),cplcChaChaAhR(5,5,5),cplcFuFuAhL(3,3,5),       & 
& cplcFuFuAhR(3,3,5),cplChaFucSdL(5,3,6),cplChaFucSdR(5,3,6)
...
Isum = 196 
Allocate( gSum(5,5,3, Isum) ) 
Allocate( Contribution(5,5,3, Isum) ) 
gSum = 0._dp  
Contribution = ' ' 
...
Real(dp),Intent(in) :: MAh(5),MChi(7),MFd(3),MSd(6)

Complex(dp),Intent(in) :: cplAhSdcSd(5,6,6),cplcFdFdAhL(3,3,5),cplcFdFdAhR(3,3,5),cplChiChiAhL(7,7,5),          & 
& cplChiChiAhR(7,7,5),cplChiFdcSdL(7,3,6),cplChiFdcSdR(7,3,6)
...
Isum = 256 
Allocate( gSum(5,7,3, Isum) ) 
Allocate( Contribution(5,7,3, Isum) ) 
gSum = 0._dp  
Contribution = ' ' 
...
Real(dp),Intent(in) :: MAh(5),MFd(3),MGlu,MSd(6)

Complex(dp),Intent(in) :: cplAhSdcSd(5,6,6),cplcFdFdAhL(3,3,5),cplcFdFdAhR(3,3,5),cplGluFdcSdL(3,6),            & 
& cplGluFdcSdR(3,6)
...
Isum = 81 
Allocate( gSum(5,3,1, Isum) ) 
Allocate( Contribution(5,3,1, Isum) ) 
gSum = 0._dp  
Contribution = ' ' 
...
Real(dp),Intent(in) :: MSu(6),MCha(5),MChi(7),MVWm,MHpm(8),MFu(3),MFd(3),MSd(6)

Complex(dp),Intent(in) :: cplHpmSucSd(8,6,6),cplSucSdVWm(6,6),cplcFdChaSuL(3,5,6),cplcFdChaSuR(3,5,6),          & 
& cplcFuChiSuL(3,7,6),cplcFuChiSuR(3,7,6),cplChaFucSdL(5,3,6),cplChaFucSdR(5,3,6),       & 
& cplChiChacHpmL(7,5,8),cplChiChacHpmR(7,5,8),cplChiChacVWmL(7,5),cplChiChacVWmR(7,5),   & 
& cplChiFdcSdL(7,3,6),cplChiFdcSdR(7,3,6)
...
Isum = 225 
Allocate( gSum(6,5,7, Isum) ) 
Allocate( Contribution(6,5,7, Isum) ) 
gSum = 0._dp  
Contribution = ' ' 
...
Real(dp),Intent(in) :: MCha(5),MFd(3),MHpm(8),MFu(3),MChi(7),MSd(6)

Complex(dp),Intent(in) :: cplcFuFdcHpmL(3,3,8),cplcFuFdcHpmR(3,3,8),cplChaFucSdL(5,3,6),cplChaFucSdR(5,3,6),    & 
& cplChiChacHpmL(7,5,8),cplChiChacHpmR(7,5,8),cplChiFdcSdL(7,3,6),cplChiFdcSdR(7,3,6)
...
Real(dp),Intent(in) :: Mhh(5),MCha(5),MFu(3),MSd(6)

Complex(dp),Intent(in) :: cplhhSdcSd(5,6,6),cplcChaChahhL(5,5,5),cplcChaChahhR(5,5,5),cplcFuFuhhL(3,3,5),       & 
& cplcFuFuhhR(3,3,5),cplChaFucSdL(5,3,6),cplChaFucSdR(5,3,6)
...
Real(dp),Intent(in) :: MSd(6),MCha(5),MVZ,MAh(5),Mhh(5),MFu(3)

Complex(dp),Intent(in) :: cplAhSdcSd(5,6,6),cplhhSdcSd(5,6,6),cplSdcSdVZ(6,6),cplcChacFuSdL(5,3,6),             & 
& cplcChacFuSdR(5,3,6),cplcChaChaAhL(5,5,5),cplcChaChaAhR(5,5,5),cplcChaChahhL(5,5,5),   & 
& cplcChaChahhR(5,5,5),cplcChaChaVZL(5,5),cplcChaChaVZR(5,5),cplChaFucSdL(5,3,6),        & 
& cplChaFucSdR(5,3,6)
...
Real(dp),Intent(in) :: MSd(6),MChi(7),MVZ,MAh(5),Mhh(5),MFd(3)

Complex(dp),Intent(in) :: cplAhSdcSd(5,6,6),cplhhSdcSd(5,6,6),cplSdcSdVZ(6,6),cplcFdChiSdL(3,7,6),              & 
& cplcFdChiSdR(3,7,6),cplChiChiAhL(7,7,5),cplChiChiAhR(7,7,5),cplChiChihhL(7,7,5),       & 
...
Real(dp),Intent(in) :: Mhh(5),MChi(7),MFd(3),MSd(6)

Complex(dp),Intent(in) :: cplhhSdcSd(5,6,6),cplcFdFdhhL(3,3,5),cplcFdFdhhR(3,3,5),cplChiChihhL(7,7,5),          & 
& cplChiChihhR(7,7,5),cplChiFdcSdL(7,3,6),cplChiFdcSdR(7,3,6)
...
Real(dp),Intent(in) :: MHpm(8),MChi(7),MFu(3),MSu(6),MFd(3),MCha(5),MSd(6)

Complex(dp),Intent(in) :: cplHpmSucSd(8,6,6),cplcChaChiHpmL(5,7,8),cplcChaChiHpmR(5,7,8),cplcFdFuHpmL(3,3,8),   & 
& cplcFdFuHpmR(3,3,8),cplChaFucSdL(5,3,6),cplChaFucSdR(5,3,6),cplChiFdcSdL(7,3,6),       & 
& cplChiFdcSdR(7,3,6),cplChiFucSuL(7,3,6),cplChiFucSuR(7,3,6)
...
Isum = 196 
Allocate( gSum(8,7,3, Isum) ) 
Allocate( Contribution(8,7,3, Isum) ) 
gSum = 0._dp  
Contribution = ' ' 
...
Real(dp),Intent(in) :: MChi(7),MGlu,MSd(6),MFd(3)
...
Isum = 36 
Allocate( gSum(7,1,6, Isum) ) 
Allocate( Contribution(7,1,6, Isum) ) 
gSum = 0._dp  
Contribution = ' ' 
...
Real(dp),Intent(in) :: MFd(3),MSd(6),MChi(7),MGlu

Complex(dp),Intent(in) :: cplChiFdcSdL(7,3,6),cplChiFdcSdR(7,3,6),cplGluFdcSdL(3,6),cplGluFdcSdR(3,6)
...
Real(dp),Intent(in) :: MFu(3),MFd(3),MSu(6),MCha(5),MChi(7),MGlu,MSd(6)
...
Real(dp),Intent(in) :: MHpm(8),MFd(3),MCha(5),MSu(6),MChi(7),MSd(6)

Complex(dp),Intent(in) :: cplHpmSucSd(8,6,6),cplcChaChiHpmL(5,7,8),cplcChaChiHpmR(5,7,8),cplcChaFdcSuL(5,3,6),  & 
& cplcChaFdcSuR(5,3,6),cplChiFdcSdL(7,3,6),cplChiFdcSdR(7,3,6)
...
Real(dp),Intent(in) :: MSd(6),MFd(3),MVZ,MAh(5),Mhh(5),MChi(7),MGlu

Complex(dp),Intent(in) :: cplAhSdcSd(5,6,6),cplhhSdcSd(5,6,6),cplSdcSdVZ(6,6),cplcFdChiSdL(3,7,6),              & 
& cplcFdChiSdR(3,7,6),cplcFdFdAhL(3,3,5),cplcFdFdAhR(3,3,5),cplcFdFdhhL(3,3,5),          & 
& cplcFdFdhhR(3,3,5),cplcFdFdVZL(3,3),cplcFdFdVZR(3,3),cplcFdGluSdL(3,6),cplcFdGluSdR(3,6),& 
& cplChiFdcSdL(7,3,6),cplChiFdcSdR(7,3,6),cplGluFdcSdL(3,6),cplGluFdcSdR(3,6)
...
Real(dp),Intent(in) :: MSu(6),MFd(3),MFu(3),MVWm,MHpm(8),MChi(7),MGlu,MSd(6)

Complex(dp),Intent(in) :: cplHpmSucSd(8,6,6),cplSucSdVWm(6,6),cplcFuChiSuL(3,7,6),cplcFuChiSuR(3,7,6),          & 
& cplcFuFdcHpmL(3,3,8),cplcFuFdcHpmR(3,3,8),cplcFuFdcVWmL(3,3),cplcFuFdcVWmR(3,3),       & 
& cplcFuGluSuL(3,6),cplcFuGluSuR(3,6),cplChiFdcSdL(7,3,6),cplChiFdcSdR(7,3,6),           & 
...
Real(dp),Intent(in) :: MSd(6),MFu(3),MVZ,MAh(5),Mhh(5),MCha(5)

Complex(dp),Intent(in) :: cplAhSdcSd(5,6,6),cplhhSdcSd(5,6,6),cplSdcSdVZ(6,6),cplcChacFuSdL(5,3,6),             & 
& cplcChacFuSdR(5,3,6),cplcFuFuAhL(3,3,5),cplcFuFuAhR(3,3,5),cplcFuFuhhL(3,3,5),         & 
& cplcFuFuhhR(3,3,5),cplcFuFuVZL(3,3),cplcFuFuVZR(3,3),cplChaFucSdL(5,3,6),              & 
& cplChaFucSdR(5,3,6)
...
Real(dp),Intent(in) :: Mhh(5),MFd(3),MGlu,MSd(6)

Complex(dp),Intent(in) :: cplhhSdcSd(5,6,6),cplcFdFdhhL(3,3,5),cplcFdFdhhR(3,3,5),cplGluFdcSdL(3,6),            & 
& cplGluFdcSdR(3,6)
