...
& M1,M2,M3,vd,vu,vL,gTSd,gTSu,gGluFdcFdChi,gGluFdcFucCha,gGluFucFuChi,epsI,              & 
...
Real(dp),Intent(inout) :: gGluFdcFdChi(1,3,3,7),gGluFdcFucCha(1,3,3,5),gGluFucFuChi(1,3,3,7)

Real(dp),Intent(in) :: gTSd(6),gTSu(6)

Real(dp) :: gGluFdcFdChii(3,3,7),gGluFdcFucChai(3,3,5),gGluFucFuChii(3,3,7)
...
& mu2,me2,mlHd2,M1,M2,M3,vd,vu,vL,cplcChacFuSdL,cplcChacFuSdR,cplcChaFdcSuL,             & 
...
Real(dp),Intent(in) :: MFd(3),MChi(7),MSd(6),MGlu
...
Isum = 144 
Allocate( gSum(3,3,7, Isum) ) 
Allocate( Contribution(3,3,7, Isum) ) 
gSum = 0._dp  
Contribution = ' ' 
...
Real(dp),Intent(in) :: MFu(3),MChi(7),MSu(6),MGlu
