...
& M1,M2,M3,vd,vu,vL,gSuAhChiFu,gSuAhFdcCha,gSuAhFuGlu,gSuSuChiChi,gSucHpmChiFd,          & 
...
Complex(dp) :: cplAhSucSu(5,6,6),cplcChacFuSdL(5,3,6),cplcChacFuSdR(5,3,6),cplcChaChaAhL(5,5,5),     & 
...
Real(dp),Intent(inout) :: gSuAhChiFu(6,5,7,3),gSuAhFdcCha(6,5,3,5),gSuAhFuGlu(6,5,3,1),gSuSuChiChi(6,6,7,7),    & 
...
Real(dp) :: gSuAhChiFui(5,7,3),gSuAhFdcChai(5,3,5),gSuAhFuGlui(5,3,1),gSuSuChiChii(6,7,7),        & 
& gSucHpmChiFdi(8,7,3),gSuhhChiFui(5,7,3),gSuChiGluSui(7,1,6),gSuSdChicChai(6,7,5),      & 
& gSuFdFucSdi(3,3,6),gSuhhFdcChai(5,3,5),gSuSuFdcFdi(6,3,3),gSucHpmChaFui(8,5,3),        & 
& gSuFuFucSui(3,3,6),gSucChaFuHpmi(5,3,8),gSuSdFucFdi(6,3,3),gSuSuFucFui(6,3,3),         & 
& gSucHpmFdGlui(8,3,1),gSuhhFuGlui(5,3,1),gSuGluGluSui(1,1,6),gSuGluSdcChai(1,6,5),      & 
& gSuSuChacChai(6,5,5)
...
& md2,mu2,me2,mlHd2,M1,M2,M3,vd,vu,vL,cplAhSucSu,cplcChacFuSdL,cplcChacFuSdR,            & 
...
Real(dp),Intent(in) :: MAh(5),MChi(7),MFu(3),MSu(6)

Complex(dp),Intent(in) :: cplAhSucSu(5,6,6),cplcFuFuAhL(3,3,5),cplcFuFuAhR(3,3,5),cplChiChiAhL(7,7,5),          & 
& cplChiChiAhR(7,7,5),cplChiFucSuL(7,3,6),cplChiFucSuR(7,3,6)
...
Real(dp),Intent(in) :: MAh(5),MFd(3),MCha(5),MSu(6)

Complex(dp),Intent(in) :: cplAhSucSu(5,6,6),cplcChaChaAhL(5,5,5),cplcChaChaAhR(5,5,5),cplcChaFdcSuL(5,3,6),     & 
& cplcChaFdcSuR(5,3,6),cplcFdFdAhL(3,3,5),cplcFdFdAhR(3,3,5)
...
Isum = 196 
Allocate( gSum(5,3,5, Isum) ) 
Allocate( Contribution(5,3,5, Isum) ) 
gSum = 0._dp  
Contribution = ' ' 
...
Real(dp),Intent(in) :: MAh(5),MFu(3),MGlu,MSu(6)

Complex(dp),Intent(in) :: cplAhSucSu(5,6,6),cplcFuFuAhL(3,3,5),cplcFuFuAhR(3,3,5),cplGluFucSuL(3,6),            & 
& cplGluFucSuR(3,6)
...
Real(dp),Intent(in) :: MSu(6),MChi(7),MVZ,MAh(5),Mhh(5),MFu(3)

Complex(dp),Intent(in) :: cplAhSucSu(5,6,6),cplhhSucSu(5,6,6),cplSucSuVZ(6,6),cplcFuChiSuL(3,7,6),              & 
& cplcFuChiSuR(3,7,6),cplChiChiAhL(7,7,5),cplChiChiAhR(7,7,5),cplChiChihhL(7,7,5),       & 
& cplChiChihhR(7,7,5),cplChiChiVZL(7,7),cplChiChiVZR(7,7),cplChiFucSuL(7,3,6),           & 
& cplChiFucSuR(7,3,6)
...
Real(dp),Intent(in) :: MHpm(8),MChi(7),MFd(3),MSd(6),MFu(3),MCha(5),MSu(6)

Complex(dp),Intent(in) :: cplSdcHpmcSu(6,8,6),cplcChaFdcSuL(5,3,6),cplcChaFdcSuR(5,3,6),cplcFuFdcHpmL(3,3,8),   & 
& cplcFuFdcHpmR(3,3,8),cplChiChacHpmL(7,5,8),cplChiChacHpmR(7,5,8),cplChiFdcSdL(7,3,6),  & 
...
Real(dp),Intent(in) :: Mhh(5),MChi(7),MFu(3),MSu(6)

Complex(dp),Intent(in) :: cplhhSucSu(5,6,6),cplcFuFuhhL(3,3,5),cplcFuFuhhR(3,3,5),cplChiChihhL(7,7,5),          & 
& cplChiChihhR(7,7,5),cplChiFucSuL(7,3,6),cplChiFucSuR(7,3,6)
...
Real(dp),Intent(in) :: MChi(7),MGlu,MSu(6),MFu(3)
...
Real(dp),Intent(in) :: MSd(6),MChi(7),MCha(5),MVWm,MHpm(8),MFu(3),MFd(3),MSu(6)
...
& cplcChaFdcSuL(5,3,6),cplcChaFdcSuR(5,3,6),cplcFdChiSdL(3,7,6),cplcFdChiSdR(3,7,6),     & 
...
Isum = 225 
Allocate( gSum(6,7,5, Isum) ) 
Allocate( Contribution(6,7,5, Isum) ) 
gSum = 0._dp  
Contribution = ' ' 
...
Real(dp),Intent(in) :: MFd(3),MFu(3),MSd(6),MCha(5),MChi(7),MGlu,MSu(6)
...
Real(dp),Intent(in) :: Mhh(5),MFd(3),MCha(5),MSu(6)

Complex(dp),Intent(in) :: cplhhSucSu(5,6,6),cplcChaChahhL(5,5,5),cplcChaChahhR(5,5,5),cplcChaFdcSuL(5,3,6),     & 
& cplcChaFdcSuR(5,3,6),cplcFdFdhhL(3,3,5),cplcFdFdhhR(3,3,5)
...
Real(dp),Intent(in) :: MSu(6),MFd(3),MVZ,MAh(5),Mhh(5),MCha(5)

Complex(dp),Intent(in) :: cplAhSucSu(5,6,6),cplhhSucSu(5,6,6),cplSucSuVZ(6,6),cplcChaFdcSuL(5,3,6),             & 
& cplcChaFdcSuR(5,3,6),cplcFdChaSuL(3,5,6),cplcFdChaSuR(3,5,6),cplcFdFdAhL(3,3,5),       & 
& cplcFdFdAhR(3,3,5),cplcFdFdhhL(3,3,5),cplcFdFdhhR(3,3,5),cplcFdFdVZL(3,3),             & 
& cplcFdFdVZR(3,3)
...
Real(dp),Intent(in) :: MHpm(8),MCha(5),MFu(3),MSd(6),MChi(7),MSu(6)

Complex(dp),Intent(in) :: cplSdcHpmcSu(6,8,6),cplChaFucSdL(5,3,6),cplChaFucSdR(5,3,6),cplChiChacHpmL(7,5,8),    & 
& cplChiChacHpmR(7,5,8),cplChiFucSuL(7,3,6),cplChiFucSuR(7,3,6)
...
Real(dp),Intent(in) :: MFu(3),MSu(6),MChi(7),MGlu

Complex(dp),Intent(in) :: cplChiFucSuL(7,3,6),cplChiFucSuR(7,3,6),cplGluFucSuL(3,6),cplGluFucSuR(3,6)
...
Real(dp),Intent(in) :: MCha(5),MFu(3),MHpm(8),MFd(3),MChi(7),MSu(6)

Complex(dp),Intent(in) :: cplcChaChiHpmL(5,7,8),cplcChaChiHpmR(5,7,8),cplcChaFdcSuL(5,3,6),cplcChaFdcSuR(5,3,6),& 
& cplcFdFuHpmL(3,3,8),cplcFdFuHpmR(3,3,8),cplChiFucSuL(7,3,6),cplChiFucSuR(7,3,6)
...
Real(dp),Intent(in) :: MSd(6),MFu(3),MFd(3),MVWm,MHpm(8),MChi(7),MGlu,MSu(6)

Complex(dp),Intent(in) :: cplSdcHpmcSu(6,8,6),cplSdcSucVWm(6,6),cplcFdChiSdL(3,7,6),cplcFdChiSdR(3,7,6),        & 
& cplcFdFuHpmL(3,3,8),cplcFdFuHpmR(3,3,8),cplcFdFuVWmL(3,3),cplcFdFuVWmR(3,3),           & 
& cplcFdGluSdL(3,6),cplcFdGluSdR(3,6),cplChiFucSuL(7,3,6),cplChiFucSuR(7,3,6),           & 
...
Real(dp),Intent(in) :: MSu(6),MFu(3),MVZ,MAh(5),Mhh(5),MChi(7),MGlu

Complex(dp),Intent(in) :: cplAhSucSu(5,6,6),cplhhSucSu(5,6,6),cplSucSuVZ(6,6),cplcFuChiSuL(3,7,6),              & 
& cplcFuChiSuR(3,7,6),cplcFuFuAhL(3,3,5),cplcFuFuAhR(3,3,5),cplcFuFuhhL(3,3,5),          & 
...
Real(dp),Intent(in) :: Mhh(5),MFu(3),MGlu,MSu(6)

Complex(dp),Intent(in) :: cplhhSucSu(5,6,6),cplcFuFuhhL(3,3,5),cplcFuFuhhR(3,3,5),cplGluFucSuL(3,6),            & 
& cplGluFucSuR(3,6)
...
Real(dp),Intent(in) :: MSu(6),MCha(5),MVZ,MAh(5),Mhh(5),MFd(3)

Complex(dp),Intent(in) :: cplAhSucSu(5,6,6),cplhhSucSu(5,6,6),cplSucSuVZ(6,6),cplcChaChaAhL(5,5,5),             & 
& cplcChaChaAhR(5,5,5),cplcChaChahhL(5,5,5),cplcChaChahhR(5,5,5),cplcChaChaVZL(5,5),     & 
