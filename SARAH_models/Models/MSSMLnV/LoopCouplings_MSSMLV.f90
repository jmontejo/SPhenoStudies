...
& MSu,MVWm,g1,g2,L1,L2,ZEL,ZER,vd,vL,vu,Yd,Ye,Yu,ZA,ZD,ZDL,ZDR,ZH,UVinput,               & 
& ZP,ZU,ZUL,ZUR,res)

Implicit None 
Real(dp),Intent(in) :: MAh(5),MCha(5),MChi(7),MFd(3),MFu(3),Mhh(5),MHpm(8),MSd(6),MSu(6),MVWm,               & 
& g1,g2,vd,vL(3),vu,ZA(5,5),ZH(5,5),ZP(8,8)

Complex(dp),Intent(in) :: L1(3,3,3),L2(3,3,3),ZEL(5,5),ZER(5,5),Yd(3,3),Ye(3,3),Yu(3,3),ZD(6,6),ZDL(3,3),       & 
& ZDR(3,3),UVinput(7,7),ZU(6,6),ZUL(3,3),ZUR(3,3)

Real(dp) :: MAh2(5),MCha2(5),MChi2(7),MFd2(3),MFu2(3),Mhh2(5),MHpm2(8),MSd2(6),MSu2(6),MVWm2

Complex(dp) :: cplAhcHpmVWm(5,8),cplcChacFuSdL(5,3,6),cplcChacFuSdR(5,3,6),cplcChaChaAhL(5,5,5),     & 
& cplcChaChaAhR(5,5,5),cplcChaChahhL(5,5,5),cplcChaChahhR(5,5,5),cplcChaChiHpmL(5,7,8),  & 
...
& cplcFdChiSdR(3,7,6),cplcFdFuVWmL(3,3),cplcFdFuVWmR(3,3),cplcFuChiSuL(3,7,6),           & 
& cplcFuChiSuR(3,7,6),cplChaFucSdL(5,3,6),cplChaFucSdR(5,3,6),cplChiChacHpmL(7,5,8),     & 
& cplChiChacHpmR(7,5,8),cplChiChacVWmL(7,5),cplChiChacVWmR(7,5),cplChiChiAhL(7,7,5),     & 
& cplChiChiAhR(7,7,5),cplChiChihhL(7,7,5),cplChiChihhR(7,7,5),cplChiFdcSdL(7,3,6),       & 
& cplChiFdcSdR(7,3,6),cplChiFucSuL(7,3,6),cplChiFucSuR(7,3,6),cplhhcHpmVWm(5,8),         & 
& cplhhcVWmVWm(5),cplSucSdVWm(6,6)
...
& ratSu,ratVWm,MCha,MFd,MFu,MHpm,MSd,MSu,MVWm,gNLO,coup)

Implicit None 
Complex(dp),Intent(in) :: ratCha(5),ratFd(3),ratFu(3),ratHpm(8),ratSd(6),ratSu(6),ratVWm

Real(dp),Intent(in) :: MCha(5),MFd(3),MFu(3),MHpm(8),MSd(6),MSu(6),MVWm
...
Subroutine CoupHiggsToPhotonSM(mHiggs,MCha,MFd,MFu,MHpm,MSd,MSu,MVWm,gNLO,coup)
...
Do i1 =1, 3 
coup = coup + 1*(-1)**2*A_onehalf(mH2p/MCha(i1)**2)
End Do 
Do i1 =1, 3 
...
& ratSd,ratSu,ratVWm,MCha,MFd,MFu,MHpm,MSd,MSu,MVWm,gNLO,coup)
...
Subroutine CoupPseudoHiggsToPhotonSM(mHiggs,MCha,MFd,MFu,MHpm,MSd,MSu,MVWm,           & 
& gNLO,coup)
...
End Module LoopCouplings_MSSMLV 
