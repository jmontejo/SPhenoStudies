...
Real(dp) :: ZPOS_0(8, 8)
Real(dp) :: ZPOS_p2(8, 8)
Complex(dp) :: UVOS_0(7, 7)
Complex(dp) :: UVOS_p2(7, 7)
Complex(dp) :: ZELOS_0(5, 5)
Complex(dp) :: ZELOS_p2(5, 5)
Complex(dp) :: ZEROS_0(5, 5)
Complex(dp) :: ZEROS_p2(5, 5)
...
Complex(dp) :: YdIN(3,3),YeIN(3,3),L1IN(3,3,3),L2IN(3,3,3),YuIN(3,3),MuIN,REpsIN(3),TdIN(3,3),       & 
& TeIN(3,3),T1IN(3,3,3),T2IN(3,3,3),TuIN(3,3),BmuIN,BepsIN(3),mq2IN(3,3),ml2IN(3,3),     & 
& md2IN(3,3),mu2IN(3,3),me2IN(3,3),M1IN,M2IN,M3IN

Real(dp) :: g1MZ,g2MZ,g3MZ,mHd2MZ,mHu2MZ,mlHd2MZ(3)

Complex(dp) :: YdMZ(3,3),YeMZ(3,3),L1MZ(3,3,3),L2MZ(3,3,3),YuMZ(3,3),MuMZ,REpsMZ(3),TdMZ(3,3),       & 
& TeMZ(3,3),T1MZ(3,3,3),T2MZ(3,3,3),TuMZ(3,3),BmuMZ,BepsMZ(3),mq2MZ(3,3),ml2MZ(3,3),     & 
& md2MZ(3,3),mu2MZ(3,3),me2MZ(3,3),M1MZ,M2MZ,M3MZ

Real(dp) :: g1GUT,g2GUT,g3GUT,mHd2GUT,mHu2GUT,mlHd2GUT(3)

Complex(dp) :: YdGUT(3,3),YeGUT(3,3),L1GUT(3,3,3),L2GUT(3,3,3),YuGUT(3,3),MuGUT,REpsGUT(3),          & 
& TdGUT(3,3),TeGUT(3,3),T1GUT(3,3,3),T2GUT(3,3,3),TuGUT(3,3),BmuGUT,BepsGUT(3),          & 
...
Real(dp) :: vdIN,vuIN,vLIN(3)

Real(dp) :: vdFix,vuFix,vLFix(3)

Real(dp) :: gPSd(6,1983),gTSd(6),BRSd(6,1983),gPSu(6,1983),gTSu(6),BRSu(6,1983),gPhh(5,272),      & 
...
Real(dp) :: gP1LSd(6,159),gT1LSd(6),BR1LSd(6,159),gP1LSu(6,159),gT1LSu(6),BR1LSu(6,159),          & 
& gP1Lhh(5,272),gT1Lhh(5),BR1Lhh(5,272),gP1LAh(5,270),gT1LAh(5),BR1LAh(5,270),           & 
& gP1LHpm(8,168),gT1LHpm(8),BR1LHpm(8,168),gP1LGlu(1,55),gT1LGlu,BR1LGlu(1,55),          & 
& gP1LFu(3,138),gT1LFu(3),BR1LFu(3,138),gP1LCha(5,147),gT1LCha(5),BR1LCha(5,147),        & 
& gP1LChi(7,154),gT1LChi(7),BR1LChi(7,154)

Real(dp) :: ratioCha(5,5),ratioFd(5,3),ratioFu(5,3),ratioHpm(5,8),ratioSd(5,6),ratioSu(5,6),      & 
& ratioVWm(5)

Complex(dp) :: ratioGG(5),ratioPP(5)

Real(dp) :: ratioPCha(5,5),ratioPFd(5,3),ratioPFu(5,3),ratioPHpm(5,8),ratioPSd(5,6),              & 
& ratioPSu(5,6),ratioPVWm(5)

Complex(dp) :: ratioPGG(5),ratioPPP(5)

Real(dp) :: TanBetaQ
Real(dp) :: gForTadpoles(449)
...
Real(dp) :: CS_Higgs_LHC(5,5,5) 
 
Real(dp) :: CS_PHiggs_LHC(5,5,5) 
 
Real (dp) :: MhhL(5), Mhh2L(5) 
Real (dp) :: Mhh_s(5), Mhh2_s(5) 
Real (dp) :: MAhL(5), MAh2L(5) 
Real (dp) :: MAh_s(5), MAh2_s(5) 
...
Logical, save :: InputValueforREps =.False. 
...
Logical, save :: InputValueforBeps =.False. 
...
Real(dp) :: nuMasses(7) 
Complex(dp) :: nuMixing(7,7) 
Complex(dp) :: temporaryValue 
Real(dp) :: m0
Complex(dp) :: m12
Real(dp) :: TanBeta
Complex(dp) :: SignumMue
Complex(dp) :: Azero
Complex(dp) :: M1input
Complex(dp) :: M2input
Complex(dp) :: M3input
...
Real(dp) :: vLSUSY(3) 
! For HiggsBounds 
Real(dp) :: BR_HpHW(8,5)  = 0._dp
Real(dp) :: BR_HpAW(8,5) = 0._dp
Real(dp) :: BR_HpTB(8) = 0._dp 
Real(dp) :: BR_HpWZ(8) = 0._dp
Real(dp) :: BR_tHb(8) = 0._dp
Real(dp) :: BR_Hcs(8)= 0._dp 
Real(dp) :: BR_Hcb(8)=0._dp 
Real(dp) :: BR_Htaunu(8)=0._dp 
Real(dp) :: BR_tWb = 0._dp
Real(dp) :: BRHll(5,3,3)  = 0._dp
Real(dp) :: BRAll(5,3,3)   = 0._dp 
 Real(dp) :: BRHHH(5,5)=0._dp
Real(dp) :: BRHAA(5,5)= 0._dp 
 Real(dp) :: BRAHH(5,5)=0._dp
Real(dp) :: BRAAA(5,5)  = 0._dp 
 Real(dp) :: BRHHHijk(5,5,5)=0._dp
Real(dp) :: BRHHAijk(5,5,5)=0._dp
Real(dp) :: BRHAAijk(5,5,5)  = 0._dp 
 Real(dp) :: BRAHHijk(5,5,5)=0._dp
Real(dp) :: BRAHAijk(5,5,5)=0._dp
Real(dp) ::  BRAAAijk(5,5,5)  = 0._dp 
 Real(dp) :: BRHHZ(5,5)=0._dp
Real(dp) :: BRHAZ(5,5)  = 0._dp 
 Real(dp) :: BRAHZ(5,5) =0._dp
Real(dp) :: BRAAZ(5,5)  = 0._dp 
 Real(dp) :: BRAHpW(5,8)=0._dp
Real(dp) :: BRHhpW(5,8)  = 0._dp 
 Real(dp) :: BRinvH(5), BRinvA(5)  = 0._dp 
Real(dp) :: rHB_P_VP(5),rHB_S_VP(5)
Real(dp) :: rHB_P_VZ(5),rHB_S_VZ(5)
Real(dp) :: rHB_P_VG(5),rHB_S_VG(5)
Real(dp) :: rHB_P_VWm(5),rHB_S_VWm(5)
Real(dp) :: rHB_P_P_Fd(5,3),rHB_P_S_Fd(5,3),rHB_S_S_Fd(5,3),rHB_S_P_Fd(5,3)
Real(dp) :: rHB_P_P_Fu(5,3),rHB_P_S_Fu(5,3),rHB_S_S_Fu(5,3),rHB_S_P_Fu(5,3)
Real(dp) :: rHB_P_P_Chi(5,7),rHB_P_S_Chi(5,7),rHB_S_S_Chi(5,7),rHB_S_P_Chi(5,7)
Real(dp) :: rHB_P_P_Cha(5,5),rHB_P_S_Cha(5,5),rHB_S_S_Cha(5,5),rHB_S_P_Cha(5,5)
Complex(dp) :: CPL_A_H_Z(5,5)  =0._dp 
 Complex(dp) :: CPL_H_H_Z(5,5) =0._dp 
 Complex(dp) :: CoupHPP(5), CoupHGG(5) =0._dp 
Complex(dp) :: CPL_A_A_Z(5,5) =0._dp 
 Complex(dp) :: CoupAPP(5), CoupAGG(5) =0._dp 
Real(dp) :: HPPloopVWm(5)
Real(dp) :: HPPloopSd(6,5)
Real(dp) :: HPPloopSu(6,5)
Real(dp) :: HPPloopHpm(8,5)
Real(dp) :: HPPloopCha(5,5)
Real(dp) :: HPPloopFd(3,5)
Real(dp) :: HPPloopFu(3,5)
...
& vL,g1,g2,g3,Yd,Ye,L1,L2,Yu,Mu,REps,Td,Te,T1,T2,Tu,Bmu,Beps,mq2,ml2,mHd2,               & 
& mHu2,md2,mu2,me2,mlHd2,M1,M2,M3,MZsuffix)
