...
InputValueforREps= .True. 
    Call ReadVectorC(99,3,REpsIN,0, "REpsIN",kont)

 
   Else If (read_line(7:14).Eq."IMREPSIN") Then 
     If (i_cpv.Lt.2) Then  
       Call Warn_CPV(i_cpv,"IMREps") 
       Cycle 
     End If 
    Call ReadVectorC(99,3,REpsIN,1, "REpsIN",kont)
...
InputValueforTu= .True. 
   ...
   Else If (read_line(7:11).Eq."RVDIN") Then 
InputValueforBeps= .True. 
    Call ReadVectorC(99,3,BepsIN,0, "BepsIN",kont)

 
   Else If (read_line(7:14).Eq."IMBEPSIN") Then 
     If (i_cpv.Lt.2) Then  
       Call Warn_CPV(i_cpv,"IMBeps") 
       Cycle 
     End If 
    Call ReadVectorC(99,3,BepsIN,1, "BepsIN",kont)
...
If (i_c.Eq.0) SignumMue= Cmplx(wert,Aimag(SignumMue),dp) 
If (i_c.Eq.1) SignumMue= Cmplx(Real(SignumMue,dp),wert,dp) 
...
Complex(dp) :: PDGSd(6),PDGSu(6),PDGhh(5),PDGAh(5),PDGHpm(8),PDGVP,PDGVZ,PDGVG,PDGVWm,               & 
& PDGgP,PDGgWm,PDGgWmC,PDGgZ,PDGgG,PDGFd(3),PDGFu(3),PDGGlu,PDGChi(7),PDGCha(5)

Character(len=30),Dimension(6):: NameParticleSd
Character(len=30),Dimension(6):: NameParticleSu
Character(len=30),Dimension(5):: NameParticlehh
Character(len=30),Dimension(5):: NameParticleAh
...
Character(len=30),Dimension(7):: NameParticleChi
...
Write(io_L,100) "# SUSY Les Houches Accord 2 - MSSM-RpV/LnV Spectrum + Decays + Flavor Observables"
...
End if 
If (Abs(Aimag(SignumMue)).gt.0._dp) Then 
Write(io_L,101) 4, Aimag(SignumMue) ,"# SignumMue"
End if 
...
Write(io_L,106) "Block RVKAPPA Q=",Q,"# (SUSY Scale)" 
Write(io_L,104) 1,Real(REps(1),dp), "# Real(REps(1) ,dp)" 
Write(io_L,104) 2,Real(REps(2),dp), "# Real(REps(2) ,dp)" 
Write(io_L,104) 3,Real(REps(3),dp), "# Real(REps(3) ,dp)" 
If ((MaxVal(Abs(AImag(REps))).gt.0._dp).OR.(OutputForMG)) Then 
Write(io_L,106) "Block IMRVKAPPA Q=",Q,"# (SUSY Scale)" 
Write(io_L,104) 1,Aimag(REps(1)), "# Aimag(REps(1) )" 
Write(io_L,104) 2,Aimag(REps(2)), "# Aimag(REps(2) )" 
Write(io_L,104) 3,Aimag(REps(3)), "# Aimag(REps(3) )" 
End If 
...
Write(io_L,106) "Block RVD Q=",Q,"# (SUSY Scale)" 
Write(io_L,104) 1,Real(Beps(1),dp), "# Real(Beps(1) ,dp)" 
Write(io_L,104) 2,Real(Beps(2),dp), "# Real(Beps(2) ,dp)" 
Write(io_L,104) 3,Real(Beps(3),dp), "# Real(Beps(3) ,dp)" 
If ((MaxVal(Abs(AImag(Beps))).gt.0._dp).OR.(OutputForMG)) Then 
Write(io_L,106) "Block IMRVD Q=",Q,"# (SUSY Scale)" 
Write(io_L,104) 1,Aimag(Beps(1)), "# Aimag(Beps(1) )" 
Write(io_L,104) 2,Aimag(Beps(2)), "# Aimag(Beps(2) )" 
Write(io_L,104) 3,Aimag(Beps(3)), "# Aimag(Beps(3) )" 
End If 
...
Write(io_L,106) "Block REpsGUT Q=",M_GUT,"# (GUT Scale)" 
Write(io_L,104) 1,Real(REpsGUT(1),dp), "# Real(REpsGUT(1) ,dp)" 
Write(io_L,104) 2,Real(REpsGUT(2),dp), "# Real(REpsGUT(2) ,dp)" 
Write(io_L,104) 3,Real(REpsGUT(3),dp), "# Real(REpsGUT(3) ,dp)" 
If ((MaxVal(Abs(AImag(REpsGUT))).gt.0._dp).OR.(OutputForMG)) Then 
Write(io_L,106) "Block IMREpsGUT Q=",M_GUT,"# (GUT Scale)" 
Write(io_L,104) 1,Aimag(REpsGUT(1)), "# Aimag(REpsGUT(1) )" 
Write(io_L,104) 2,Aimag(REpsGUT(2)), "# Aimag(REpsGUT(2) )" 
Write(io_L,104) 3,Aimag(REpsGUT(3)), "# Aimag(REpsGUT(3) )" 
End If 
...
Write(io_L,106) "Block BepsGUT Q=",M_GUT,"# (GUT Scale)" 
Write(io_L,104) 1,Real(BepsGUT(1),dp), "# Real(BepsGUT(1) ,dp)" 
Write(io_L,104) 2,Real(BepsGUT(2),dp), "# Real(BepsGUT(2) ,dp)" 
Write(io_L,104) 3,Real(BepsGUT(3),dp), "# Real(BepsGUT(3) ,dp)" 
If ((MaxVal(Abs(AImag(BepsGUT))).gt.0._dp).OR.(OutputForMG)) Then 
Write(io_L,106) "Block IMBepsGUT Q=",M_GUT,"# (GUT Scale)" 
Write(io_L,104) 1,Aimag(BepsGUT(1)), "# Aimag(BepsGUT(1) )" 
Write(io_L,104) 2,Aimag(BepsGUT(2)), "# Aimag(BepsGUT(2) )" 
Write(io_L,104) 3,Aimag(BepsGUT(3)), "# Aimag(BepsGUT(3) )" 
End If 
...
Write(io_L,106) "Block RVHMIX Q=",Q,"# ()" 
...
Write(io_L,106) "Block RVAMIX Q=",Q,"# ()" 
...
Write(io_L,106) "Block RVLMIX Q=",Q,"# ()" 
...
Write(io_L,106) "Block RVNMIX Q=",Q,"# ()" 
...
Write(io_L,106) "Block IMRVNMIX Q=",Q,"# ()" 
...
Write(io_L,106) "Block RVUMIX Q=",Q,"# ()" 
...
Write(io_L,106) "Block IMRVUMIX Q=",Q,"# ()" 
...
Write(io_L,106) "Block RVVMIX Q=",Q,"# ()" 
...
Write(io_L,106) "Block IMRVVMIX Q=",Q,"# ()" 
...
icount = icount +1 
  End Do 
If (Maxval(BRSd(1,160:1983)).Gt.BRmin) Then 
...
icount = icount +1 
  End Do 
If (Maxval(BRSd(2,160:1983)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=2,5
  Do gt2=1,5
...
icount = icount +1 
  End Do 
If (Maxval(BRSd(3,160:1983)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=2,5
  Do gt2=1,5
...
icount = icount +1 
  End Do 
If (Maxval(BRSd(4,160:1983)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=2,5
  Do gt2=1,5
...
icount = icount +1 
  End Do 
If (Maxval(BRSd(5,160:1983)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=2,5
  Do gt2=1,5
...
icount = icount +1 
  End Do 
If (Maxval(BRSd(6,160:1983)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=2,5
  Do gt2=1,5
...
icount = icount +1 
  End Do 
If (Maxval(BRSu(1,160:1983)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=2,5
  Do gt2=1,7
...
icount = icount +1 
  End Do 
If (Maxval(BRSu(2,160:1983)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=2,5
  Do gt2=1,7
...
icount = icount +1 
  End Do 
If (Maxval(BRSu(3,160:1983)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=2,5
  Do gt2=1,7
...
icount = icount +1 
  End Do 
If (Maxval(BRSu(4,160:1983)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=2,5
  Do gt2=1,7
...
icount = icount +1 
  End Do 
If (Maxval(BRSu(5,160:1983)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=2,5
  Do gt2=1,7
...
icount = icount +1 
  End Do 
If (Maxval(BRSu(6,160:1983)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=2,5
  Do gt2=1,7
...
CurrentPDG2(2) = PDGhh(gt2) 
Write(io_L,201) BRhh(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(3))//" -> "//Trim(NameParticleAh(gt1))//" "//Trim(NameParticlehh(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGGlu 
Write(io_L,201) BRhh(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(3))//" -> "//Trim(NameParticleGlu)//" "//Trim(NameParticleGlu)//" "//")"
If (((gTGlu.le.WidthToBeInvisible).and.(gTGlu.le.WidthToBeInvisible)).OR. & 
 & ((WidthToBeInvisible.le.-1._dp).And.(CurrentPDG2(1).eq.PDGLSP(1)).And.(CurrentPDG2(2).eq.PDGLSP(1)))) Then 
  BRinvH(3) = BRinvH(3)+BRhh(3,icount) 
End if 
...
CurrentPDG2(2) = PDGhh(gt2) 
Write(io_L,201) BRhh(4,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(4))//" -> "//Trim(NameParticleAh(gt1))//" "//Trim(NameParticlehh(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRhh(4,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(4))//" -> "//Trim(NameParticleAh(gt1))//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
  End Do 
If (BRhh(4,icount).Gt.BrMin) Then 
...
CurrentPDG2(2) = PDGGlu 
Write(io_L,201) BRhh(4,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(4))//" -> "//Trim(NameParticleGlu)//" "//Trim(NameParticleGlu)//" "//")"
If (((gTGlu.le.WidthToBeInvisible).and.(gTGlu.le.WidthToBeInvisible)).OR. & 
 & ((WidthToBeInvisible.le.-1._dp).And.(CurrentPDG2(1).eq.PDGLSP(1)).And.(CurrentPDG2(2).eq.PDGLSP(1)))) Then 
  BRinvH(4) = BRinvH(4)+BRhh(4,icount) 
End if 
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRhh(4,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(4))//" -> "//Trim(NameParticlehh(gt1))//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 5
...
CurrentPDG2(2) = PDGVZ 
Write(io_L,201) BRhh(4,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(4))//" -> "//Trim(NameParticlehh(gt1))//" "//Trim(NameParticleVZ)//" "//")"
End if 
icount = icount +1 
  End Do 
If (BRhh(4,icount).Gt.BrMin) Then 
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRhh(4,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(4))//" -> "//Trim(NameParticleVZ)//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
End if 
If ((gThh(5).gt.MinWidth).or.(OutputForMG)) Then 
...
CurrentPDG2(2) = PDGhh(gt2) 
Write(io_L,201) BRhh(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(5))//" -> "//Trim(NameParticleAh(gt1))//" "//Trim(NameParticlehh(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRhh(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(5))//" -> "//Trim(NameParticleAh(gt1))//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
  End Do 
If (BRhh(5,icount).Gt.BrMin) Then 
...
CurrentPDG2(2) = PDGGlu 
Write(io_L,201) BRhh(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(5))//" -> "//Trim(NameParticleGlu)//" "//Trim(NameParticleGlu)//" "//")"
If (((gTGlu.le.WidthToBeInvisible).and.(gTGlu.le.WidthToBeInvisible)).OR. & 
 & ((WidthToBeInvisible.le.-1._dp).And.(CurrentPDG2(1).eq.PDGLSP(1)).And.(CurrentPDG2(2).eq.PDGLSP(1)))) Then 
  BRinvH(5) = BRinvH(5)+BRhh(5,icount) 
End if 
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRhh(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(5))//" -> "//Trim(NameParticlehh(gt1))//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 5
...
CurrentPDG2(2) = PDGVZ 
Write(io_L,201) BRhh(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(5))//" -> "//Trim(NameParticlehh(gt1))//" "//Trim(NameParticleVZ)//" "//")"
End if 
icount = icount +1 
  End Do 
If (BRhh(5,icount).Gt.BrMin) Then 
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRhh(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(5))//" -> "//Trim(NameParticleVZ)//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
End if 
...
CurrentPDG2(2) = PDGGlu 
Write(io_L,201) BRAh(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleAh(3))//" -> "//Trim(NameParticleGlu)//" "//Trim(NameParticleGlu)//" "//")"
If (((gTGlu.le.WidthToBeInvisible).and.(gTGlu.le.WidthToBeInvisible)).OR. & 
 & ((WidthToBeInvisible.le.-1._dp).And.(CurrentPDG2(1).eq.PDGLSP(1)).And.(CurrentPDG2(2).eq.PDGLSP(1)))) Then 
  BRinvA(3) = BRinvA(3)+BRAh(3,icount) 
End if 
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRAh(4,icount),2,CurrentPDG2, & 
 & Trim(NameParticleAh(4))//" -> "//Trim(NameParticleAh(gt1))//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 2, 5
...
CurrentPDG2(2) = PDGVZ 
Write(io_L,201) BRAh(4,icount),2,CurrentPDG2, & 
 & Trim(NameParticleAh(4))//" -> "//Trim(NameParticleAh(gt1))//" "//Trim(NameParticleVZ)//" "//")"
End if 
icount = icount +1 
  End Do 
If (BRAh(4,icount).Gt.BrMin) Then 
...
CurrentPDG2(2) = PDGGlu 
Write(io_L,201) BRAh(4,icount),2,CurrentPDG2, & 
 & Trim(NameParticleAh(4))//" -> "//Trim(NameParticleGlu)//" "//Trim(NameParticleGlu)//" "//")"
If (((gTGlu.le.WidthToBeInvisible).and.(gTGlu.le.WidthToBeInvisible)).OR. & 
 & ((WidthToBeInvisible.le.-1._dp).And.(CurrentPDG2(1).eq.PDGLSP(1)).And.(CurrentPDG2(2).eq.PDGLSP(1)))) Then 
  BRinvA(4) = BRinvA(4)+BRAh(4,icount) 
End if 
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRAh(4,icount),2,CurrentPDG2, & 
 & Trim(NameParticleAh(4))//" -> "//Trim(NameParticlehh(gt1))//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
  End Do 
If (BRAh(4,icount).Gt.BrMin) Then 
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRAh(4,icount),2,CurrentPDG2, & 
 & Trim(NameParticleAh(4))//" -> "//Trim(NameParticleVZ)//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
If (BRAh(4,icount).Gt.BrMin) Then 
CurrentPDG2(1) = -PDGVWm 
CurrentPDG2(2) = PDGVWm 
Write(io_L,201) BRAh(4,icount),2,CurrentPDG2, & 
 & Trim(NameParticleAh(4))//" -> "//Trim(NameParticleVWm)//"^* "//Trim(NameParticleVWm)//" "//")"
End if 
icount = icount +1 
If (BRAh(4,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGVZ 
CurrentPDG2(2) = PDGVZ 
Write(io_L,201) BRAh(4,icount),2,CurrentPDG2, & 
 & Trim(NameParticleAh(4))//" -> "//Trim(NameParticleVZ)//" "//Trim(NameParticleVZ)//" "//")"
End if 
icount = icount +1 
End if 
If ((gTAh(5).gt.MinWidth).or.(OutputForMG)) Then 
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRAh(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticleAh(5))//" -> "//Trim(NameParticleAh(gt1))//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 2, 5
...
CurrentPDG2(2) = PDGVZ 
Write(io_L,201) BRAh(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticleAh(5))//" -> "//Trim(NameParticleAh(gt1))//" "//Trim(NameParticleVZ)//" "//")"
End if 
icount = icount +1 
  End Do 
If (BRAh(5,icount).Gt.BrMin) Then 
...
CurrentPDG2(2) = PDGGlu 
Write(io_L,201) BRAh(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticleAh(5))//" -> "//Trim(NameParticleGlu)//" "//Trim(NameParticleGlu)//" "//")"
If (((gTGlu.le.WidthToBeInvisible).and.(gTGlu.le.WidthToBeInvisible)).OR. & 
 & ((WidthToBeInvisible.le.-1._dp).And.(CurrentPDG2(1).eq.PDGLSP(1)).And.(CurrentPDG2(2).eq.PDGLSP(1)))) Then 
  BRinvA(5) = BRinvA(5)+BRAh(5,icount) 
End if 
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRAh(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticleAh(5))//" -> "//Trim(NameParticlehh(gt1))//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
  End Do 
If (BRAh(5,icount).Gt.BrMin) Then 
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRAh(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticleAh(5))//" -> "//Trim(NameParticleVZ)//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
If (BRAh(5,icount).Gt.BrMin) Then 
CurrentPDG2(1) = -PDGVWm 
CurrentPDG2(2) = PDGVWm 
Write(io_L,201) BRAh(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticleAh(5))//" -> "//Trim(NameParticleVWm)//"^* "//Trim(NameParticleVWm)//" "//")"
End if 
icount = icount +1 
If (BRAh(5,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGVZ 
CurrentPDG2(2) = PDGVZ 
Write(io_L,201) BRAh(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticleAh(5))//" -> "//Trim(NameParticleVZ)//" "//Trim(NameParticleVZ)//" "//")"
End if 
icount = icount +1 
End if 
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRHpm(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHpm(3))//" -> "//Trim(NameParticleHpm(gt1))//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
  End Do 
If (BRHpm(3,icount).Gt.BrMin) Then 
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRHpm(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHpm(3))//" -> "//Trim(NameParticleVWm)//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
End if 
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRHpm(4,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHpm(4))//" -> "//Trim(NameParticleHpm(gt1))//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
  End Do 
If (BRHpm(4,icount).Gt.BrMin) Then 
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRHpm(4,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHpm(4))//" -> "//Trim(NameParticleVWm)//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
End if 
If ((gTHpm(5).gt.MinWidth).or.(OutputForMG)) Then 
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRHpm(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHpm(5))//" -> "//Trim(NameParticleHpm(gt1))//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
  End Do 
If (BRHpm(5,icount).Gt.BrMin) Then 
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRHpm(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHpm(5))//" -> "//Trim(NameParticleVWm)//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
End if 
If ((gTHpm(6).gt.MinWidth).or.(OutputForMG)) Then 
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRHpm(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHpm(6))//" -> "//Trim(NameParticleHpm(gt1))//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
  End Do 
If (BRHpm(6,icount).Gt.BrMin) Then 
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRHpm(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHpm(6))//" -> "//Trim(NameParticleVWm)//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
End if 
If ((gTHpm(7).gt.MinWidth).or.(OutputForMG)) Then 
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRHpm(7,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHpm(7))//" -> "//Trim(NameParticleHpm(gt1))//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
  End Do 
If (BRHpm(7,icount).Gt.BrMin) Then 
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRHpm(7,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHpm(7))//" -> "//Trim(NameParticleVWm)//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
End if 
If ((gTHpm(8).gt.MinWidth).or.(OutputForMG)) Then 
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRHpm(8,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHpm(8))//" -> "//Trim(NameParticleHpm(gt1))//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
  End Do 
If (BRHpm(8,icount).Gt.BrMin) Then 
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRHpm(8,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHpm(8))//" -> "//Trim(NameParticleVWm)//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
End if 
...
End if 
icount = icount +1 
If (Maxval(BRGlu(1,56:226)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRCha(1,148:679)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,5
  Do gt2=1,5
...
icount = icount +1 
  End Do 
If (Maxval(BRCha(2,148:679)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,5
  Do gt2=1,5
...
End if 
If ((gTCha(3).gt.MinWidth).or.(OutputForMG)) Then 
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRCha(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleCha(3))//" -> "//Trim(NameParticleCha(gt1))//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRCha(3,148:679)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,5
  Do gt2=1,5
...
End if 
If ((gTCha(4).gt.MinWidth).or.(OutputForMG)) Then 
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRCha(4,icount),2,CurrentPDG2, & 
 & Trim(NameParticleCha(4))//"^* -> "//Trim(NameParticleCha(gt1))//"^* "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRCha(4,148:679)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,5
  Do gt2=1,5
...
End if 
If ((gTCha(5).gt.MinWidth).or.(OutputForMG)) Then 
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRCha(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticleCha(5))//"^* -> "//Trim(NameParticleCha(gt1))//"^* "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRCha(5,148:679)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,5
  Do gt2=1,5
...
End if 
icount = icount +1 
If (Maxval(BRChi(1,155:861)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,7
  Do gt2=1,5
...
End if 
icount = icount +1 
If (Maxval(BRChi(2,155:861)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,7
  Do gt2=1,5
...
End if 
icount = icount +1 
If (Maxval(BRChi(3,155:861)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,7
  Do gt2=1,5
...
End if 
icount = icount +1 
If (Maxval(BRChi(4,155:861)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,7
  Do gt2=1,5
...
CurrentPDG2(2) = PDGVG 
Write(io_L,201) BRChi(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticleChi(5))//" -> "//Trim(NameParticleGlu)//" "//Trim(NameParticleVG)//" "//")"
End if 
icount = icount +1 
If (Maxval(BRChi(5,155:861)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,7
  Do gt2=1,5
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRChi(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticleChi(6))//" -> "//Trim(NameParticleChi(gt1))//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
  End Do 
If (BRChi(6,icount).Gt.BrMin) Then 
...
CurrentPDG2(2) = PDGVG 
Write(io_L,201) BRChi(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticleChi(6))//" -> "//Trim(NameParticleGlu)//" "//Trim(NameParticleVG)//" "//")"
End if 
icount = icount +1 
If (Maxval(BRChi(6,155:861)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,7
  Do gt2=1,5
...
End if 
If ((gTChi(7).gt.MinWidth).or.(OutputForMG)) Then 
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRChi(7,icount),2,CurrentPDG2, & 
 & Trim(NameParticleChi(7))//" -> "//Trim(NameParticleChi(gt1))//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
  End Do 
If (BRChi(7,icount).Gt.BrMin) Then 
...
CurrentPDG2(2) = PDGVG 
Write(io_L,201) BRChi(7,icount),2,CurrentPDG2, & 
 & Trim(NameParticleChi(7))//" -> "//Trim(NameParticleGlu)//" "//Trim(NameParticleVG)//" "//")"
End if 
icount = icount +1 
If (Maxval(BRChi(7,155:861)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,7
  Do gt2=1,5
...
icount = icount +1 
End if 
If(gT1Lhh(4).gt.MinWidth) Then 
Write(io_L,210) INT(PDGhh(4)),gT1Lhh(4),Trim(NameParticlehh(4)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
If (BR1Lhh(4,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGVP 
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BR1Lhh(4,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(4))//" -> "//Trim(NameParticleVP)//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
If (BR1Lhh(4,icount).Gt.BrMin) Then 
...
CurrentPDG2(1) = PDGHpm(gt1) 
CurrentPDG2(2) = -PDGVWm 
Write(io_L,201) BR1Lhh(4,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticlehh(4))//" -> "//Trim(NameParticleHpm(gt1))//" "//Trim(NameParticleVWm)//"^* "//")"
Write(io_L,201) BR1Lhh(4,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticlehh(4))//" -> "//Trim(NameParticleHpm(gt1))//"^* "//Trim(NameParticleVWm)//" "//")"
End if 
...
icount = icount +1 
End if 
If(gT1Lhh(5).gt.MinWidth) Then 
Write(io_L,210) INT(PDGhh(5)),gT1Lhh(5),Trim(NameParticlehh(5)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
If (BR1Lhh(5,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGVP 
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BR1Lhh(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(5))//" -> "//Trim(NameParticleVP)//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
If (BR1Lhh(5,icount).Gt.BrMin) Then 
...
CurrentPDG2(1) = PDGHpm(gt1) 
CurrentPDG2(2) = -PDGVWm 
Write(io_L,201) BR1Lhh(5,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticlehh(5))//" -> "//Trim(NameParticleHpm(gt1))//" "//Trim(NameParticleVWm)//"^* "//")"
Write(io_L,201) BR1Lhh(5,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticlehh(5))//" -> "//Trim(NameParticleHpm(gt1))//"^* "//Trim(NameParticleVWm)//" "//")"
End if 
...
icount = icount +1 
End if 
If(gT1LAh(4).gt.MinWidth) Then 
Write(io_L,210) INT(PDGAh(4)),gT1LAh(4),Trim(NameParticleAh(4)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
If (BR1LAh(4,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGVP 
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BR1LAh(4,icount),2,CurrentPDG2, & 
 & Trim(NameParticleAh(4))//" -> "//Trim(NameParticleVP)//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
If (BR1LAh(4,icount).Gt.BrMin) Then 
...
CurrentPDG2(1) = PDGHpm(gt1) 
CurrentPDG2(2) = -PDGVWm 
Write(io_L,201) BR1LAh(4,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleAh(4))//" -> "//Trim(NameParticleHpm(gt1))//" "//Trim(NameParticleVWm)//"^* "//")"
Write(io_L,201) BR1LAh(4,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleAh(4))//" -> "//Trim(NameParticleHpm(gt1))//"^* "//Trim(NameParticleVWm)//" "//")"
End if 
...
icount = icount +1 
End if 
If(gT1LAh(5).gt.MinWidth) Then 
Write(io_L,210) INT(PDGAh(5)),gT1LAh(5),Trim(NameParticleAh(5)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
If (BR1LAh(5,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGVP 
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BR1LAh(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticleAh(5))//" -> "//Trim(NameParticleVP)//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
If (BR1LAh(5,icount).Gt.BrMin) Then 
...
CurrentPDG2(1) = PDGHpm(gt1) 
CurrentPDG2(2) = -PDGVWm 
Write(io_L,201) BR1LAh(5,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleAh(5))//" -> "//Trim(NameParticleHpm(gt1))//" "//Trim(NameParticleVWm)//"^* "//")"
Write(io_L,201) BR1LAh(5,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleAh(5))//" -> "//Trim(NameParticleHpm(gt1))//"^* "//Trim(NameParticleVWm)//" "//")"
End if 
...
icount = icount +1 
End if 
If(gT1LHpm(3).gt.MinWidth) Then 
Write(io_L,210) INT(PDGHpm(3)),gT1LHpm(3),Trim(NameParticleHpm(3)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 2, 8
  Do gt2=2, 5
If (BR1LHpm(3,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGHpm(gt1) 
CurrentPDG2(2) = PDGAh(gt2) 
Write(io_L,201) BR1LHpm(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHpm(3))//" -> "//Trim(NameParticleHpm(gt1))//" "//Trim(NameParticleAh(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
...
icount = icount +1 
End if 
If(gT1LHpm(4).gt.MinWidth) Then 
Write(io_L,210) INT(PDGHpm(4)),gT1LHpm(4),Trim(NameParticleHpm(4)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 2, 8
  Do gt2=2, 5
If (BR1LHpm(4,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGHpm(gt1) 
CurrentPDG2(2) = PDGAh(gt2) 
Write(io_L,201) BR1LHpm(4,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHpm(4))//" -> "//Trim(NameParticleHpm(gt1))//" "//Trim(NameParticleAh(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
...
icount = icount +1 
End if 
If(gT1LHpm(5).gt.MinWidth) Then 
Write(io_L,210) INT(PDGHpm(5)),gT1LHpm(5),Trim(NameParticleHpm(5)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 2, 8
  Do gt2=2, 5
If (BR1LHpm(5,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGHpm(gt1) 
CurrentPDG2(2) = PDGAh(gt2) 
Write(io_L,201) BR1LHpm(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHpm(5))//" -> "//Trim(NameParticleHpm(gt1))//" "//Trim(NameParticleAh(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
...
icount = icount +1 
End if 
If(gT1LHpm(6).gt.MinWidth) Then 
Write(io_L,210) INT(PDGHpm(6)),gT1LHpm(6),Trim(NameParticleHpm(6)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 2, 8
  Do gt2=2, 5
If (BR1LHpm(6,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGHpm(gt1) 
CurrentPDG2(2) = PDGAh(gt2) 
Write(io_L,201) BR1LHpm(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHpm(6))//" -> "//Trim(NameParticleHpm(gt1))//" "//Trim(NameParticleAh(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
...
icount = icount +1 
End if 
If(gT1LHpm(7).gt.MinWidth) Then 
Write(io_L,210) INT(PDGHpm(7)),gT1LHpm(7),Trim(NameParticleHpm(7)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 2, 8
  Do gt2=2, 5
If (BR1LHpm(7,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGHpm(gt1) 
CurrentPDG2(2) = PDGAh(gt2) 
Write(io_L,201) BR1LHpm(7,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHpm(7))//" -> "//Trim(NameParticleHpm(gt1))//" "//Trim(NameParticleAh(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
...
icount = icount +1 
End if 
If(gT1LHpm(8).gt.MinWidth) Then 
Write(io_L,210) INT(PDGHpm(8)),gT1LHpm(8),Trim(NameParticleHpm(8)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 2, 8
  Do gt2=2, 5
If (BR1LHpm(8,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGHpm(gt1) 
CurrentPDG2(2) = PDGAh(gt2) 
Write(io_L,201) BR1LHpm(8,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHpm(8))//" -> "//Trim(NameParticleHpm(gt1))//" "//Trim(NameParticleAh(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
...
icount = icount +1 
  End Do 
End if 
If(gT1LCha(3).gt.MinWidth) Then 
Write(io_L,210) INT(PDGCha(3)),gT1LCha(3),Trim(NameParticleCha(3)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 5
  Do gt2=2, 5
If (BR1LCha(3,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGCha(gt1) 
CurrentPDG2(2) = PDGAh(gt2) 
Write(io_L,201) BR1LCha(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleCha(3))//" -> "//Trim(NameParticleCha(gt1))//" "//Trim(NameParticleAh(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
...
icount = icount +1 
  End Do 
End if 
If(gT1LCha(4).gt.MinWidth) Then 
Write(io_L,210) -INT(PDGCha(4)),gT1LCha(4),Trim(NameParticleCha(4)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 5
  Do gt2=2, 5
If (BR1LCha(4,icount).Gt.BrMin) Then 
CurrentPDG2(1) = -PDGCha(gt1) 
CurrentPDG2(2) = PDGAh(gt2) 
Write(io_L,201) BR1LCha(4,icount),2,CurrentPDG2, & 
 & Trim(NameParticleCha(4))//"^* -> "//Trim(NameParticleCha(gt1))//"^* "//Trim(NameParticleAh(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
...
icount = icount +1 
  End Do 
End if 
If(gT1LCha(5).gt.MinWidth) Then 
Write(io_L,210) -INT(PDGCha(5)),gT1LCha(5),Trim(NameParticleCha(5)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 5
  Do gt2=2, 5
If (BR1LCha(5,icount).Gt.BrMin) Then 
CurrentPDG2(1) = -PDGCha(gt1) 
CurrentPDG2(2) = PDGAh(gt2) 
Write(io_L,201) BR1LCha(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticleCha(5))//"^* -> "//Trim(NameParticleCha(gt1))//"^* "//Trim(NameParticleAh(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
...
icount = icount +1 
End if 
If(gT1LChi(6).gt.MinWidth) Then 
Write(io_L,210) INT(PDGChi(6)),gT1LChi(6),Trim(NameParticleChi(6)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 7
  Do gt2=2, 5
If (BR1LChi(6,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGChi(gt1) 
CurrentPDG2(2) = PDGAh(gt2) 
Write(io_L,201) BR1LChi(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticleChi(6))//" -> "//Trim(NameParticleChi(gt1))//" "//Trim(NameParticleAh(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
...
CurrentPDG2(1) = PDGCha(gt1) 
CurrentPDG2(2) = -PDGHpm(gt2) 
Write(io_L,201) BR1LChi(6,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleChi(6))//" -> "//Trim(NameParticleCha(gt1))//" "//Trim(NameParticleHpm(gt2))//"^* "//")"
Write(io_L,201) BR1LChi(6,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleChi(6))//" -> "//Trim(NameParticleCha(gt1))//"^* "//Trim(NameParticleHpm(gt2))//" "//")"
End if 
...
icount = icount +1 
End if 
If(gT1LChi(7).gt.MinWidth) Then 
Write(io_L,210) INT(PDGChi(7)),gT1LChi(7),Trim(NameParticleChi(7)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 7
  Do gt2=2, 5
If (BR1LChi(7,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGChi(gt1) 
CurrentPDG2(2) = PDGAh(gt2) 
Write(io_L,201) BR1LChi(7,icount),2,CurrentPDG2, & 
 & Trim(NameParticleChi(7))//" -> "//Trim(NameParticleChi(gt1))//" "//Trim(NameParticleAh(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
...
CurrentPDG2(1) = PDGCha(gt1) 
CurrentPDG2(2) = -PDGHpm(gt2) 
Write(io_L,201) BR1LChi(7,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleChi(7))//" -> "//Trim(NameParticleCha(gt1))//" "//Trim(NameParticleHpm(gt2))//"^* "//")"
Write(io_L,201) BR1LChi(7,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleChi(7))//" -> "//Trim(NameParticleCha(gt1))//"^* "//Trim(NameParticleHpm(gt2))//" "//")"
End if 
...
Subroutine WriteWHIZARD 
   Open(123,file="WHIZARD.par.MSSMLV",status="unknown")
...
Write(123,*) "REps1_r= ",Real(REps(1),dp)
Write(123,*) "REps2_r= ",Real(REps(2),dp)
Write(123,*) "REps3_r= ",Real(REps(3),dp)
Write(123,*) "REps1_i= ",AImag(REps(1))
Write(123,*) "REps2_i= ",AImag(REps(2))
Write(123,*) "REps3_i= ",AImag(REps(3))
...
Write(90,"(e16.8)",advance="No") BRHHH(1,5)/gThh(1) 
...
Write(90,"(e16.8)",advance="No") BRHAA(1,5)/gThh(1) 
...
Write(90,"(e16.8)",advance="No") BRHHH(2,5)/gThh(2) 
...
Write(90,"(e16.8)",advance="No") BRHAA(2,5)/gThh(2) 
...
Write(90,"(e16.8)",advance="No") BRHHH(3,5)/gThh(3) 
...
Write(90,"(e16.8)",advance="No") BRHAA(3,5)/gThh(3) 
...
Write(90,"(e16.8)",advance="No") BRHHH(4,5)/gThh(4) 
Write(90,"(e16.8)",advance="No") BRHAA(4,2)/gThh(4) 
Write(90,"(e16.8)",advance="No") BRHAA(4,3)/gThh(4) 
Write(90,"(e16.8)",advance="No") BRHAA(4,4)/gThh(4) 
Write(90,"(e16.8)",advance="No") BRHAA(4,5)/gThh(4) 
Write(90,"(e16.8)",advance="No") BRHHH(5,1)/gThh(5) 
Write(90,"(e16.8)",advance="No") BRHHH(5,2)/gThh(5) 
Write(90,"(e16.8)",advance="No") BRHHH(5,3)/gThh(5) 
Write(90,"(e16.8)",advance="No") BRHHH(5,4)/gThh(5) 
Write(90,"(e16.8)",advance="No") BRHAA(5,2)/gThh(5) 
Write(90,"(e16.8)",advance="No") BRHAA(5,3)/gThh(5) 
Write(90,"(e16.8)",advance="No") BRHAA(5,4)/gThh(5) 
Write(90,"(e16.8)",advance="No") BRHAA(5,5)/gThh(5) 
...
Write(90,"(e16.8)",advance="No") BRAHH(2,4)/gTAh(2) 
Write(90,"(e16.8)",advance="No") BRAHH(2,5)/gTAh(2) 
Write(90,"(e16.8)",advance="No") BRAAA(2,3)/gTAh(2) 
Write(90,"(e16.8)",advance="No") BRAAA(2,4)/gTAh(2) 
Write(90,"(e16.8)",advance="No") BRAAA(2,5)/gTAh(2) 
...
Write(90,"(e16.8)",advance="No") BRAHH(3,5)/gTAh(3) 
Write(90,"(e16.8)",advance="No") BRAAA(3,2)/gTAh(3) 
Write(90,"(e16.8)",advance="No") BRAAA(3,4)/gTAh(3) 
Write(90,"(e16.8)",advance="No") BRAAA(3,5)/gTAh(3) 
...
Write(90,"(e16.8)",advance="No") BRAHH(4,5)/gTAh(4) 
Write(90,"(e16.8)",advance="No") BRAAA(4,2)/gTAh(4) 
Write(90,"(e16.8)",advance="No") BRAAA(4,3)/gTAh(4) 
Write(90,"(e16.8)",advance="No") BRAAA(4,5)/gTAh(4) 
Write(90,"(e16.8)",advance="No") BRAHH(5,1)/gTAh(5) 
Write(90,"(e16.8)",advance="No") BRAHH(5,2)/gTAh(5) 
Write(90,"(e16.8)",advance="No") BRAHH(5,3)/gTAh(5) 
Write(90,"(e16.8)",advance="No") BRAHH(5,4)/gTAh(5) 
Write(90,"(e16.8)",advance="No") BRAHH(5,5)/gTAh(5) 
Write(90,"(e16.8)",advance="No") BRAAA(5,2)/gTAh(5) 
Write(90,"(e16.8)",advance="No") BRAAA(5,3)/gTAh(5) 
Write(90,"(e16.8)",advance="No") BRAAA(5,4)/gTAh(5) 
...
Write(89,"(3e16.8)",advance="No") rHB_S_S_Fd(5,2)**2
...
Write(89,"(3e16.8)",advance="No") rHB_P_S_Fd(5,2)**2
...
Write(89,"(3e16.8)",advance="No") rHB_S_P_Fd(5,2)**2
...
Write(89,"(3e16.8)",advance="No") rHB_P_P_Fd(5,2)**2
...
Write(89,"(3e16.8)",advance="No") rHB_S_S_Fu(5,2)**2
...
Write(89,"(3e16.8)",advance="No") rHB_P_S_Fu(5,2)**2
...
Write(89,"(3e16.8)",advance="No") rHB_S_P_Fu(5,2)**2
...
Write(89,"(3e16.8)",advance="No") rHB_P_P_Fu(5,2)**2
...
Write(89,"(3e16.8)",advance="No") rHB_S_S_Fd(5,3)**2
...
Write(89,"(3e16.8)",advance="No") rHB_P_S_Fd(5,3)**2
...
Write(89,"(3e16.8)",advance="No") rHB_S_P_Fd(5,3)**2
...
Write(89,"(3e16.8)",advance="No") rHB_P_P_Fd(5,3)**2
...
Write(89,"(3e16.8)",advance="No") rHB_S_S_Fu(5,3)**2
...
Write(89,"(3e16.8)",advance="No") rHB_P_S_Fu(5,3)**2
...
Write(89,"(3e16.8)",advance="No") rHB_S_P_Fu(5,3)**2
...
Write(89,"(3e16.8)",advance="No") rHB_P_P_Fu(5,3)**2
Write(89,"(3e16.8)",advance="No") rHB_S_S_Cha(1,2)**2
Write(89,"(3e16.8)",advance="No") rHB_S_S_Cha(2,2)**2
Write(89,"(3e16.8)",advance="No") rHB_S_S_Cha(3,2)**2
Write(89,"(3e16.8)",advance="No") rHB_S_S_Cha(4,2)**2
Write(89,"(3e16.8)",advance="No") rHB_S_S_Cha(5,2)**2
Write(89,"(3e16.8)",advance="No") rHB_P_S_Cha(2,2)**2
Write(89,"(3e16.8)",advance="No") rHB_P_S_Cha(3,2)**2
Write(89,"(3e16.8)",advance="No") rHB_P_S_Cha(4,2)**2
Write(89,"(3e16.8)",advance="No") rHB_P_S_Cha(5,2)**2
Write(89,"(3e16.8)",advance="No") rHB_S_P_Cha(1,2)**2
Write(89,"(3e16.8)",advance="No") rHB_S_P_Cha(2,2)**2
Write(89,"(3e16.8)",advance="No") rHB_S_P_Cha(3,2)**2
Write(89,"(3e16.8)",advance="No") rHB_S_P_Cha(4,2)**2
Write(89,"(3e16.8)",advance="No") rHB_S_P_Cha(5,2)**2
Write(89,"(3e16.8)",advance="No") rHB_P_P_Cha(2,2)**2
Write(89,"(3e16.8)",advance="No") rHB_P_P_Cha(3,2)**2
Write(89,"(3e16.8)",advance="No") rHB_P_P_Cha(4,2)**2
Write(89,"(3e16.8)",advance="No") rHB_P_P_Cha(5,2)**2
Write(89,"(3e16.8)",advance="No") rHB_S_S_Cha(1,3)**2
Write(89,"(3e16.8)",advance="No") rHB_S_S_Cha(2,3)**2
Write(89,"(3e16.8)",advance="No") rHB_S_S_Cha(3,3)**2
Write(89,"(3e16.8)",advance="No") rHB_S_S_Cha(4,3)**2
Write(89,"(3e16.8)",advance="No") rHB_S_S_Cha(5,3)**2
Write(89,"(3e16.8)",advance="No") rHB_P_S_Cha(2,3)**2
Write(89,"(3e16.8)",advance="No") rHB_P_S_Cha(3,3)**2
Write(89,"(3e16.8)",advance="No") rHB_P_S_Cha(4,3)**2
Write(89,"(3e16.8)",advance="No") rHB_P_S_Cha(5,3)**2
Write(89,"(3e16.8)",advance="No") rHB_S_P_Cha(1,3)**2
Write(89,"(3e16.8)",advance="No") rHB_S_P_Cha(2,3)**2
Write(89,"(3e16.8)",advance="No") rHB_S_P_Cha(3,3)**2
Write(89,"(3e16.8)",advance="No") rHB_S_P_Cha(4,3)**2
Write(89,"(3e16.8)",advance="No") rHB_S_P_Cha(5,3)**2
Write(89,"(3e16.8)",advance="No") rHB_P_P_Cha(2,3)**2
Write(89,"(3e16.8)",advance="No") rHB_P_P_Cha(3,3)**2
Write(89,"(3e16.8)",advance="No") rHB_P_P_Cha(4,3)**2
Write(89,"(3e16.8)",advance="No") rHB_P_P_Cha(5,3)**2
Write(89,"(3e16.8)",advance="No") rHB_S_VWm(1)**2
Write(89,"(3e16.8)",advance="No") rHB_S_VWm(2)**2
Write(89,"(3e16.8)",advance="No") rHB_S_VWm(3)**2
Write(89,"(3e16.8)",advance="No") rHB_S_VWm(4)**2
Write(89,"(3e16.8)",advance="No") rHB_S_VWm(5)**2
Write(89,"(3e16.8)",advance="No") rHB_P_VWm(2)**2
Write(89,"(3e16.8)",advance="No") rHB_P_VWm(3)**2
Write(89,"(3e16.8)",advance="No") rHB_P_VWm(4)**2
Write(89,"(3e16.8)",advance="No") rHB_P_VWm(5)**2
...
Write(89,"(3e16.8)",advance="No")  Real(ratioPP(5),dp)**2 
...
Write(89,"(3e16.8)",advance="No") Real(ratioPPP(5),dp)**2 
...
Write(89,"(3e16.8)",advance="No")  Real(ratioGG(5),dp)**2 
...
Write(89,"(3e16.8)",advance="No") Real(ratioPGG(5),dp)**2 
Write(89,"(3e16.8)",advance="No") 0._dp 
Write(89,"(3e16.8)",advance="No") 0._dp 
Write(89,"(3e16.8)",advance="No") 0._dp 
Write(89,"(3e16.8)",advance="No") 0._dp 
