...
Module FlavorKit_Observables_MSSMLV 
Use Control 
Use Settings 
...
Implicit None 
Complex(dp) :: OH2lSL(3,3,5),OH2lSR(3,3,5)
...
& O4dTLR(3,3,3,3),O4dTRL(3,3,3,3),O4dTRR(3,3,3,3),OH2qSL(3,3,5),OH2qSR(3,3,5),           & 
& OAh2qSL(3,3,5),OAh2qSR(3,3,5)
...
End Function C1C2 
End Module FlavorKit_Observables_MSSMLV 
