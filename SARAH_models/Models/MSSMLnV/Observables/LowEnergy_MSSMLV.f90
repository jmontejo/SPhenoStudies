...
& MFu2(3),Mhh(5),Mhh2(5),MHpm(8),MHpm2(8),MSd(6),MSd2(6),MSu(6),MSu2(6)
...
& cplcChaChiHpmL(5,7,8),cplcChaChiHpmR(5,7,8),cplcFdFdVPL(3,3),cplcFdFdVPR(3,3),         & 
...
Complex(dp),Intent(in)  :: cplAhAhcVWmVWm(5,5),cplAhAhVZVZ(5,5),cplAhhhVZ(5,5),cplAhHpmcVWm(5,8),cplcChaChaVZL(5,5),& 
...
& cplcgWpCgAcVWm,cplcgWpCgWpCVZ,cplcgWpCgZcVWm,cplcgZgWmcVWm,cplChiChacVWmL(7,5),        & 
& cplChiChacVWmR(7,5),cplChiChiVZL(7,7),cplChiChiVZR(7,7),cplcVWmcVWmVWmVWm1,            & 
...
& cplhhcVWmVWm(5),cplhhhhcVWmVWm(5,5),cplhhhhVZVZ(5,5),cplhhHpmcVWm(5,8),cplhhVZVZ(5),   & 
