...
Program SPhenoMSSMBpV 
 
Use Control
Use InputOutput_MSSMBpV
Use LoopFunctions
Use Settings
Use RunSM_MSSMBpV
Use LowEnergy_MSSMBpV
Use FlavorKit_LFV_MSSMBpV
Use FlavorKit_QFV_MSSMBpV
Use FlavorKit_Observables_MSSMBpV
Use Mathematics
...
Use Boundaries_MSSMBpV
 Use FineTuning_MSSMBpV
Use HiggsCS_MSSMBpV
Use TreeLevelMasses_MSSMBpV
Use LoopMasses_MSSMBpV
 
Use BranchingRatios_MSSMBpV
...
& g3,Yd,Ye,L3,Yu,Mu,Td,Te,T3,Tu,Bmu,mq2,ml2,mHd2,mHu2,md2,mu2,me2,M1,M2,M3,.False.)
...
& g3,Yd,Ye,L3,Yu,Mu,Td,Te,T3,Tu,Bmu,mq2,ml2,mHd2,mHu2,md2,mu2,me2,M1,M2,M3,mGUT)
...
& MSd2,MSe,MSe2,MSu,MSu2,MSv,MSv2,MVWm,MVWm2,MVZ,MVZ2,pG,TW,UM,UP,v,ZA,ZD,               & 
& ZDL,ZDR,ZE,ZEL,ZER,ZH,ZN,ZP,ZU,ZUL,ZUR,ZV,ZW,ZZ,alphaH,betaH,vd,vu,g1,g2,              & 
& g3,Yd,Ye,L3,Yu,Mu,Td,Te,T3,Tu,Bmu,mq2,ml2,mHd2,mHu2,md2,mu2,me2,M1,M2,M3,              & 
& gPSd,gTSd,BRSd,gPSu,gTSu,BRSu,gPSe,gTSe,BRSe,gPSv,gTSv,BRSv,gPhh,gThh,BRhh,            & 
& gPAh,gTAh,BRAh,gPHpm,gTHpm,BRHpm,gPGlu,gTGlu,BRGlu,gPChi,gTChi,BRChi,gPCha,            & 
...
Call CalculateLowEnergyConstraints(g1,g2,g3,Yd,Ye,L3,Yu,Mu,Td,Te,T3,Tu,               & 
& Bmu,mq2,ml2,mHd2,mHu2,md2,mu2,me2,M1,M2,M3,vd,vu,ae,amu,atau,EDMe,EDMmu,               & 
...
If (HighScaleModel.ne."LOW") Then 
  If (calcFT) Then 
Call FineTuning(g1,g2,g3,Yd,Ye,L3,Yu,Mu,Td,Te,T3,Tu,Bmu,mq2,ml2,mHd2,mHu2,            & 
& md2,mu2,me2,M1,M2,M3,vd,vu,mGut,kont)
...
& MVWm2,MVZ,MVZ2,pG,TW,UM,UP,v,ZA,ZD,ZDL,ZDR,ZE,ZEL,ZER,ZH,ZN,ZP,ZU,ZUL,ZUR,             & 
& ZV,ZW,ZZ,alphaH,betaH,vd,vu,g1,g2,g3,Yd,Ye,L3,Yu,Mu,Td,Te,T3,Tu,Bmu,mq2,               & 
& ml2,mHd2,mHu2,md2,mu2,me2,M1,M2,M3,kont)
...
& mHu2,md2,mu2,me2,M1,M2,M3,mGut,kont,WriteOut,n_run)
...
& mHd2,mHu2,md2,mu2,me2,M1,M2,M3,mGut,kont,WriteOut,n_run)
...
& Yeinput,L3input,Yuinput,Muinput,Tdinput,Teinput,T3input,Tuinput,Bmuinput,              & 
& mq2input,ml2input,mHd2input,mHu2input,md2input,mu2input,me2input,M1input,              & 
& M2input,M3input,vdinput,vuinput,ae,amu,atau,EDMe,EDMmu,EDMtau,dRho,BrBsGamma,          & 
...
Complex(dp),Intent(inout) :: Ydinput(3,3),Yeinput(3,3),L3input(3,3,3),Yuinput(3,3),Muinput,Tdinput(3,3),           & 
...
& cplcFdcFucSdR(3,3,6),cplcFdChaSuL(3,2,6),cplcFdChaSuR(3,2,6),cplcFdChiSdL(3,4,6),      & 
...
Complex(dp) :: cplhhSdcSd(2,6,6),cplhhSecSe(2,6,6),cplhhSucSu(2,6,6),cplhhSvcSv(2,3,3),               & 
& cplhhVZVZ(2),cplHpmcHpmcVWmVWm(2,2),cplHpmcHpmVP(2,2),cplHpmcHpmVPVZ(2,2),             & 
...
& cplSdSdSu(6,6,6),cplSecHpmcSv(6,2,3),cplSecSecVWmVWm(6,6),cplSecSeVP(6,6),             & 
& cplSecSeVPVZ(6,6),cplSecSeVZ(6,6),cplSecSeVZVZ(6,6),cplSecSvcVWm(6,3),cplSucSdVWm(6,6),& 
& cplSucSucVWmVWm(6,6),cplSucSuVG(6,6),cplSucSuVP(6,6),cplSucSuVPVZ(6,6),cplSucSuVZ(6,6),& 
...
& L3input,Yuinput,Muinput,Tdinput,Teinput,T3input,Tuinput,Bmuinput,mq2input,             & 
& ml2input,mHd2input,mHu2input,md2input,mu2input,me2input,M1input,M2input,               & 
& M3input,vdinput,vuinput,g1,g2,g3,Yd,Ye,L3,Yu,Mu,Td,Te,T3,Tu,Bmu,mq2,ml2,               & 
& mHd2,mHu2,md2,mu2,me2,M1,M2,M3,vd,vu,CKM_160,sinW2_160,Alpha_160,AlphaS_160,.false.)
...
& L3,T3,TW,g3,UM,UP,ZN,ZDL,ZDR,ZEL,ZER,ZUL,ZUR,pG,cplAhAhhh,cplAhHpmcHpm,cplAhSdcSd,     & 
...
& cplFdFuSdR,cplGluFdcSdL,cplGluFdcSdR,cplcFdFdhhL,cplcFdFdhhR,cplcChaFdcSuL,            & 
...
& cplcChacFvSeR,cplcFdcFdcSuL,cplcFdcFdcSuR,cplcFdcFucSdL,cplcFdcFucSdR,cplChiChacVWmL,  & 
...
& cplcFuFuVZR,cplcFvFecHpmL,cplcFvFecHpmR,cplcFvFecVWmL,cplcFvFecVWmR,cplChiChiAhL,      & 
& cplChiChiAhR,cplChiChihhL,cplChiChihhR,cplChiChiVZL,cplChiChiVZR,cplChiFdcSdL,         & 
& cplChiFdcSdR,cplChiFecSeL,cplChiFecSeR,cplcHpmVPVWm,cplcHpmVWmVZ,cplcVWmVPVWm,         & 
...
& cplcChaChaVZL,cplcChaChaVZR,cplcChaFdcSuL,cplcChaFdcSuR,cplcFdcFdcSuL,cplcFdcFdcSuR,   & 
& cplHpmcHpmVZ,cplHpmcVWmVZ,cplSdcSdVZ,cplSecSeVZ,cplSucSuVZ,cplSvcSvVZ,TVOddvvVRR(gt1,gt2,gt3,gt4)& 
...
& cplcFdcFdcSuL,cplcFdcFdcSuR,cplcFdcFucSdL,cplcFdcFucSdR,cplcFdChaSuL,cplcFdChaSuR,     & 
...
& cplSucSdVWm,cplSucSuVG,cplSucSuVP,cplSucSuVZ,BO4dSLL(gt1,gt2,gt3,gt4),BO4dSRR(gt1,gt2,gt3,gt4)& 
...
& cplhhSdcSd,cplhhSucSu,cplhhVZVZ,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcVWmVP,cplHpmcVWmVZ,   & 
& cplHpmSucSd,cplSdcHpmcSu,cplSdcSdVG,cplSdcSdVP,cplSdcSdVZ,cplSdcSucVWm,cplSdSdSu,      & 
& cplSucSdVWm,cplSucSuVG,cplSucSuVP,cplSucSuVZ,TSO4dSLL(gt1,gt2,gt3,gt4),TSO4dSRR(gt1,gt2,gt3,gt4)& 
...
& cplhhSdcSd,cplhhSucSu,cplhhVZVZ,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcVWmVP,cplHpmcVWmVZ,   & 
& cplHpmSucSd,cplSdcHpmcSu,cplSdcSdVG,cplSdcSdVP,cplSdcSdVZ,cplSdcSucVWm,cplSdSdSu,      & 
& cplSucSdVWm,cplSucSuVG,cplSucSuVP,cplSucSuVZ,TVO4dSLL(gt1,gt2,gt3,gt4),TVO4dSRR(gt1,gt2,gt3,gt4)& 
...
& cplAhSucSu,cplcChaChaAhL,cplcChaChaAhR,cplcChaFdcSuL,cplcChaFdcSuR,cplcFdcFdcSuL,      & 
& cplcFdcFdcSuR,cplcFdcFucSdL,cplcFdcFucSdR,cplcFdChaSuL,cplcFdChaSuR,cplcFdChiSdL,      & 
...
& cplChiChiAhR,cplChiFdcSdL,cplChiFdcSdR,cplFdFdSuL,cplFdFdSuR,cplFdFuSdL,               & 
& cplFdFuSdR,cplGluFdcSdL,cplGluFdcSdR,OAh2qSL(gt1,gt2,gt3),OAh2qSR(gt1,gt2,gt3))
...
& cplChiFvcSvL,cplChiFvcSvR,cplcHpmVPVWm,cplcHpmVWmVZ,cplcVWmVWmVZ,cplFdFdSuL,           & 
& cplFdFdSuR,cplFdFuSdL,cplFdFuSdR,cplGluFdcSdL,cplGluFdcSdR,cplGluFucSuL,               & 
& cplGluFucSuR,cplhhcHpmVWm,cplhhcVWmVWm,cplhhHpmcHpm,cplhhHpmcVWm,cplHpmcHpmVP,         & 
& cplHpmcHpmVZ,cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmSvcSe,cplSdcHpmcSu,cplSdcSucVWm,          & 
...
& cplFdFdSuL,cplFdFdSuR,cplFdFuSdL,cplFdFuSdR,cplGluFdcSdL,cplGluFdcSdR,cplhhVZVZ,       & 
& cplHpmcHpmVZ,cplHpmcVWmVZ,cplSdcSdVZ,cplSecSeVZ,cplSucSuVZ,cplSvcSvVZ,BOddvvVRRSM(gt1,gt2,gt3,gt4)& 
...
& cplChiFdcSdL,cplChiFdcSdR,cplChiFvcSvL,cplChiFvcSvR,cplcHpmVWmVZ,cplcVWmVWmVZ,         & 
& cplFdFdSuL,cplFdFdSuR,cplFdFuSdL,cplFdFuSdR,cplGluFdcSdL,cplGluFdcSdR,cplhhVZVZ,       & 
& cplHpmcHpmVZ,cplHpmcVWmVZ,cplSdcSdVZ,cplSecSeVZ,cplSucSuVZ,cplSvcSvVZ,PSOddvvVRRSM(gt1,gt2,gt3,gt4)& 
...
& cplChiFdcSdL,cplChiFdcSdR,cplChiFvcSvL,cplChiFvcSvR,cplcHpmVWmVZ,cplcVWmVWmVZ,         & 
& cplFdFdSuL,cplFdFdSuR,cplFdFuSdL,cplFdFuSdR,cplGluFdcSdL,cplGluFdcSdR,cplhhVZVZ,       & 
& cplHpmcHpmVZ,cplHpmcVWmVZ,cplSdcSdVZ,cplSecSeVZ,cplSucSuVZ,cplSvcSvVZ,PVOddvvVRRSM(gt1,gt2,gt3,gt4)& 
...
& cplChiFdcSdL,cplChiFdcSdR,cplChiFvcSvL,cplChiFvcSvR,cplcHpmVWmVZ,cplcVWmVWmVZ,         & 
& cplFdFdSuL,cplFdFdSuR,cplFdFuSdL,cplFdFuSdR,cplGluFdcSdL,cplGluFdcSdR,cplhhVZVZ,       & 
& cplHpmcHpmVZ,cplHpmcVWmVZ,cplSdcSdVZ,cplSecSeVZ,cplSucSuVZ,cplSvcSvVZ,TSOddvvVRRSM(gt1,gt2,gt3,gt4)& 
...
& cplChiFdcSdL,cplChiFdcSdR,cplChiFvcSvL,cplChiFvcSvR,cplcHpmVWmVZ,cplcVWmVWmVZ,         & 
& cplFdFdSuL,cplFdFdSuR,cplFdFuSdL,cplFdFuSdR,cplGluFdcSdL,cplGluFdcSdR,cplhhVZVZ,       & 
& cplHpmcHpmVZ,cplHpmcVWmVZ,cplSdcSdVZ,cplSecSeVZ,cplSucSuVZ,cplSvcSvVZ,TVOddvvVRRSM(gt1,gt2,gt3,gt4)& 
...
& cplhhSdcSd,cplhhSucSu,cplhhVZVZ,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcVWmVP,cplHpmcVWmVZ,   & 
& cplHpmSucSd,cplSdcHpmcSu,cplSdcSdVG,cplSdcSdVP,cplSdcSdVZ,cplSdcSucVWm,cplSdSdSu,      & 
& cplSucSdVWm,cplSucSuVG,cplSucSuVP,cplSucSuVZ,BO4dSLLSM(gt1,gt2,gt3,gt4),               & 
...
& cplhhSdcSd,cplhhSucSu,cplhhVZVZ,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcVWmVP,cplHpmcVWmVZ,   & 
& cplHpmSucSd,cplSdcHpmcSu,cplSdcSdVG,cplSdcSdVP,cplSdcSdVZ,cplSdcSucVWm,cplSdSdSu,      & 
& cplSucSdVWm,cplSucSuVG,cplSucSuVP,cplSucSuVZ,TSO4dSLLSM(gt1,gt2,gt3,gt4)               & 
...
& cplhhSdcSd,cplhhSucSu,cplhhVZVZ,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcVWmVP,cplHpmcVWmVZ,   & 
& cplHpmSucSd,cplSdcHpmcSu,cplSdcSdVG,cplSdcSdVP,cplSdcSdVZ,cplSdcSucVWm,cplSdSdSu,      & 
& cplSucSdVWm,cplSucSuVG,cplSucSuVP,cplSucSuVZ,TVO4dSLLSM(gt1,gt2,gt3,gt4)               & 
...
& cplcFuFdcHpmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuAhL,cplcFuFuAhR,cplChiChiAhL,        & 
& cplChiChiAhR,cplChiFdcSdL,cplChiFdcSdR,cplFdFdSuL,cplFdFdSuR,cplFdFuSdL,               & 
& cplFdFuSdR,cplGluFdcSdL,cplGluFdcSdR,OAh2qSLSM(gt1,gt2,gt3),OAh2qSRSM(gt1,gt2,gt3))
...
& cplcFuFdcVWmR,cplcFuFuVGL,cplcFuFuVGR,cplChiFdcSdL,cplChiFdcSdR,cplFdFdSuL,            & 
& cplFdFdSuR,cplFdFuSdL,cplFdFuSdR,cplGluFdcSdL,cplGluFdcSdR,cplGluGluVGL,               & 
& cplGluGluVGR,cplSdcSdVG,cplSucSuVG,OG2qSLSM(gt1,gt2),OG2qSRSM(gt1,gt2))
...
& cplChiChihhL,cplChiChihhR,cplChiFdcSdL,cplChiFdcSdR,cplFdFdSuL,cplFdFdSuR,             & 
& cplFdFuSdL,cplFdFuSdR,cplGluFdcSdL,cplGluFdcSdR,cplhhcHpmVWm,cplhhcVWmVWm,             & 
& cplhhhhhh,cplhhHpmcHpm,cplhhHpmcVWm,cplhhSdcSd,cplhhSucSu,cplhhVZVZ,OH2qSLSM(gt1,gt2,gt3)& 
...
Call RunSM_and_SUSY_RGEs(mz,g1input,g2input,g3input,Ydinput,Yeinput,L3input,          & 
& Yuinput,Muinput,Tdinput,Teinput,T3input,Tuinput,Bmuinput,mq2input,ml2input,            & 
& mHd2input,mHu2input,md2input,mu2input,me2input,M1input,M2input,M3input,vdinput,        & 
& vuinput,g1,g2,g3,Yd,Ye,L3,Yu,Mu,Td,Te,T3,Tu,Bmu,mq2,ml2,mHd2,mHu2,md2,mu2,             & 
& me2,M1,M2,M3,vd,vu,CKM_MZ,sinW2_MZ,Alpha_MZ,AlphaS_MZ,.true.)
...
& cplcChaChaVPR,cplcChaChaVZL,cplcChaChaVZR,cplcChaFecSvL,cplcChaFecSvR,cplcFdcFucSdL,   & 
& cplcFdcFucSdR,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVPL,             & 
& cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFuHpmL,cplcFdFuHpmR,cplcFdFuVWmL,            & 
...
& cplChiChihhR,cplChiChiVZL,cplChiChiVZR,cplChiFecSeL,cplChiFecSeR,cplChiFucSuL,         & 
& cplChiFucSuR,cplcHpmVPVWm,cplcHpmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,cplFdFuSdL,           & 
& cplFdFuSdR,cplGluFucSuL,cplGluFucSuR,cplhhcHpmVWm,cplhhcVWmVWm,cplhhhhhh,              & 
...
& cplSecSeVP,cplSecSeVZ,cplSucSuVP,cplSucSuVZ,cplSvcSvVZ,BOlluuSLL(gt1,gt2,gt3,gt4)      & 
...
& cplhhHpmcHpm,cplhhHpmcVWm,cplhhSdcSd,cplhhSecSe,cplhhSucSu,cplhhSvcSv,cplhhVZVZ,       & 
& cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcVWmVP,cplHpmcVWmVZ,cplSdcSdVP,cplSdcSdVZ,             & 
& cplSecSeVP,cplSecSeVZ,cplSucSuVP,cplSucSuVZ,cplSvcSvVZ,PSOlluuSLL(gt1,gt2,gt3,gt4)     & 
...
& cplhhHpmcHpm,cplhhHpmcVWm,cplhhSdcSd,cplhhSecSe,cplhhSucSu,cplhhSvcSv,cplhhVZVZ,       & 
& cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcVWmVP,cplHpmcVWmVZ,cplSdcSdVP,cplSdcSdVZ,             & 
& cplSecSeVP,cplSecSeVZ,cplSucSuVP,cplSucSuVZ,cplSvcSvVZ,PVOlluuSLL(gt1,gt2,gt3,gt4)     & 
...
& cplhhHpmcHpm,cplhhHpmcVWm,cplhhSdcSd,cplhhSecSe,cplhhSucSu,cplhhSvcSv,cplhhVZVZ,       & 
& cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcVWmVP,cplHpmcVWmVZ,cplSdcSdVP,cplSdcSdVZ,             & 
& cplSecSeVP,cplSecSeVZ,cplSucSuVP,cplSucSuVZ,cplSvcSvVZ,TSOlluuSLL(gt1,gt2,gt3,gt4)     & 
...
& cplhhHpmcHpm,cplhhHpmcVWm,cplhhSdcSd,cplhhSecSe,cplhhSucSu,cplhhSvcSv,cplhhVZVZ,       & 
& cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcVWmVP,cplHpmcVWmVZ,cplSdcSdVP,cplSdcSdVZ,             & 
& cplSecSeVP,cplSecSeVZ,cplSucSuVP,cplSucSuVZ,cplSvcSvVZ,TVOlluuSLL(gt1,gt2,gt3,gt4)     & 
