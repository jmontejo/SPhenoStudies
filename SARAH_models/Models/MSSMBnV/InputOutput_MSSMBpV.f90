...
Use Boundaries_MSSMBpV 
 
Use EffPotFunctions 
Logical,Save::LesHouches_Format
Character(len=8),Save,Private::versionSARAH="4.12.0"
...
InputValueforYe= .True. 
   ...
   Else If (read_line(7:16).Eq."RVLAMUDDIN") Then 
InputValueforL3= .True. 
    Call ReadTensorC(99,3,3,3,L3IN,0, "L3IN",kont)

 
   Else If (read_line(7:12).Eq."IML3IN") Then 
     If (i_cpv.Lt.2) Then  
       Call Warn_CPV(i_cpv,"IML3") 
       Cycle 
     End If 
    Call ReadTensorC(99,3,3,3,L3IN,1, "L3IN",kont)
...
InputValueforTe= .True. 
   ...
   Else If (read_line(7:14).Eq."RVTUDDIN") Then 
InputValueforT3= .True. 
    Call ReadTensorC(99,3,3,3,T3IN,0, "T3IN",kont)

 
   Else If (read_line(7:12).Eq."IMT3IN") Then 
     If (i_cpv.Lt.2) Then  
       Call Warn_CPV(i_cpv,"IMT3") 
       Cycle 
     End If 
    Call ReadTensorC(99,3,3,3,T3IN,1, "T3IN",kont)
...
Case(1001) 
  If (wert.ne.1) CalcLoopDecay_Sd= .False. 
Case(1002) 
  If (wert.ne.1) CalcLoopDecay_Su= .False. 
Case(1003) 
  If (wert.ne.1) CalcLoopDecay_Se= .False. 
Case(1004) 
  If (wert.ne.1) CalcLoopDecay_Sv= .False. 
Case(1005) 
...
Case(1008) 
  If (wert.ne.1) CalcLoopDecay_Glu= .False. 
Case(1009) 
...
Write(io_L,100) "# SUSY Les Houches Accord 2 - MSSM-RpV/BnV Spectrum + Decays + Flavor Observables"
...
Write(io_L,106) "Block RVLAMUDD Q=",Q,"# (SUSY Scale)" 
Write(io_L,127) 1,1,1,Real(L3(1,1,1),dp), "# Real(L3(1,1,1),dp)" 
Write(io_L,127) 1,1,2,Real(L3(1,1,2),dp), "# Real(L3(1,1,2),dp)" 
Write(io_L,127) 1,1,3,Real(L3(1,1,3),dp), "# Real(L3(1,1,3),dp)" 
Write(io_L,127) 1,2,1,Real(L3(1,2,1),dp), "# Real(L3(1,2,1),dp)" 
Write(io_L,127) 1,2,2,Real(L3(1,2,2),dp), "# Real(L3(1,2,2),dp)" 
Write(io_L,127) 1,2,3,Real(L3(1,2,3),dp), "# Real(L3(1,2,3),dp)" 
Write(io_L,127) 1,3,1,Real(L3(1,3,1),dp), "# Real(L3(1,3,1),dp)" 
Write(io_L,127) 1,3,2,Real(L3(1,3,2),dp), "# Real(L3(1,3,2),dp)" 
Write(io_L,127) 1,3,3,Real(L3(1,3,3),dp), "# Real(L3(1,3,3),dp)" 
Write(io_L,127) 2,1,1,Real(L3(2,1,1),dp), "# Real(L3(2,1,1),dp)" 
Write(io_L,127) 2,1,2,Real(L3(2,1,2),dp), "# Real(L3(2,1,2),dp)" 
Write(io_L,127) 2,1,3,Real(L3(2,1,3),dp), "# Real(L3(2,1,3),dp)" 
Write(io_L,127) 2,2,1,Real(L3(2,2,1),dp), "# Real(L3(2,2,1),dp)" 
Write(io_L,127) 2,2,2,Real(L3(2,2,2),dp), "# Real(L3(2,2,2),dp)" 
Write(io_L,127) 2,2,3,Real(L3(2,2,3),dp), "# Real(L3(2,2,3),dp)" 
Write(io_L,127) 2,3,1,Real(L3(2,3,1),dp), "# Real(L3(2,3,1),dp)" 
Write(io_L,127) 2,3,2,Real(L3(2,3,2),dp), "# Real(L3(2,3,2),dp)" 
Write(io_L,127) 2,3,3,Real(L3(2,3,3),dp), "# Real(L3(2,3,3),dp)" 
Write(io_L,127) 3,1,1,Real(L3(3,1,1),dp), "# Real(L3(3,1,1),dp)" 
Write(io_L,127) 3,1,2,Real(L3(3,1,2),dp), "# Real(L3(3,1,2),dp)" 
Write(io_L,127) 3,1,3,Real(L3(3,1,3),dp), "# Real(L3(3,1,3),dp)" 
Write(io_L,127) 3,2,1,Real(L3(3,2,1),dp), "# Real(L3(3,2,1),dp)" 
Write(io_L,127) 3,2,2,Real(L3(3,2,2),dp), "# Real(L3(3,2,2),dp)" 
Write(io_L,127) 3,2,3,Real(L3(3,2,3),dp), "# Real(L3(3,2,3),dp)" 
Write(io_L,127) 3,3,1,Real(L3(3,3,1),dp), "# Real(L3(3,3,1),dp)" 
Write(io_L,127) 3,3,2,Real(L3(3,3,2),dp), "# Real(L3(3,3,2),dp)" 
Write(io_L,127) 3,3,3,Real(L3(3,3,3),dp), "# Real(L3(3,3,3),dp)" 
If ((MaxVal(Abs(AImag(L3))).gt.0._dp).OR.(OutputForMG)) Then 
Write(io_L,106) "Block IMRVLAMUDD Q=",Q,"# (SUSY Scale)" 
Write(io_L,127) 1,1,1,Aimag(L3(1,1,1)), "# Aimag(L3(1,1,1))" 
Write(io_L,127) 1,1,2,Aimag(L3(1,1,2)), "# Aimag(L3(1,1,2))" 
Write(io_L,127) 1,1,3,Aimag(L3(1,1,3)), "# Aimag(L3(1,1,3))" 
Write(io_L,127) 1,2,1,Aimag(L3(1,2,1)), "# Aimag(L3(1,2,1))" 
Write(io_L,127) 1,2,2,Aimag(L3(1,2,2)), "# Aimag(L3(1,2,2))" 
Write(io_L,127) 1,2,3,Aimag(L3(1,2,3)), "# Aimag(L3(1,2,3))" 
Write(io_L,127) 1,3,1,Aimag(L3(1,3,1)), "# Aimag(L3(1,3,1))" 
Write(io_L,127) 1,3,2,Aimag(L3(1,3,2)), "# Aimag(L3(1,3,2))" 
Write(io_L,127) 1,3,3,Aimag(L3(1,3,3)), "# Aimag(L3(1,3,3))" 
Write(io_L,127) 2,1,1,Aimag(L3(2,1,1)), "# Aimag(L3(2,1,1))" 
Write(io_L,127) 2,1,2,Aimag(L3(2,1,2)), "# Aimag(L3(2,1,2))" 
Write(io_L,127) 2,1,3,Aimag(L3(2,1,3)), "# Aimag(L3(2,1,3))" 
Write(io_L,127) 2,2,1,Aimag(L3(2,2,1)), "# Aimag(L3(2,2,1))" 
Write(io_L,127) 2,2,2,Aimag(L3(2,2,2)), "# Aimag(L3(2,2,2))" 
Write(io_L,127) 2,2,3,Aimag(L3(2,2,3)), "# Aimag(L3(2,2,3))" 
Write(io_L,127) 2,3,1,Aimag(L3(2,3,1)), "# Aimag(L3(2,3,1))" 
Write(io_L,127) 2,3,2,Aimag(L3(2,3,2)), "# Aimag(L3(2,3,2))" 
Write(io_L,127) 2,3,3,Aimag(L3(2,3,3)), "# Aimag(L3(2,3,3))" 
Write(io_L,127) 3,1,1,Aimag(L3(3,1,1)), "# Aimag(L3(3,1,1))" 
Write(io_L,127) 3,1,2,Aimag(L3(3,1,2)), "# Aimag(L3(3,1,2))" 
Write(io_L,127) 3,1,3,Aimag(L3(3,1,3)), "# Aimag(L3(3,1,3))" 
Write(io_L,127) 3,2,1,Aimag(L3(3,2,1)), "# Aimag(L3(3,2,1))" 
Write(io_L,127) 3,2,2,Aimag(L3(3,2,2)), "# Aimag(L3(3,2,2))" 
Write(io_L,127) 3,2,3,Aimag(L3(3,2,3)), "# Aimag(L3(3,2,3))" 
Write(io_L,127) 3,3,1,Aimag(L3(3,3,1)), "# Aimag(L3(3,3,1))" 
Write(io_L,127) 3,3,2,Aimag(L3(3,3,2)), "# Aimag(L3(3,3,2))" 
Write(io_L,127) 3,3,3,Aimag(L3(3,3,3)), "# Aimag(L3(3,3,3))" 
End If 
...
Write(io_L,106) "Block RVTUDD Q=",Q,"# (SUSY Scale)" 
Write(io_L,127) 1,1,1,Real(T3(1,1,1),dp), "# Real(T3(1,1,1),dp)" 
Write(io_L,127) 1,1,2,Real(T3(1,1,2),dp), "# Real(T3(1,1,2),dp)" 
Write(io_L,127) 1,1,3,Real(T3(1,1,3),dp), "# Real(T3(1,1,3),dp)" 
Write(io_L,127) 1,2,1,Real(T3(1,2,1),dp), "# Real(T3(1,2,1),dp)" 
Write(io_L,127) 1,2,2,Real(T3(1,2,2),dp), "# Real(T3(1,2,2),dp)" 
Write(io_L,127) 1,2,3,Real(T3(1,2,3),dp), "# Real(T3(1,2,3),dp)" 
Write(io_L,127) 1,3,1,Real(T3(1,3,1),dp), "# Real(T3(1,3,1),dp)" 
Write(io_L,127) 1,3,2,Real(T3(1,3,2),dp), "# Real(T3(1,3,2),dp)" 
Write(io_L,127) 1,3,3,Real(T3(1,3,3),dp), "# Real(T3(1,3,3),dp)" 
Write(io_L,127) 2,1,1,Real(T3(2,1,1),dp), "# Real(T3(2,1,1),dp)" 
Write(io_L,127) 2,1,2,Real(T3(2,1,2),dp), "# Real(T3(2,1,2),dp)" 
Write(io_L,127) 2,1,3,Real(T3(2,1,3),dp), "# Real(T3(2,1,3),dp)" 
Write(io_L,127) 2,2,1,Real(T3(2,2,1),dp), "# Real(T3(2,2,1),dp)" 
Write(io_L,127) 2,2,2,Real(T3(2,2,2),dp), "# Real(T3(2,2,2),dp)" 
Write(io_L,127) 2,2,3,Real(T3(2,2,3),dp), "# Real(T3(2,2,3),dp)" 
Write(io_L,127) 2,3,1,Real(T3(2,3,1),dp), "# Real(T3(2,3,1),dp)" 
Write(io_L,127) 2,3,2,Real(T3(2,3,2),dp), "# Real(T3(2,3,2),dp)" 
Write(io_L,127) 2,3,3,Real(T3(2,3,3),dp), "# Real(T3(2,3,3),dp)" 
Write(io_L,127) 3,1,1,Real(T3(3,1,1),dp), "# Real(T3(3,1,1),dp)" 
Write(io_L,127) 3,1,2,Real(T3(3,1,2),dp), "# Real(T3(3,1,2),dp)" 
Write(io_L,127) 3,1,3,Real(T3(3,1,3),dp), "# Real(T3(3,1,3),dp)" 
Write(io_L,127) 3,2,1,Real(T3(3,2,1),dp), "# Real(T3(3,2,1),dp)" 
Write(io_L,127) 3,2,2,Real(T3(3,2,2),dp), "# Real(T3(3,2,2),dp)" 
Write(io_L,127) 3,2,3,Real(T3(3,2,3),dp), "# Real(T3(3,2,3),dp)" 
Write(io_L,127) 3,3,1,Real(T3(3,3,1),dp), "# Real(T3(3,3,1),dp)" 
Write(io_L,127) 3,3,2,Real(T3(3,3,2),dp), "# Real(T3(3,3,2),dp)" 
Write(io_L,127) 3,3,3,Real(T3(3,3,3),dp), "# Real(T3(3,3,3),dp)" 
If ((MaxVal(Abs(AImag(T3))).gt.0._dp).OR.(OutputForMG)) Then 
Write(io_L,106) "Block IMRVTUDD Q=",Q,"# (SUSY Scale)" 
Write(io_L,127) 1,1,1,Aimag(T3(1,1,1)), "# Aimag(T3(1,1,1))" 
Write(io_L,127) 1,1,2,Aimag(T3(1,1,2)), "# Aimag(T3(1,1,2))" 
Write(io_L,127) 1,1,3,Aimag(T3(1,1,3)), "# Aimag(T3(1,1,3))" 
Write(io_L,127) 1,2,1,Aimag(T3(1,2,1)), "# Aimag(T3(1,2,1))" 
Write(io_L,127) 1,2,2,Aimag(T3(1,2,2)), "# Aimag(T3(1,2,2))" 
Write(io_L,127) 1,2,3,Aimag(T3(1,2,3)), "# Aimag(T3(1,2,3))" 
Write(io_L,127) 1,3,1,Aimag(T3(1,3,1)), "# Aimag(T3(1,3,1))" 
Write(io_L,127) 1,3,2,Aimag(T3(1,3,2)), "# Aimag(T3(1,3,2))" 
Write(io_L,127) 1,3,3,Aimag(T3(1,3,3)), "# Aimag(T3(1,3,3))" 
Write(io_L,127) 2,1,1,Aimag(T3(2,1,1)), "# Aimag(T3(2,1,1))" 
Write(io_L,127) 2,1,2,Aimag(T3(2,1,2)), "# Aimag(T3(2,1,2))" 
Write(io_L,127) 2,1,3,Aimag(T3(2,1,3)), "# Aimag(T3(2,1,3))" 
Write(io_L,127) 2,2,1,Aimag(T3(2,2,1)), "# Aimag(T3(2,2,1))" 
Write(io_L,127) 2,2,2,Aimag(T3(2,2,2)), "# Aimag(T3(2,2,2))" 
Write(io_L,127) 2,2,3,Aimag(T3(2,2,3)), "# Aimag(T3(2,2,3))" 
Write(io_L,127) 2,3,1,Aimag(T3(2,3,1)), "# Aimag(T3(2,3,1))" 
Write(io_L,127) 2,3,2,Aimag(T3(2,3,2)), "# Aimag(T3(2,3,2))" 
Write(io_L,127) 2,3,3,Aimag(T3(2,3,3)), "# Aimag(T3(2,3,3))" 
Write(io_L,127) 3,1,1,Aimag(T3(3,1,1)), "# Aimag(T3(3,1,1))" 
Write(io_L,127) 3,1,2,Aimag(T3(3,1,2)), "# Aimag(T3(3,1,2))" 
Write(io_L,127) 3,1,3,Aimag(T3(3,1,3)), "# Aimag(T3(3,1,3))" 
Write(io_L,127) 3,2,1,Aimag(T3(3,2,1)), "# Aimag(T3(3,2,1))" 
Write(io_L,127) 3,2,2,Aimag(T3(3,2,2)), "# Aimag(T3(3,2,2))" 
Write(io_L,127) 3,2,3,Aimag(T3(3,2,3)), "# Aimag(T3(3,2,3))" 
Write(io_L,127) 3,3,1,Aimag(T3(3,3,1)), "# Aimag(T3(3,3,1))" 
Write(io_L,127) 3,3,2,Aimag(T3(3,3,2)), "# Aimag(T3(3,3,2))" 
Write(io_L,127) 3,3,3,Aimag(T3(3,3,3)), "# Aimag(T3(3,3,3))" 
End If 
...
Write(io_L,106) "Block L3GUT Q=",M_GUT,"# (GUT Scale)" 
Write(io_L,127) 1,1,1,Real(L3GUT(1,1,1),dp), "# Real(L3GUT(1,1,1),dp)" 
Write(io_L,127) 1,1,2,Real(L3GUT(1,1,2),dp), "# Real(L3GUT(1,1,2),dp)" 
Write(io_L,127) 1,1,3,Real(L3GUT(1,1,3),dp), "# Real(L3GUT(1,1,3),dp)" 
Write(io_L,127) 1,2,1,Real(L3GUT(1,2,1),dp), "# Real(L3GUT(1,2,1),dp)" 
Write(io_L,127) 1,2,2,Real(L3GUT(1,2,2),dp), "# Real(L3GUT(1,2,2),dp)" 
Write(io_L,127) 1,2,3,Real(L3GUT(1,2,3),dp), "# Real(L3GUT(1,2,3),dp)" 
Write(io_L,127) 1,3,1,Real(L3GUT(1,3,1),dp), "# Real(L3GUT(1,3,1),dp)" 
Write(io_L,127) 1,3,2,Real(L3GUT(1,3,2),dp), "# Real(L3GUT(1,3,2),dp)" 
Write(io_L,127) 1,3,3,Real(L3GUT(1,3,3),dp), "# Real(L3GUT(1,3,3),dp)" 
Write(io_L,127) 2,1,1,Real(L3GUT(2,1,1),dp), "# Real(L3GUT(2,1,1),dp)" 
Write(io_L,127) 2,1,2,Real(L3GUT(2,1,2),dp), "# Real(L3GUT(2,1,2),dp)" 
Write(io_L,127) 2,1,3,Real(L3GUT(2,1,3),dp), "# Real(L3GUT(2,1,3),dp)" 
Write(io_L,127) 2,2,1,Real(L3GUT(2,2,1),dp), "# Real(L3GUT(2,2,1),dp)" 
Write(io_L,127) 2,2,2,Real(L3GUT(2,2,2),dp), "# Real(L3GUT(2,2,2),dp)" 
Write(io_L,127) 2,2,3,Real(L3GUT(2,2,3),dp), "# Real(L3GUT(2,2,3),dp)" 
Write(io_L,127) 2,3,1,Real(L3GUT(2,3,1),dp), "# Real(L3GUT(2,3,1),dp)" 
Write(io_L,127) 2,3,2,Real(L3GUT(2,3,2),dp), "# Real(L3GUT(2,3,2),dp)" 
Write(io_L,127) 2,3,3,Real(L3GUT(2,3,3),dp), "# Real(L3GUT(2,3,3),dp)" 
Write(io_L,127) 3,1,1,Real(L3GUT(3,1,1),dp), "# Real(L3GUT(3,1,1),dp)" 
Write(io_L,127) 3,1,2,Real(L3GUT(3,1,2),dp), "# Real(L3GUT(3,1,2),dp)" 
Write(io_L,127) 3,1,3,Real(L3GUT(3,1,3),dp), "# Real(L3GUT(3,1,3),dp)" 
Write(io_L,127) 3,2,1,Real(L3GUT(3,2,1),dp), "# Real(L3GUT(3,2,1),dp)" 
Write(io_L,127) 3,2,2,Real(L3GUT(3,2,2),dp), "# Real(L3GUT(3,2,2),dp)" 
Write(io_L,127) 3,2,3,Real(L3GUT(3,2,3),dp), "# Real(L3GUT(3,2,3),dp)" 
Write(io_L,127) 3,3,1,Real(L3GUT(3,3,1),dp), "# Real(L3GUT(3,3,1),dp)" 
Write(io_L,127) 3,3,2,Real(L3GUT(3,3,2),dp), "# Real(L3GUT(3,3,2),dp)" 
Write(io_L,127) 3,3,3,Real(L3GUT(3,3,3),dp), "# Real(L3GUT(3,3,3),dp)" 
If ((MaxVal(Abs(AImag(L3GUT))).gt.0._dp).OR.(OutputForMG)) Then 
Write(io_L,106) "Block IML3GUT Q=",M_GUT,"# (GUT Scale)" 
Write(io_L,127) 1,1,1,Aimag(L3GUT(1,1,1)), "# Aimag(L3GUT(1,1,1))" 
Write(io_L,127) 1,1,2,Aimag(L3GUT(1,1,2)), "# Aimag(L3GUT(1,1,2))" 
Write(io_L,127) 1,1,3,Aimag(L3GUT(1,1,3)), "# Aimag(L3GUT(1,1,3))" 
Write(io_L,127) 1,2,1,Aimag(L3GUT(1,2,1)), "# Aimag(L3GUT(1,2,1))" 
Write(io_L,127) 1,2,2,Aimag(L3GUT(1,2,2)), "# Aimag(L3GUT(1,2,2))" 
Write(io_L,127) 1,2,3,Aimag(L3GUT(1,2,3)), "# Aimag(L3GUT(1,2,3))" 
Write(io_L,127) 1,3,1,Aimag(L3GUT(1,3,1)), "# Aimag(L3GUT(1,3,1))" 
Write(io_L,127) 1,3,2,Aimag(L3GUT(1,3,2)), "# Aimag(L3GUT(1,3,2))" 
Write(io_L,127) 1,3,3,Aimag(L3GUT(1,3,3)), "# Aimag(L3GUT(1,3,3))" 
Write(io_L,127) 2,1,1,Aimag(L3GUT(2,1,1)), "# Aimag(L3GUT(2,1,1))" 
Write(io_L,127) 2,1,2,Aimag(L3GUT(2,1,2)), "# Aimag(L3GUT(2,1,2))" 
Write(io_L,127) 2,1,3,Aimag(L3GUT(2,1,3)), "# Aimag(L3GUT(2,1,3))" 
Write(io_L,127) 2,2,1,Aimag(L3GUT(2,2,1)), "# Aimag(L3GUT(2,2,1))" 
Write(io_L,127) 2,2,2,Aimag(L3GUT(2,2,2)), "# Aimag(L3GUT(2,2,2))" 
Write(io_L,127) 2,2,3,Aimag(L3GUT(2,2,3)), "# Aimag(L3GUT(2,2,3))" 
Write(io_L,127) 2,3,1,Aimag(L3GUT(2,3,1)), "# Aimag(L3GUT(2,3,1))" 
Write(io_L,127) 2,3,2,Aimag(L3GUT(2,3,2)), "# Aimag(L3GUT(2,3,2))" 
Write(io_L,127) 2,3,3,Aimag(L3GUT(2,3,3)), "# Aimag(L3GUT(2,3,3))" 
Write(io_L,127) 3,1,1,Aimag(L3GUT(3,1,1)), "# Aimag(L3GUT(3,1,1))" 
Write(io_L,127) 3,1,2,Aimag(L3GUT(3,1,2)), "# Aimag(L3GUT(3,1,2))" 
Write(io_L,127) 3,1,3,Aimag(L3GUT(3,1,3)), "# Aimag(L3GUT(3,1,3))" 
Write(io_L,127) 3,2,1,Aimag(L3GUT(3,2,1)), "# Aimag(L3GUT(3,2,1))" 
Write(io_L,127) 3,2,2,Aimag(L3GUT(3,2,2)), "# Aimag(L3GUT(3,2,2))" 
Write(io_L,127) 3,2,3,Aimag(L3GUT(3,2,3)), "# Aimag(L3GUT(3,2,3))" 
Write(io_L,127) 3,3,1,Aimag(L3GUT(3,3,1)), "# Aimag(L3GUT(3,3,1))" 
Write(io_L,127) 3,3,2,Aimag(L3GUT(3,3,2)), "# Aimag(L3GUT(3,3,2))" 
Write(io_L,127) 3,3,3,Aimag(L3GUT(3,3,3)), "# Aimag(L3GUT(3,3,3))" 
End If 
...
Write(io_L,106) "Block T3GUT Q=",M_GUT,"# (GUT Scale)" 
Write(io_L,127) 1,1,1,Real(T3GUT(1,1,1),dp), "# Real(T3GUT(1,1,1),dp)" 
Write(io_L,127) 1,1,2,Real(T3GUT(1,1,2),dp), "# Real(T3GUT(1,1,2),dp)" 
Write(io_L,127) 1,1,3,Real(T3GUT(1,1,3),dp), "# Real(T3GUT(1,1,3),dp)" 
Write(io_L,127) 1,2,1,Real(T3GUT(1,2,1),dp), "# Real(T3GUT(1,2,1),dp)" 
Write(io_L,127) 1,2,2,Real(T3GUT(1,2,2),dp), "# Real(T3GUT(1,2,2),dp)" 
Write(io_L,127) 1,2,3,Real(T3GUT(1,2,3),dp), "# Real(T3GUT(1,2,3),dp)" 
Write(io_L,127) 1,3,1,Real(T3GUT(1,3,1),dp), "# Real(T3GUT(1,3,1),dp)" 
Write(io_L,127) 1,3,2,Real(T3GUT(1,3,2),dp), "# Real(T3GUT(1,3,2),dp)" 
Write(io_L,127) 1,3,3,Real(T3GUT(1,3,3),dp), "# Real(T3GUT(1,3,3),dp)" 
Write(io_L,127) 2,1,1,Real(T3GUT(2,1,1),dp), "# Real(T3GUT(2,1,1),dp)" 
Write(io_L,127) 2,1,2,Real(T3GUT(2,1,2),dp), "# Real(T3GUT(2,1,2),dp)" 
Write(io_L,127) 2,1,3,Real(T3GUT(2,1,3),dp), "# Real(T3GUT(2,1,3),dp)" 
Write(io_L,127) 2,2,1,Real(T3GUT(2,2,1),dp), "# Real(T3GUT(2,2,1),dp)" 
Write(io_L,127) 2,2,2,Real(T3GUT(2,2,2),dp), "# Real(T3GUT(2,2,2),dp)" 
Write(io_L,127) 2,2,3,Real(T3GUT(2,2,3),dp), "# Real(T3GUT(2,2,3),dp)" 
Write(io_L,127) 2,3,1,Real(T3GUT(2,3,1),dp), "# Real(T3GUT(2,3,1),dp)" 
Write(io_L,127) 2,3,2,Real(T3GUT(2,3,2),dp), "# Real(T3GUT(2,3,2),dp)" 
Write(io_L,127) 2,3,3,Real(T3GUT(2,3,3),dp), "# Real(T3GUT(2,3,3),dp)" 
Write(io_L,127) 3,1,1,Real(T3GUT(3,1,1),dp), "# Real(T3GUT(3,1,1),dp)" 
Write(io_L,127) 3,1,2,Real(T3GUT(3,1,2),dp), "# Real(T3GUT(3,1,2),dp)" 
Write(io_L,127) 3,1,3,Real(T3GUT(3,1,3),dp), "# Real(T3GUT(3,1,3),dp)" 
Write(io_L,127) 3,2,1,Real(T3GUT(3,2,1),dp), "# Real(T3GUT(3,2,1),dp)" 
Write(io_L,127) 3,2,2,Real(T3GUT(3,2,2),dp), "# Real(T3GUT(3,2,2),dp)" 
Write(io_L,127) 3,2,3,Real(T3GUT(3,2,3),dp), "# Real(T3GUT(3,2,3),dp)" 
Write(io_L,127) 3,3,1,Real(T3GUT(3,3,1),dp), "# Real(T3GUT(3,3,1),dp)" 
Write(io_L,127) 3,3,2,Real(T3GUT(3,3,2),dp), "# Real(T3GUT(3,3,2),dp)" 
Write(io_L,127) 3,3,3,Real(T3GUT(3,3,3),dp), "# Real(T3GUT(3,3,3),dp)" 
If ((MaxVal(Abs(AImag(T3GUT))).gt.0._dp).OR.(OutputForMG)) Then 
Write(io_L,106) "Block IMT3GUT Q=",M_GUT,"# (GUT Scale)" 
Write(io_L,127) 1,1,1,Aimag(T3GUT(1,1,1)), "# Aimag(T3GUT(1,1,1))" 
Write(io_L,127) 1,1,2,Aimag(T3GUT(1,1,2)), "# Aimag(T3GUT(1,1,2))" 
Write(io_L,127) 1,1,3,Aimag(T3GUT(1,1,3)), "# Aimag(T3GUT(1,1,3))" 
Write(io_L,127) 1,2,1,Aimag(T3GUT(1,2,1)), "# Aimag(T3GUT(1,2,1))" 
Write(io_L,127) 1,2,2,Aimag(T3GUT(1,2,2)), "# Aimag(T3GUT(1,2,2))" 
Write(io_L,127) 1,2,3,Aimag(T3GUT(1,2,3)), "# Aimag(T3GUT(1,2,3))" 
Write(io_L,127) 1,3,1,Aimag(T3GUT(1,3,1)), "# Aimag(T3GUT(1,3,1))" 
Write(io_L,127) 1,3,2,Aimag(T3GUT(1,3,2)), "# Aimag(T3GUT(1,3,2))" 
Write(io_L,127) 1,3,3,Aimag(T3GUT(1,3,3)), "# Aimag(T3GUT(1,3,3))" 
Write(io_L,127) 2,1,1,Aimag(T3GUT(2,1,1)), "# Aimag(T3GUT(2,1,1))" 
Write(io_L,127) 2,1,2,Aimag(T3GUT(2,1,2)), "# Aimag(T3GUT(2,1,2))" 
Write(io_L,127) 2,1,3,Aimag(T3GUT(2,1,3)), "# Aimag(T3GUT(2,1,3))" 
Write(io_L,127) 2,2,1,Aimag(T3GUT(2,2,1)), "# Aimag(T3GUT(2,2,1))" 
Write(io_L,127) 2,2,2,Aimag(T3GUT(2,2,2)), "# Aimag(T3GUT(2,2,2))" 
Write(io_L,127) 2,2,3,Aimag(T3GUT(2,2,3)), "# Aimag(T3GUT(2,2,3))" 
Write(io_L,127) 2,3,1,Aimag(T3GUT(2,3,1)), "# Aimag(T3GUT(2,3,1))" 
Write(io_L,127) 2,3,2,Aimag(T3GUT(2,3,2)), "# Aimag(T3GUT(2,3,2))" 
Write(io_L,127) 2,3,3,Aimag(T3GUT(2,3,3)), "# Aimag(T3GUT(2,3,3))" 
Write(io_L,127) 3,1,1,Aimag(T3GUT(3,1,1)), "# Aimag(T3GUT(3,1,1))" 
Write(io_L,127) 3,1,2,Aimag(T3GUT(3,1,2)), "# Aimag(T3GUT(3,1,2))" 
Write(io_L,127) 3,1,3,Aimag(T3GUT(3,1,3)), "# Aimag(T3GUT(3,1,3))" 
Write(io_L,127) 3,2,1,Aimag(T3GUT(3,2,1)), "# Aimag(T3GUT(3,2,1))" 
Write(io_L,127) 3,2,2,Aimag(T3GUT(3,2,2)), "# Aimag(T3GUT(3,2,2))" 
Write(io_L,127) 3,2,3,Aimag(T3GUT(3,2,3)), "# Aimag(T3GUT(3,2,3))" 
Write(io_L,127) 3,3,1,Aimag(T3GUT(3,3,1)), "# Aimag(T3GUT(3,3,1))" 
Write(io_L,127) 3,3,2,Aimag(T3GUT(3,3,2)), "# Aimag(T3GUT(3,3,2))" 
Write(io_L,127) 3,3,3,Aimag(T3GUT(3,3,3)), "# Aimag(T3GUT(3,3,3))" 
End If 
...
Write(io_L,104) 1, Abs(mlHd2), "# mlHd2 "  
MassLSP = 100000._dp 
...
Write(io_L,1010) 6, FineTuningResultsAllVEVs(6),  "# Yu" 
Write(io_L,1010) 7, FineTuningResultsAllVEVs(7),  "# L3" 
...
CurrentPDG2(2) = -PDGFd(gt2) 
Write(io_L,201) BRSd(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSd(1))//" -> "//Trim(NameParticleFu(gt1))//"^* "//Trim(NameParticleFd(gt2))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
Write(io_L,201) BRSd(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSd(1))//" -> "//Trim(NameParticleSu(gt1))//"^* "//Trim(NameParticleSd(gt2))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGVG 
Write(io_L,201) BRSd(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSd(1))//" -> "//Trim(NameParticleSd(gt1))//" "//Trim(NameParticleVG)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 6
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRSd(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSd(1))//" -> "//Trim(NameParticleSd(gt1))//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRSd(1,115:1461)).Gt.BRmin) Then 
...
CurrentPDG3(3) = -PDGFu(gt3) 
Write(io_L,202) BRSd(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSd(1))//" -> "//Trim(NameParticleAh(gt1))//" "//Trim(NameParticleFd(gt2))//"^* "//Trim(NameParticleFu(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRSd(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSd(1))//" -> "//Trim(NameParticleSd(gt1))//"^* "//Trim(NameParticleCha(gt2))//" "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRSd(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSd(1))//" -> "//Trim(NameParticleSu(gt1))//"^* "//Trim(NameParticleChi(gt2))//" "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFu(gt3) 
Write(io_L,202) BRSd(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSd(1))//" -> "//Trim(NameParticleSd(gt1))//"^* "//Trim(NameParticleChi(gt2))//" "//Trim(NameParticleFu(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRSd(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSd(1))//" -> "//Trim(NameParticleSu(gt1))//"^* "//Trim(NameParticleGlu)//" "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFu(gt3) 
Write(io_L,202) BRSd(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSd(1))//" -> "//Trim(NameParticleSd(gt1))//"^* "//Trim(NameParticleGlu)//" "//Trim(NameParticleFu(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFu(gt3) 
Write(io_L,202) BRSd(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSd(1))//" -> "//Trim(NameParticlehh(gt1))//" "//Trim(NameParticleFd(gt2))//"^* "//Trim(NameParticleFu(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRSd(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSd(1))//" -> "//Trim(NameParticleHpm(gt1))//" "//Trim(NameParticleFd(gt2))//"^* "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFu(gt3) 
Write(io_L,202) BRSd(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSd(1))//" -> "//Trim(NameParticleSu(gt1))//"^* "//Trim(NameParticleCha(gt2))//"^* "//Trim(NameParticleFu(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGHpm(gt3) 
Write(io_L,202) BRSd(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSd(1))//" -> "//Trim(NameParticleFu(gt1))//"^* "//Trim(NameParticleFu(gt2))//"^* "//Trim(NameParticleHpm(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = -PDGFd(gt2) 
Write(io_L,201) BRSd(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSd(2))//" -> "//Trim(NameParticleFu(gt1))//"^* "//Trim(NameParticleFd(gt2))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = -PDGSd(gt2) 
Write(io_L,201) BRSd(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSd(2))//" -> "//Trim(NameParticleSu(gt1))//"^* "//Trim(NameParticleSd(gt2))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGVG 
Write(io_L,201) BRSd(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSd(2))//" -> "//Trim(NameParticleSd(gt1))//" "//Trim(NameParticleVG)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 6
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRSd(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSd(2))//" -> "//Trim(NameParticleSd(gt1))//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRSd(2,115:1461)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=2,2
  Do gt2=1,2
...
CurrentPDG3(3) = -PDGFu(gt3) 
Write(io_L,202) BRSd(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSd(2))//" -> "//Trim(NameParticleAh(gt1))//" "//Trim(NameParticleFd(gt2))//"^* "//Trim(NameParticleFu(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRSd(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSd(2))//" -> "//Trim(NameParticleSd(gt1))//"^* "//Trim(NameParticleCha(gt2))//" "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRSd(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSd(2))//" -> "//Trim(NameParticleSu(gt1))//"^* "//Trim(NameParticleChi(gt2))//" "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFu(gt3) 
Write(io_L,202) BRSd(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSd(2))//" -> "//Trim(NameParticleSd(gt1))//"^* "//Trim(NameParticleChi(gt2))//" "//Trim(NameParticleFu(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRSd(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSd(2))//" -> "//Trim(NameParticleSu(gt1))//"^* "//Trim(NameParticleGlu)//" "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFu(gt3) 
Write(io_L,202) BRSd(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSd(2))//" -> "//Trim(NameParticleSd(gt1))//"^* "//Trim(NameParticleGlu)//" "//Trim(NameParticleFu(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFu(gt3) 
Write(io_L,202) BRSd(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSd(2))//" -> "//Trim(NameParticlehh(gt1))//" "//Trim(NameParticleFd(gt2))//"^* "//Trim(NameParticleFu(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRSd(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSd(2))//" -> "//Trim(NameParticleHpm(gt1))//" "//Trim(NameParticleFd(gt2))//"^* "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFu(gt3) 
Write(io_L,202) BRSd(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSd(2))//" -> "//Trim(NameParticleSu(gt1))//"^* "//Trim(NameParticleCha(gt2))//"^* "//Trim(NameParticleFu(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGHpm(gt3) 
Write(io_L,202) BRSd(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSd(2))//" -> "//Trim(NameParticleFu(gt1))//"^* "//Trim(NameParticleFu(gt2))//"^* "//Trim(NameParticleHpm(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = -PDGFd(gt2) 
Write(io_L,201) BRSd(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSd(3))//" -> "//Trim(NameParticleFu(gt1))//"^* "//Trim(NameParticleFd(gt2))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = -PDGSd(gt2) 
Write(io_L,201) BRSd(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSd(3))//" -> "//Trim(NameParticleSu(gt1))//"^* "//Trim(NameParticleSd(gt2))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGVG 
Write(io_L,201) BRSd(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSd(3))//" -> "//Trim(NameParticleSd(gt1))//" "//Trim(NameParticleVG)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 6
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRSd(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSd(3))//" -> "//Trim(NameParticleSd(gt1))//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRSd(3,115:1461)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=2,2
  Do gt2=1,2
...
CurrentPDG3(3) = -PDGFu(gt3) 
Write(io_L,202) BRSd(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSd(3))//" -> "//Trim(NameParticleAh(gt1))//" "//Trim(NameParticleFd(gt2))//"^* "//Trim(NameParticleFu(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRSd(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSd(3))//" -> "//Trim(NameParticleSd(gt1))//"^* "//Trim(NameParticleCha(gt2))//" "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRSd(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSd(3))//" -> "//Trim(NameParticleSu(gt1))//"^* "//Trim(NameParticleChi(gt2))//" "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFu(gt3) 
Write(io_L,202) BRSd(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSd(3))//" -> "//Trim(NameParticleSd(gt1))//"^* "//Trim(NameParticleChi(gt2))//" "//Trim(NameParticleFu(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRSd(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSd(3))//" -> "//Trim(NameParticleSu(gt1))//"^* "//Trim(NameParticleGlu)//" "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFu(gt3) 
Write(io_L,202) BRSd(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSd(3))//" -> "//Trim(NameParticleSd(gt1))//"^* "//Trim(NameParticleGlu)//" "//Trim(NameParticleFu(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFu(gt3) 
Write(io_L,202) BRSd(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSd(3))//" -> "//Trim(NameParticlehh(gt1))//" "//Trim(NameParticleFd(gt2))//"^* "//Trim(NameParticleFu(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRSd(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSd(3))//" -> "//Trim(NameParticleHpm(gt1))//" "//Trim(NameParticleFd(gt2))//"^* "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFu(gt3) 
Write(io_L,202) BRSd(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSd(3))//" -> "//Trim(NameParticleSu(gt1))//"^* "//Trim(NameParticleCha(gt2))//"^* "//Trim(NameParticleFu(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGHpm(gt3) 
Write(io_L,202) BRSd(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSd(3))//" -> "//Trim(NameParticleFu(gt1))//"^* "//Trim(NameParticleFu(gt2))//"^* "//Trim(NameParticleHpm(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = -PDGFd(gt2) 
Write(io_L,201) BRSd(4,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSd(4))//" -> "//Trim(NameParticleFu(gt1))//"^* "//Trim(NameParticleFd(gt2))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = -PDGSd(gt2) 
Write(io_L,201) BRSd(4,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSd(4))//" -> "//Trim(NameParticleSu(gt1))//"^* "//Trim(NameParticleSd(gt2))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGVG 
Write(io_L,201) BRSd(4,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSd(4))//" -> "//Trim(NameParticleSd(gt1))//" "//Trim(NameParticleVG)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 6
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRSd(4,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSd(4))//" -> "//Trim(NameParticleSd(gt1))//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRSd(4,115:1461)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=2,2
  Do gt2=1,2
...
CurrentPDG3(3) = -PDGFu(gt3) 
Write(io_L,202) BRSd(4,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSd(4))//" -> "//Trim(NameParticleAh(gt1))//" "//Trim(NameParticleFd(gt2))//"^* "//Trim(NameParticleFu(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRSd(4,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSd(4))//" -> "//Trim(NameParticleSd(gt1))//"^* "//Trim(NameParticleCha(gt2))//" "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRSd(4,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSd(4))//" -> "//Trim(NameParticleSu(gt1))//"^* "//Trim(NameParticleChi(gt2))//" "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFu(gt3) 
Write(io_L,202) BRSd(4,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSd(4))//" -> "//Trim(NameParticleSd(gt1))//"^* "//Trim(NameParticleChi(gt2))//" "//Trim(NameParticleFu(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRSd(4,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSd(4))//" -> "//Trim(NameParticleSu(gt1))//"^* "//Trim(NameParticleGlu)//" "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFu(gt3) 
Write(io_L,202) BRSd(4,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSd(4))//" -> "//Trim(NameParticleSd(gt1))//"^* "//Trim(NameParticleGlu)//" "//Trim(NameParticleFu(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFu(gt3) 
Write(io_L,202) BRSd(4,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSd(4))//" -> "//Trim(NameParticlehh(gt1))//" "//Trim(NameParticleFd(gt2))//"^* "//Trim(NameParticleFu(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRSd(4,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSd(4))//" -> "//Trim(NameParticleHpm(gt1))//" "//Trim(NameParticleFd(gt2))//"^* "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFu(gt3) 
Write(io_L,202) BRSd(4,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSd(4))//" -> "//Trim(NameParticleSu(gt1))//"^* "//Trim(NameParticleCha(gt2))//"^* "//Trim(NameParticleFu(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGHpm(gt3) 
Write(io_L,202) BRSd(4,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSd(4))//" -> "//Trim(NameParticleFu(gt1))//"^* "//Trim(NameParticleFu(gt2))//"^* "//Trim(NameParticleHpm(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = -PDGFd(gt2) 
Write(io_L,201) BRSd(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSd(5))//" -> "//Trim(NameParticleFu(gt1))//"^* "//Trim(NameParticleFd(gt2))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = -PDGSd(gt2) 
Write(io_L,201) BRSd(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSd(5))//" -> "//Trim(NameParticleSu(gt1))//"^* "//Trim(NameParticleSd(gt2))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGVG 
Write(io_L,201) BRSd(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSd(5))//" -> "//Trim(NameParticleSd(gt1))//" "//Trim(NameParticleVG)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 6
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRSd(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSd(5))//" -> "//Trim(NameParticleSd(gt1))//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRSd(5,115:1461)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=2,2
  Do gt2=1,2
...
CurrentPDG3(3) = -PDGFu(gt3) 
Write(io_L,202) BRSd(5,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSd(5))//" -> "//Trim(NameParticleAh(gt1))//" "//Trim(NameParticleFd(gt2))//"^* "//Trim(NameParticleFu(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRSd(5,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSd(5))//" -> "//Trim(NameParticleSd(gt1))//"^* "//Trim(NameParticleCha(gt2))//" "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRSd(5,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSd(5))//" -> "//Trim(NameParticleSu(gt1))//"^* "//Trim(NameParticleChi(gt2))//" "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFu(gt3) 
Write(io_L,202) BRSd(5,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSd(5))//" -> "//Trim(NameParticleSd(gt1))//"^* "//Trim(NameParticleChi(gt2))//" "//Trim(NameParticleFu(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRSd(5,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSd(5))//" -> "//Trim(NameParticleSu(gt1))//"^* "//Trim(NameParticleGlu)//" "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFu(gt3) 
Write(io_L,202) BRSd(5,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSd(5))//" -> "//Trim(NameParticleSd(gt1))//"^* "//Trim(NameParticleGlu)//" "//Trim(NameParticleFu(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFu(gt3) 
Write(io_L,202) BRSd(5,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSd(5))//" -> "//Trim(NameParticlehh(gt1))//" "//Trim(NameParticleFd(gt2))//"^* "//Trim(NameParticleFu(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRSd(5,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSd(5))//" -> "//Trim(NameParticleHpm(gt1))//" "//Trim(NameParticleFd(gt2))//"^* "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFu(gt3) 
Write(io_L,202) BRSd(5,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSd(5))//" -> "//Trim(NameParticleSu(gt1))//"^* "//Trim(NameParticleCha(gt2))//"^* "//Trim(NameParticleFu(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGHpm(gt3) 
Write(io_L,202) BRSd(5,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSd(5))//" -> "//Trim(NameParticleFu(gt1))//"^* "//Trim(NameParticleFu(gt2))//"^* "//Trim(NameParticleHpm(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = -PDGFd(gt2) 
Write(io_L,201) BRSd(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSd(6))//" -> "//Trim(NameParticleFu(gt1))//"^* "//Trim(NameParticleFd(gt2))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = -PDGSd(gt2) 
Write(io_L,201) BRSd(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSd(6))//" -> "//Trim(NameParticleSu(gt1))//"^* "//Trim(NameParticleSd(gt2))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGVG 
Write(io_L,201) BRSd(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSd(6))//" -> "//Trim(NameParticleSd(gt1))//" "//Trim(NameParticleVG)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 6
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRSd(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSd(6))//" -> "//Trim(NameParticleSd(gt1))//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRSd(6,115:1461)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=2,2
  Do gt2=1,2
...
CurrentPDG3(3) = -PDGFu(gt3) 
Write(io_L,202) BRSd(6,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSd(6))//" -> "//Trim(NameParticleAh(gt1))//" "//Trim(NameParticleFd(gt2))//"^* "//Trim(NameParticleFu(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRSd(6,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSd(6))//" -> "//Trim(NameParticleSd(gt1))//"^* "//Trim(NameParticleCha(gt2))//" "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRSd(6,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSd(6))//" -> "//Trim(NameParticleSu(gt1))//"^* "//Trim(NameParticleChi(gt2))//" "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFu(gt3) 
Write(io_L,202) BRSd(6,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSd(6))//" -> "//Trim(NameParticleSd(gt1))//"^* "//Trim(NameParticleChi(gt2))//" "//Trim(NameParticleFu(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRSd(6,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSd(6))//" -> "//Trim(NameParticleSu(gt1))//"^* "//Trim(NameParticleGlu)//" "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFu(gt3) 
Write(io_L,202) BRSd(6,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSd(6))//" -> "//Trim(NameParticleSd(gt1))//"^* "//Trim(NameParticleGlu)//" "//Trim(NameParticleFu(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFu(gt3) 
Write(io_L,202) BRSd(6,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSd(6))//" -> "//Trim(NameParticlehh(gt1))//" "//Trim(NameParticleFd(gt2))//"^* "//Trim(NameParticleFu(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRSd(6,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSd(6))//" -> "//Trim(NameParticleHpm(gt1))//" "//Trim(NameParticleFd(gt2))//"^* "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFu(gt3) 
Write(io_L,202) BRSd(6,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSd(6))//" -> "//Trim(NameParticleSu(gt1))//"^* "//Trim(NameParticleCha(gt2))//"^* "//Trim(NameParticleFu(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGHpm(gt3) 
Write(io_L,202) BRSd(6,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSd(6))//" -> "//Trim(NameParticleFu(gt1))//"^* "//Trim(NameParticleFu(gt2))//"^* "//Trim(NameParticleHpm(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = -PDGFd(gt2) 
Write(io_L,201) BRSu(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSu(1))//" -> "//Trim(NameParticleFd(gt1))//"^* "//Trim(NameParticleFd(gt2))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = -PDGSd(gt2) 
Write(io_L,201) BRSu(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSu(1))//" -> "//Trim(NameParticleSd(gt1))//"^* "//Trim(NameParticleSd(gt2))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGVG 
Write(io_L,201) BRSu(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSu(1))//" -> "//Trim(NameParticleSu(gt1))//" "//Trim(NameParticleVG)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 6
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRSu(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSu(1))//" -> "//Trim(NameParticleSu(gt1))//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRSu(1,97:1335)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=2,2
  Do gt2=1,4
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRSu(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSu(1))//" -> "//Trim(NameParticleAh(gt1))//" "//Trim(NameParticleFd(gt2))//"^* "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRSu(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSu(1))//" -> "//Trim(NameParticleSd(gt1))//"^* "//Trim(NameParticleChi(gt2))//" "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFu(gt3) 
Write(io_L,202) BRSu(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSu(1))//" -> "//Trim(NameParticleSd(gt1))//"^* "//Trim(NameParticleFd(gt2))//" "//Trim(NameParticleFu(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRSu(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSu(1))//" -> "//Trim(NameParticleSd(gt1))//"^* "//Trim(NameParticleGlu)//" "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRSu(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSu(1))//" -> "//Trim(NameParticlehh(gt1))//" "//Trim(NameParticleFd(gt2))//"^* "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGSu(gt3) 
Write(io_L,202) BRSu(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSu(1))//" -> "//Trim(NameParticleCha(gt1))//"^* "//Trim(NameParticleFd(gt2))//"^* "//Trim(NameParticleSu(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFu(gt3) 
Write(io_L,202) BRSu(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSu(1))//" -> "//Trim(NameParticleSd(gt1))//"^* "//Trim(NameParticleCha(gt2))//"^* "//Trim(NameParticleFu(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFu(gt3) 
Write(io_L,202) BRSu(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSu(1))//" -> "//Trim(NameParticleHpm(gt1))//"^* "//Trim(NameParticleFd(gt2))//"^* "//Trim(NameParticleFu(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = -PDGFd(gt2) 
Write(io_L,201) BRSu(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSu(2))//" -> "//Trim(NameParticleFd(gt1))//"^* "//Trim(NameParticleFd(gt2))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = -PDGSd(gt2) 
Write(io_L,201) BRSu(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSu(2))//" -> "//Trim(NameParticleSd(gt1))//"^* "//Trim(NameParticleSd(gt2))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGVG 
Write(io_L,201) BRSu(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSu(2))//" -> "//Trim(NameParticleSu(gt1))//" "//Trim(NameParticleVG)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 6
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRSu(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSu(2))//" -> "//Trim(NameParticleSu(gt1))//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRSu(2,97:1335)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=2,2
  Do gt2=1,4
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRSu(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSu(2))//" -> "//Trim(NameParticleAh(gt1))//" "//Trim(NameParticleFd(gt2))//"^* "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRSu(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSu(2))//" -> "//Trim(NameParticleSd(gt1))//"^* "//Trim(NameParticleChi(gt2))//" "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFu(gt3) 
Write(io_L,202) BRSu(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSu(2))//" -> "//Trim(NameParticleSd(gt1))//"^* "//Trim(NameParticleFd(gt2))//" "//Trim(NameParticleFu(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRSu(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSu(2))//" -> "//Trim(NameParticleSd(gt1))//"^* "//Trim(NameParticleGlu)//" "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRSu(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSu(2))//" -> "//Trim(NameParticlehh(gt1))//" "//Trim(NameParticleFd(gt2))//"^* "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGSu(gt3) 
Write(io_L,202) BRSu(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSu(2))//" -> "//Trim(NameParticleCha(gt1))//"^* "//Trim(NameParticleFd(gt2))//"^* "//Trim(NameParticleSu(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFu(gt3) 
Write(io_L,202) BRSu(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSu(2))//" -> "//Trim(NameParticleSd(gt1))//"^* "//Trim(NameParticleCha(gt2))//"^* "//Trim(NameParticleFu(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFu(gt3) 
Write(io_L,202) BRSu(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSu(2))//" -> "//Trim(NameParticleHpm(gt1))//"^* "//Trim(NameParticleFd(gt2))//"^* "//Trim(NameParticleFu(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = -PDGFd(gt2) 
Write(io_L,201) BRSu(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSu(3))//" -> "//Trim(NameParticleFd(gt1))//"^* "//Trim(NameParticleFd(gt2))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = -PDGSd(gt2) 
Write(io_L,201) BRSu(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSu(3))//" -> "//Trim(NameParticleSd(gt1))//"^* "//Trim(NameParticleSd(gt2))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGVG 
Write(io_L,201) BRSu(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSu(3))//" -> "//Trim(NameParticleSu(gt1))//" "//Trim(NameParticleVG)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 6
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRSu(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSu(3))//" -> "//Trim(NameParticleSu(gt1))//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRSu(3,97:1335)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=2,2
  Do gt2=1,4
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRSu(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSu(3))//" -> "//Trim(NameParticleAh(gt1))//" "//Trim(NameParticleFd(gt2))//"^* "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRSu(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSu(3))//" -> "//Trim(NameParticleSd(gt1))//"^* "//Trim(NameParticleChi(gt2))//" "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFu(gt3) 
Write(io_L,202) BRSu(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSu(3))//" -> "//Trim(NameParticleSd(gt1))//"^* "//Trim(NameParticleFd(gt2))//" "//Trim(NameParticleFu(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRSu(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSu(3))//" -> "//Trim(NameParticleSd(gt1))//"^* "//Trim(NameParticleGlu)//" "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRSu(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSu(3))//" -> "//Trim(NameParticlehh(gt1))//" "//Trim(NameParticleFd(gt2))//"^* "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGSu(gt3) 
Write(io_L,202) BRSu(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSu(3))//" -> "//Trim(NameParticleCha(gt1))//"^* "//Trim(NameParticleFd(gt2))//"^* "//Trim(NameParticleSu(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFu(gt3) 
Write(io_L,202) BRSu(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSu(3))//" -> "//Trim(NameParticleSd(gt1))//"^* "//Trim(NameParticleCha(gt2))//"^* "//Trim(NameParticleFu(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFu(gt3) 
Write(io_L,202) BRSu(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSu(3))//" -> "//Trim(NameParticleHpm(gt1))//"^* "//Trim(NameParticleFd(gt2))//"^* "//Trim(NameParticleFu(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = -PDGFd(gt2) 
Write(io_L,201) BRSu(4,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSu(4))//" -> "//Trim(NameParticleFd(gt1))//"^* "//Trim(NameParticleFd(gt2))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = -PDGSd(gt2) 
Write(io_L,201) BRSu(4,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSu(4))//" -> "//Trim(NameParticleSd(gt1))//"^* "//Trim(NameParticleSd(gt2))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGVG 
Write(io_L,201) BRSu(4,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSu(4))//" -> "//Trim(NameParticleSu(gt1))//" "//Trim(NameParticleVG)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 6
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRSu(4,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSu(4))//" -> "//Trim(NameParticleSu(gt1))//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRSu(4,97:1335)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=2,2
  Do gt2=1,4
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRSu(4,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSu(4))//" -> "//Trim(NameParticleAh(gt1))//" "//Trim(NameParticleFd(gt2))//"^* "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRSu(4,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSu(4))//" -> "//Trim(NameParticleSd(gt1))//"^* "//Trim(NameParticleChi(gt2))//" "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFu(gt3) 
Write(io_L,202) BRSu(4,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSu(4))//" -> "//Trim(NameParticleSd(gt1))//"^* "//Trim(NameParticleFd(gt2))//" "//Trim(NameParticleFu(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRSu(4,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSu(4))//" -> "//Trim(NameParticleSd(gt1))//"^* "//Trim(NameParticleGlu)//" "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRSu(4,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSu(4))//" -> "//Trim(NameParticlehh(gt1))//" "//Trim(NameParticleFd(gt2))//"^* "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGSu(gt3) 
Write(io_L,202) BRSu(4,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSu(4))//" -> "//Trim(NameParticleCha(gt1))//"^* "//Trim(NameParticleFd(gt2))//"^* "//Trim(NameParticleSu(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFu(gt3) 
Write(io_L,202) BRSu(4,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSu(4))//" -> "//Trim(NameParticleSd(gt1))//"^* "//Trim(NameParticleCha(gt2))//"^* "//Trim(NameParticleFu(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFu(gt3) 
Write(io_L,202) BRSu(4,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSu(4))//" -> "//Trim(NameParticleHpm(gt1))//"^* "//Trim(NameParticleFd(gt2))//"^* "//Trim(NameParticleFu(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = -PDGFd(gt2) 
Write(io_L,201) BRSu(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSu(5))//" -> "//Trim(NameParticleFd(gt1))//"^* "//Trim(NameParticleFd(gt2))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = -PDGSd(gt2) 
Write(io_L,201) BRSu(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSu(5))//" -> "//Trim(NameParticleSd(gt1))//"^* "//Trim(NameParticleSd(gt2))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGVG 
Write(io_L,201) BRSu(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSu(5))//" -> "//Trim(NameParticleSu(gt1))//" "//Trim(NameParticleVG)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 6
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRSu(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSu(5))//" -> "//Trim(NameParticleSu(gt1))//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRSu(5,97:1335)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=2,2
  Do gt2=1,4
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRSu(5,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSu(5))//" -> "//Trim(NameParticleAh(gt1))//" "//Trim(NameParticleFd(gt2))//"^* "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRSu(5,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSu(5))//" -> "//Trim(NameParticleSd(gt1))//"^* "//Trim(NameParticleChi(gt2))//" "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFu(gt3) 
Write(io_L,202) BRSu(5,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSu(5))//" -> "//Trim(NameParticleSd(gt1))//"^* "//Trim(NameParticleFd(gt2))//" "//Trim(NameParticleFu(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRSu(5,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSu(5))//" -> "//Trim(NameParticleSd(gt1))//"^* "//Trim(NameParticleGlu)//" "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRSu(5,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSu(5))//" -> "//Trim(NameParticlehh(gt1))//" "//Trim(NameParticleFd(gt2))//"^* "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGSu(gt3) 
Write(io_L,202) BRSu(5,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSu(5))//" -> "//Trim(NameParticleCha(gt1))//"^* "//Trim(NameParticleFd(gt2))//"^* "//Trim(NameParticleSu(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFu(gt3) 
Write(io_L,202) BRSu(5,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSu(5))//" -> "//Trim(NameParticleSd(gt1))//"^* "//Trim(NameParticleCha(gt2))//"^* "//Trim(NameParticleFu(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFu(gt3) 
Write(io_L,202) BRSu(5,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSu(5))//" -> "//Trim(NameParticleHpm(gt1))//"^* "//Trim(NameParticleFd(gt2))//"^* "//Trim(NameParticleFu(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = -PDGFd(gt2) 
Write(io_L,201) BRSu(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSu(6))//" -> "//Trim(NameParticleFd(gt1))//"^* "//Trim(NameParticleFd(gt2))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = -PDGSd(gt2) 
Write(io_L,201) BRSu(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSu(6))//" -> "//Trim(NameParticleSd(gt1))//"^* "//Trim(NameParticleSd(gt2))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGVG 
Write(io_L,201) BRSu(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSu(6))//" -> "//Trim(NameParticleSu(gt1))//" "//Trim(NameParticleVG)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 6
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRSu(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSu(6))//" -> "//Trim(NameParticleSu(gt1))//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRSu(6,97:1335)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=2,2
  Do gt2=1,4
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRSu(6,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSu(6))//" -> "//Trim(NameParticleAh(gt1))//" "//Trim(NameParticleFd(gt2))//"^* "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRSu(6,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSu(6))//" -> "//Trim(NameParticleSd(gt1))//"^* "//Trim(NameParticleChi(gt2))//" "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFu(gt3) 
Write(io_L,202) BRSu(6,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSu(6))//" -> "//Trim(NameParticleSd(gt1))//"^* "//Trim(NameParticleFd(gt2))//" "//Trim(NameParticleFu(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRSu(6,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSu(6))//" -> "//Trim(NameParticleSd(gt1))//"^* "//Trim(NameParticleGlu)//" "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRSu(6,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSu(6))//" -> "//Trim(NameParticlehh(gt1))//" "//Trim(NameParticleFd(gt2))//"^* "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGSu(gt3) 
Write(io_L,202) BRSu(6,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSu(6))//" -> "//Trim(NameParticleCha(gt1))//"^* "//Trim(NameParticleFd(gt2))//"^* "//Trim(NameParticleSu(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFu(gt3) 
Write(io_L,202) BRSu(6,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSu(6))//" -> "//Trim(NameParticleSd(gt1))//"^* "//Trim(NameParticleCha(gt2))//"^* "//Trim(NameParticleFu(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFu(gt3) 
Write(io_L,202) BRSu(6,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSu(6))//" -> "//Trim(NameParticleHpm(gt1))//"^* "//Trim(NameParticleFd(gt2))//"^* "//Trim(NameParticleFu(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRSe(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSe(1))//" -> "//Trim(NameParticleSe(gt1))//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRSe(1,55:993)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=2,2
  Do gt2=1,2
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRSe(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSe(2))//" -> "//Trim(NameParticleSe(gt1))//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRSe(2,55:993)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=2,2
  Do gt2=1,2
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRSe(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSe(3))//" -> "//Trim(NameParticleSe(gt1))//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRSe(3,55:993)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=2,2
  Do gt2=1,2
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRSe(4,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSe(4))//" -> "//Trim(NameParticleSe(gt1))//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRSe(4,55:993)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=2,2
  Do gt2=1,2
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRSe(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSe(5))//" -> "//Trim(NameParticleSe(gt1))//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRSe(5,55:993)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=2,2
  Do gt2=1,2
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRSe(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSe(6))//" -> "//Trim(NameParticleSe(gt1))//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRSe(6,55:993)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=2,2
  Do gt2=1,2
...
Write(io_L,201) BRSv(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSv(1))//" -> "//Trim(NameParticleAh(gt1))//" "//Trim(NameParticleSv(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRSv(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSv(1))//" -> "//Trim(NameParticleSv(gt1))//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRSv(1,46:894)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,4
...
CurrentPDG2(2) = PDGSv(gt2) 
Write(io_L,201) BRSv(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSv(2))//" -> "//Trim(NameParticleAh(gt1))//" "//Trim(NameParticleSv(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRSv(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSv(2))//" -> "//Trim(NameParticleSv(gt1))//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRSv(2,46:894)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,4
...
CurrentPDG2(2) = PDGSv(gt2) 
Write(io_L,201) BRSv(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSv(3))//" -> "//Trim(NameParticleAh(gt1))//" "//Trim(NameParticleSv(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRSv(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSv(3))//" -> "//Trim(NameParticleSv(gt1))//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRSv(3,46:894)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,4
...
CurrentPDG2(2) = PDGhh(gt2) 
Write(io_L,201) BRhh(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(1))//" -> "//Trim(NameParticleAh(gt1))//" "//Trim(NameParticlehh(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
If (BRhh(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGGlu 
CurrentPDG2(2) = PDGGlu 
Write(io_L,201) BRhh(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(1))//" -> "//Trim(NameParticleGlu)//" "//Trim(NameParticleGlu)//" "//")"
If (((gTGlu.le.WidthToBeInvisible).and.(gTGlu.le.WidthToBeInvisible)).OR. & 
 & ((WidthToBeInvisible.le.-1._dp).And.(CurrentPDG2(1).eq.PDGLSP(1)).And.(CurrentPDG2(2).eq.PDGLSP(1)))) Then 
  BRinvH(1) = BRinvH(1)+BRhh(1,icount) 
End if 
End if 
...
CurrentPDG2(2) = PDGhh(gt2) 
Write(io_L,201) BRhh(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(2))//" -> "//Trim(NameParticleAh(gt1))//" "//Trim(NameParticlehh(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGGlu 
Write(io_L,201) BRhh(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(2))//" -> "//Trim(NameParticleGlu)//" "//Trim(NameParticleGlu)//" "//")"
If (((gTGlu.le.WidthToBeInvisible).and.(gTGlu.le.WidthToBeInvisible)).OR. & 
 & ((WidthToBeInvisible.le.-1._dp).And.(CurrentPDG2(1).eq.PDGLSP(1)).And.(CurrentPDG2(2).eq.PDGLSP(1)))) Then 
  BRinvH(2) = BRinvH(2)+BRhh(2,icount) 
End if 
...
CurrentPDG2(2) = PDGGlu 
Write(io_L,201) BRAh(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleAh(2))//" -> "//Trim(NameParticleGlu)//" "//Trim(NameParticleGlu)//" "//")"
If (((gTGlu.le.WidthToBeInvisible).and.(gTGlu.le.WidthToBeInvisible)).OR. & 
 & ((WidthToBeInvisible.le.-1._dp).And.(CurrentPDG2(1).eq.PDGLSP(1)).And.(CurrentPDG2(2).eq.PDGLSP(1)))) Then 
  BRinvA(2) = BRinvA(2)+BRAh(2,icount) 
End if 
...
CurrentPDG2(2) = -PDGSv(gt2) 
Write(io_L,201) BRAh(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleAh(2))//" -> "//Trim(NameParticleSv(gt1))//" "//Trim(NameParticleSv(gt2))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(1) = PDGChi(gt1) 
CurrentPDG2(2) = PDGVG 
Write(io_L,201) BRGlu(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleGlu)//" -> "//Trim(NameParticleChi(gt1))//" "//Trim(NameParticleVG)//" "//")"
End if 
icount = icount +1 
  End Do 
  Do gt2=2, 2
...
CurrentPDG2(2) = PDGAh(gt2) 
Write(io_L,201) BRGlu(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleGlu)//" -> "//Trim(NameParticleGlu)//" "//Trim(NameParticleAh(gt2))//" "//")"
End if 
icount = icount +1 
End Do 
...
CurrentPDG2(2) = PDGhh(gt2) 
Write(io_L,201) BRGlu(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleGlu)//" -> "//Trim(NameParticleGlu)//" "//Trim(NameParticlehh(gt2))//" "//")"
End if 
icount = icount +1 
End Do 
...
CurrentPDG2(2) = PDGVG 
Write(io_L,201) BRGlu(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleGlu)//" -> "//Trim(NameParticleGlu)//" "//Trim(NameParticleVG)//" "//")"
End if 
icount = icount +1 
If (BRGlu(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGGlu 
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRGlu(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleGlu)//" -> "//Trim(NameParticleGlu)//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
If (BRGlu(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGGlu 
CurrentPDG2(2) = PDGVZ 
Write(io_L,201) BRGlu(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleGlu)//" -> "//Trim(NameParticleGlu)//" "//Trim(NameParticleVZ)//" "//")"
End if 
icount = icount +1 
If (Maxval(BRGlu(1,47:163)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
Write(io_L,202) BRGlu(1,icount)/2._dp,3,CurrentPDG3, & 
 & Trim(NameParticleGlu)//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleFu(gt2))//" "//Trim(NameParticleFd(gt3))//" "//")"
Write(io_L,202) BRGlu(1,icount)/2._dp,3,-CurrentPDG3, & 
 & Trim(NameParticleGlu)//" -> "//Trim(NameParticleFd(gt1))//"^* "//Trim(NameParticleFu(gt2))//"^* "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
...
CurrentPDG2(2) = PDGVG 
Write(io_L,201) BRChi(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleChi(1))//" -> "//Trim(NameParticleGlu)//" "//Trim(NameParticleVG)//" "//")"
End if 
icount = icount +1 
If (Maxval(BRChi(1,89:393)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,4
  Do gt2=1,2
...
CurrentPDG3(3) = PDGFd(gt3) 
Write(io_L,202) BRChi(1,icount)/2._dp,3,CurrentPDG3, & 
 & Trim(NameParticleChi(1))//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleFu(gt2))//" "//Trim(NameParticleFd(gt3))//" "//")"
Write(io_L,202) BRChi(1,icount)/2._dp,3,-CurrentPDG3, & 
 & Trim(NameParticleChi(1))//" -> "//Trim(NameParticleFd(gt1))//"^* "//Trim(NameParticleFu(gt2))//"^* "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
...
CurrentPDG2(2) = PDGVG 
Write(io_L,201) BRChi(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleChi(2))//" -> "//Trim(NameParticleGlu)//" "//Trim(NameParticleVG)//" "//")"
End if 
icount = icount +1 
If (Maxval(BRChi(2,89:393)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,4
  Do gt2=1,2
...
CurrentPDG3(3) = PDGFd(gt3) 
Write(io_L,202) BRChi(2,icount)/2._dp,3,CurrentPDG3, & 
 & Trim(NameParticleChi(2))//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleFu(gt2))//" "//Trim(NameParticleFd(gt3))//" "//")"
Write(io_L,202) BRChi(2,icount)/2._dp,3,-CurrentPDG3, & 
 & Trim(NameParticleChi(2))//" -> "//Trim(NameParticleFd(gt1))//"^* "//Trim(NameParticleFu(gt2))//"^* "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
...
CurrentPDG2(2) = PDGVG 
Write(io_L,201) BRChi(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleChi(3))//" -> "//Trim(NameParticleGlu)//" "//Trim(NameParticleVG)//" "//")"
End if 
icount = icount +1 
If (Maxval(BRChi(3,89:393)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,4
  Do gt2=1,2
...
CurrentPDG3(3) = PDGFd(gt3) 
Write(io_L,202) BRChi(3,icount)/2._dp,3,CurrentPDG3, & 
 & Trim(NameParticleChi(3))//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleFu(gt2))//" "//Trim(NameParticleFd(gt3))//" "//")"
Write(io_L,202) BRChi(3,icount)/2._dp,3,-CurrentPDG3, & 
 & Trim(NameParticleChi(3))//" -> "//Trim(NameParticleFd(gt1))//"^* "//Trim(NameParticleFu(gt2))//"^* "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
...
CurrentPDG2(2) = PDGVG 
Write(io_L,201) BRChi(4,icount),2,CurrentPDG2, & 
 & Trim(NameParticleChi(4))//" -> "//Trim(NameParticleGlu)//" "//Trim(NameParticleVG)//" "//")"
End if 
icount = icount +1 
If (Maxval(BRChi(4,89:393)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,4
  Do gt2=1,2
...
CurrentPDG3(3) = PDGFd(gt3) 
Write(io_L,202) BRChi(4,icount)/2._dp,3,CurrentPDG3, & 
 & Trim(NameParticleChi(4))//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleFu(gt2))//" "//Trim(NameParticleFd(gt3))//" "//")"
Write(io_L,202) BRChi(4,icount)/2._dp,3,-CurrentPDG3, & 
 & Trim(NameParticleChi(4))//" -> "//Trim(NameParticleFd(gt1))//"^* "//Trim(NameParticleFu(gt2))//"^* "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
...
icount = icount +1 
  End Do 
If (Maxval(BRCha(1,82:328)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,2
  Do gt2=1,2
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRCha(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleCha(1))//"^* -> "//Trim(NameParticleFd(gt1))//"^* "//Trim(NameParticleFd(gt2))//"^* "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFd(gt3) 
Write(io_L,202) BRCha(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleCha(1))//"^* -> "//Trim(NameParticleFu(gt1))//" "//Trim(NameParticleFu(gt2))//" "//Trim(NameParticleFd(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
icount = icount +1 
  End Do 
If (Maxval(BRCha(2,82:328)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,2
  Do gt2=1,2
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRCha(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleCha(2))//"^* -> "//Trim(NameParticleFd(gt1))//"^* "//Trim(NameParticleFd(gt2))//"^* "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFd(gt3) 
Write(io_L,202) BRCha(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleCha(2))//"^* -> "//Trim(NameParticleFu(gt1))//" "//Trim(NameParticleFu(gt2))//" "//Trim(NameParticleFd(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = -PDGSd(gt2) 
Write(io_L,201) BRFu(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFu(1))//" -> "//Trim(NameParticleFd(gt1))//"^* "//Trim(NameParticleSd(gt2))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = -PDGSd(gt2) 
Write(io_L,201) BRFu(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFu(2))//" -> "//Trim(NameParticleFd(gt1))//"^* "//Trim(NameParticleSd(gt2))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = -PDGSd(gt2) 
Write(io_L,201) BRFu(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFu(3))//" -> "//Trim(NameParticleFd(gt1))//"^* "//Trim(NameParticleSd(gt2))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
If(gT1LSd(1).gt.MinWidth) Then 
Write(io_L,210) INT(PDGSd(1)),gT1LSd(1),Trim(NameParticleSd(1)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 6
  Do gt2=2, 2
If (BR1LSd(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGSd(gt1) 
CurrentPDG2(2) = PDGAh(gt2) 
Write(io_L,201) BR1LSd(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSd(1))//" -> "//Trim(NameParticleSd(gt1))//" "//Trim(NameParticleAh(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
...
icount = icount +1 
  End Do 
End if 
If(gT1LSd(2).gt.MinWidth) Then 
Write(io_L,210) INT(PDGSd(2)),gT1LSd(2),Trim(NameParticleSd(2)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 6
  Do gt2=2, 2
If (BR1LSd(2,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGSd(gt1) 
CurrentPDG2(2) = PDGAh(gt2) 
Write(io_L,201) BR1LSd(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSd(2))//" -> "//Trim(NameParticleSd(gt1))//" "//Trim(NameParticleAh(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
...
icount = icount +1 
  End Do 
End if 
If(gT1LSd(3).gt.MinWidth) Then 
Write(io_L,210) INT(PDGSd(3)),gT1LSd(3),Trim(NameParticleSd(3)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 6
  Do gt2=2, 2
If (BR1LSd(3,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGSd(gt1) 
CurrentPDG2(2) = PDGAh(gt2) 
Write(io_L,201) BR1LSd(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSd(3))//" -> "//Trim(NameParticleSd(gt1))//" "//Trim(NameParticleAh(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
...
icount = icount +1 
  End Do 
End if 
If(gT1LSd(4).gt.MinWidth) Then 
Write(io_L,210) INT(PDGSd(4)),gT1LSd(4),Trim(NameParticleSd(4)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 6
  Do gt2=2, 2
If (BR1LSd(4,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGSd(gt1) 
CurrentPDG2(2) = PDGAh(gt2) 
Write(io_L,201) BR1LSd(4,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSd(4))//" -> "//Trim(NameParticleSd(gt1))//" "//Trim(NameParticleAh(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
...
icount = icount +1 
  End Do 
End if 
If(gT1LSd(5).gt.MinWidth) Then 
Write(io_L,210) INT(PDGSd(5)),gT1LSd(5),Trim(NameParticleSd(5)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 6
  Do gt2=2, 2
If (BR1LSd(5,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGSd(gt1) 
CurrentPDG2(2) = PDGAh(gt2) 
Write(io_L,201) BR1LSd(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSd(5))//" -> "//Trim(NameParticleSd(gt1))//" "//Trim(NameParticleAh(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
...
icount = icount +1 
  End Do 
End if 
If(gT1LSd(6).gt.MinWidth) Then 
Write(io_L,210) INT(PDGSd(6)),gT1LSd(6),Trim(NameParticleSd(6)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 6
  Do gt2=2, 2
If (BR1LSd(6,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGSd(gt1) 
CurrentPDG2(2) = PDGAh(gt2) 
Write(io_L,201) BR1LSd(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSd(6))//" -> "//Trim(NameParticleSd(gt1))//" "//Trim(NameParticleAh(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
...
If(gT1LSu(1).gt.MinWidth) Then 
Write(io_L,210) INT(PDGSu(1)),gT1LSu(1),Trim(NameParticleSu(1)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 6
  Do gt2=2, 2
If (BR1LSu(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGSu(gt1) 
CurrentPDG2(2) = PDGAh(gt2) 
Write(io_L,201) BR1LSu(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSu(1))//" -> "//Trim(NameParticleSu(gt1))//" "//Trim(NameParticleAh(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
...
icount = icount +1 
  End Do 
End if 
If(gT1LSu(2).gt.MinWidth) Then 
Write(io_L,210) INT(PDGSu(2)),gT1LSu(2),Trim(NameParticleSu(2)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 6
  Do gt2=2, 2
If (BR1LSu(2,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGSu(gt1) 
CurrentPDG2(2) = PDGAh(gt2) 
Write(io_L,201) BR1LSu(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSu(2))//" -> "//Trim(NameParticleSu(gt1))//" "//Trim(NameParticleAh(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
...
icount = icount +1 
  End Do 
End if 
If(gT1LSu(3).gt.MinWidth) Then 
Write(io_L,210) INT(PDGSu(3)),gT1LSu(3),Trim(NameParticleSu(3)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 6
  Do gt2=2, 2
If (BR1LSu(3,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGSu(gt1) 
CurrentPDG2(2) = PDGAh(gt2) 
Write(io_L,201) BR1LSu(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSu(3))//" -> "//Trim(NameParticleSu(gt1))//" "//Trim(NameParticleAh(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
...
icount = icount +1 
  End Do 
End if 
If(gT1LSu(4).gt.MinWidth) Then 
Write(io_L,210) INT(PDGSu(4)),gT1LSu(4),Trim(NameParticleSu(4)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 6
  Do gt2=2, 2
If (BR1LSu(4,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGSu(gt1) 
CurrentPDG2(2) = PDGAh(gt2) 
Write(io_L,201) BR1LSu(4,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSu(4))//" -> "//Trim(NameParticleSu(gt1))//" "//Trim(NameParticleAh(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
...
icount = icount +1 
  End Do 
End if 
If(gT1LSu(5).gt.MinWidth) Then 
Write(io_L,210) INT(PDGSu(5)),gT1LSu(5),Trim(NameParticleSu(5)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 6
  Do gt2=2, 2
If (BR1LSu(5,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGSu(gt1) 
CurrentPDG2(2) = PDGAh(gt2) 
Write(io_L,201) BR1LSu(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSu(5))//" -> "//Trim(NameParticleSu(gt1))//" "//Trim(NameParticleAh(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
...
icount = icount +1 
  End Do 
End if 
If(gT1LSu(6).gt.MinWidth) Then 
Write(io_L,210) INT(PDGSu(6)),gT1LSu(6),Trim(NameParticleSu(6)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 6
  Do gt2=2, 2
If (BR1LSu(6,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGSu(gt1) 
CurrentPDG2(2) = PDGAh(gt2) 
Write(io_L,201) BR1LSu(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSu(6))//" -> "//Trim(NameParticleSu(gt1))//" "//Trim(NameParticleAh(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
...
If(gT1LSe(1).gt.MinWidth) Then 
Write(io_L,210) INT(PDGSe(1)),gT1LSe(1),Trim(NameParticleSe(1)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 6
  Do gt2=2, 2
If (BR1LSe(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGSe(gt1) 
CurrentPDG2(2) = PDGAh(gt2) 
Write(io_L,201) BR1LSe(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSe(1))//" -> "//Trim(NameParticleSe(gt1))//" "//Trim(NameParticleAh(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
...
icount = icount +1 
  End Do 
End if 
If(gT1LSe(2).gt.MinWidth) Then 
Write(io_L,210) INT(PDGSe(2)),gT1LSe(2),Trim(NameParticleSe(2)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 6
  Do gt2=2, 2
If (BR1LSe(2,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGSe(gt1) 
CurrentPDG2(2) = PDGAh(gt2) 
Write(io_L,201) BR1LSe(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSe(2))//" -> "//Trim(NameParticleSe(gt1))//" "//Trim(NameParticleAh(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
...
icount = icount +1 
  End Do 
End if 
If(gT1LSe(3).gt.MinWidth) Then 
Write(io_L,210) INT(PDGSe(3)),gT1LSe(3),Trim(NameParticleSe(3)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 6
  Do gt2=2, 2
If (BR1LSe(3,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGSe(gt1) 
CurrentPDG2(2) = PDGAh(gt2) 
Write(io_L,201) BR1LSe(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSe(3))//" -> "//Trim(NameParticleSe(gt1))//" "//Trim(NameParticleAh(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
...
icount = icount +1 
  End Do 
End if 
If(gT1LSe(4).gt.MinWidth) Then 
Write(io_L,210) INT(PDGSe(4)),gT1LSe(4),Trim(NameParticleSe(4)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 6
  Do gt2=2, 2
If (BR1LSe(4,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGSe(gt1) 
CurrentPDG2(2) = PDGAh(gt2) 
Write(io_L,201) BR1LSe(4,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSe(4))//" -> "//Trim(NameParticleSe(gt1))//" "//Trim(NameParticleAh(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
...
icount = icount +1 
  End Do 
End if 
If(gT1LSe(5).gt.MinWidth) Then 
Write(io_L,210) INT(PDGSe(5)),gT1LSe(5),Trim(NameParticleSe(5)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 6
  Do gt2=2, 2
If (BR1LSe(5,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGSe(gt1) 
CurrentPDG2(2) = PDGAh(gt2) 
Write(io_L,201) BR1LSe(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSe(5))//" -> "//Trim(NameParticleSe(gt1))//" "//Trim(NameParticleAh(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
...
icount = icount +1 
  End Do 
End if 
If(gT1LSe(6).gt.MinWidth) Then 
Write(io_L,210) INT(PDGSe(6)),gT1LSe(6),Trim(NameParticleSe(6)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 6
  Do gt2=2, 2
If (BR1LSe(6,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGSe(gt1) 
CurrentPDG2(2) = PDGAh(gt2) 
Write(io_L,201) BR1LSe(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSe(6))//" -> "//Trim(NameParticleSe(gt1))//" "//Trim(NameParticleAh(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
...
If(gT1LSv(1).gt.MinWidth) Then 
Write(io_L,210) INT(PDGSv(1)),gT1LSv(1),Trim(NameParticleSv(1)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 3
  Do gt2=1, 4
If (BR1LSv(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGFv(gt1) 
CurrentPDG2(2) = PDGChi(gt2) 
Write(io_L,201) BR1LSv(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSv(1))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleChi(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
...
icount = icount +1 
  End Do 
End if 
If(gT1LSv(2).gt.MinWidth) Then 
Write(io_L,210) INT(PDGSv(2)),gT1LSv(2),Trim(NameParticleSv(2)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 3
  Do gt2=1, 4
If (BR1LSv(2,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGFv(gt1) 
CurrentPDG2(2) = PDGChi(gt2) 
Write(io_L,201) BR1LSv(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSv(2))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleChi(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
...
icount = icount +1 
  End Do 
End if 
If(gT1LSv(3).gt.MinWidth) Then 
Write(io_L,210) INT(PDGSv(3)),gT1LSv(3),Trim(NameParticleSv(3)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 3
  Do gt2=1, 4
If (BR1LSv(3,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGFv(gt1) 
CurrentPDG2(2) = PDGChi(gt2) 
Write(io_L,201) BR1LSv(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSv(3))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleChi(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
...
If(gT1LGlu.gt.MinWidth) Then 
Write(io_L,210) INT(PDGGlu),gT1LGlu,Trim(NameParticleGlu) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 3
  Do gt2=1, 6
If (BR1LGlu(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGFd(gt1) 
CurrentPDG2(2) = -PDGSd(gt2) 
Write(io_L,201) BR1LGlu(1,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleGlu)//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleSd(gt2))//"^* "//")"
Write(io_L,201) BR1LGlu(1,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleGlu)//" -> "//Trim(NameParticleFd(gt1))//"^* "//Trim(NameParticleSd(gt2))//" "//")"
End if 
...
CurrentPDG2(1) = PDGChi(gt1) 
CurrentPDG2(2) = PDGVG 
Write(io_L,201) BR1LGlu(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleGlu)//" -> "//Trim(NameParticleChi(gt1))//" "//Trim(NameParticleVG)//" "//")"
End if 
icount = icount +1 
  End Do 
...
Subroutine WriteWHIZARD 
   Open(123,file="WHIZARD.par.MSSMBpV",status="unknown")
...
Write(123,*) "L3111_r= ",Real(L3(1,1,1),dp)
Write(123,*) "L3112_r= ",Real(L3(1,1,2),dp)
Write(123,*) "L3113_r= ",Real(L3(1,1,3),dp)
Write(123,*) "L3121_r= ",Real(L3(1,2,1),dp)
Write(123,*) "L3122_r= ",Real(L3(1,2,2),dp)
Write(123,*) "L3123_r= ",Real(L3(1,2,3),dp)
Write(123,*) "L3131_r= ",Real(L3(1,3,1),dp)
Write(123,*) "L3132_r= ",Real(L3(1,3,2),dp)
Write(123,*) "L3133_r= ",Real(L3(1,3,3),dp)
Write(123,*) "L3211_r= ",Real(L3(2,1,1),dp)
Write(123,*) "L3212_r= ",Real(L3(2,1,2),dp)
Write(123,*) "L3213_r= ",Real(L3(2,1,3),dp)
Write(123,*) "L3221_r= ",Real(L3(2,2,1),dp)
Write(123,*) "L3222_r= ",Real(L3(2,2,2),dp)
Write(123,*) "L3223_r= ",Real(L3(2,2,3),dp)
Write(123,*) "L3231_r= ",Real(L3(2,3,1),dp)
Write(123,*) "L3232_r= ",Real(L3(2,3,2),dp)
Write(123,*) "L3233_r= ",Real(L3(2,3,3),dp)
Write(123,*) "L3311_r= ",Real(L3(3,1,1),dp)
Write(123,*) "L3312_r= ",Real(L3(3,1,2),dp)
Write(123,*) "L3313_r= ",Real(L3(3,1,3),dp)
Write(123,*) "L3321_r= ",Real(L3(3,2,1),dp)
Write(123,*) "L3322_r= ",Real(L3(3,2,2),dp)
Write(123,*) "L3323_r= ",Real(L3(3,2,3),dp)
Write(123,*) "L3331_r= ",Real(L3(3,3,1),dp)
Write(123,*) "L3332_r= ",Real(L3(3,3,2),dp)
Write(123,*) "L3333_r= ",Real(L3(3,3,3),dp)
Write(123,*) "L3111_i= ",AImag(L3(1,1,1))
Write(123,*) "L3112_i= ",AImag(L3(1,1,2))
Write(123,*) "L3113_i= ",AImag(L3(1,1,3))
Write(123,*) "L3121_i= ",AImag(L3(1,2,1))
Write(123,*) "L3122_i= ",AImag(L3(1,2,2))
Write(123,*) "L3123_i= ",AImag(L3(1,2,3))
Write(123,*) "L3131_i= ",AImag(L3(1,3,1))
Write(123,*) "L3132_i= ",AImag(L3(1,3,2))
Write(123,*) "L3133_i= ",AImag(L3(1,3,3))
Write(123,*) "L3211_i= ",AImag(L3(2,1,1))
Write(123,*) "L3212_i= ",AImag(L3(2,1,2))
Write(123,*) "L3213_i= ",AImag(L3(2,1,3))
Write(123,*) "L3221_i= ",AImag(L3(2,2,1))
Write(123,*) "L3222_i= ",AImag(L3(2,2,2))
Write(123,*) "L3223_i= ",AImag(L3(2,2,3))
Write(123,*) "L3231_i= ",AImag(L3(2,3,1))
Write(123,*) "L3232_i= ",AImag(L3(2,3,2))
Write(123,*) "L3233_i= ",AImag(L3(2,3,3))
Write(123,*) "L3311_i= ",AImag(L3(3,1,1))
Write(123,*) "L3312_i= ",AImag(L3(3,1,2))
Write(123,*) "L3313_i= ",AImag(L3(3,1,3))
Write(123,*) "L3321_i= ",AImag(L3(3,2,1))
Write(123,*) "L3322_i= ",AImag(L3(3,2,2))
Write(123,*) "L3323_i= ",AImag(L3(3,2,3))
Write(123,*) "L3331_i= ",AImag(L3(3,3,1))
Write(123,*) "L3332_i= ",AImag(L3(3,3,2))
Write(123,*) "L3333_i= ",AImag(L3(3,3,3))
...
Write(123,*) "T3111_r= ",Real(T3(1,1,1),dp)
Write(123,*) "T3112_r= ",Real(T3(1,1,2),dp)
Write(123,*) "T3113_r= ",Real(T3(1,1,3),dp)
Write(123,*) "T3121_r= ",Real(T3(1,2,1),dp)
Write(123,*) "T3122_r= ",Real(T3(1,2,2),dp)
Write(123,*) "T3123_r= ",Real(T3(1,2,3),dp)
Write(123,*) "T3131_r= ",Real(T3(1,3,1),dp)
Write(123,*) "T3132_r= ",Real(T3(1,3,2),dp)
Write(123,*) "T3133_r= ",Real(T3(1,3,3),dp)
Write(123,*) "T3211_r= ",Real(T3(2,1,1),dp)
Write(123,*) "T3212_r= ",Real(T3(2,1,2),dp)
Write(123,*) "T3213_r= ",Real(T3(2,1,3),dp)
Write(123,*) "T3221_r= ",Real(T3(2,2,1),dp)
Write(123,*) "T3222_r= ",Real(T3(2,2,2),dp)
Write(123,*) "T3223_r= ",Real(T3(2,2,3),dp)
Write(123,*) "T3231_r= ",Real(T3(2,3,1),dp)
Write(123,*) "T3232_r= ",Real(T3(2,3,2),dp)
Write(123,*) "T3233_r= ",Real(T3(2,3,3),dp)
Write(123,*) "T3311_r= ",Real(T3(3,1,1),dp)
Write(123,*) "T3312_r= ",Real(T3(3,1,2),dp)
Write(123,*) "T3313_r= ",Real(T3(3,1,3),dp)
Write(123,*) "T3321_r= ",Real(T3(3,2,1),dp)
Write(123,*) "T3322_r= ",Real(T3(3,2,2),dp)
Write(123,*) "T3323_r= ",Real(T3(3,2,3),dp)
Write(123,*) "T3331_r= ",Real(T3(3,3,1),dp)
Write(123,*) "T3332_r= ",Real(T3(3,3,2),dp)
Write(123,*) "T3333_r= ",Real(T3(3,3,3),dp)
Write(123,*) "T3111_i= ",AImag(T3(1,1,1))
Write(123,*) "T3112_i= ",AImag(T3(1,1,2))
Write(123,*) "T3113_i= ",AImag(T3(1,1,3))
Write(123,*) "T3121_i= ",AImag(T3(1,2,1))
Write(123,*) "T3122_i= ",AImag(T3(1,2,2))
Write(123,*) "T3123_i= ",AImag(T3(1,2,3))
Write(123,*) "T3131_i= ",AImag(T3(1,3,1))
Write(123,*) "T3132_i= ",AImag(T3(1,3,2))
Write(123,*) "T3133_i= ",AImag(T3(1,3,3))
Write(123,*) "T3211_i= ",AImag(T3(2,1,1))
Write(123,*) "T3212_i= ",AImag(T3(2,1,2))
Write(123,*) "T3213_i= ",AImag(T3(2,1,3))
Write(123,*) "T3221_i= ",AImag(T3(2,2,1))
Write(123,*) "T3222_i= ",AImag(T3(2,2,2))
Write(123,*) "T3223_i= ",AImag(T3(2,2,3))
Write(123,*) "T3231_i= ",AImag(T3(2,3,1))
Write(123,*) "T3232_i= ",AImag(T3(2,3,2))
Write(123,*) "T3233_i= ",AImag(T3(2,3,3))
Write(123,*) "T3311_i= ",AImag(T3(3,1,1))
Write(123,*) "T3312_i= ",AImag(T3(3,1,2))
Write(123,*) "T3313_i= ",AImag(T3(3,1,3))
Write(123,*) "T3321_i= ",AImag(T3(3,2,1))
Write(123,*) "T3322_i= ",AImag(T3(3,2,2))
Write(123,*) "T3323_i= ",AImag(T3(3,2,3))
Write(123,*) "T3331_i= ",AImag(T3(3,3,1))
Write(123,*) "T3332_i= ",AImag(T3(3,3,2))
Write(123,*) "T3333_i= ",AImag(T3(3,3,3))
...
End Module InputOutput_MSSMBpV 
