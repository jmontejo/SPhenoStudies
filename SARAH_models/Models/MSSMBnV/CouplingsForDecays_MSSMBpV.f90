...
! ------------------------------------------------------------------------------  
! File created at 12:57 on 25.1.2018   
! ----------------------------------------------------------------------  
 
 
Module CouplingsForDecays_MSSMBpV
...
& g1input,g2input,g3input,Ydinput,Yeinput,L3input,Yuinput,Muinput,Tdinput,               & 
& Teinput,T3input,Tuinput,Bmuinput,mq2input,ml2input,mHd2input,mHu2input,md2input,       & 
& mu2input,me2input,M1input,M2input,M3input,vdinput,vuinput,cplAhSdcSd,cplChaFucSdL,     & 
& cplChaFucSdR,cplChiFdcSdL,cplChiFdcSdR,cplGluFdcSdL,cplGluFdcSdR,cplhhSdcSd,           & 
& cplHpmSucSd,cplSdcSdVZ,cplSucSdVWm,cplcFdcFucSdL,cplcFdcFucSdR,cplcSdcSdcSu,deltaM)
...
& cplHpmSucSd(2,6,6),cplSdcSdVZ(6,6),cplSucSdVWm(6,6),cplcFdcFucSdL(3,3,6),              & 
...
If ((m_in.le.Qin).and.(RunningCouplingsDecays)) Then 
  ...
  dt=tz/50._dp 
  Call odeint(g1D,323,0._dp,tz,deltaM,dt,0._dp,rge323,kont)

End if 
Call GToParameters323(g1D,g1,g2,g3,Yd,Ye,L3,Yu,Mu,Td,Te,T3,Tu,Bmu,mq2,ml2,            & 
...
& g1input,g2input,g3input,Ydinput,Yeinput,L3input,Yuinput,Muinput,Tdinput,               & 
& Teinput,T3input,Tuinput,Bmuinput,mq2input,ml2input,mHd2input,mHu2input,md2input,       & 
& mu2input,me2input,M1input,M2input,M3input,vdinput,vuinput,cplAhSucSu,cplChiFucSuL,     & 
& cplChiFucSuR,cplcChaFdcSuL,cplcChaFdcSuR,cplGluFucSuL,cplGluFucSuR,cplhhSucSu,         & 
& cplSdcHpmcSu,cplSdcSucVWm,cplSucSuVZ,cplcFdcFdcSuL,cplcFdcFdcSuR,cplcSdcSdcSu,deltaM)
...
& cplSdcHpmcSu(6,2,6),cplSdcSucVWm(6,6),cplSucSuVZ(6,6),cplcFdcFdcSuL(3,3,6),            & 
...
& g1input,g2input,g3input,Ydinput,Yeinput,L3input,Yuinput,Muinput,Tdinput,               & 
& Teinput,T3input,Tuinput,Bmuinput,mq2input,ml2input,mHd2input,mHu2input,md2input,       & 
& mu2input,me2input,M1input,M2input,M3input,vdinput,vuinput,cplAhSecSe,cplChaFvcSeL,     & 
...
& g1input,g2input,g3input,Ydinput,Yeinput,L3input,Yuinput,Muinput,Tdinput,               & 
& Teinput,T3input,Tuinput,Bmuinput,mq2input,ml2input,mHd2input,mHu2input,md2input,       & 
& mu2input,me2input,M1input,M2input,M3input,vdinput,vuinput,cplChiFvcSvL,cplChiFvcSvR,   & 
...
& g1input,g2input,g3input,Ydinput,Yeinput,L3input,Yuinput,Muinput,Tdinput,               & 
& Teinput,T3input,Tuinput,Bmuinput,mq2input,ml2input,mHd2input,mHu2input,md2input,       & 
& mu2input,me2input,M1input,M2input,M3input,vdinput,vuinput,cplHiggsPP,cplHiggsGG,       & 
...
& g1input,g2input,g3input,Ydinput,Yeinput,L3input,Yuinput,Muinput,Tdinput,               & 
& Teinput,T3input,Tuinput,Bmuinput,mq2input,ml2input,mHd2input,mHu2input,md2input,       & 
& mu2input,me2input,M1input,M2input,M3input,vdinput,vuinput,cplPseudoHiggsPP,            & 
...
& g1input,g2input,g3input,Ydinput,Yeinput,L3input,Yuinput,Muinput,Tdinput,               & 
& Teinput,T3input,Tuinput,Bmuinput,mq2input,ml2input,mHd2input,mHu2input,md2input,       & 
& mu2input,me2input,M1input,M2input,M3input,vdinput,vuinput,cplAhHpmcHpm,cplAhcHpmVWm,   & 
...
& g1input,g2input,g3input,Ydinput,Yeinput,L3input,Yuinput,Muinput,Tdinput,               & 
& Teinput,T3input,Tuinput,Bmuinput,mq2input,ml2input,mHd2input,mHu2input,md2input,       & 
& mu2input,me2input,M1input,M2input,M3input,vdinput,vuinput,cplGluFdcSdL,cplGluFdcSdR,   & 
...
& g1input,g2input,g3input,Ydinput,Yeinput,L3input,Yuinput,Muinput,Tdinput,               & 
& Teinput,T3input,Tuinput,Bmuinput,mq2input,ml2input,mHd2input,mHu2input,md2input,       & 
& mu2input,me2input,M1input,M2input,M3input,vdinput,vuinput,cplChiChiAhL,cplChiChiAhR,   & 
...
& g1input,g2input,g3input,Ydinput,Yeinput,L3input,Yuinput,Muinput,Tdinput,               & 
& Teinput,T3input,Tuinput,Bmuinput,mq2input,ml2input,mHd2input,mHu2input,md2input,       & 
& mu2input,me2input,M1input,M2input,M3input,vdinput,vuinput,cplcChaChaAhL,               & 
...
& g1input,g2input,g3input,Ydinput,Yeinput,L3input,Yuinput,Muinput,Tdinput,               & 
& Teinput,T3input,Tuinput,Bmuinput,mq2input,ml2input,mHd2input,mHu2input,md2input,       & 
& mu2input,me2input,M1input,M2input,M3input,vdinput,vuinput,cplcFuFuAhL,cplcFuFuAhR,     & 
...
& cplcChacFuSdL,cplcChacFuSdR,cplcFdcFucSdL,cplcFdcFucSdR,deltaM)
...
& g1input,g2input,g3input,Ydinput,Yeinput,L3input,Yuinput,Muinput,Tdinput,               & 
& Teinput,T3input,Tuinput,Bmuinput,mq2input,ml2input,mHd2input,mHu2input,md2input,       & 
& mu2input,me2input,M1input,M2input,M3input,vdinput,vuinput,cplcChacFuSdL,               & 
...
& cplChiFdcSdR,cplChiFucSuL,cplChiFucSuR,cplFdFdSuL,cplFdFdSuR,cplFdFuSdL,               & 
& cplFdFuSdR,cplGluFdcSdL,cplGluFdcSdR,cplGluFucSuL,cplGluFucSuR,deltaM)
...
& cplcChaFecSvR,cplcFdcFucSdL,cplcFdcFucSdR,cplcFdChaSuL,cplcFdChaSuR,cplcFdFdAhL,       & 
& cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,cplcFeChaSvL,              & 
...
& cplChaFucSdR,cplChaFvcSeL,cplChaFvcSeR,cplChiChacHpmL,cplChiChacHpmR,cplChiChacVWmL,   & 
& cplChiChacVWmR,cplChiChiAhL,cplChiChiAhR,cplChiChihhL,cplChiChihhR,cplChiChiVZL,       & 
& cplChiChiVZR,cplChiFdcSdL,cplChiFdcSdR,cplChiFecSeL,cplChiFecSeR,cplFdFdSuL,           & 
& cplFdFdSuR,cplGluFdcSdL,cplGluFdcSdR,deltaM)
...
& cplChiChihhL(4,4,2),cplChiChihhR(4,4,2),cplChiChiVZL(4,4),cplChiChiVZR(4,4),           & 
& cplChiFdcSdL(4,3,6),cplChiFdcSdR(4,3,6),cplChiFecSeL(4,3,6),cplChiFecSeR(4,3,6),       & 
& cplFdFdSuL(3,3,6),cplFdFdSuR(3,3,6),cplGluFdcSdL(3,6),cplGluFdcSdR(3,6)
...
& g1input,g2input,g3input,Ydinput,Yeinput,L3input,Yuinput,Muinput,Tdinput,               & 
& Teinput,T3input,Tuinput,Bmuinput,mq2input,ml2input,mHd2input,mHu2input,md2input,       & 
& mu2input,me2input,M1input,M2input,M3input,vdinput,vuinput,cplAhSdcSd,cplcChacFuSdL,    & 
& cplcChacFuSdR,cplcChacFvSeL,cplcChacFvSeR,cplcChaChaAhL,cplcChaChaAhR,cplcChaChahhL,   & 
& cplcChaChahhR,cplcChaChaVZL,cplcChaChaVZR,cplcChaChiHpmL,cplcChaChiHpmR,               & 
...
& g1input,g2input,g3input,Ydinput,Yeinput,L3input,Yuinput,Muinput,Tdinput,               & 
& Teinput,T3input,Tuinput,Bmuinput,mq2input,ml2input,mHd2input,mHu2input,md2input,       & 
& mu2input,me2input,M1input,M2input,M3input,vdinput,vuinput,cplAhSucSu,cplcChacFuSdL,    & 
...
& cplcSdcSdcSu,cplFdFdSuL,cplFdFdSuR,cplFdFuSdL,cplFdFuSdR,cplGluFdcSdL,cplGluFdcSdR,    & 
...
& g1input,g2input,g3input,Ydinput,Yeinput,L3input,Yuinput,Muinput,Tdinput,               & 
& Teinput,T3input,Tuinput,Bmuinput,mq2input,ml2input,mHd2input,mHu2input,md2input,       & 
& mu2input,me2input,M1input,M2input,M3input,vdinput,vuinput,cplAhSecSe,cplcChacFuSdL,    & 
& cplcChacFuSdR,cplcChacFvSeL,cplcChacFvSeR,cplcChaChaAhL,cplcChaChaAhR,cplcChaChahhL,   & 
& cplcChaChahhR,cplcChaChaVZL,cplcChaChaVZR,cplcChaChiHpmL,cplcChaChiHpmR,               & 
...
& g1input,g2input,g3input,Ydinput,Yeinput,L3input,Yuinput,Muinput,Tdinput,               & 
& Teinput,T3input,Tuinput,Bmuinput,mq2input,ml2input,mHd2input,mHu2input,md2input,       & 
& mu2input,me2input,M1input,M2input,M3input,vdinput,vuinput,cplcChacFvSeL,               & 
...
End Module CouplingsForDecays_MSSMBpV
