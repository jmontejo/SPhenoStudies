...
Complex(dp) :: YdIN(3,3),YeIN(3,3),L3IN(3,3,3),YuIN(3,3)

Real(dp) :: g1MZ,g2MZ,g3MZ

Complex(dp) :: YdMZ(3,3),YeMZ(3,3),L3MZ(3,3,3),YuMZ(3,3)

Real(dp) :: g1GUT,g2GUT,g3GUT

Complex(dp) :: YdGUT(3,3),YeGUT(3,3),L3GUT(3,3,3),YuGUT(3,3)

Real(dp) :: mHd2IN,mHu2IN

Complex(dp) :: MuIN,TdIN(3,3),TeIN(3,3),T3IN(3,3,3),TuIN(3,3),BmuIN,mq2IN(3,3),ml2IN(3,3),           & 
& md2IN(3,3),mu2IN(3,3),me2IN(3,3),M1IN,M2IN,M3IN

Real(dp) :: mHd2MZ,mHu2MZ

Complex(dp) :: MuMZ,TdMZ(3,3),TeMZ(3,3),T3MZ(3,3,3),TuMZ(3,3),BmuMZ,mq2MZ(3,3),ml2MZ(3,3),           & 
& md2MZ(3,3),mu2MZ(3,3),me2MZ(3,3),M1MZ,M2MZ,M3MZ

Real(dp) :: mHd2GUT,mHu2GUT

Complex(dp) :: MuGUT,TdGUT(3,3),TeGUT(3,3),T3GUT(3,3,3),TuGUT(3,3),BmuGUT,mq2GUT(3,3),               & 
& ml2GUT(3,3),md2GUT(3,3),mu2GUT(3,3),me2GUT(3,3),M1GUT,M2GUT,M3GUT
...
Real(dp) :: gPSd(6,1461),gTSd(6),BRSd(6,1461),gPSu(6,1335),gTSu(6),BRSu(6,1335),gPSe(6,993),      & 
...
Real(dp) :: gP1LSd(6,114),gT1LSd(6),BR1LSd(6,114),gP1LSu(6,96),gT1LSu(6),BR1LSu(6,96),            & 
& gP1LSe(6,54),gT1LSe(6),BR1LSe(6,54),gP1LSv(3,45),gT1LSv(3),BR1LSv(3,45),               & 
& gP1Lhh(2,191),gT1Lhh(2),BR1Lhh(2,191),gP1LAh(2,189),gT1LAh(2),BR1LAh(2,189),           & 
& gP1LHpm(2,90),gT1LHpm(2),BR1LHpm(2,90),gP1LGlu(1,46),gT1LGlu,BR1LGlu(1,46),            & 
& gP1LChi(4,88),gT1LChi(4),BR1LChi(4,88),gP1LCha(2,81),gT1LCha(2),BR1LCha(2,81),         & 
& gP1LFu(3,84),gT1LFu(3),BR1LFu(3,84)
...
Real (dp) :: FineTuningResults(7) 
Real (dp) :: FineTuningResultsAllVEVs(7) 
...
& g1,g2,g3,Yd,Ye,L3,Yu,Mu,Td,Te,T3,Tu,Bmu,mq2,ml2,mHd2,mHu2,md2,mu2,me2,M1,              & 
& M2,M3,MZsuffix)
