...
Module Wrapper_OneLoopDecay_Ah_MSSMBpV
Use Model_Data_MSSMBpV 
Use Kinematics 
Use OneLoopDecay_Ah_MSSMBpV 
Use Control 
Use Settings 
...
& cplAhcHpmVWm(2,2),cplAhcHpmVWmVZ1(2,2),cplAhcSdcSdcSuepsTensorct2ct3ct4(2,6,6,6),      & 
& cplAhhhHpmcHpm1(2,2,2,2),cplAhhhVZ(2,2),cplAhHpmcHpm(2,2,2),cplAhHpmcVWm(2,2),         & 
& cplAhHpmcVWmVP1(2,2),cplAhHpmcVWmVZ1(2,2),cplAhHpmSucSdaa(2,2,6,6),cplAhHpmSvcSe1(2,2,3,6),& 
& cplAhSdcHpmcSuaa(2,6,2,6),cplAhSdcSd(2,6,6),cplAhSdSdSuepsTensorct2ct3ct4(2,6,6,6),    & 
& cplAhSecHpmcSv1(2,6,2,3),cplAhSecSe(2,6,6),cplAhSucSu(2,6,6),cplcChacFuSdL(2,3,6),     & 
...
& cplcgWmgWmAh(2),cplcgWmgWmhh(2),cplcgWmgWmVP,cplcgWmgWmVZ,cplcgWmgZHpm(2),             & 
...
Complex(dp),Intent(in) :: cplChiFucSuR(4,3,6),cplChiFvcSvL(4,3,3),cplChiFvcSvR(4,3,3),cplcHpmVPVWm(2),           & 
& cplcHpmVWmVZ(2),cplcSdcSdcSu(6,6,6),cplcVWmVPVWm,cplcVWmVWmVZ,cplFdFdSuL(3,3,6),       & 
...
& cplhhcHpmVWm(2,2),cplhhcHpmVWmVZ1(2,2),cplhhcVWmVWm(2),cplhhhhhh(2,2,2),               & 
& cplhhhhHpmcHpm1(2,2,2,2),cplhhhhSdcSdaa(2,2,6,6),cplhhhhSecSe1(2,2,6,6),               & 
& cplhhhhSucSuaa(2,2,6,6),cplhhhhVZVZ1(2,2),cplhhHpmcHpm(2,2,2),cplhhHpmcVWm(2,2),       & 
& cplhhHpmcVWmVP1(2,2),cplhhHpmcVWmVZ1(2,2),cplhhSdcSd(2,6,6),cplhhSecSe(2,6,6),         & 
...
& ctcplAhAhhh(2,2,2),ctcplAhhhVZ(2,2),ctcplAhHpmcHpm(2,2,2),ctcplAhHpmcVWm(2,2),         & 
& ctcplAhSdcSd(2,6,6),ctcplAhSecSe(2,6,6),ctcplAhSucSu(2,6,6),ctcplcChaChaAhL(2,2,2),    & 
& ctcplcChaChaAhR(2,2,2),ctcplcFdFdAhL(3,3,2),ctcplcFdFdAhR(3,3,2),ctcplcFeFeAhL(3,3,2), & 
& ctcplcFeFeAhR(3,3,2),ctcplcFuFuAhL(3,3,2),ctcplcFuFuAhR(3,3,2),ctcplChiChiAhL(4,4,2),  & 
& ctcplChiChiAhR(4,4,2),GcplAhHpmcHpm(2,2,2),GcplcHpmVPVWm(2),GcplHpmcVWmVP(2),          & 
& GosZcplAhHpmcHpm(2,2,2),GosZcplcHpmVPVWm(2),GosZcplHpmcVWmVP(2),GZcplAhHpmcHpm(2,2,2), & 
& GZcplcHpmVPVWm(2),GZcplHpmcVWmVP(2),ZcplAhAhhh(2,2,2),ZcplAhhhVZ(2,2),ZcplAhHpmcHpm(2,2,2),& 
...
Complex(dp) :: AmpTreeAhTocChaCha(2,2,2,2),AmpWaveAhTocChaCha(2,2,2,2)=(0._dp,0._dp),AmpVertexAhTocChaCha(2,2,2,2)& 
...
Complex(dp) :: AmpTreeAhToChiChi(2,2,4,4),AmpWaveAhToChiChi(2,2,4,4)=(0._dp,0._dp),AmpVertexAhToChiChi(2,2,4,4)& 
...
Complex(dp) :: AmpTreeAhTocHpmHpm(2,2,2),AmpWaveAhTocHpmHpm(2,2,2)=(0._dp,0._dp),AmpVertexAhTocHpmHpm(2,2,2)& 
...
Complex(dp) :: AmpTreeAhToHpmcVWm(2,2,2),AmpWaveAhToHpmcVWm(2,2,2)=(0._dp,0._dp),AmpVertexAhToHpmcVWm(2,2,2)& 
...
Complex(dp) :: AmpTreeAhTocSdSd(2,6,6),AmpWaveAhTocSdSd(2,6,6)=(0._dp,0._dp),AmpVertexAhTocSdSd(2,6,6)& 
...
Complex(dp) :: AmpTreeAhTocSeSe(2,6,6),AmpWaveAhTocSeSe(2,6,6)=(0._dp,0._dp),AmpVertexAhTocSeSe(2,6,6)& 
...
Complex(dp) :: AmpTreeAhTocSuSu(2,6,6),AmpWaveAhTocSuSu(2,6,6)=(0._dp,0._dp),AmpVertexAhTocSuSu(2,6,6)& 
...
Complex(dp) :: AmpTreeAhToGluGlu(2,2),AmpWaveAhToGluGlu(2,2)=(0._dp,0._dp),AmpVertexAhToGluGlu(2,2)& 
...
Complex(dp) :: AmpTreeAhToSvcSv(2,3,3),AmpWaveAhToSvcSv(2,3,3)=(0._dp,0._dp),AmpVertexAhToSvcSv(2,3,3)& 
...
Call Amplitude_Tree_MSSMBpV_AhTohhAh(cplAhAhhh,MAh,Mhh,MAh2,Mhh2,AmpTreeAhTohhAh)

  Else 
Call Amplitude_Tree_MSSMBpV_AhTohhAh(ZcplAhAhhh,MAh,Mhh,MAh2,Mhh2,AmpTreeAhTohhAh)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_MSSMBpV_AhTohhAh(MLambda,em,gs,cplAhAhhh,MAhOS,MhhOS,MRPAhTohhAh,     & 
& MRGAhTohhAh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_MSSMBpV_AhTohhAh(MLambda,em,gs,ZcplAhAhhh,MAhOS,MhhOS,MRPAhTohhAh,    & 
& MRGAhTohhAh)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_MSSMBpV_AhTohhAh(MLambda,em,gs,cplAhAhhh,MAh,Mhh,MRPAhTohhAh,         & 
& MRGAhTohhAh)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_MSSMBpV_AhTohhAh(MLambda,em,gs,ZcplAhAhhh,MAh,Mhh,MRPAhTohhAh,        & 
& MRGAhTohhAh)
...
Call Amplitude_WAVE_MSSMBpV_AhTohhAh(cplAhAhhh,ctcplAhAhhh,MAh,MAh2,Mhh,              & 
& Mhh2,ZfAh,Zfhh,AmpWaveAhTohhAh)



!Vertex Corrections 
Call Amplitude_VERTEX_MSSMBpV_AhTohhAh(MAh,MCha,MChi,MFd,MFe,MFu,Mhh,MHpm,            & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_MSSMBpV_AhTohhAh(MAh,MCha,MChi,MFd,MFe,MFu,Mhh,              & 
...
& AmpVertexIRdrAhTohhAh)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_MSSMBpV_AhTohhAh(MAhOS,MChaOS,MChiOS,MFdOS,MFeOS,            & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_MSSMBpV_AhTocChaCha(cplcChaChaAhL,cplcChaChaAhR,MAh,              & 
& MCha,MAh2,MCha2,AmpTreeAhTocChaCha)

  Else 
Call Amplitude_Tree_MSSMBpV_AhTocChaCha(ZcplcChaChaAhL,ZcplcChaChaAhR,MAh,            & 
& MCha,MAh2,MCha2,AmpTreeAhTocChaCha)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_MSSMBpV_AhTocChaCha(MLambda,em,gs,cplcChaChaAhL,cplcChaChaAhR,        & 
& MAhOS,MChaOS,MRPAhTocChaCha,MRGAhTocChaCha)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_MSSMBpV_AhTocChaCha(MLambda,em,gs,ZcplcChaChaAhL,ZcplcChaChaAhR,      & 
& MAhOS,MChaOS,MRPAhTocChaCha,MRGAhTocChaCha)
...
!Self-energy Corrections 
Call Amplitude_WAVE_MSSMBpV_AhTocChaCha(cplcChaChaAhL,cplcChaChaAhR,ctcplcChaChaAhL,  & 
& ctcplcChaChaAhR,MAh,MAh2,MCha,MCha2,ZfAh,ZfLm,ZfLp,AmpWaveAhTocChaCha)



!Vertex Corrections 
Call Amplitude_VERTEX_MSSMBpV_AhTocChaCha(MAh,MCha,MChi,MFd,MFe,MFu,Mhh,              & 
...
& cplcChacFuSdR,cplcChacFvSeL,cplcChacFvSeR,AmpVertexAhTocChaCha)

If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_MSSMBpV_AhTocChaCha(MAh,MCha,MChi,MFd,MFe,MFu,               & 
...
& cplcChaChaVZL,cplcChaChaVZR,cplcChaChiHpmL,cplcChaChiHpmR,cplcChaChiVWmL,              & 
& cplcChaChiVWmR,cplcChaFdcSuL,cplcChaFdcSuR,cplcChaFecSvL,cplcChaFecSvR,cplcChacFuSdL,  & 
& cplcChacFuSdR,cplcChacFvSeL,cplcChacFvSeR,AmpVertexIRdrAhTocChaCha)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_MSSMBpV_AhTocChaCha(MAhOS,MChaOS,MChiOS,MFdOS,               & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_MSSMBpV_AhToChiChi(cplChiChiAhL,cplChiChiAhR,MAh,MChi,            & 
& MAh2,MChi2,AmpTreeAhToChiChi)

  Else 
Call Amplitude_Tree_MSSMBpV_AhToChiChi(ZcplChiChiAhL,ZcplChiChiAhR,MAh,               & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_MSSMBpV_AhToChiChi(MLambda,em,gs,cplChiChiAhL,cplChiChiAhR,           & 
& MAhOS,MChiOS,MRPAhToChiChi,MRGAhToChiChi)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_MSSMBpV_AhToChiChi(MLambda,em,gs,ZcplChiChiAhL,ZcplChiChiAhR,         & 
& MAhOS,MChiOS,MRPAhToChiChi,MRGAhToChiChi)
...
!Self-energy Corrections 
Call Amplitude_WAVE_MSSMBpV_AhToChiChi(cplChiChiAhL,cplChiChiAhR,ctcplChiChiAhL,      & 
& ctcplChiChiAhR,MAh,MAh2,MChi,MChi2,ZfAh,ZfL0,AmpWaveAhToChiChi)



!Vertex Corrections 
Call Amplitude_VERTEX_MSSMBpV_AhToChiChi(MAh,MCha,MChi,MFd,MFe,MFu,Mhh,               & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_MSSMBpV_AhToChiChi(MAh,MCha,MChi,MFd,MFe,MFu,Mhh,            & 
& MHpm,MSd,MSe,MSu,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,Mhh2,MHpm2,MSd2,             & 
& MSe2,MSu2,MVWm2,MVZ2,cplAhAhhh,cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,               & 
& cplChiChiAhR,cplcFdFdAhL,cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,              & 
& cplcFuFuAhR,cplAhhhVZ,cplAhHpmcHpm,cplAhHpmcVWm,cplAhSdcSd,cplAhSecSe,cplAhSucSu,      & 
...
& cplcChaChiVWmL,cplcChaChiVWmR,AmpVertexIRdrAhToChiChi)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_MSSMBpV_AhToChiChi(MAhOS,MChaOS,MChiOS,MFdOS,MFeOS,          & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_MSSMBpV_AhTocFdFd(cplcFdFdAhL,cplcFdFdAhR,MAh,MFd,MAh2,           & 
& MFd2,AmpTreeAhTocFdFd)

  Else 
Call Amplitude_Tree_MSSMBpV_AhTocFdFd(ZcplcFdFdAhL,ZcplcFdFdAhR,MAh,MFd,              & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_MSSMBpV_AhTocFdFd(MLambda,em,gs,cplcFdFdAhL,cplcFdFdAhR,              & 
& MAhOS,MFdOS,MRPAhTocFdFd,MRGAhTocFdFd)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_MSSMBpV_AhTocFdFd(MLambda,em,gs,ZcplcFdFdAhL,ZcplcFdFdAhR,            & 
& MAhOS,MFdOS,MRPAhTocFdFd,MRGAhTocFdFd)
...
!Self-energy Corrections 
Call Amplitude_WAVE_MSSMBpV_AhTocFdFd(cplcFdFdAhL,cplcFdFdAhR,ctcplcFdFdAhL,          & 
& ctcplcFdFdAhR,MAh,MAh2,MFd,MFd2,ZfAh,ZfFDL,ZfFDR,AmpWaveAhTocFdFd)



!Vertex Corrections 
Call Amplitude_VERTEX_MSSMBpV_AhTocFdFd(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,               & 
...
& cplcFdcFdcSuL,cplcFdcFdcSuR,cplcFdcFucSdL,cplcFdcFucSdR,AmpVertexAhTocFdFd)

If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_MSSMBpV_AhTocFdFd(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,            & 
& MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,MHpm2,             & 
& MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,cplAhAhhh,cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,     & 
& cplChiChiAhR,cplcFdFdAhL,cplcFdFdAhR,cplcFuFuAhL,cplcFuFuAhR,cplAhhhVZ,cplAhHpmcHpm,   & 
& cplAhHpmcVWm,cplAhSdcSd,cplAhSucSu,cplAhcHpmVWm,cplcFdChaSuL,cplcFdChaSuR,             & 
...
& cplcChaFdcSuL,cplcChaFdcSuR,cplcFuFdcHpmL,cplcFuFdcHpmR,cplcFuFdcVWmL,cplcFuFdcVWmR,   & 
& cplcFdFuHpmL,cplcFdFuHpmR,cplcFdFuVWmL,cplcFdFuVWmR,cplcFdGluSdL,cplcFdGluSdR,         & 
& cplcFdcFdcSuL,cplcFdcFdcSuR,cplcFdcFucSdL,cplcFdcFucSdR,AmpVertexIRdrAhTocFdFd)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_MSSMBpV_AhTocFdFd(MAhOS,MChaOS,MChiOS,MFdOS,MFuOS,           & 
...
& cplChiFdcSdR,cplcFdChiSdL,cplcFdChiSdR,cplFdFdSuL,cplFdFdSuR,cplFdFuSdL,               & 
...
& cplcFdcFdcSuR,cplcFdcFucSdL,cplcFdcFucSdR,AmpVertexIRosAhTocFdFd)
...
& cplcFdChaSuR,cplChiFdcSdL,cplChiFdcSdR,cplcFdChiSdL,cplcFdChiSdR,cplFdFdSuL,           & 
& cplFdFdSuR,cplFdFuSdL,cplFdFuSdR,cplGluFdcSdL,cplGluFdcSdR,cplcFdFdhhL,cplcFdFdhhR,    & 
& cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,               & 
& cplcChaFdcSuL,cplcChaFdcSuR,cplcFuFdcHpmL,cplcFuFdcHpmR,cplcFuFdcVWmL,cplcFuFdcVWmR,   & 
& cplcFdFuHpmL,cplcFdFuHpmR,cplcFdFuVWmL,cplcFdFuVWmR,cplcFdGluSdL,cplcFdGluSdR,         & 
& cplcFdcFdcSuL,cplcFdcFdcSuR,cplcFdcFucSdL,cplcFdcFucSdR,AmpVertexIRosAhTocFdFd)
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_MSSMBpV_AhTocFeFe(cplcFeFeAhL,cplcFeFeAhR,MAh,MFe,MAh2,           & 
& MFe2,AmpTreeAhTocFeFe)

  Else 
Call Amplitude_Tree_MSSMBpV_AhTocFeFe(ZcplcFeFeAhL,ZcplcFeFeAhR,MAh,MFe,              & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_MSSMBpV_AhTocFeFe(MLambda,em,gs,cplcFeFeAhL,cplcFeFeAhR,              & 
& MAhOS,MFeOS,MRPAhTocFeFe,MRGAhTocFeFe)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_MSSMBpV_AhTocFeFe(MLambda,em,gs,ZcplcFeFeAhL,ZcplcFeFeAhR,            & 
& MAhOS,MFeOS,MRPAhTocFeFe,MRGAhTocFeFe)
...
!Self-energy Corrections 
Call Amplitude_WAVE_MSSMBpV_AhTocFeFe(cplcFeFeAhL,cplcFeFeAhR,ctcplcFeFeAhL,          & 
& ctcplcFeFeAhR,MAh,MAh2,MFe,MFe2,ZfAh,ZfFEL,ZfFER,AmpWaveAhTocFeFe)



!Vertex Corrections 
Call Amplitude_VERTEX_MSSMBpV_AhTocFeFe(MAh,MCha,MChi,MFe,Mhh,MHpm,MSe,               & 
...
& cplcFeFeAhR,cplAhhhVZ,cplAhHpmcHpm,cplAhHpmcVWm,cplAhSecSe,cplAhcHpmVWm,               & 
...
& cplcFeFvHpmL,cplcFeFvHpmR,cplcFeFvVWmL,cplcFeFvVWmR,AmpVertexAhTocFeFe)

If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_MSSMBpV_AhTocFeFe(MAh,MCha,MChi,MFe,Mhh,MHpm,MSe,            & 
& MSv,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFe2,Mhh2,MHpm2,MSe2,MSv2,MVP2,MVWm2,MVZ2,           & 
& cplAhAhhh,cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,cplcFeFeAhL,           & 
& cplcFeFeAhR,cplAhhhVZ,cplAhHpmcHpm,cplAhHpmcVWm,cplAhSecSe,cplAhcHpmVWm,               & 
& cplcFeChaSvL,cplcFeChaSvR,cplChiFecSeL,cplChiFecSeR,cplcFeChiSeL,cplcFeChiSeR,         & 
& cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,               & 
& cplcChaFecSvL,cplcChaFecSvR,cplcFvFecHpmL,cplcFvFecHpmR,cplcFvFecVWmL,cplcFvFecVWmR,   & 
& cplcFeFvHpmL,cplcFeFvHpmR,cplcFeFvVWmL,cplcFeFvVWmR,AmpVertexIRdrAhTocFeFe)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_MSSMBpV_AhTocFeFe(MAhOS,MChaOS,MChiOS,MFeOS,MhhOS,           & 
& MHpmOS,MSeOS,MSvOS,MVP,MVWmOS,MVZOS,MAh2OS,MCha2OS,MChi2OS,MFe2OS,Mhh2OS,              & 
& MHpm2OS,MSe2OS,MSv2OS,MVP2,MVWm2OS,MVZ2OS,cplAhAhhh,cplcChaChaAhL,cplcChaChaAhR,       & 
& cplChiChiAhL,cplChiChiAhR,ZcplcFeFeAhL,ZcplcFeFeAhR,cplAhhhVZ,cplAhHpmcHpm,            & 
...
& ZcplcFeFeAhR,cplAhhhVZ,cplAhHpmcHpm,cplAhHpmcVWm,cplAhSecSe,cplAhcHpmVWm,              & 
& cplcFeChaSvL,cplcFeChaSvR,cplChiFecSeL,cplChiFecSeR,cplcFeChiSeL,cplcFeChiSeR,         & 
& cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,               & 
& cplcChaFecSvL,cplcChaFecSvR,cplcFvFecHpmL,cplcFvFecHpmR,cplcFvFecVWmL,cplcFvFecVWmR,   & 
...
& MHpmOS,MSeOS,MSvOS,MVP,MVWmOS,MVZOS,MAh2OS,MCha2OS,MChi2OS,MFe2OS,Mhh2OS,              & 
& MHpm2OS,MSe2OS,MSv2OS,MVP2,MVWm2OS,MVZ2OS,cplAhAhhh,cplcChaChaAhL,cplcChaChaAhR,       & 
& cplChiChiAhL,cplChiChiAhR,cplcFeFeAhL,cplcFeFeAhR,cplAhhhVZ,cplAhHpmcHpm,              & 
& cplAhHpmcVWm,cplAhSecSe,cplAhcHpmVWm,cplcFeChaSvL,cplcFeChaSvR,cplChiFecSeL,           & 
& cplChiFecSeR,cplcFeChiSeL,cplcFeChiSeR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,            & 
& cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,cplcChaFecSvL,cplcChaFecSvR,cplcFvFecHpmL,         & 
& cplcFvFecHpmR,cplcFvFecVWmL,cplcFvFecVWmR,cplcFeFvHpmL,cplcFeFvHpmR,cplcFeFvVWmL,      & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_MSSMBpV_AhTocFuFu(cplcFuFuAhL,cplcFuFuAhR,MAh,MFu,MAh2,           & 
& MFu2,AmpTreeAhTocFuFu)

  Else 
Call Amplitude_Tree_MSSMBpV_AhTocFuFu(ZcplcFuFuAhL,ZcplcFuFuAhR,MAh,MFu,              & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_MSSMBpV_AhTocFuFu(MLambda,em,gs,cplcFuFuAhL,cplcFuFuAhR,              & 
& MAhOS,MFuOS,MRPAhTocFuFu,MRGAhTocFuFu)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_MSSMBpV_AhTocFuFu(MLambda,em,gs,ZcplcFuFuAhL,ZcplcFuFuAhR,            & 
& MAhOS,MFuOS,MRPAhTocFuFu,MRGAhTocFuFu)
...
!Self-energy Corrections 
Call Amplitude_WAVE_MSSMBpV_AhTocFuFu(cplcFuFuAhL,cplcFuFuAhR,ctcplcFuFuAhL,          & 
& ctcplcFuFuAhR,MAh,MAh2,MFu,MFu2,ZfAh,ZfFUL,ZfFUR,AmpWaveAhTocFuFu)



!Vertex Corrections 
Call Amplitude_VERTEX_MSSMBpV_AhTocFuFu(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,               & 
& MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,MHpm2,             & 
& MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,cplAhAhhh,cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,     & 
& cplChiChiAhR,cplcFdFdAhL,cplcFdFdAhR,cplcFuFuAhL,cplcFuFuAhR,cplAhhhVZ,cplAhHpmcHpm,   & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_MSSMBpV_AhTocFuFu(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,            & 
& MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,MHpm2,             & 
& MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,cplAhAhhh,cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,     & 
& cplChiChiAhR,cplcFdFdAhL,cplcFdFdAhR,cplcFuFuAhL,cplcFuFuAhR,cplAhhhVZ,cplAhHpmcHpm,   & 
& cplAhHpmcVWm,cplAhSdcSd,cplAhSucSu,cplAhcHpmVWm,cplChaFucSdL,cplChaFucSdR,             & 
...
& AmpVertexIRdrAhTocFuFu)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_MSSMBpV_AhTocFuFu(MAhOS,MChaOS,MChiOS,MFdOS,MFuOS,           & 
& MGluOS,MhhOS,MHpmOS,MSdOS,MSuOS,MVG,MVP,MVWmOS,MVZOS,MAh2OS,MCha2OS,MChi2OS,           & 
& MFd2OS,MFu2OS,MGlu2OS,Mhh2OS,MHpm2OS,MSd2OS,MSu2OS,MVG2,MVP2,MVWm2OS,MVZ2OS,           & 
& cplAhAhhh,cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,cplcFdFdAhL,           & 
...
& cplcFuGluSuR,cplcChacFuSdL,cplcChacFuSdR,cplcFdcFucSdL,cplcFdcFucSdR,AmpVertexIRosAhTocFuFu)
...
& cplcFdcFucSdR,AmpVertexIRosAhTocFuFu)
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_MSSMBpV_AhTohhVZ(cplAhhhVZ,MAh,Mhh,MVZ,MAh2,Mhh2,MVZ2,            & 
& AmpTreeAhTohhVZ)

  Else 
Call Amplitude_Tree_MSSMBpV_AhTohhVZ(ZcplAhhhVZ,MAh,Mhh,MVZ,MAh2,Mhh2,MVZ2,           & 
& AmpTreeAhTohhVZ)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_MSSMBpV_AhTohhVZ(MLambda,em,gs,cplAhhhVZ,MAhOS,MhhOS,MVZOS,           & 
& MRPAhTohhVZ,MRGAhTohhVZ)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_MSSMBpV_AhTohhVZ(MLambda,em,gs,ZcplAhhhVZ,MAhOS,MhhOS,MVZOS,          & 
& MRPAhTohhVZ,MRGAhTohhVZ)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_MSSMBpV_AhTohhVZ(MLambda,em,gs,cplAhhhVZ,MAh,Mhh,MVZ,MRPAhTohhVZ,     & 
& MRGAhTohhVZ)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_MSSMBpV_AhTohhVZ(MLambda,em,gs,ZcplAhhhVZ,MAh,Mhh,MVZ,MRPAhTohhVZ,    & 
& MRGAhTohhVZ)
...
!Self-energy Corrections 
Call Amplitude_WAVE_MSSMBpV_AhTohhVZ(cplAhhhVZ,ctcplAhhhVZ,MAh,MAh2,Mhh,              & 
& Mhh2,MVZ,MVZ2,ZfAh,Zfhh,ZfVZ,AmpWaveAhTohhVZ)



!Vertex Corrections 
Call Amplitude_VERTEX_MSSMBpV_AhTohhVZ(MAh,MCha,MChi,MFd,MFe,MFu,Mhh,MHpm,            & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_MSSMBpV_AhTohhVZ(MAh,MCha,MChi,MFd,MFe,MFu,Mhh,              & 
& MHpm,MSd,MSe,MSu,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,Mhh2,MHpm2,MSd2,             & 
& MSe2,MSu2,MVWm2,MVZ2,cplAhAhhh,cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,               & 
& cplChiChiAhR,cplcFdFdAhL,cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,              & 
& cplcFuFuAhR,cplcgWmgWmAh,cplcgWpCgWpCAh,cplAhhhVZ,cplAhHpmcHpm,cplAhHpmcVWm,           & 
...
& cplhhcHpmVWmVZ1,AmpVertexIRdrAhTohhVZ)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_MSSMBpV_AhTohhVZ(MAhOS,MChaOS,MChiOS,MFdOS,MFeOS,            & 
& MFuOS,MhhOS,MHpmOS,MSdOS,MSeOS,MSuOS,MVWmOS,MVZOS,MAh2OS,MCha2OS,MChi2OS,              & 
& MFd2OS,MFe2OS,MFu2OS,Mhh2OS,MHpm2OS,MSd2OS,MSe2OS,MSu2OS,MVWm2OS,MVZ2OS,               & 
& cplAhAhhh,cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,cplcFdFdAhL,           & 
& cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplcgWmgWmAh,              & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_MSSMBpV_AhTocHpmHpm(cplAhHpmcHpm,MAh,MHpm,MAh2,MHpm2,             & 
& AmpTreeAhTocHpmHpm)

  Else 
Call Amplitude_Tree_MSSMBpV_AhTocHpmHpm(ZcplAhHpmcHpm,MAh,MHpm,MAh2,MHpm2,            & 
& AmpTreeAhTocHpmHpm)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_MSSMBpV_AhTocHpmHpm(MLambda,em,gs,cplAhHpmcHpm,MAhOS,MHpmOS,          & 
& MRPAhTocHpmHpm,MRGAhTocHpmHpm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_MSSMBpV_AhTocHpmHpm(MLambda,em,gs,ZcplAhHpmcHpm,MAhOS,MHpmOS,         & 
& MRPAhTocHpmHpm,MRGAhTocHpmHpm)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_MSSMBpV_AhTocHpmHpm(MLambda,em,gs,cplAhHpmcHpm,MAh,MHpm,              & 
& MRPAhTocHpmHpm,MRGAhTocHpmHpm)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_MSSMBpV_AhTocHpmHpm(MLambda,em,gs,ZcplAhHpmcHpm,MAh,MHpm,             & 
& MRPAhTocHpmHpm,MRGAhTocHpmHpm)
...
!Self-energy Corrections 
Call Amplitude_WAVE_MSSMBpV_AhTocHpmHpm(cplAhHpmcHpm,ctcplAhHpmcHpm,MAh,              & 
& MAh2,MHpm,MHpm2,ZfAh,ZfHpm,AmpWaveAhTocHpmHpm)



!Vertex Corrections 
Call Amplitude_VERTEX_MSSMBpV_AhTocHpmHpm(MAh,MCha,MChi,MFd,MFe,MFu,Mhh,              & 
& MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,Mhh2,MHpm2,          & 
& MSd2,MSe2,MSu2,MSv2,MVP2,MVWm2,MVZ2,cplAhAhhh,cplcChaChaAhL,cplcChaChaAhR,             & 
& cplChiChiAhL,cplChiChiAhR,cplcFdFdAhL,cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,             & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_MSSMBpV_AhTocHpmHpm(MAh,MCha,MChi,MFd,MFe,MFu,               & 
& Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,Mhh2,            & 
& MHpm2,MSd2,MSe2,MSu2,MSv2,MVP2,MVWm2,MVZ2,cplAhAhhh,cplcChaChaAhL,cplcChaChaAhR,       & 
& cplChiChiAhL,cplChiChiAhR,cplcFdFdAhL,cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,             & 
& cplcFuFuAhL,cplcFuFuAhR,cplcgWmgWmAh,cplcgWpCgWpCAh,cplAhhhVZ,cplAhHpmcHpm,            & 
...
& cplHpmSdcHpmcSdaa,cplHpmSecHpmcSe1,cplHpmSucHpmcSuaa,AmpVertexIRdrAhTocHpmHpm)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_MSSMBpV_AhTocHpmHpm(MAhOS,MChaOS,MChiOS,MFdOS,               & 
& MFeOS,MFuOS,MhhOS,MHpmOS,MSdOS,MSeOS,MSuOS,MSvOS,MVP,MVWmOS,MVZOS,MAh2OS,              & 
& MCha2OS,MChi2OS,MFd2OS,MFe2OS,MFu2OS,Mhh2OS,MHpm2OS,MSd2OS,MSe2OS,MSu2OS,              & 
& MSv2OS,MVP2,MVWm2OS,MVZ2OS,cplAhAhhh,cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,         & 
& cplChiChiAhR,cplcFdFdAhL,cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,              & 
...
& cplSdcHpmcSu,cplSecHpmcSv,cplcHpmVPVWm,cplcHpmVWmVZ,cplAhAhHpmcHpm1,cplAhhhHpmcHpm1,   & 
& cplAhHpmSucSdaa,cplAhHpmSvcSe1,cplAhHpmcVWmVP1,cplAhHpmcVWmVZ1,cplAhSdcHpmcSuaa,       & 
& cplAhSecHpmcSv1,cplAhcHpmVPVWm1,cplAhcHpmVWmVZ1,cplHpmHpmcHpmcHpm1,cplHpmSdcHpmcSdaa,  & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_MSSMBpV_AhToHpmcVWm(cplAhHpmcVWm,MAh,MHpm,MVWm,MAh2,              & 
& MHpm2,MVWm2,AmpTreeAhToHpmcVWm)

  Else 
Call Amplitude_Tree_MSSMBpV_AhToHpmcVWm(ZcplAhHpmcVWm,MAh,MHpm,MVWm,MAh2,             & 
& MHpm2,MVWm2,AmpTreeAhToHpmcVWm)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_MSSMBpV_AhToHpmcVWm(MLambda,em,gs,cplAhHpmcVWm,MAhOS,MHpmOS,          & 
& MVWmOS,MRPAhToHpmcVWm,MRGAhToHpmcVWm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_MSSMBpV_AhToHpmcVWm(MLambda,em,gs,ZcplAhHpmcVWm,MAhOS,MHpmOS,         & 
& MVWmOS,MRPAhToHpmcVWm,MRGAhToHpmcVWm)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_MSSMBpV_AhToHpmcVWm(MLambda,em,gs,cplAhHpmcVWm,MAh,MHpm,              & 
& MVWm,MRPAhToHpmcVWm,MRGAhToHpmcVWm)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_MSSMBpV_AhToHpmcVWm(MLambda,em,gs,ZcplAhHpmcVWm,MAh,MHpm,             & 
& MVWm,MRPAhToHpmcVWm,MRGAhToHpmcVWm)
...
!Self-energy Corrections 
Call Amplitude_WAVE_MSSMBpV_AhToHpmcVWm(cplAhHpmcVWm,ctcplAhHpmcVWm,MAh,              & 
& MAh2,MHpm,MHpm2,MVWm,MVWm2,ZfAh,ZfHpm,ZfVWm,AmpWaveAhToHpmcVWm)



!Vertex Corrections 
Call Amplitude_VERTEX_MSSMBpV_AhToHpmcVWm(MAh,MCha,MChi,MFd,MFe,MFu,Mhh,              & 
& MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,Mhh2,MHpm2,          & 
& MSd2,MSe2,MSu2,MSv2,MVP2,MVWm2,MVZ2,cplAhAhhh,cplcChaChaAhL,cplcChaChaAhR,             & 
& cplChiChiAhL,cplChiChiAhR,cplcFdFdAhL,cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,             & 
& cplcFuFuAhL,cplcFuFuAhR,cplcgWmgWmAh,cplcgWpCgWpCAh,cplAhhhVZ,cplAhHpmcHpm,            & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_MSSMBpV_AhToHpmcVWm(MAh,MCha,MChi,MFd,MFe,MFu,               & 
& Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,Mhh2,            & 
& MHpm2,MSd2,MSe2,MSu2,MSv2,MVP2,MVWm2,MVZ2,cplAhAhhh,cplcChaChaAhL,cplcChaChaAhR,       & 
& cplChiChiAhL,cplChiChiAhR,cplcFdFdAhL,cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,             & 
& cplcFuFuAhL,cplcFuFuAhR,cplcgWmgWmAh,cplcgWpCgWpCAh,cplAhhhVZ,cplAhHpmcHpm,            & 
...
& cplHpmcHpmcVWmVWm1,AmpVertexIRdrAhToHpmcVWm)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_MSSMBpV_AhToHpmcVWm(MAhOS,MChaOS,MChiOS,MFdOS,               & 
& MFeOS,MFuOS,MhhOS,MHpmOS,MSdOS,MSeOS,MSuOS,MSvOS,MVP,MVWmOS,MVZOS,MAh2OS,              & 
& MCha2OS,MChi2OS,MFd2OS,MFe2OS,MFu2OS,Mhh2OS,MHpm2OS,MSd2OS,MSe2OS,MSu2OS,              & 
& MSv2OS,MVP2,MVWm2OS,MVZ2OS,cplAhAhhh,cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,         & 
& cplChiChiAhR,cplcFdFdAhL,cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,              & 
...
& cplhhHpmcVWm,cplhhcVWmVWm,cplHpmSucSd,cplHpmSvcSe,cplHpmcHpmVP,GosZcplHpmcVWmVP,       & 
& cplHpmcHpmVZ,cplHpmcVWmVZ,cplSdcSucVWm,cplSecSvcVWm,cplcVWmVPVWm,cplcVWmVWmVZ,         & 
& cplAhAhcVWmVWm1,cplAhHpmcVWmVP1,cplAhHpmcVWmVZ1,cplhhHpmcVWmVZ1,cplHpmcHpmcVWmVWm1,    & 
...
& cplcFvFecVWmR,cplcFdFuHpmL,cplcFdFuHpmR,cplcFeFvHpmL,cplcFeFvHpmR,cplcgWmgAHpm,        & 
& cplcgAgWmcVWm,cplcgZgWmcVWm,cplcgZgWpCHpm,cplcgWmgZHpm,cplcgWpCgZcVWm,cplhhHpmcHpm,    & 
& cplhhHpmcVWm,cplhhcVWmVWm,cplHpmSucSd,cplHpmSvcSe,cplHpmcHpmVP,GcplHpmcVWmVP,          & 
& cplHpmcHpmVZ,cplHpmcVWmVZ,cplSdcSucVWm,cplSecSvcVWm,cplcVWmVPVWm,cplcVWmVWmVZ,         & 
& cplAhAhcVWmVWm1,cplAhHpmcVWmVP1,cplAhHpmcVWmVZ1,cplhhHpmcVWmVZ1,cplHpmcHpmcVWmVWm1,    & 
& AmpVertexIRosAhToHpmcVWm)
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_MSSMBpV_AhTocSdSd(cplAhSdcSd,MAh,MSd,MAh2,MSd2,AmpTreeAhTocSdSd)

  Else 
Call Amplitude_Tree_MSSMBpV_AhTocSdSd(ZcplAhSdcSd,MAh,MSd,MAh2,MSd2,AmpTreeAhTocSdSd)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_MSSMBpV_AhTocSdSd(MLambda,em,gs,cplAhSdcSd,MAhOS,MSdOS,               & 
& MRPAhTocSdSd,MRGAhTocSdSd)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_MSSMBpV_AhTocSdSd(MLambda,em,gs,ZcplAhSdcSd,MAhOS,MSdOS,              & 
& MRPAhTocSdSd,MRGAhTocSdSd)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_MSSMBpV_AhTocSdSd(MLambda,em,gs,cplAhSdcSd,MAh,MSd,MRPAhTocSdSd,      & 
& MRGAhTocSdSd)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_MSSMBpV_AhTocSdSd(MLambda,em,gs,ZcplAhSdcSd,MAh,MSd,MRPAhTocSdSd,     & 
& MRGAhTocSdSd)
...
!Self-energy Corrections 
Call Amplitude_WAVE_MSSMBpV_AhTocSdSd(cplAhSdcSd,ctcplAhSdcSd,MAh,MAh2,               & 
& MSd,MSd2,ZfAh,ZfSd,AmpWaveAhTocSdSd)



!Vertex Corrections 
Call Amplitude_VERTEX_MSSMBpV_AhTocSdSd(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,               & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_MSSMBpV_AhTocSdSd(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,            & 
& MHpm,MSd,MSe,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,               & 
& MHpm2,MSd2,MSe2,MSu2,MVG2,MVP2,MVWm2,MVZ2,cplAhAhhh,cplcChaChaAhL,cplcChaChaAhR,       & 
& cplChiChiAhL,cplChiChiAhR,cplcFdFdAhL,cplcFdFdAhR,cplcFuFuAhL,cplcFuFuAhR,             & 
& cplAhhhVZ,cplAhHpmcHpm,cplAhHpmcVWm,cplAhSdcSd,cplAhSecSe,cplAhSucSu,cplAhcHpmVWm,     & 
...
& AmpVertexIRdrAhTocSdSd)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_MSSMBpV_AhTocSdSd(MAhOS,MChaOS,MChiOS,MFdOS,MFuOS,           & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_MSSMBpV_AhTocSeSe(cplAhSecSe,MAh,MSe,MAh2,MSe2,AmpTreeAhTocSeSe)

  Else 
Call Amplitude_Tree_MSSMBpV_AhTocSeSe(ZcplAhSecSe,MAh,MSe,MAh2,MSe2,AmpTreeAhTocSeSe)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_MSSMBpV_AhTocSeSe(MLambda,em,gs,cplAhSecSe,MAhOS,MSeOS,               & 
& MRPAhTocSeSe,MRGAhTocSeSe)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_MSSMBpV_AhTocSeSe(MLambda,em,gs,ZcplAhSecSe,MAhOS,MSeOS,              & 
& MRPAhTocSeSe,MRGAhTocSeSe)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_MSSMBpV_AhTocSeSe(MLambda,em,gs,cplAhSecSe,MAh,MSe,MRPAhTocSeSe,      & 
& MRGAhTocSeSe)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_MSSMBpV_AhTocSeSe(MLambda,em,gs,ZcplAhSecSe,MAh,MSe,MRPAhTocSeSe,     & 
& MRGAhTocSeSe)
...
!Self-energy Corrections 
Call Amplitude_WAVE_MSSMBpV_AhTocSeSe(cplAhSecSe,ctcplAhSecSe,MAh,MAh2,               & 
& MSe,MSe2,ZfAh,ZfSe,AmpWaveAhTocSeSe)



!Vertex Corrections 
Call Amplitude_VERTEX_MSSMBpV_AhTocSeSe(MAh,MCha,MChi,MFe,Mhh,MHpm,MSd,               & 
...
& cplSdSecSdcSeaa,cplSeSecSecSe1,cplSeSucSecSuaa,AmpVertexAhTocSeSe)

If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_MSSMBpV_AhTocSeSe(MAh,MCha,MChi,MFe,Mhh,MHpm,MSd,            & 
& MSe,MSu,MSv,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFe2,Mhh2,MHpm2,MSd2,MSe2,MSu2,              & 
& MSv2,MVP2,MVWm2,MVZ2,cplAhAhhh,cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,               & 
& cplChiChiAhR,cplcFeFeAhL,cplcFeFeAhR,cplAhhhVZ,cplAhHpmcHpm,cplAhHpmcVWm,              & 
& cplAhSdcSd,cplAhSecSe,cplAhSucSu,cplAhcHpmVWm,cplChaFvcSeL,cplChaFvcSeR,               & 
...
& cplSecSeVP,cplSecSeVZ,cplcChacFvSeL,cplcChacFvSeR,cplSecHpmcSv,cplSecSvcVWm,           & 
& cplSvcSeVWm,cplAhAhSecSe1,cplAhHpmSvcSe1,cplAhSecHpmcSv1,cplHpmSecHpmcSe1,             & 
& cplSdSecSdcSeaa,cplSeSecSecSe1,cplSeSucSecSuaa,AmpVertexIRdrAhTocSeSe)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_MSSMBpV_AhTocSeSe(MAhOS,MChaOS,MChiOS,MFeOS,MhhOS,           & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_MSSMBpV_AhTocSuSu(cplAhSucSu,MAh,MSu,MAh2,MSu2,AmpTreeAhTocSuSu)

  Else 
Call Amplitude_Tree_MSSMBpV_AhTocSuSu(ZcplAhSucSu,MAh,MSu,MAh2,MSu2,AmpTreeAhTocSuSu)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_MSSMBpV_AhTocSuSu(MLambda,em,gs,cplAhSucSu,MAhOS,MSuOS,               & 
& MRPAhTocSuSu,MRGAhTocSuSu)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_MSSMBpV_AhTocSuSu(MLambda,em,gs,ZcplAhSucSu,MAhOS,MSuOS,              & 
& MRPAhTocSuSu,MRGAhTocSuSu)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_MSSMBpV_AhTocSuSu(MLambda,em,gs,cplAhSucSu,MAh,MSu,MRPAhTocSuSu,      & 
& MRGAhTocSuSu)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_MSSMBpV_AhTocSuSu(MLambda,em,gs,ZcplAhSucSu,MAh,MSu,MRPAhTocSuSu,     & 
& MRGAhTocSuSu)
...
!Self-energy Corrections 
Call Amplitude_WAVE_MSSMBpV_AhTocSuSu(cplAhSucSu,ctcplAhSucSu,MAh,MAh2,               & 
& MSu,MSu2,ZfAh,ZfSu,AmpWaveAhTocSuSu)



!Vertex Corrections 
Call Amplitude_VERTEX_MSSMBpV_AhTocSuSu(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,               & 
& MHpm,MSd,MSe,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,               & 
& MHpm2,MSd2,MSe2,MSu2,MVG2,MVP2,MVWm2,MVZ2,cplAhAhhh,cplcChaChaAhL,cplcChaChaAhR,       & 
& cplChiChiAhL,cplChiChiAhR,cplcFdFdAhL,cplcFdFdAhR,cplcFuFuAhL,cplcFuFuAhR,             & 
& cplAhhhVZ,cplAhHpmcHpm,cplAhHpmcVWm,cplAhSdcSd,cplAhSecSe,cplAhSucSu,cplAhcHpmVWm,     & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_MSSMBpV_AhTocSuSu(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,            & 
& MHpm,MSd,MSe,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,               & 
& MHpm2,MSd2,MSe2,MSu2,MVG2,MVP2,MVWm2,MVZ2,cplAhAhhh,cplcChaChaAhL,cplcChaChaAhR,       & 
& cplChiChiAhL,cplChiChiAhR,cplcFdFdAhL,cplcFdFdAhR,cplcFuFuAhL,cplcFuFuAhR,             & 
& cplAhhhVZ,cplAhHpmcHpm,cplAhHpmcVWm,cplAhSdcSd,cplAhSecSe,cplAhSucSu,cplAhcHpmVWm,     & 
...
& cplAhSdcHpmcSuaa,cplAhcSdcSdcSuepsTensorct2ct3ct4,cplHpmSucHpmcSuaa,cplSdSucSdcSuabba, & 
& cplSdSucSdcSuabab,cplSdSucSdcSusumj113epsTensorct1ct2j1epsTensorct3ct4j1,              & 
& cplSeSucSecSuaa,cplSuSucSucSuabba,cplSuSucSucSuabab,AmpVertexIRdrAhTocSuSu)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_MSSMBpV_AhTocSuSu(MAhOS,MChaOS,MChiOS,MFdOS,MFuOS,           & 
& MGluOS,MhhOS,MHpmOS,MSdOS,MSeOS,MSuOS,MVG,MVP,MVWmOS,MVZOS,MAh2OS,MCha2OS,             & 
& MChi2OS,MFd2OS,MFu2OS,MGlu2OS,Mhh2OS,MHpm2OS,MSd2OS,MSe2OS,MSu2OS,MVG2,MVP2,           & 
& MVWm2OS,MVZ2OS,cplAhAhhh,cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,        & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFuFuAhL,cplcFuFuAhR,cplAhhhVZ,cplAhHpmcHpm,cplAhHpmcVWm,   & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_MSSMBpV_AhToAhAh(MAhOS,MChaOS,MChiOS,MFdOS,MFeOS,               & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_MSSMBpV_AhToAhAh(MAh,MCha,MChi,MFd,MFe,MFu,MHpm,MSd,            & 
& MSe,MSu,MVWm,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,MHpm2,MSd2,MSe2,MSu2,MVWm2,               & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_MSSMBpV_AhToAhVP(MAhOS,MChaOS,MFdOS,MFeOS,MFuOS,MHpmOS,         & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_MSSMBpV_AhToAhVP(MAh,MCha,MFd,MFe,MFu,MHpm,MSd,MSe,             & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_MSSMBpV_AhToAhVZ(MAhOS,MChaOS,MChiOS,MFdOS,MFeOS,               & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_MSSMBpV_AhToAhVZ(MAh,MCha,MChi,MFd,MFe,MFu,MHpm,MSd,            & 
& MSe,MSu,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,MHpm2,MSd2,MSe2,MSu2,MVWm2,           & 
& MVZ2,cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,cplcFdFdAhL,cplcFdFdAhR,    & 
& cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplcgWmgWmAh,cplcgWpCgWpCAh,           & 
& cplAhHpmcHpm,cplAhHpmcVWm,cplAhSdcSd,cplAhSecSe,cplAhSucSu,cplAhcHpmVWm,               & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_MSSMBpV_AhToFvcFv(MAhOS,MChaOS,MChiOS,MFeOS,MHpmOS,             & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_MSSMBpV_AhToFvcFv(MAh,MCha,MChi,MFe,MHpm,MSe,MSv,               & 
& MVWm,MAh2,MCha2,MChi2,MFe2,MHpm2,MSe2,MSv2,MVWm2,cplcChaChaAhL,cplcChaChaAhR,          & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_MSSMBpV_AhToGluGlu(MAhOS,MFdOS,MFuOS,MGluOS,MSdOS,              & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_MSSMBpV_AhToGluGlu(MAh,MFd,MFu,MGlu,MSd,MSu,MAh2,               & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_MSSMBpV_AhTohhhh(MAhOS,MChaOS,MChiOS,MFdOS,MFeOS,               & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_MSSMBpV_AhTohhhh(MAh,MCha,MChi,MFd,MFe,MFu,Mhh,MHpm,            & 
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_MSSMBpV_AhTohhVP(cplAhhhVZ,ctcplAhhhVZ,MAhOS,MAh2OS,              & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_MSSMBpV_AhTohhVP(MAhOS,MChaOS,MFdOS,MFeOS,MFuOS,MhhOS,          & 
...
!Self-energy Corrections 
Call Amplitude_WAVE_MSSMBpV_AhTohhVP(cplAhhhVZ,ctcplAhhhVZ,MAh,MAh2,Mhh,              & 
& Mhh2,MVP,MVP2,MVZ,MVZ2,ZfAh,Zfhh,ZfVP,ZfVZVP,AmpWaveAhTohhVP)



!Vertex Corrections 
Call Amplitude_VERTEX_MSSMBpV_AhTohhVP(MAh,MCha,MFd,MFe,MFu,Mhh,MHpm,MSd,             & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_MSSMBpV_AhToSvcSv(MAhOS,MChaOS,MChiOS,MFeOS,MhhOS,              & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_MSSMBpV_AhToSvcSv(MAh,MCha,MChi,MFe,Mhh,MHpm,MSd,               & 
& MSe,MSu,MSv,MVWm,MVZ,MAh2,MCha2,MChi2,MFe2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSv2,             & 
& MVWm2,MVZ2,cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,cplcFeFeAhL,          & 
...
& cplSdSvcSdcSvaa,cplSeSvcSecSv1,cplSuSvcSucSvaa,AmpVertexAhToSvcSv)
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_MSSMBpV_AhToVGVG(MAhOS,MFdOS,MFuOS,MSdOS,MSuOS,MVG,             & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_MSSMBpV_AhToVGVG(MAh,MFd,MFu,MSd,MSu,MVG,MAh2,MFd2,             & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_MSSMBpV_AhToVPVP(MAhOS,MChaOS,MFdOS,MFeOS,MFuOS,MHpmOS,         & 
& MSdOS,MSeOS,MSuOS,MVP,MVWmOS,MAh2OS,MCha2OS,MFd2OS,MFe2OS,MFu2OS,MHpm2OS,              & 
& MSd2OS,MSe2OS,MSu2OS,MVP2,MVWm2OS,cplcChaChaAhL,cplcChaChaAhR,cplcFdFdAhL,             & 
& cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplcgWmgWmAh,              & 
& cplcgWpCgWpCAh,cplAhHpmcHpm,cplAhHpmcVWm,cplAhSdcSd,cplAhSecSe,cplAhSucSu,             & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_MSSMBpV_AhToVPVP(MAh,MCha,MFd,MFe,MFu,MHpm,MSd,MSe,             & 
& MSu,MVP,MVWm,MAh2,MCha2,MFd2,MFe2,MFu2,MHpm2,MSd2,MSe2,MSu2,MVP2,MVWm2,cplcChaChaAhL,  & 
& cplcChaChaAhR,cplcFdFdAhL,cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,             & 
& cplcFuFuAhR,cplcgWmgWmAh,cplcgWpCgWpCAh,cplAhHpmcHpm,cplAhHpmcVWm,cplAhSdcSd,          & 
& cplAhSecSe,cplAhSucSu,cplAhcHpmVWm,cplcChaChaVPL,cplcChaChaVPR,cplcFdFdVPL,            & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_MSSMBpV_AhToVPVZ(MAhOS,MChaOS,MFdOS,MFeOS,MFuOS,MHpmOS,         & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_MSSMBpV_AhToVPVZ(MAh,MCha,MFd,MFe,MFu,MHpm,MSd,MSe,             & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_MSSMBpV_AhToVWmcVWm(MAhOS,MChaOS,MChiOS,MFdOS,MFeOS,            & 
...
& cplcFdFdAhL,cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,               & 
& cplcgWmgWmAh,cplcgWpCgWpCAh,cplAhhhVZ,cplAhHpmcHpm,cplAhHpmcVWm,cplAhSdcSd,            & 
& cplAhSecSe,cplAhSucSu,cplAhcHpmVWm,cplChiChacVWmL,cplChiChacVWmR,cplcChaChiVWmL,       & 
& cplcChaChiVWmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFvFecVWmL,cplcFvFecVWmR,cplcFdFuVWmL,   & 
...
& cplhhcHpmVWm,cplhhcVWmVWm,cplHpmcVWmVP,cplHpmcVWmVZ,cplSdcSucVWm,cplSecSvcVWm,         & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_MSSMBpV_AhToVWmcVWm(MAh,MCha,MChi,MFd,MFe,MFu,Mhh,              & 
& MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,Mhh2,MHpm2,          & 
& MSd2,MSe2,MSu2,MSv2,MVP2,MVWm2,MVZ2,cplAhAhhh,cplcChaChaAhL,cplcChaChaAhR,             & 
& cplChiChiAhL,cplChiChiAhR,cplcFdFdAhL,cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,             & 
& cplcFuFuAhL,cplcFuFuAhR,cplcgWmgWmAh,cplcgWpCgWpCAh,cplAhhhVZ,cplAhHpmcHpm,            & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_MSSMBpV_AhToVZVZ(MAhOS,MChaOS,MChiOS,MFdOS,MFeOS,               & 
& MFuOS,MHpmOS,MSdOS,MSeOS,MSuOS,MVWmOS,MVZOS,MAh2OS,MCha2OS,MChi2OS,MFd2OS,             & 
& MFe2OS,MFu2OS,MHpm2OS,MSd2OS,MSe2OS,MSu2OS,MVWm2OS,MVZ2OS,cplcChaChaAhL,               & 
& cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,cplcFdFdAhL,cplcFdFdAhR,cplcFeFeAhL,           & 
& cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplcgWmgWmAh,cplcgWpCgWpCAh,cplAhHpmcHpm,          & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_MSSMBpV_AhToVZVZ(MAh,MCha,MChi,MFd,MFe,MFu,MHpm,MSd,            & 
& MSe,MSu,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,MHpm2,MSd2,MSe2,MSu2,MVWm2,           & 
& MVZ2,cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,cplcFdFdAhL,cplcFdFdAhR,    & 
& cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplcgWmgWmAh,cplcgWpCgWpCAh,           & 
& cplAhHpmcHpm,cplAhHpmcVWm,cplAhSdcSd,cplAhSecSe,cplAhSucSu,cplAhcHpmVWm,               & 
...
& cplcFeFeVZL,cplcFeFeVZR,cplcFuFuVZL,cplcFuFuVZR,cplcgWmgWmVZ,cplcgWpCgWpCVZ,           & 
& cplHpmcHpmVZ,cplHpmcVWmVZ,cplSdcSdVZ,cplSecSeVZ,cplSucSuVZ,cplcHpmVWmVZ,               & 
& cplcVWmVWmVZ,cplAhHpmcVWmVZ1,cplAhcHpmVWmVZ1,cplHpmcHpmVZVZ1,cplSdcSdVZVZaa,           & 
& cplSecSeVZVZ1,cplSucSuVZVZaa,AmpVertexAhToVZVZ)
...
End Module Wrapper_OneLoopDecay_Ah_MSSMBpV
