...
Module Wrapper_OneLoopDecay_Glu_MSSMBpV
Use Model_Data_MSSMBpV 
Use Kinematics 
Use OneLoopDecay_Glu_MSSMBpV 
Use Control 
Use Settings 
...
& cplGluFucSuR(3,6),cplGluGluVGL,cplGluGluVGR,cplhhSdcSd(2,6,6),cplhhSucSu(2,6,6),       & 
...
& ZcplChiFdcSdR(4,3,6),ZcplChiFucSuL(4,3,6),ZcplChiFucSuR(4,3,6),ZcplGluFdcSdL(3,6),     & 
& ZcplGluFdcSdR(3,6),ZcplGluFucSuL(3,6),ZcplGluFucSuR(3,6),ZcplGluGluVGL,ZcplGluGluVGR,  & 
& ZcplhhSdcSd(2,6,6),ZcplhhSucSu(2,6,6),ZcplSdcSdVG(6,6),ZcplSdcSdVP(6,6),               & 
...
Complex(dp) :: AmpTreeGluToChiVG(4,4),AmpWaveGluToChiVG(4,4)=(0._dp,0._dp),AmpVertexGluToChiVG(4,4)& 
...
Complex(dp) :: AmpTreeGluToGluAh(2,2),AmpWaveGluToGluAh(2,2)=(0._dp,0._dp),AmpVertexGluToGluAh(2,2)& 
...
Complex(dp) :: AmpTreeGluToGluhh(2,2),AmpWaveGluToGluhh(2,2)=(0._dp,0._dp),AmpVertexGluToGluhh(2,2)& 
...
Call Amplitude_Tree_MSSMBpV_GluToFdcSd(cplGluFdcSdL,cplGluFdcSdR,MFd,MGlu,            & 
& MSd,MFd2,MGlu2,MSd2,AmpTreeGluToFdcSd)

  Else 
Call Amplitude_Tree_MSSMBpV_GluToFdcSd(ZcplGluFdcSdL,ZcplGluFdcSdR,MFd,               & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_MSSMBpV_GluToFdcSd(MLambda,em,gs,cplGluFdcSdL,cplGluFdcSdR,           & 
& MFdOS,MGluOS,MSdOS,MRPGluToFdcSd,MRGGluToFdcSd)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_MSSMBpV_GluToFdcSd(MLambda,em,gs,ZcplGluFdcSdL,ZcplGluFdcSdR,         & 
& MFdOS,MGluOS,MSdOS,MRPGluToFdcSd,MRGGluToFdcSd)
...
Call Amplitude_WAVE_MSSMBpV_GluToFdcSd(cplGluFdcSdL,cplGluFdcSdR,ctcplGluFdcSdL,      & 
& ctcplGluFdcSdR,MFd,MFd2,MGlu,MGlu2,MSd,MSd2,ZfFDL,ZfFDR,ZffG,ZfSd,AmpWaveGluToFdcSd)



!Vertex Corrections 
Call Amplitude_VERTEX_MSSMBpV_GluToFdcSd(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,              & 
...
& cplcFdcFucSdL,cplcFdcFucSdR,cplcSdcSdcSu,AmpVertexGluToFdcSd)

If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_MSSMBpV_GluToFdcSd(MAh,MCha,MChi,MFd,MFu,MGlu,               & 
...
& cplSucSdVWm,cplcFdcFucSdL,cplcFdcFucSdR,cplcSdcSdcSu,AmpVertexIRdrGluToFdcSd)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_MSSMBpV_GluToFdcSd(MAhOS,MChaOS,MChiOS,MFdOS,MFuOS,          & 
...
& cplcSdcSdcSu,AmpVertexIRosGluToFdcSd)
...
& MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdAhL,cplcFdFdAhR,cplAhSdcSd,               & 
& cplChaFucSdL,cplChaFucSdR,cplChiFdcSdL,cplChiFdcSdR,cplFdFdSuL,cplFdFdSuR,             & 
& cplFdFuSdL,cplFdFuSdR,ZcplGluFdcSdL,ZcplGluFdcSdR,cplcFdFdhhL,cplcFdFdhhR,             & 
& cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,               & 
& cplcChaFdcSuL,cplcChaFdcSuR,cplcFuFdcHpmL,cplcFuFdcHpmR,cplcFuFdcVWmL,cplcFuFdcVWmR,   & 
& cplGluFucSuL,cplGluFucSuR,cplGluGluVGL,cplGluGluVGR,cplcFdGluSdL,cplcFdGluSdR,         & 
& cplcFuGluSuL,cplcFuGluSuR,cplhhSdcSd,cplHpmSucSd,cplSdcSdVG,cplSdcSdVP,cplSdcSdVZ,     & 
& cplSucSdVWm,cplcFdcFucSdL,cplcFdcFucSdR,cplcSdcSdcSu,AmpVertexIRosGluToFdcSd)
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_MSSMBpV_GluToFucSu(cplGluFucSuL,cplGluFucSuR,MFu,MGlu,            & 
& MSu,MFu2,MGlu2,MSu2,AmpTreeGluToFucSu)

  Else 
Call Amplitude_Tree_MSSMBpV_GluToFucSu(ZcplGluFucSuL,ZcplGluFucSuR,MFu,               & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_MSSMBpV_GluToFucSu(MLambda,em,gs,cplGluFucSuL,cplGluFucSuR,           & 
& MFuOS,MGluOS,MSuOS,MRPGluToFucSu,MRGGluToFucSu)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_MSSMBpV_GluToFucSu(MLambda,em,gs,ZcplGluFucSuL,ZcplGluFucSuR,         & 
& MFuOS,MGluOS,MSuOS,MRPGluToFucSu,MRGGluToFucSu)
...
!Self-energy Corrections 
Call Amplitude_WAVE_MSSMBpV_GluToFucSu(cplGluFucSuL,cplGluFucSuR,ctcplGluFucSuL,      & 
& ctcplGluFucSuR,MFu,MFu2,MGlu,MGlu2,MSu,MSu2,ZffG,ZfFUL,ZfFUR,ZfSu,AmpWaveGluToFucSu)



!Vertex Corrections 
Call Amplitude_VERTEX_MSSMBpV_GluToFucSu(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,              & 
& MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,MHpm2,             & 
...
& cplcFdcFdcSuR,cplcSdcSdcSu,AmpVertexGluToFucSu)

If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_MSSMBpV_GluToFucSu(MAh,MCha,MChi,MFd,MFu,MGlu,               & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,               & 
...
& cplcFdcFdcSuR,cplcSdcSdcSu,AmpVertexIRdrGluToFucSu)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_MSSMBpV_GluToFucSu(MAhOS,MChaOS,MChiOS,MFdOS,MFuOS,          & 
& MGluOS,MhhOS,MHpmOS,MSdOS,MSuOS,MVG,MVP,MVWmOS,MVZOS,MAh2OS,MCha2OS,MChi2OS,           & 
& MFd2OS,MFu2OS,MGlu2OS,Mhh2OS,MHpm2OS,MSd2OS,MSu2OS,MVG2,MVP2,MVWm2OS,MVZ2OS,           & 
...
& MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,cplcFuFuAhL,cplcFuFuAhR,cplAhSucSu,               & 
& cplChaFucSdL,cplChaFucSdR,cplChiFucSuL,cplChiFucSuR,cplFdFuSdL,cplFdFuSdR,             & 
& cplGluFdcSdL,cplGluFdcSdR,cplcChaFdcSuL,cplcChaFdcSuR,ZcplGluFucSuL,ZcplGluFucSuR,     & 
& cplcFuFuhhL,cplcFuFuhhR,cplcFdFuHpmL,cplcFdFuHpmR,cplcFuFuVGL,cplcFuFuVGR,             & 
& cplcFuFuVPL,cplcFuFuVPR,cplcFdFuVWmL,cplcFdFuVWmR,cplcFuFuVZL,cplcFuFuVZR,             & 
& cplGluGluVGL,cplGluGluVGR,cplcFdGluSdL,cplcFdGluSdR,cplcFuGluSuL,cplcFuGluSuR,         & 
& cplhhSucSu,cplSdcHpmcSu,cplSdcSucVWm,cplSucSuVG,cplSucSuVP,cplSucSuVZ,cplcFdcFdcSuL,   & 
& cplcFdcFdcSuR,cplcSdcSdcSu,AmpVertexIRosGluToFucSu)
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_MSSMBpV_GluToChiVG(MChiOS,MFdOS,MFuOS,MGluOS,MSdOS,             & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_MSSMBpV_GluToChiVG(MChi,MFd,MFu,MGlu,MSd,MSu,MVG,               & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_MSSMBpV_GluToGluAh(MAhOS,MFdOS,MFuOS,MGluOS,MSdOS,              & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_MSSMBpV_GluToGluAh(MAh,MFd,MFu,MGlu,MSd,MSu,MAh2,               & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_MSSMBpV_GluToGluhh(MFdOS,MFuOS,MGluOS,MhhOS,MSdOS,              & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_MSSMBpV_GluToGluhh(MFd,MFu,MGlu,Mhh,MSd,MSu,MFd2,               & 
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_MSSMBpV_GluToGluVG(ZcplGluGluVGL,ZcplGluGluVGR,ctcplGluGluVGL,    & 
& ctcplGluGluVGR,MGluOS,MGlu2OS,MVG,MVG2,ZffG,ZfVG,AmpWaveGluToGluVG)

 Else 
Call Amplitude_WAVE_MSSMBpV_GluToGluVG(cplGluGluVGL,cplGluGluVGR,ctcplGluGluVGL,      & 
& ctcplGluGluVGR,MGluOS,MGlu2OS,MVG,MVG2,ZffG,ZfVG,AmpWaveGluToGluVG)
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_MSSMBpV_GluToGluVG(MFdOS,MFuOS,MGluOS,MSdOS,MSuOS,              & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_MSSMBpV_GluToGluVG(MFd,MFu,MGlu,MSd,MSu,MVG,MFd2,               & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_MSSMBpV_GluToGluVP(MFdOS,MFuOS,MGluOS,MSdOS,MSuOS,              & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_MSSMBpV_GluToGluVP(MFd,MFu,MGlu,MSd,MSu,MVP,MFd2,               & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_MSSMBpV_GluToGluVZ(MFdOS,MFuOS,MGluOS,MSdOS,MSuOS,              & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_MSSMBpV_GluToGluVZ(MFd,MFu,MGlu,MSd,MSu,MVZ,MFd2,               & 
...
End Module Wrapper_OneLoopDecay_Glu_MSSMBpV
