...
! ------------------------------------------------------------------------------  
! File created at 12:41 on 25.1.2018   
! ----------------------------------------------------------------------  
 
 
Module Su3Decays_MSSMBpV 
...
& gSuAhFuGlu,gSuAhcFdcFd,gSuSuChiChi,gSucHpmChiFd,gSuhhChiFu,gSuChiGluSu,gSuSdChicCha,   & 
& gSucSdChicFd,gSucSdFdFu,gSuFdFvcSe,gSuhhFdcCha,gSuSuFdcFd,gSuFdSvcFe,gSucHpmChaFu,     & 
& gSuFuFecSe,gSuFuFucSu,gSuFuFvcSv,gSucChaFuHpm,gSuSdFucFd,gSuFuSecFe,gSuSuFucFu,        & 
& gSuFuSvcFv,gSucHpmFdGlu,gSuhhFuGlu,gSuGluGluSu,gSuGluSdcCha,gSucSdGlucFd,              & 
& gSuhhcFdcFd,gSuSdFvcFe,gSuSuChacCha,gSuSuFecFe,gSuSuFvcFv,gSucChacFdcSu,               & 
& gSucSdcChacFu,gSucHpmcFdcFu,epsI,deltaM,CheckRealStates,gT,gPartial,BR)
...
& cplcChaChiVWmR(2,4),cplcChaFdcSuL(2,3,6),cplcChaFdcSuR(2,3,6),cplcFdcFdcSuL(3,3,6),    & 
...
& cplcSdcSdcSu(6,6,6),cplFdFdSuL(3,3,6),cplFdFdSuR(3,3,6),cplFdFuSdL(3,3,6),             & 
& cplFdFuSdR(3,3,6),cplGluFdcSdL(3,6),cplGluFdcSdR(3,6),cplGluFucSuL(3,6),               & 
& cplGluFucSuR(3,6),cplhhSucSu(2,6,6),cplSdcHpmcSu(6,2,6),cplSdcSucVWm(6,6),             & 
& cplSucSuVZ(6,6)
...
Real(dp),Intent(inout) :: gSuAhChiFu(6,2,4,3),gSuAhFdcCha(6,2,3,2),gSuAhFuGlu(6,2,3,1),gSuAhcFdcFd(6,2,3,3),    & 
& gSuSuChiChi(6,6,4,4),gSucHpmChiFd(6,2,4,3),gSuhhChiFu(6,2,4,3),gSuChiGluSu(6,4,1,6),   & 
& gSuSdChicCha(6,6,4,2),gSucSdChicFd(6,6,4,3),gSucSdFdFu(6,6,3,3),gSuFdFvcSe(6,3,3,6),   & 
& gSuhhFdcCha(6,2,3,2),gSuSuFdcFd(6,6,3,3),gSuFdSvcFe(6,3,3,3),gSucHpmChaFu(6,2,2,3),    & 
& gSuFuFecSe(6,3,3,6),gSuFuFucSu(6,3,3,6),gSuFuFvcSv(6,3,3,3),gSucChaFuHpm(6,2,3,2),     & 
& gSuSdFucFd(6,6,3,3),gSuFuSecFe(6,3,6,3),gSuSuFucFu(6,6,3,3),gSuFuSvcFv(6,3,3,3),       & 
& gSucHpmFdGlu(6,2,3,1),gSuhhFuGlu(6,2,3,1),gSuGluGluSu(6,1,1,6),gSuGluSdcCha(6,1,6,2),  & 
& gSucSdGlucFd(6,6,1,3),gSuhhcFdcFd(6,2,3,3),gSuSdFvcFe(6,6,3,3),gSuSuChacCha(6,6,2,2),  & 
& gSuSuFecFe(6,6,3,3),gSuSuFvcFv(6,6,3,3),gSucChacFdcSu(6,2,3,6),gSucSdcChacFu(6,6,2,3), & 
& gSucHpmcFdcFu(6,2,3,3)

Real(dp) :: gSuAhChiFui(2,4,3),gSuAhFdcChai(2,3,2),gSuAhFuGlui(2,3,1),gSuAhcFdcFdi(2,3,3),        & 
& gSuSuChiChii(6,4,4),gSucHpmChiFdi(2,4,3),gSuhhChiFui(2,4,3),gSuChiGluSui(4,1,6),       & 
& gSuSdChicChai(6,4,2),gSucSdChicFdi(6,4,3),gSucSdFdFui(6,3,3),gSuFdFvcSei(3,3,6),       & 
& gSuhhFdcChai(2,3,2),gSuSuFdcFdi(6,3,3),gSuFdSvcFei(3,3,3),gSucHpmChaFui(2,2,3),        & 
& gSuFuFecSei(3,3,6),gSuFuFucSui(3,3,6),gSuFuFvcSvi(3,3,3),gSucChaFuHpmi(2,3,2),         & 
& gSuSdFucFdi(6,3,3),gSuFuSecFei(3,6,3),gSuSuFucFui(6,3,3),gSuFuSvcFvi(3,3,3),           & 
& gSucHpmFdGlui(2,3,1),gSuhhFuGlui(2,3,1),gSuGluGluSui(1,1,6),gSuGluSdcChai(1,6,2),      & 
& gSucSdGlucFdi(6,1,3),gSuhhcFdcFdi(2,3,3),gSuSdFvcFei(6,3,3),gSuSuChacChai(6,2,2),      & 
& gSuSuFecFei(6,3,3),gSuSuFvcFvi(6,3,3),gSucChacFdcSui(2,3,6),gSucSdcChacFui(6,2,3),     & 
& gSucHpmcFdcFui(2,3,3)
...
& ZE,ZEL,ZER,ZH,ZN,ZP,ZU,ZUL,ZUR,ZV,ZW,ZZ,alphaH,betaH,g1,g2,g3,Yd,Ye,L3,Yu,             & 
& Mu,Td,Te,T3,Tu,Bmu,mq2,ml2,mHd2,mHu2,md2,mu2,me2,M1,M2,M3,vd,vu,cplAhSucSu,            & 
...
& cplcChaChiVWmR,cplcChaFdcSuL,cplcChaFdcSuR,cplcFdcFdcSuL,cplcFdcFdcSuR,cplcFdcFucSdL,  & 
...
& cplcFeFehhR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFvHpmL,cplcFeFvHpmR,cplcFeFvVWmL,            & 
...
& cplChiFvcSvR,cplcSdcSdcSu,cplFdFdSuL,cplFdFdSuR,cplFdFuSdL,cplFdFuSdR,cplGluFdcSdL,    & 
...
gSucSdFdFui = 0._dp 
Call SuTocSdFdFu(i_run,MSd,MFd,MFu,MCha,MChi,MGlu,MSu,cplcSdcSdcSu,cplcChaFdcSuL,     & 
...
& cplGluFucSuR,deltaM,epsI,check,gSucSdFdFui)
...
& cplcChaFdcSuL,cplcChaFdcSuR,cplcFdcFdcSuL,cplcFdcFdcSuR,cplcFdChaSuL,cplcFdChaSuR,     & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,               & 
& cplFdFdSuL,cplFdFdSuR,deltaM,epsI,check,gSuSuFdcFdi)
...
& cplSdcSucVWm,cplcFdcFdcSuL,cplcFdcFdcSuR,cplcFdChiSdL,cplcFdChiSdR,cplcFdFuHpmL,       & 
& cplcFdFuHpmR,cplcFdFuVWmL,cplcFdFuVWmR,cplcFdGluSdL,cplcFdGluSdR,cplChiFucSuL,         & 
& cplChiFucSuR,cplFdFuSdL,cplFdFuSdR,cplGluFucSuL,cplGluFucSuR,deltaM,epsI,              & 
& check,gSuSdFucFdi)
...
Subroutine SuTocSdFdFu(iIN,MSd,MFd,MFu,MCha,MChi,MGlu,MSu,cplcSdcSdcSu,               & 
& cplcChaFdcSuL,cplcChaFdcSuR,cplChaFucSdL,cplChaFucSdR,cplChiFdcSdL,cplChiFdcSdR,       & 
& cplChiFucSuL,cplChiFucSuR,cplFdFuSdL,cplFdFuSdR,cplGluFdcSdL,cplGluFdcSdR,             & 
& cplGluFucSuL,cplGluFucSuR,deltaM,epsI,check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MSd(6),MFd(3),MFu(3),MCha(2),MChi(4),MGlu,MSu(6)

Complex(dp),Intent(in) :: cplcSdcSdcSu(6,6,6),cplcChaFdcSuL(2,3,6),cplcChaFdcSuR(2,3,6),cplChaFucSdL(2,3,6),    & 
& cplChaFucSdR(2,3,6),cplChiFdcSdL(4,3,6),cplChiFdcSdR(4,3,6),cplChiFucSuL(4,3,6),       & 
& cplChiFucSuR(4,3,6),cplFdFuSdL(3,3,6),cplFdFuSdR(3,3,6),cplGluFdcSdL(3,6),             & 
...
& cplcFdFdVZR,cplFdFdSuL,cplFdFdSuR,deltaM,epsI,check,g,WriteContributions)
...
& cplcFdFdhhR(3,3,2),cplcFdFdVZL(3,3),cplcFdFdVZR(3,3),cplFdFdSuL(3,3,6),cplFdFdSuR(3,3,6)
...
Complex(dp),Intent(in) :: cplSdcHpmcSu(6,2,6),cplSdcSucVWm(6,6),cplcFdcFdcSuL(3,3,6),cplcFdcFdcSuR(3,3,6),      & 
& cplcFdChiSdL(3,4,6),cplcFdChiSdR(3,4,6),cplcFdFuHpmL(3,3,2),cplcFdFuHpmR(3,3,2),       & 
& cplcFdFuVWmL(3,3),cplcFdFuVWmR(3,3),cplcFdGluSdL(3,6),cplcFdGluSdR(3,6),               & 
& cplChiFucSuL(4,3,6),cplChiFucSuR(4,3,6),cplFdFuSdL(3,3,6),cplFdFuSdR(3,3,6),           & 
