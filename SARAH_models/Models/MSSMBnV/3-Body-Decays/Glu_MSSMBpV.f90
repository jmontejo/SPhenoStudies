...
& gGluFdFuFd,gGluFdcFucCha,gGluFucFuChi,epsI,deltaM,CheckRealStates,gT,gPartial,BR)
...
Real(dp),Intent(inout) :: gGluFdcFdChi(1,3,3,4),gGluFdFuFd(1,3,3,3),gGluFdcFucCha(1,3,3,2),gGluFucFuChi(1,3,3,4)

Real(dp),Intent(in) :: gTSd(6),gTSu(6)

Real(dp) :: gGluFdcFdChii(3,3,4),gGluFdFuFdi(3,3,3),gGluFdcFucChai(3,3,2),gGluFucFuChii(3,3,4)
...
& ZER,ZH,ZN,ZP,ZU,ZUL,ZUR,ZV,ZW,ZZ,alphaH,betaH,g1,g2,g3,Yd,Ye,L3,Yu,Mu,Td,              & 
& Te,T3,Tu,Bmu,mq2,ml2,mHd2,mHu2,md2,mu2,me2,M1,M2,M3,vd,vu,cplcChacFuSdL,               & 
