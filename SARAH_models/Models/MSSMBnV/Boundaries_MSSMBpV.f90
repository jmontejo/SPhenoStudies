...
Call GToParameters111(gA,g1,g2,g3,Yd,Ye,L3,Yu)
...
Call ParametersToG111(g1,g2,g3,Yd,Ye,L3,Yu,gB)
...
& ZP,ZU,ZUL,ZUR,ZV,ZW,ZZ,alphaH,betaH,vd,vu,g1,g2,g3,Yd,Ye,L3,Yu,Mu,Td,Te,               & 
& T3,Tu,Bmu,mq2,ml2,mHd2,mHu2,md2,mu2,me2,M1,M2,M3,delta0,gMZ,kont)
...
& cplcVWmcVWmVWmVWm2,cplcVWmcVWmVWmVWm3,cplHpmcHpmVPVZ(2,2),cplSdcSdVPVZ(6,6),           & 
...
Call SetMatchingConditions(g1SM,g2SM,g3SM,YuSM,YdSM,YeSM,vSM,vd,vu,g1,g2,             & 
& g3,Yd,Ye,L3,Yu,Mu,Td,Te,T3,Tu,Bmu,mq2,ml2,mHd2,mHu2,md2,mu2,me2,M1,M2,M3,.True.)
...
& Yd,ZDL,ZDR,Yu,ZU,ZD,g3,ZUL,ZUR,pG,L3,cplcUFeFeAhL,cplcUFeFeAhR,cplcUFeChaSvL,          & 
...
& cplcUFdFuVWmR,cplcUFdGluSdL,cplcUFdGluSdR,cplcUFdcFdcSuL,cplcUFdcFdcSuR,               & 
& cplcUFdcFucSdL,cplcUFdcFucSdR,cplcUFuFuAhL,cplcUFuFuAhR,cplcUFuChiSuL,cplcUFuChiSuR,   & 
...
& cplcUFuFuVZR,cplcUFuGluSuL,cplcUFuGluSuR,cplcChacUFuSdL,cplcChacUFuSdR,cplcFdcUFucSdL, & 
& cplcFdcUFucSdR)
...
& cplcChacUFuSdR,cplcFdcUFucSdL,cplcFdcUFucSdR,sigR_u,sigL_u,sigSL_u,sigSR_u)
...
Call ParametersToG111(g1,g2,g3,Yd,Ye,L3,Yu,gMZ)
...
& mHd2,mHu2,md2,mu2,me2,M1,M2,M3,mGut,kont,WriteComment,niter)

Implicit None
Logical,Intent(in) :: WriteComment
Integer,Intent(inout) :: kont
Integer,Intent(in) :: niter
Real(dp) :: delta0,deltaG0, gA(321), gB(111)
Real(dp) :: gC(323),  gD(323) 
...
& mq2,ml2,mHd2,mHu2,md2,mu2,me2,M1,M2,M3,delta0,gB,kont)
...
Call odeint(gC,323,tz,0._dp,0.1_dp*delta0,dt,0._dp,rge323,kont)
...
Call ParametersToG323(g1,g2,g3,Yd,Ye,L3,Yu,Mu,Td,Te,T3,Tu,Bmu,mq2,ml2,mHd2,           & 
& mHu2,md2,mu2,me2,M1,M2,M3,vd,vu,gD)

tz=Log(mZ/Q)
dt=-tz/50._dp
Call odeint(gD,323,tz,0._dp,0.1_dp*delta0,dt,0._dp,rge323,kont)
Call GToParameters323(gD,g1,g2,g3,Yd,Ye,L3,Yu,Mu,Td,Te,T3,Tu,Bmu,mq2,ml2,             & 
& mHd2,mHu2,md2,mu2,me2,M1,M2,M3,vd,vu)
...
Real(dp),Intent(in)::delta0
Integer :: i1, i2, i3, i4 
Real(dp),Intent(inout)::g1A(111)
Real(dp),Intent(out)::g1C(321),mGUT
Real(dp)::tz,dt,t_out 
Real(dp)::mudim,gGUT,gA_h(111),g1b(111),m_hi,m_lo
Real(dp)::g1S(111)
...
dt=tz/100._dp
Call odeint(g1A,111,tz,0._dp,delta0,dt,0._dp,rge111,kont)
...
Call odeint(g1B,111,tz,0._dp,delta0,dt,0._dp,rge111,kont)
...
Call odeintB2(g1B,111,tz,0._dp,delta0,dt,0._dp,rge111,checkGUT111,t_out,kont)
...
dt=tz/100._dp
Call odeint(g1c,321,0._dp,tz,delta0,dt,0._dp,rge321,kont)
Iname=Iname-1
...
Subroutine checkGUT111(y,eps,unified,greater)  
Implicit None 
Real(dp), Intent(in) :: y(111), eps 
Logical, Intent(out) :: unified, greater 
Call GToParameters111(y,g1,g2,g3,Yd,Ye,L3,Yu)
...
Complex(dp),Intent(out) :: Yd(3,3),Ye(3,3),L3(3,3,3),Yu(3,3),Mu,Td(3,3),Te(3,3),T3(3,3,3),Tu(3,3),               & 
& Bmu,mq2(3,3),ml2(3,3),md2(3,3),mu2(3,3),me2(3,3),M1,M2,M3
...
Real(dp):: gA(111), gB(321), Scale_Save 
...
Call ParametersToG111(g1,g2,g3,Yd,Ye,L3,Yu,gA)
