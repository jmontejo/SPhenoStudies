...
! ------------------------------------------------------------------------------  
! File created at 12:38 on 25.1.2018   
! ----------------------------------------------------------------------  
 
 
Module TreeLevelMasses_MSSMBpV 
...
Complex(dp) :: MGluC 
Iname = Iname + 1 
NameOfUnit(Iname) = 'TreeMassesMSSM-RpV/BnV'
...
& vd,vu,g1,g2,g3,Yd,Ye,L3,Yu,Mu,Td,Te,T3,Tu,Bmu,mq2,ml2,mHd2,mHu2,md2,mu2,               & 
& me2,M1,M2,M3,kont)
...
& TW,ZDL,ZDR,ZEL,ZER,ZUL,ZUR,ZW,ZZ,vd,vu,g1,g2,g3,Yd,Ye,L3,Yu,Mu,Td,Te,T3,               & 
...
End Module TreeLevelMasses_MSSMBpV 
