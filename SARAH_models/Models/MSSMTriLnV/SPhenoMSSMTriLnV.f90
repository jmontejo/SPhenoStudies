...
! ------------------------------------------------------------------------------  
! File created at 10:20 on 20.4.2021   
! ----------------------------------------------------------------------  
...
& cplcVWmVWmVZVZ2,cplcVWmVWmVZVZ3,cplFeFucSdL(3,3,6),cplFeFucSdR(3,3,6),cplFvChacSeL(3,2,6),& 
& cplFvChacSeR(3,2,6),cplFvFdcSdL(3,3,6),cplFvFdcSdR(3,3,6),cplFvFecHpmL(3,3,2)

Complex(dp) :: cplFvFecHpmR(3,3,2),cplFvFecSeL(3,3,6),cplFvFecSeR(3,3,6),cplFvFecVWmL(3,3),           & 
...
& cplSdcSdVPVZ(6,6),cplSdcSdVZ(6,6),cplSdcSdVZVZ(6,6),cplSdcSecSu(6,6,6),cplSdcSucVWm(6,6),& 
& cplSdSvcSd(6,3,6),cplSecHpmcSv(6,2,3),cplSecSecSv(6,6,3),cplSecSecVWmVWm(6,6),         & 
& cplSecSeVP(6,6),cplSecSeVPVZ(6,6),cplSecSeVZ(6,6),cplSecSeVZVZ(6,6),cplSecSvcVWm(6,3), & 
& cplSeSucSd(6,6,6),cplSeSvcSe(6,3,6),cplSucSdVWm(6,6),cplSucSucVWmVWm(6,6),             & 
& cplSucSuVG(6,6),cplSucSuVP(6,6),cplSucSuVPVZ(6,6),cplSucSuVZ(6,6),cplSucSuVZVZ(6,6),   & 
& cplSvcSeVWm(3,6),cplSvcSvcVWmVWm(3,3),cplSvcSvVZ(3,3),cplSvcSvVZVZ(3,3),cplVGVGVG
