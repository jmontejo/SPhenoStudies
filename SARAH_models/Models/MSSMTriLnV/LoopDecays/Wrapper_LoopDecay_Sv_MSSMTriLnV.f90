...
! ------------------------------------------------------------------------------  
! File created at 10:09 on 20.4.2021   
! ----------------------------------------------------------------------  
...
Complex(dp) :: AmpTreeSvTocFdFd(2,3,3,3),AmpWaveSvTocFdFd(2,3,3,3)=(0._dp,0._dp),AmpVertexSvTocFdFd(2,3,3,3)& 
...
Complex(dp) :: AmpTreeSvTocFeFe(2,3,3,3),AmpWaveSvTocFeFe(2,3,3,3)=(0._dp,0._dp),AmpVertexSvTocFeFe(2,3,3,3)& 
...
Complex(dp) :: AmpTreeSvTocSdSd(3,6,6),AmpWaveSvTocSdSd(3,6,6)=(0._dp,0._dp),AmpVertexSvTocSdSd(3,6,6)& 
...
Complex(dp) :: AmpTreeSvTocSeSe(3,6,6),AmpWaveSvTocSeSe(3,6,6)=(0._dp,0._dp),AmpVertexSvTocSeSe(3,6,6)& 
...
Complex(dp) :: AmpTreeSvToAhAh(3,2,2),AmpWaveSvToAhAh(3,2,2)=(0._dp,0._dp),AmpVertexSvToAhAh(3,2,2)& 
...
Complex(dp) :: AmpTreeSvToAhhh(3,2,2),AmpWaveSvToAhhh(3,2,2)=(0._dp,0._dp),AmpVertexSvToAhhh(3,2,2)& 
...
Complex(dp) :: AmpTreeSvToAhVP(2,3,2),AmpWaveSvToAhVP(2,3,2)=(0._dp,0._dp),AmpVertexSvToAhVP(2,3,2)& 
...
Complex(dp) :: AmpTreeSvToAhVZ(2,3,2),AmpWaveSvToAhVZ(2,3,2)=(0._dp,0._dp),AmpVertexSvToAhVZ(2,3,2)& 
...
Complex(dp) :: AmpTreeSvToChacCha(2,3,2,2),AmpWaveSvToChacCha(2,3,2,2)=(0._dp,0._dp),AmpVertexSvToChacCha(2,3,2,2)& 
...
Complex(dp) :: AmpTreeSvToChiChi(2,3,4,4),AmpWaveSvToChiChi(2,3,4,4)=(0._dp,0._dp),AmpVertexSvToChiChi(2,3,4,4)& 
...
Complex(dp) :: AmpTreeSvToFucFu(2,3,3,3),AmpWaveSvToFucFu(2,3,3,3)=(0._dp,0._dp),AmpVertexSvToFucFu(2,3,3,3)& 
...
Complex(dp) :: AmpTreeSvToFvFv(2,3,3,3),AmpWaveSvToFvFv(2,3,3,3)=(0._dp,0._dp),AmpVertexSvToFvFv(2,3,3,3)& 
...
Complex(dp) :: AmpTreeSvToGluGlu(2,3),AmpWaveSvToGluGlu(2,3)=(0._dp,0._dp),AmpVertexSvToGluGlu(2,3)& 
...
Complex(dp) :: AmpTreeSvTohhhh(3,2,2),AmpWaveSvTohhhh(3,2,2)=(0._dp,0._dp),AmpVertexSvTohhhh(3,2,2)& 
...
Complex(dp) :: AmpTreeSvTohhVP(2,3,2),AmpWaveSvTohhVP(2,3,2)=(0._dp,0._dp),AmpVertexSvTohhVP(2,3,2)& 
...
Complex(dp) :: AmpTreeSvTohhVZ(2,3,2),AmpWaveSvTohhVZ(2,3,2)=(0._dp,0._dp),AmpVertexSvTohhVZ(2,3,2)& 
...
Complex(dp) :: AmpTreeSvToHpmcHpm(3,2,2),AmpWaveSvToHpmcHpm(3,2,2)=(0._dp,0._dp),AmpVertexSvToHpmcHpm(3,2,2)& 
...
Complex(dp) :: AmpTreeSvToHpmcVWm(2,3,2),AmpWaveSvToHpmcVWm(2,3,2)=(0._dp,0._dp),AmpVertexSvToHpmcVWm(2,3,2)& 
...
Complex(dp) :: AmpTreeSvToSucSu(3,6,6),AmpWaveSvToSucSu(3,6,6)=(0._dp,0._dp),AmpVertexSvToSucSu(3,6,6)& 
...
Complex(dp) :: AmpTreeSvToSvSv(3,3,3),AmpWaveSvToSvSv(3,3,3)=(0._dp,0._dp),AmpVertexSvToSvSv(3,3,3)& 
...
Complex(dp) :: AmpTreeSvToSvcSv(3,3,3),AmpWaveSvToSvcSv(3,3,3)=(0._dp,0._dp),AmpVertexSvToSvcSv(3,3,3)& 
...
Complex(dp) :: AmpTreeSvToVGVG(2,3),AmpWaveSvToVGVG(2,3)=(0._dp,0._dp),AmpVertexSvToVGVG(2,3)& 
...
Complex(dp) :: AmpTreeSvToVPVP(2,3),AmpWaveSvToVPVP(2,3)=(0._dp,0._dp),AmpVertexSvToVPVP(2,3)& 
...
Complex(dp) :: AmpTreeSvToVPVZ(2,3),AmpWaveSvToVPVZ(2,3)=(0._dp,0._dp),AmpVertexSvToVPVZ(2,3)& 
...
Complex(dp) :: AmpTreeSvToVWmcVWm(2,3),AmpWaveSvToVWmcVWm(2,3)=(0._dp,0._dp),AmpVertexSvToVWmcVWm(2,3)& 
...
Complex(dp) :: AmpTreeSvToVZVZ(2,3),AmpWaveSvToVZVZ(2,3)=(0._dp,0._dp),AmpVertexSvToVZVZ(2,3)& 
...
If (OSkinematics) Then 
  AmpSum2SvTocFdFd = AmpTreeSvTocFdFd
  Call SquareAmp_StoFF(MSvOS(gt1),MFdOS(gt2),MFdOS(gt3),AmpSumSvTocFdFd(:,gt1, gt2, gt3),AmpSum2SvTocFdFd(:,gt1, gt2, gt3),AmpSqSvTocFdFd(gt1, gt2, gt3)) 
  AmpSqTreeSvTocFdFd(gt1, gt2, gt3) = AmpSqSvTocFdFd(gt1, gt2, gt3)  
...
Else 
If (OSkinematics) Then 
  gP1LSv(gt1,i4) = 3._dp*GammaTPS(MSvOS(gt1),MFdOS(gt2),MFdOS(gt3),helfactor*AmpSqSvTocFdFd(gt1, gt2, gt3))
Else 
  gP1LSv(gt1,i4) = 3._dp*GammaTPS(MSv(gt1),MFd(gt2),MFd(gt3),helfactor*AmpSqSvTocFdFd(gt1, gt2, gt3))
End if 
...
If ((Abs(MRPSvTocFdFd(gt1, gt2, gt3)).gt.1.0E-20_dp).or.(Abs(MRGSvTocFdFd(gt1, gt2, gt3)).gt.1.0E-20_dp)) Then 
 If (.not.OnlyTreeLevelContributions) Then 
   If (DebugLoopDecays) Write(*,*) "real", phasespacefactor*0.5_dp*helfactor*(MRPSvTocFdFd(gt1, gt2, gt3) + MRGSvTocFdFd(gt1, gt2, gt3)) 
  gP1LSv(gt1,i4) = gP1LSv(gt1,i4) + phasespacefactor*0.5_dp*helfactor*(MRPSvTocFdFd(gt1, gt2, gt3) + MRGSvTocFdFd(gt1, gt2, gt3))
   If (DebugLoopDecays) Write(*,*) "sum",  gP1LSv(gt1,i4) 
  End if 
End if 
End if 
...
If (OSkinematics) Then 
  AmpSum2SvTocFeFe = AmpTreeSvTocFeFe
  Call SquareAmp_StoFF(MSvOS(gt1),MFeOS(gt2),MFeOS(gt3),AmpSumSvTocFeFe(:,gt1, gt2, gt3),AmpSum2SvTocFeFe(:,gt1, gt2, gt3),AmpSqSvTocFeFe(gt1, gt2, gt3)) 
  AmpSqTreeSvTocFeFe(gt1, gt2, gt3) = AmpSqSvTocFeFe(gt1, gt2, gt3)  
...
Else 
If (OSkinematics) Then 
  gP1LSv(gt1,i4) = 1._dp*GammaTPS(MSvOS(gt1),MFeOS(gt2),MFeOS(gt3),helfactor*AmpSqSvTocFeFe(gt1, gt2, gt3))
Else 
  gP1LSv(gt1,i4) = 1._dp*GammaTPS(MSv(gt1),MFe(gt2),MFe(gt3),helfactor*AmpSqSvTocFeFe(gt1, gt2, gt3))
End if 
...
If ((Abs(MRPSvTocFeFe(gt1, gt2, gt3)).gt.1.0E-20_dp).or.(Abs(MRGSvTocFeFe(gt1, gt2, gt3)).gt.1.0E-20_dp)) Then 
 If (.not.OnlyTreeLevelContributions) Then 
   If (DebugLoopDecays) Write(*,*) "real", phasespacefactor*0.5_dp*helfactor*(MRPSvTocFeFe(gt1, gt2, gt3) + MRGSvTocFeFe(gt1, gt2, gt3)) 
  gP1LSv(gt1,i4) = gP1LSv(gt1,i4) + phasespacefactor*0.5_dp*helfactor*(MRPSvTocFeFe(gt1, gt2, gt3) + MRGSvTocFeFe(gt1, gt2, gt3))
   If (DebugLoopDecays) Write(*,*) "sum",  gP1LSv(gt1,i4) 
  End if 
End if 
End if 
...
If (OSkinematics) Then 
  AmpSum2SvTocSdSd = AmpTreeSvTocSdSd
  Call SquareAmp_StoSS(MSvOS(gt1),MSdOS(gt2),MSdOS(gt3),AmpSumSvTocSdSd(gt1, gt2, gt3),AmpSum2SvTocSdSd(gt1, gt2, gt3),AmpSqSvTocSdSd(gt1, gt2, gt3)) 
  AmpSqTreeSvTocSdSd(gt1, gt2, gt3) = AmpSqSvTocSdSd(gt1, gt2, gt3)  
...
Else 
If (OSkinematics) Then 
  gP1LSv(gt1,i4) = 3._dp*GammaTPS(MSvOS(gt1),MSdOS(gt2),MSdOS(gt3),helfactor*AmpSqSvTocSdSd(gt1, gt2, gt3))
Else 
  gP1LSv(gt1,i4) = 3._dp*GammaTPS(MSv(gt1),MSd(gt2),MSd(gt3),helfactor*AmpSqSvTocSdSd(gt1, gt2, gt3))
End if 
...
If ((Abs(MRPSvTocSdSd(gt1, gt2, gt3)).gt.1.0E-20_dp).or.(Abs(MRGSvTocSdSd(gt1, gt2, gt3)).gt.1.0E-20_dp)) Then 
 If (.not.OnlyTreeLevelContributions) Then 
   If (DebugLoopDecays) Write(*,*) "real", phasespacefactor*0.5_dp*helfactor*(MRPSvTocSdSd(gt1, gt2, gt3) + MRGSvTocSdSd(gt1, gt2, gt3)) 
  gP1LSv(gt1,i4) = gP1LSv(gt1,i4) + phasespacefactor*0.5_dp*helfactor*(MRPSvTocSdSd(gt1, gt2, gt3) + MRGSvTocSdSd(gt1, gt2, gt3))
   If (DebugLoopDecays) Write(*,*) "sum",  gP1LSv(gt1,i4) 
  End if 
End if 
End if 
...
If (OSkinematics) Then 
  AmpSum2SvTocSeSe = AmpTreeSvTocSeSe
  Call SquareAmp_StoSS(MSvOS(gt1),MSeOS(gt2),MSeOS(gt3),AmpSumSvTocSeSe(gt1, gt2, gt3),AmpSum2SvTocSeSe(gt1, gt2, gt3),AmpSqSvTocSeSe(gt1, gt2, gt3)) 
  AmpSqTreeSvTocSeSe(gt1, gt2, gt3) = AmpSqSvTocSeSe(gt1, gt2, gt3)  
...
Else 
If (OSkinematics) Then 
  gP1LSv(gt1,i4) = 1._dp*GammaTPS(MSvOS(gt1),MSeOS(gt2),MSeOS(gt3),helfactor*AmpSqSvTocSeSe(gt1, gt2, gt3))
Else 
  gP1LSv(gt1,i4) = 1._dp*GammaTPS(MSv(gt1),MSe(gt2),MSe(gt3),helfactor*AmpSqSvTocSeSe(gt1, gt2, gt3))
End if 
...
If ((Abs(MRPSvTocSeSe(gt1, gt2, gt3)).gt.1.0E-20_dp).or.(Abs(MRGSvTocSeSe(gt1, gt2, gt3)).gt.1.0E-20_dp)) Then 
 If (.not.OnlyTreeLevelContributions) Then 
   If (DebugLoopDecays) Write(*,*) "real", phasespacefactor*0.5_dp*helfactor*(MRPSvTocSeSe(gt1, gt2, gt3) + MRGSvTocSeSe(gt1, gt2, gt3)) 
  gP1LSv(gt1,i4) = gP1LSv(gt1,i4) + phasespacefactor*0.5_dp*helfactor*(MRPSvTocSeSe(gt1, gt2, gt3) + MRGSvTocSeSe(gt1, gt2, gt3))
   If (DebugLoopDecays) Write(*,*) "sum",  gP1LSv(gt1,i4) 
  End if 
End if 
End if 
...
Else 
If (OSkinematics) Then 
  gP1LSv(gt1,i4) = 1._dp*GammaTPS(MSvOS(gt1),MAhOS(gt2),MhhOS(gt3),helfactor*AmpSqSvToAhhh(gt1, gt2, gt3))
Else 
  gP1LSv(gt1,i4) = 1._dp*GammaTPS(MSv(gt1),MAh(gt2),Mhh(gt3),helfactor*AmpSqSvToAhhh(gt1, gt2, gt3))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LSv(gt1,i4) = 1._dp*GammaTPS(MSvOS(gt1),MAhOS(gt2),0._dp,helfactor*AmpSqSvToAhVP(gt1, gt2))
Else 
  gP1LSv(gt1,i4) = 1._dp*GammaTPS(MSv(gt1),MAh(gt2),MVP,helfactor*AmpSqSvToAhVP(gt1, gt2))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LSv(gt1,i4) = 1._dp*GammaTPS(MSvOS(gt1),MAhOS(gt2),MVZOS,helfactor*AmpSqSvToAhVZ(gt1, gt2))
Else 
  gP1LSv(gt1,i4) = 1._dp*GammaTPS(MSv(gt1),MAh(gt2),MVZ,helfactor*AmpSqSvToAhVZ(gt1, gt2))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LSv(gt1,i4) = 1._dp*GammaTPS(MSvOS(gt1),MChaOS(gt2),MChaOS(gt3),helfactor*AmpSqSvToChacCha(gt1, gt2, gt3))
Else 
  gP1LSv(gt1,i4) = 1._dp*GammaTPS(MSv(gt1),MCha(gt2),MCha(gt3),helfactor*AmpSqSvToChacCha(gt1, gt2, gt3))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LSv(gt1,i4) = 3._dp*GammaTPS(MSvOS(gt1),MFuOS(gt2),MFuOS(gt3),helfactor*AmpSqSvToFucFu(gt1, gt2, gt3))
Else 
  gP1LSv(gt1,i4) = 3._dp*GammaTPS(MSv(gt1),MFu(gt2),MFu(gt3),helfactor*AmpSqSvToFucFu(gt1, gt2, gt3))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LSv(gt1,i4) = 4._dp*GammaTPS(MSvOS(gt1),MGluOS,MGluOS,helfactor*AmpSqSvToGluGlu(gt1))
Else 
  gP1LSv(gt1,i4) = 4._dp*GammaTPS(MSv(gt1),MGlu,MGlu,helfactor*AmpSqSvToGluGlu(gt1))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LSv(gt1,i4) = 1._dp*GammaTPS(MSvOS(gt1),MhhOS(gt2),0._dp,helfactor*AmpSqSvTohhVP(gt1, gt2))
Else 
  gP1LSv(gt1,i4) = 1._dp*GammaTPS(MSv(gt1),Mhh(gt2),MVP,helfactor*AmpSqSvTohhVP(gt1, gt2))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LSv(gt1,i4) = 1._dp*GammaTPS(MSvOS(gt1),MhhOS(gt2),MVZOS,helfactor*AmpSqSvTohhVZ(gt1, gt2))
Else 
  gP1LSv(gt1,i4) = 1._dp*GammaTPS(MSv(gt1),Mhh(gt2),MVZ,helfactor*AmpSqSvTohhVZ(gt1, gt2))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LSv(gt1,i4) = 1._dp*GammaTPS(MSvOS(gt1),MHpmOS(gt2),MHpmOS(gt3),helfactor*AmpSqSvToHpmcHpm(gt1, gt2, gt3))
Else 
  gP1LSv(gt1,i4) = 1._dp*GammaTPS(MSv(gt1),MHpm(gt2),MHpm(gt3),helfactor*AmpSqSvToHpmcHpm(gt1, gt2, gt3))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LSv(gt1,i4) = 1._dp*GammaTPS(MSvOS(gt1),MHpmOS(gt2),MVWmOS,helfactor*AmpSqSvToHpmcVWm(gt1, gt2))
Else 
  gP1LSv(gt1,i4) = 1._dp*GammaTPS(MSv(gt1),MHpm(gt2),MVWm,helfactor*AmpSqSvToHpmcVWm(gt1, gt2))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LSv(gt1,i4) = 3._dp*GammaTPS(MSvOS(gt1),MSuOS(gt2),MSuOS(gt3),helfactor*AmpSqSvToSucSu(gt1, gt2, gt3))
Else 
  gP1LSv(gt1,i4) = 3._dp*GammaTPS(MSv(gt1),MSu(gt2),MSu(gt3),helfactor*AmpSqSvToSucSu(gt1, gt2, gt3))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LSv(gt1,i4) = 1._dp/2._dp*GammaTPS(MSvOS(gt1),MSvOS(gt2),MSvOS(gt3),helfactor*AmpSqSvToSvSv(gt1, gt2, gt3))
Else 
  gP1LSv(gt1,i4) = 1._dp/2._dp*GammaTPS(MSv(gt1),MSv(gt2),MSv(gt3),helfactor*AmpSqSvToSvSv(gt1, gt2, gt3))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LSv(gt1,i4) = 1._dp*GammaTPS(MSvOS(gt1),MSvOS(gt2),MSvOS(gt3),helfactor*AmpSqSvToSvcSv(gt1, gt2, gt3))
Else 
  gP1LSv(gt1,i4) = 1._dp*GammaTPS(MSv(gt1),MSv(gt2),MSv(gt3),helfactor*AmpSqSvToSvcSv(gt1, gt2, gt3))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LSv(gt1,i4) = 8._dp*GammaTPS(MSvOS(gt1),0._dp,0._dp,helfactor*AmpSqSvToVGVG(gt1))
Else 
  gP1LSv(gt1,i4) = 8._dp*GammaTPS(MSv(gt1),MVG,MVG,helfactor*AmpSqSvToVGVG(gt1))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LSv(gt1,i4) = 1._dp*GammaTPS(MSvOS(gt1),0._dp,0._dp,helfactor*AmpSqSvToVPVP(gt1))
Else 
  gP1LSv(gt1,i4) = 1._dp*GammaTPS(MSv(gt1),MVP,MVP,helfactor*AmpSqSvToVPVP(gt1))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LSv(gt1,i4) = 2._dp*GammaTPS(MSvOS(gt1),0._dp,MVZOS,helfactor*AmpSqSvToVPVZ(gt1))
Else 
  gP1LSv(gt1,i4) = 2._dp*GammaTPS(MSv(gt1),MVP,MVZ,helfactor*AmpSqSvToVPVZ(gt1))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LSv(gt1,i4) = 2._dp*GammaTPS(MSvOS(gt1),MVWmOS,MVWmOS,helfactor*AmpSqSvToVWmcVWm(gt1))
Else 
  gP1LSv(gt1,i4) = 2._dp*GammaTPS(MSv(gt1),MVWm,MVWm,helfactor*AmpSqSvToVWmcVWm(gt1))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LSv(gt1,i4) = 1._dp*GammaTPS(MSvOS(gt1),MVZOS,MVZOS,helfactor*AmpSqSvToVZVZ(gt1))
Else 
  gP1LSv(gt1,i4) = 1._dp*GammaTPS(MSv(gt1),MVZ,MVZ,helfactor*AmpSqSvToVZVZ(gt1))
End if 
