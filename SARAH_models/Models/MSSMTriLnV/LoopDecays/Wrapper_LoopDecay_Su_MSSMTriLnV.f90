...
Complex(dp) :: AmpTreeSuTocFeFd(2,6,3,3),AmpWaveSuTocFeFd(2,6,3,3)=(0._dp,0._dp),AmpVertexSuTocFeFd(2,6,3,3)& 
...
Complex(dp) :: AmpTreeSuTocSeSd(6,6,6),AmpWaveSuTocSeSd(6,6,6)=(0._dp,0._dp),AmpVertexSuTocSeSd(6,6,6)& 
...
Complex(dp) :: AmpTreeSuToFuFv(2,6,3,3),AmpWaveSuToFuFv(2,6,3,3)=(0._dp,0._dp),AmpVertexSuToFuFv(2,6,3,3)& 
...
Complex(dp) :: AmpTreeSuToSuSv(6,6,3),AmpWaveSuToSuSv(6,6,3)=(0._dp,0._dp),AmpVertexSuToSuSv(6,6,3)& 
...
Complex(dp) :: AmpTreeSuToSucSv(6,6,3),AmpWaveSuToSucSv(6,6,3)=(0._dp,0._dp),AmpVertexSuToSucSv(6,6,3)& 
...
If (OSkinematics) Then 
  AmpSum2SuTocFeFd = AmpTreeSuTocFeFd
  Call SquareAmp_StoFF(MSuOS(gt1),MFeOS(gt2),MFdOS(gt3),AmpSumSuTocFeFd(:,gt1, gt2, gt3),AmpSum2SuTocFeFd(:,gt1, gt2, gt3),AmpSqSuTocFeFd(gt1, gt2, gt3)) 
  AmpSqTreeSuTocFeFd(gt1, gt2, gt3) = AmpSqSuTocFeFd(gt1, gt2, gt3)  
...
Else 
If (OSkinematics) Then 
  gP1LSu(gt1,i4) = 1._dp*GammaTPS(MSuOS(gt1),MFeOS(gt2),MFdOS(gt3),helfactor*AmpSqSuTocFeFd(gt1, gt2, gt3))
Else 
  gP1LSu(gt1,i4) = 1._dp*GammaTPS(MSu(gt1),MFe(gt2),MFd(gt3),helfactor*AmpSqSuTocFeFd(gt1, gt2, gt3))
End if 
...
If ((Abs(MRPSuTocFeFd(gt1, gt2, gt3)).gt.1.0E-20_dp).or.(Abs(MRGSuTocFeFd(gt1, gt2, gt3)).gt.1.0E-20_dp)) Then 
 If (.not.OnlyTreeLevelContributions) Then 
   If (DebugLoopDecays) Write(*,*) "real", phasespacefactor*0.5_dp*helfactor*(MRPSuTocFeFd(gt1, gt2, gt3) + MRGSuTocFeFd(gt1, gt2, gt3)) 
  gP1LSu(gt1,i4) = gP1LSu(gt1,i4) + phasespacefactor*0.5_dp*helfactor*(MRPSuTocFeFd(gt1, gt2, gt3) + MRGSuTocFeFd(gt1, gt2, gt3))
   If (DebugLoopDecays) Write(*,*) "sum",  gP1LSu(gt1,i4) 
  End if 
End if 
End if 
...
If (OSkinematics) Then 
  AmpSum2SuTocSeSd = AmpTreeSuTocSeSd
  Call SquareAmp_StoSS(MSuOS(gt1),MSeOS(gt2),MSdOS(gt3),AmpSumSuTocSeSd(gt1, gt2, gt3),AmpSum2SuTocSeSd(gt1, gt2, gt3),AmpSqSuTocSeSd(gt1, gt2, gt3)) 
  AmpSqTreeSuTocSeSd(gt1, gt2, gt3) = AmpSqSuTocSeSd(gt1, gt2, gt3)  
...
Else 
If (OSkinematics) Then 
  gP1LSu(gt1,i4) = 1._dp*GammaTPS(MSuOS(gt1),MSeOS(gt2),MSdOS(gt3),helfactor*AmpSqSuTocSeSd(gt1, gt2, gt3))
Else 
  gP1LSu(gt1,i4) = 1._dp*GammaTPS(MSu(gt1),MSe(gt2),MSd(gt3),helfactor*AmpSqSuTocSeSd(gt1, gt2, gt3))
End if 
...
If ((Abs(MRPSuTocSeSd(gt1, gt2, gt3)).gt.1.0E-20_dp).or.(Abs(MRGSuTocSeSd(gt1, gt2, gt3)).gt.1.0E-20_dp)) Then 
 If (.not.OnlyTreeLevelContributions) Then 
   If (DebugLoopDecays) Write(*,*) "real", phasespacefactor*0.5_dp*helfactor*(MRPSuTocSeSd(gt1, gt2, gt3) + MRGSuTocSeSd(gt1, gt2, gt3)) 
  gP1LSu(gt1,i4) = gP1LSu(gt1,i4) + phasespacefactor*0.5_dp*helfactor*(MRPSuTocSeSd(gt1, gt2, gt3) + MRGSuTocSeSd(gt1, gt2, gt3))
   If (DebugLoopDecays) Write(*,*) "sum",  gP1LSu(gt1,i4) 
  End if 
End if 
End if 
...
Else 
If (OSkinematics) Then 
  gP1LSu(gt1,i4) = 1._dp*GammaTPS(MSuOS(gt1),MFuOS(gt2),0._dp,helfactor*AmpSqSuToFuFv(gt1, gt2, gt3))
Else 
  gP1LSu(gt1,i4) = 1._dp*GammaTPS(MSu(gt1),MFu(gt2),0._dp,helfactor*AmpSqSuToFuFv(gt1, gt2, gt3))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LSu(gt1,i4) = 1._dp*GammaTPS(MSuOS(gt1),MSuOS(gt2),MSvOS(gt3),helfactor*AmpSqSuToSuSv(gt1, gt2, gt3))
Else 
  gP1LSu(gt1,i4) = 1._dp*GammaTPS(MSu(gt1),MSu(gt2),MSv(gt3),helfactor*AmpSqSuToSuSv(gt1, gt2, gt3))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LSu(gt1,i4) = 1._dp*GammaTPS(MSuOS(gt1),MSuOS(gt2),MSvOS(gt3),helfactor*AmpSqSuToSucSv(gt1, gt2, gt3))
Else 
  gP1LSu(gt1,i4) = 1._dp*GammaTPS(MSu(gt1),MSu(gt2),MSv(gt3),helfactor*AmpSqSuToSucSv(gt1, gt2, gt3))
End if 
