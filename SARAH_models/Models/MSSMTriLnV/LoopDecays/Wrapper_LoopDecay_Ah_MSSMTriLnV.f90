...
Complex(dp) :: AmpTreeAhToAhSv(2,2,3),AmpWaveAhToAhSv(2,2,3)=(0._dp,0._dp),AmpVertexAhToAhSv(2,2,3)& 
...
Complex(dp) :: AmpTreeAhToChacFe(2,2,2,3),AmpWaveAhToChacFe(2,2,2,3)=(0._dp,0._dp),AmpVertexAhToChacFe(2,2,2,3)& 
...
Complex(dp) :: AmpTreeAhToChiFv(2,2,4,3),AmpWaveAhToChiFv(2,2,4,3)=(0._dp,0._dp),AmpVertexAhToChiFv(2,2,4,3)& 
...
Complex(dp) :: AmpTreeAhToFvFv(2,2,3,3),AmpWaveAhToFvFv(2,2,3,3)=(0._dp,0._dp),AmpVertexAhToFvFv(2,2,3,3)& 
...
Complex(dp) :: AmpTreeAhTohhSv(2,2,3),AmpWaveAhTohhSv(2,2,3)=(0._dp,0._dp),AmpVertexAhTohhSv(2,2,3)& 
...
Complex(dp) :: AmpTreeAhToHpmcSe(2,2,6),AmpWaveAhToHpmcSe(2,2,6)=(0._dp,0._dp),AmpVertexAhToHpmcSe(2,2,6)& 
...
Complex(dp) :: AmpTreeAhToSecVWm(2,2,6),AmpWaveAhToSecVWm(2,2,6)=(0._dp,0._dp),AmpVertexAhToSecVWm(2,2,6)& 
...
Complex(dp) :: AmpTreeAhToSvSv(2,3,3),AmpWaveAhToSvSv(2,3,3)=(0._dp,0._dp),AmpVertexAhToSvSv(2,3,3)& 
...
Complex(dp) :: AmpTreeAhToSvVP(2,2,3),AmpWaveAhToSvVP(2,2,3)=(0._dp,0._dp),AmpVertexAhToSvVP(2,2,3)& 
...
Complex(dp) :: AmpTreeAhToSvVZ(2,2,3),AmpWaveAhToSvVZ(2,2,3)=(0._dp,0._dp),AmpVertexAhToSvVZ(2,2,3)& 
...
Else 
If (OSkinematics) Then 
  gP1LAh(gt1,i4) = 2._dp*GammaTPS(MAhOS(gt1),MAhOS(gt2),MSvOS(gt3),helfactor*AmpSqAhToAhSv(gt1, gt2, gt3))
Else 
  gP1LAh(gt1,i4) = 2._dp*GammaTPS(MAh(gt1),MAh(gt2),MSv(gt3),helfactor*AmpSqAhToAhSv(gt1, gt2, gt3))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LAh(gt1,i4) = 2._dp*GammaTPS(MAhOS(gt1),MChaOS(gt2),MFeOS(gt3),helfactor*AmpSqAhToChacFe(gt1, gt2, gt3))
Else 
  gP1LAh(gt1,i4) = 2._dp*GammaTPS(MAh(gt1),MCha(gt2),MFe(gt3),helfactor*AmpSqAhToChacFe(gt1, gt2, gt3))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LAh(gt1,i4) = 1._dp/2._dp*GammaTPS(MAhOS(gt1),MChiOS(gt2),0._dp,helfactor*AmpSqAhToChiFv(gt1, gt2, gt3))
Else 
  gP1LAh(gt1,i4) = 1._dp/2._dp*GammaTPS(MAh(gt1),MChi(gt2),0._dp,helfactor*AmpSqAhToChiFv(gt1, gt2, gt3))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LAh(gt1,i4) = 2._dp*GammaTPS(MAhOS(gt1),MhhOS(gt2),MSvOS(gt3),helfactor*AmpSqAhTohhSv(gt1, gt2, gt3))
Else 
  gP1LAh(gt1,i4) = 2._dp*GammaTPS(MAh(gt1),Mhh(gt2),MSv(gt3),helfactor*AmpSqAhTohhSv(gt1, gt2, gt3))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LAh(gt1,i4) = 2._dp*GammaTPS(MAhOS(gt1),MHpmOS(gt2),MSeOS(gt3),helfactor*AmpSqAhToHpmcSe(gt1, gt2, gt3))
Else 
  gP1LAh(gt1,i4) = 2._dp*GammaTPS(MAh(gt1),MHpm(gt2),MSe(gt3),helfactor*AmpSqAhToHpmcSe(gt1, gt2, gt3))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LAh(gt1,i4) = 2._dp*GammaTPS(MAhOS(gt1),MSeOS(gt2),MVWmOS,helfactor*AmpSqAhToSecVWm(gt1, gt2))
Else 
  gP1LAh(gt1,i4) = 2._dp*GammaTPS(MAh(gt1),MSe(gt2),MVWm,helfactor*AmpSqAhToSecVWm(gt1, gt2))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LAh(gt1,i4) = 1._dp*GammaTPS(MAhOS(gt1),MSvOS(gt2),MSvOS(gt3),helfactor*AmpSqAhToSvSv(gt1, gt2, gt3))
Else 
  gP1LAh(gt1,i4) = 1._dp*GammaTPS(MAh(gt1),MSv(gt2),MSv(gt3),helfactor*AmpSqAhToSvSv(gt1, gt2, gt3))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LAh(gt1,i4) = 2._dp*GammaTPS(MAhOS(gt1),MSvOS(gt2),0._dp,helfactor*AmpSqAhToSvVP(gt1, gt2))
Else 
  gP1LAh(gt1,i4) = 2._dp*GammaTPS(MAh(gt1),MSv(gt2),MVP,helfactor*AmpSqAhToSvVP(gt1, gt2))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LAh(gt1,i4) = 2._dp*GammaTPS(MAhOS(gt1),MSvOS(gt2),MVZOS,helfactor*AmpSqAhToSvVZ(gt1, gt2))
Else 
  gP1LAh(gt1,i4) = 2._dp*GammaTPS(MAh(gt1),MSv(gt2),MVZ,helfactor*AmpSqAhToSvVZ(gt1, gt2))
End if 
