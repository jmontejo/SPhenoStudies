...
Complex(dp) :: AmpTreeSeTocFuFd(2,6,3,3),AmpWaveSeTocFuFd(2,6,3,3)=(0._dp,0._dp),AmpVertexSeTocFuFd(2,6,3,3)& 
...
Complex(dp) :: AmpTreeSeToFvFe(2,6,3,3),AmpWaveSeToFvFe(2,6,3,3)=(0._dp,0._dp),AmpVertexSeToFvFe(2,6,3,3)& 
...
Complex(dp) :: AmpTreeSeTocSuSd(6,6,6),AmpWaveSeTocSuSd(6,6,6)=(0._dp,0._dp),AmpVertexSeTocSuSd(6,6,6)& 
...
Complex(dp) :: AmpTreeSeToSvSe(6,3,6),AmpWaveSeToSvSe(6,3,6)=(0._dp,0._dp),AmpVertexSeToSvSe(6,3,6)& 
...
Complex(dp) :: AmpTreeSeTocSvSe(6,3,6),AmpWaveSeTocSvSe(6,3,6)=(0._dp,0._dp),AmpVertexSeTocSvSe(6,3,6)& 
...
Complex(dp) :: AmpTreeSeToAhHpm(6,2,2),AmpWaveSeToAhHpm(6,2,2)=(0._dp,0._dp),AmpVertexSeToAhHpm(6,2,2)& 
...
Complex(dp) :: AmpTreeSeToAhVWm(2,6,2),AmpWaveSeToAhVWm(2,6,2)=(0._dp,0._dp),AmpVertexSeToAhVWm(2,6,2)& 
...
Complex(dp) :: AmpTreeSeToChaChi(2,6,2,4),AmpWaveSeToChaChi(2,6,2,4)=(0._dp,0._dp),AmpVertexSeToChaChi(2,6,2,4)& 
...
Complex(dp) :: AmpTreeSeTohhHpm(6,2,2),AmpWaveSeTohhHpm(6,2,2)=(0._dp,0._dp),AmpVertexSeTohhHpm(6,2,2)& 
...
Complex(dp) :: AmpTreeSeTohhVWm(2,6,2),AmpWaveSeTohhVWm(2,6,2)=(0._dp,0._dp),AmpVertexSeTohhVWm(2,6,2)& 
...
Complex(dp) :: AmpTreeSeToHpmVP(2,6,2),AmpWaveSeToHpmVP(2,6,2)=(0._dp,0._dp),AmpVertexSeToHpmVP(2,6,2)& 
...
Complex(dp) :: AmpTreeSeToHpmVZ(2,6,2),AmpWaveSeToHpmVZ(2,6,2)=(0._dp,0._dp),AmpVertexSeToHpmVZ(2,6,2)& 
...
Complex(dp) :: AmpTreeSeToHpmcSv(6,2,3),AmpWaveSeToHpmcSv(6,2,3)=(0._dp,0._dp),AmpVertexSeToHpmcSv(6,2,3)& 
...
Complex(dp) :: AmpTreeSeToVPVWm(2,6),AmpWaveSeToVPVWm(2,6)=(0._dp,0._dp),AmpVertexSeToVPVWm(2,6)& 
...
Complex(dp) :: AmpTreeSeToVWmVZ(2,6),AmpWaveSeToVWmVZ(2,6)=(0._dp,0._dp),AmpVertexSeToVWmVZ(2,6)& 
...
Complex(dp) :: AmpTreeSeTocSvVWm(2,6,3),AmpWaveSeTocSvVWm(2,6,3)=(0._dp,0._dp),AmpVertexSeTocSvVWm(2,6,3)& 
...
If (OSkinematics) Then 
  AmpSum2SeTocFuFd = AmpTreeSeTocFuFd
  Call SquareAmp_StoFF(MSeOS(gt1),MFuOS(gt2),MFdOS(gt3),AmpSumSeTocFuFd(:,gt1, gt2, gt3),AmpSum2SeTocFuFd(:,gt1, gt2, gt3),AmpSqSeTocFuFd(gt1, gt2, gt3)) 
  AmpSqTreeSeTocFuFd(gt1, gt2, gt3) = AmpSqSeTocFuFd(gt1, gt2, gt3)  
...
Else 
If (OSkinematics) Then 
  gP1LSe(gt1,i4) = 3._dp*GammaTPS(MSeOS(gt1),MFuOS(gt2),MFdOS(gt3),helfactor*AmpSqSeTocFuFd(gt1, gt2, gt3))
Else 
  gP1LSe(gt1,i4) = 3._dp*GammaTPS(MSe(gt1),MFu(gt2),MFd(gt3),helfactor*AmpSqSeTocFuFd(gt1, gt2, gt3))
End if 
...
If ((Abs(MRPSeTocFuFd(gt1, gt2, gt3)).gt.1.0E-20_dp).or.(Abs(MRGSeTocFuFd(gt1, gt2, gt3)).gt.1.0E-20_dp)) Then 
 If (.not.OnlyTreeLevelContributions) Then 
   If (DebugLoopDecays) Write(*,*) "real", phasespacefactor*0.5_dp*helfactor*(MRPSeTocFuFd(gt1, gt2, gt3) + MRGSeTocFuFd(gt1, gt2, gt3)) 
  gP1LSe(gt1,i4) = gP1LSe(gt1,i4) + phasespacefactor*0.5_dp*helfactor*(MRPSeTocFuFd(gt1, gt2, gt3) + MRGSeTocFuFd(gt1, gt2, gt3))
   If (DebugLoopDecays) Write(*,*) "sum",  gP1LSe(gt1,i4) 
  End if 
End if 
End if 
...
If (OSkinematics) Then 
  AmpSum2SeToFvFe = AmpTreeSeToFvFe
  Call SquareAmp_StoFF(MSeOS(gt1),0._dp,MFeOS(gt3),AmpSumSeToFvFe(:,gt1, gt2, gt3),AmpSum2SeToFvFe(:,gt1, gt2, gt3),AmpSqSeToFvFe(gt1, gt2, gt3)) 
  AmpSqTreeSeToFvFe(gt1, gt2, gt3) = AmpSqSeToFvFe(gt1, gt2, gt3)  
...
Else 
If (OSkinematics) Then 
  gP1LSe(gt1,i4) = 1._dp*GammaTPS(MSeOS(gt1),0._dp,MFeOS(gt3),helfactor*AmpSqSeToFvFe(gt1, gt2, gt3))
Else 
  gP1LSe(gt1,i4) = 1._dp*GammaTPS(MSe(gt1),0._dp,MFe(gt3),helfactor*AmpSqSeToFvFe(gt1, gt2, gt3))
End if 
...
If ((Abs(MRPSeToFvFe(gt1, gt2, gt3)).gt.1.0E-20_dp).or.(Abs(MRGSeToFvFe(gt1, gt2, gt3)).gt.1.0E-20_dp)) Then 
 If (.not.OnlyTreeLevelContributions) Then 
   If (DebugLoopDecays) Write(*,*) "real", phasespacefactor*0.5_dp*helfactor*(MRPSeToFvFe(gt1, gt2, gt3) + MRGSeToFvFe(gt1, gt2, gt3)) 
  gP1LSe(gt1,i4) = gP1LSe(gt1,i4) + phasespacefactor*0.5_dp*helfactor*(MRPSeToFvFe(gt1, gt2, gt3) + MRGSeToFvFe(gt1, gt2, gt3))
   If (DebugLoopDecays) Write(*,*) "sum",  gP1LSe(gt1,i4) 
  End if 
End if 
End if 
...
If (OSkinematics) Then 
  AmpSum2SeTocSuSd = AmpTreeSeTocSuSd
  Call SquareAmp_StoSS(MSeOS(gt1),MSuOS(gt2),MSdOS(gt3),AmpSumSeTocSuSd(gt1, gt2, gt3),AmpSum2SeTocSuSd(gt1, gt2, gt3),AmpSqSeTocSuSd(gt1, gt2, gt3)) 
  AmpSqTreeSeTocSuSd(gt1, gt2, gt3) = AmpSqSeTocSuSd(gt1, gt2, gt3)  
...
Else 
If (OSkinematics) Then 
  gP1LSe(gt1,i4) = 3._dp*GammaTPS(MSeOS(gt1),MSuOS(gt2),MSdOS(gt3),helfactor*AmpSqSeTocSuSd(gt1, gt2, gt3))
Else 
  gP1LSe(gt1,i4) = 3._dp*GammaTPS(MSe(gt1),MSu(gt2),MSd(gt3),helfactor*AmpSqSeTocSuSd(gt1, gt2, gt3))
End if 
...
If ((Abs(MRPSeTocSuSd(gt1, gt2, gt3)).gt.1.0E-20_dp).or.(Abs(MRGSeTocSuSd(gt1, gt2, gt3)).gt.1.0E-20_dp)) Then 
 If (.not.OnlyTreeLevelContributions) Then 
   If (DebugLoopDecays) Write(*,*) "real", phasespacefactor*0.5_dp*helfactor*(MRPSeTocSuSd(gt1, gt2, gt3) + MRGSeTocSuSd(gt1, gt2, gt3)) 
  gP1LSe(gt1,i4) = gP1LSe(gt1,i4) + phasespacefactor*0.5_dp*helfactor*(MRPSeTocSuSd(gt1, gt2, gt3) + MRGSeTocSuSd(gt1, gt2, gt3))
   If (DebugLoopDecays) Write(*,*) "sum",  gP1LSe(gt1,i4) 
  End if 
End if 
End if 
...
If (OSkinematics) Then 
  AmpSum2SeToSvSe = AmpTreeSeToSvSe
  Call SquareAmp_StoSS(MSeOS(gt1),MSvOS(gt2),MSeOS(gt3),AmpSumSeToSvSe(gt1, gt2, gt3),AmpSum2SeToSvSe(gt1, gt2, gt3),AmpSqSeToSvSe(gt1, gt2, gt3)) 
  AmpSqTreeSeToSvSe(gt1, gt2, gt3) = AmpSqSeToSvSe(gt1, gt2, gt3)  
...
Else 
If (OSkinematics) Then 
  gP1LSe(gt1,i4) = 1._dp*GammaTPS(MSeOS(gt1),MSvOS(gt2),MSeOS(gt3),helfactor*AmpSqSeToSvSe(gt1, gt2, gt3))
Else 
  gP1LSe(gt1,i4) = 1._dp*GammaTPS(MSe(gt1),MSv(gt2),MSe(gt3),helfactor*AmpSqSeToSvSe(gt1, gt2, gt3))
End if 
...
If ((Abs(MRPSeToSvSe(gt1, gt2, gt3)).gt.1.0E-20_dp).or.(Abs(MRGSeToSvSe(gt1, gt2, gt3)).gt.1.0E-20_dp)) Then 
 If (.not.OnlyTreeLevelContributions) Then 
   If (DebugLoopDecays) Write(*,*) "real", phasespacefactor*0.5_dp*helfactor*(MRPSeToSvSe(gt1, gt2, gt3) + MRGSeToSvSe(gt1, gt2, gt3)) 
  gP1LSe(gt1,i4) = gP1LSe(gt1,i4) + phasespacefactor*0.5_dp*helfactor*(MRPSeToSvSe(gt1, gt2, gt3) + MRGSeToSvSe(gt1, gt2, gt3))
   If (DebugLoopDecays) Write(*,*) "sum",  gP1LSe(gt1,i4) 
  End if 
End if 
End if 
...
If (OSkinematics) Then 
  AmpSum2SeTocSvSe = AmpTreeSeTocSvSe
  Call SquareAmp_StoSS(MSeOS(gt1),MSvOS(gt2),MSeOS(gt3),AmpSumSeTocSvSe(gt1, gt2, gt3),AmpSum2SeTocSvSe(gt1, gt2, gt3),AmpSqSeTocSvSe(gt1, gt2, gt3)) 
  AmpSqTreeSeTocSvSe(gt1, gt2, gt3) = AmpSqSeTocSvSe(gt1, gt2, gt3)  
...
Else 
If (OSkinematics) Then 
  gP1LSe(gt1,i4) = 1._dp*GammaTPS(MSeOS(gt1),MSvOS(gt2),MSeOS(gt3),helfactor*AmpSqSeTocSvSe(gt1, gt2, gt3))
Else 
  gP1LSe(gt1,i4) = 1._dp*GammaTPS(MSe(gt1),MSv(gt2),MSe(gt3),helfactor*AmpSqSeTocSvSe(gt1, gt2, gt3))
End if 
...
If ((Abs(MRPSeTocSvSe(gt1, gt2, gt3)).gt.1.0E-20_dp).or.(Abs(MRGSeTocSvSe(gt1, gt2, gt3)).gt.1.0E-20_dp)) Then 
 If (.not.OnlyTreeLevelContributions) Then 
   If (DebugLoopDecays) Write(*,*) "real", phasespacefactor*0.5_dp*helfactor*(MRPSeTocSvSe(gt1, gt2, gt3) + MRGSeTocSvSe(gt1, gt2, gt3)) 
  gP1LSe(gt1,i4) = gP1LSe(gt1,i4) + phasespacefactor*0.5_dp*helfactor*(MRPSeTocSvSe(gt1, gt2, gt3) + MRGSeTocSvSe(gt1, gt2, gt3))
   If (DebugLoopDecays) Write(*,*) "sum",  gP1LSe(gt1,i4) 
  End if 
End if 
End if 
...
Else 
If (OSkinematics) Then 
  gP1LSe(gt1,i4) = 1._dp*GammaTPS(MSeOS(gt1),MAhOS(gt2),MHpmOS(gt3),helfactor*AmpSqSeToAhHpm(gt1, gt2, gt3))
Else 
  gP1LSe(gt1,i4) = 1._dp*GammaTPS(MSe(gt1),MAh(gt2),MHpm(gt3),helfactor*AmpSqSeToAhHpm(gt1, gt2, gt3))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LSe(gt1,i4) = 1._dp*GammaTPS(MSeOS(gt1),MAhOS(gt2),MVWmOS,helfactor*AmpSqSeToAhVWm(gt1, gt2))
Else 
  gP1LSe(gt1,i4) = 1._dp*GammaTPS(MSe(gt1),MAh(gt2),MVWm,helfactor*AmpSqSeToAhVWm(gt1, gt2))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LSe(gt1,i4) = 1._dp*GammaTPS(MSeOS(gt1),MChaOS(gt2),MChiOS(gt3),helfactor*AmpSqSeToChaChi(gt1, gt2, gt3))
Else 
  gP1LSe(gt1,i4) = 1._dp*GammaTPS(MSe(gt1),MCha(gt2),MChi(gt3),helfactor*AmpSqSeToChaChi(gt1, gt2, gt3))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LSe(gt1,i4) = 1._dp*GammaTPS(MSeOS(gt1),MhhOS(gt2),MHpmOS(gt3),helfactor*AmpSqSeTohhHpm(gt1, gt2, gt3))
Else 
  gP1LSe(gt1,i4) = 1._dp*GammaTPS(MSe(gt1),Mhh(gt2),MHpm(gt3),helfactor*AmpSqSeTohhHpm(gt1, gt2, gt3))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LSe(gt1,i4) = 1._dp*GammaTPS(MSeOS(gt1),MhhOS(gt2),MVWmOS,helfactor*AmpSqSeTohhVWm(gt1, gt2))
Else 
  gP1LSe(gt1,i4) = 1._dp*GammaTPS(MSe(gt1),Mhh(gt2),MVWm,helfactor*AmpSqSeTohhVWm(gt1, gt2))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LSe(gt1,i4) = 1._dp*GammaTPS(MSeOS(gt1),MHpmOS(gt2),0._dp,helfactor*AmpSqSeToHpmVP(gt1, gt2))
Else 
  gP1LSe(gt1,i4) = 1._dp*GammaTPS(MSe(gt1),MHpm(gt2),MVP,helfactor*AmpSqSeToHpmVP(gt1, gt2))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LSe(gt1,i4) = 1._dp*GammaTPS(MSeOS(gt1),MHpmOS(gt2),MVZOS,helfactor*AmpSqSeToHpmVZ(gt1, gt2))
Else 
  gP1LSe(gt1,i4) = 1._dp*GammaTPS(MSe(gt1),MHpm(gt2),MVZ,helfactor*AmpSqSeToHpmVZ(gt1, gt2))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LSe(gt1,i4) = 1._dp*GammaTPS(MSeOS(gt1),MHpmOS(gt2),MSvOS(gt3),helfactor*AmpSqSeToHpmcSv(gt1, gt2, gt3))
Else 
  gP1LSe(gt1,i4) = 1._dp*GammaTPS(MSe(gt1),MHpm(gt2),MSv(gt3),helfactor*AmpSqSeToHpmcSv(gt1, gt2, gt3))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LSe(gt1,i4) = 2._dp*GammaTPS(MSeOS(gt1),0._dp,MVWmOS,helfactor*AmpSqSeToVPVWm(gt1))
Else 
  gP1LSe(gt1,i4) = 2._dp*GammaTPS(MSe(gt1),MVP,MVWm,helfactor*AmpSqSeToVPVWm(gt1))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LSe(gt1,i4) = 2._dp*GammaTPS(MSeOS(gt1),MVWmOS,MVZOS,helfactor*AmpSqSeToVWmVZ(gt1))
Else 
  gP1LSe(gt1,i4) = 2._dp*GammaTPS(MSe(gt1),MVWm,MVZ,helfactor*AmpSqSeToVWmVZ(gt1))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LSe(gt1,i4) = 1._dp*GammaTPS(MSeOS(gt1),MSvOS(gt2),MVWmOS,helfactor*AmpSqSeTocSvVWm(gt1, gt2))
Else 
  gP1LSe(gt1,i4) = 1._dp*GammaTPS(MSe(gt1),MSv(gt2),MVWm,helfactor*AmpSqSeTocSvVWm(gt1, gt2))
End if 
