...
Complex(dp) :: AmpTreeChaToFvSe(2,2,3,6),AmpWaveChaToFvSe(2,2,3,6)=(0._dp,0._dp),AmpVertexChaToFvSe(2,2,3,6)& 
...
Complex(dp) :: AmpTreeChaToChaSv(2,2,2,3),AmpWaveChaToChaSv(2,2,2,3)=(0._dp,0._dp),AmpVertexChaToChaSv(2,2,2,3)& 
...
Complex(dp) :: AmpTreeChaToChacSv(2,2,2,3),AmpWaveChaToChacSv(2,2,2,3)=(0._dp,0._dp),AmpVertexChaToChacSv(2,2,2,3)& 
...
Complex(dp) :: AmpTreeChaToChiSe(2,2,4,6),AmpWaveChaToChiSe(2,2,4,6)=(0._dp,0._dp),AmpVertexChaToChiSe(2,2,4,6)& 
...
Complex(dp) :: AmpTreeChaToFeAh(2,2,3,2),AmpWaveChaToFeAh(2,2,3,2)=(0._dp,0._dp),AmpVertexChaToFeAh(2,2,3,2)& 
...
Complex(dp) :: AmpTreeChaToFehh(2,2,3,2),AmpWaveChaToFehh(2,2,3,2)=(0._dp,0._dp),AmpVertexChaToFehh(2,2,3,2)& 
...
Complex(dp) :: AmpTreeChaToFeSv(2,2,3,3),AmpWaveChaToFeSv(2,2,3,3)=(0._dp,0._dp),AmpVertexChaToFeSv(2,2,3,3)& 
...
Complex(dp) :: AmpTreeChaToFeVP(4,2,3),AmpWaveChaToFeVP(4,2,3)=(0._dp,0._dp),AmpVertexChaToFeVP(4,2,3)& 
...
Complex(dp) :: AmpTreeChaToFeVZ(4,2,3),AmpWaveChaToFeVZ(4,2,3)=(0._dp,0._dp),AmpVertexChaToFeVZ(4,2,3)& 
...
Complex(dp) :: AmpTreeChaToFvHpm(2,2,3,2),AmpWaveChaToFvHpm(2,2,3,2)=(0._dp,0._dp),AmpVertexChaToFvHpm(2,2,3,2)& 
...
Complex(dp) :: AmpTreeChaToFvVWm(4,2,3),AmpWaveChaToFvVWm(4,2,3)=(0._dp,0._dp),AmpVertexChaToFvVWm(4,2,3)& 
...
Else 
If (OSkinematics) Then 
  gP1LCha(gt1,i4) = 1._dp*GammaTPS(MChaOS(gt1),0._dp,MSeOS(gt3),helfactor*AmpSqChaToFvSe(gt1, gt2, gt3))
Else 
  gP1LCha(gt1,i4) = 1._dp*GammaTPS(MCha(gt1),0._dp,MSe(gt3),helfactor*AmpSqChaToFvSe(gt1, gt2, gt3))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LCha(gt1,i4) = 1._dp*GammaTPS(MChaOS(gt1),MChaOS(gt2),MSvOS(gt3),helfactor*AmpSqChaToChaSv(gt1, gt2, gt3))
Else 
  gP1LCha(gt1,i4) = 1._dp*GammaTPS(MCha(gt1),MCha(gt2),MSv(gt3),helfactor*AmpSqChaToChaSv(gt1, gt2, gt3))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LCha(gt1,i4) = 1._dp*GammaTPS(MChaOS(gt1),MChaOS(gt2),MSvOS(gt3),helfactor*AmpSqChaToChacSv(gt1, gt2, gt3))
Else 
  gP1LCha(gt1,i4) = 1._dp*GammaTPS(MCha(gt1),MCha(gt2),MSv(gt3),helfactor*AmpSqChaToChacSv(gt1, gt2, gt3))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LCha(gt1,i4) = 1._dp*GammaTPS(MChaOS(gt1),MChiOS(gt2),MSeOS(gt3),helfactor*AmpSqChaToChiSe(gt1, gt2, gt3))
Else 
  gP1LCha(gt1,i4) = 1._dp*GammaTPS(MCha(gt1),MChi(gt2),MSe(gt3),helfactor*AmpSqChaToChiSe(gt1, gt2, gt3))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LCha(gt1,i4) = 1._dp*GammaTPS(MChaOS(gt1),MFeOS(gt2),MAhOS(gt3),helfactor*AmpSqChaToFeAh(gt1, gt2, gt3))
Else 
  gP1LCha(gt1,i4) = 1._dp*GammaTPS(MCha(gt1),MFe(gt2),MAh(gt3),helfactor*AmpSqChaToFeAh(gt1, gt2, gt3))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LCha(gt1,i4) = 1._dp*GammaTPS(MChaOS(gt1),MFeOS(gt2),MhhOS(gt3),helfactor*AmpSqChaToFehh(gt1, gt2, gt3))
Else 
  gP1LCha(gt1,i4) = 1._dp*GammaTPS(MCha(gt1),MFe(gt2),Mhh(gt3),helfactor*AmpSqChaToFehh(gt1, gt2, gt3))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LCha(gt1,i4) = 1._dp*GammaTPS(MChaOS(gt1),MFeOS(gt2),MSvOS(gt3),helfactor*AmpSqChaToFeSv(gt1, gt2, gt3))
Else 
  gP1LCha(gt1,i4) = 1._dp*GammaTPS(MCha(gt1),MFe(gt2),MSv(gt3),helfactor*AmpSqChaToFeSv(gt1, gt2, gt3))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LCha(gt1,i4) = 1._dp*GammaTPS(MChaOS(gt1),MFeOS(gt2),0._dp,helfactor*AmpSqChaToFeVP(gt1, gt2))
Else 
  gP1LCha(gt1,i4) = 1._dp*GammaTPS(MCha(gt1),MFe(gt2),MVP,helfactor*AmpSqChaToFeVP(gt1, gt2))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LCha(gt1,i4) = 1._dp*GammaTPS(MChaOS(gt1),MFeOS(gt2),MVZOS,helfactor*AmpSqChaToFeVZ(gt1, gt2))
Else 
  gP1LCha(gt1,i4) = 1._dp*GammaTPS(MCha(gt1),MFe(gt2),MVZ,helfactor*AmpSqChaToFeVZ(gt1, gt2))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LCha(gt1,i4) = 1._dp*GammaTPS(MChaOS(gt1),0._dp,MHpmOS(gt3),helfactor*AmpSqChaToFvHpm(gt1, gt2, gt3))
Else 
  gP1LCha(gt1,i4) = 1._dp*GammaTPS(MCha(gt1),0._dp,MHpm(gt3),helfactor*AmpSqChaToFvHpm(gt1, gt2, gt3))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LCha(gt1,i4) = 1._dp*GammaTPS(MChaOS(gt1),0._dp,MVWmOS,helfactor*AmpSqChaToFvVWm(gt1, gt2))
Else 
  gP1LCha(gt1,i4) = 1._dp*GammaTPS(MCha(gt1),0._dp,MVWm,helfactor*AmpSqChaToFvVWm(gt1, gt2))
End if 
