...
Complex(dp) :: AmpTreehhToAhSv(2,2,3),AmpWavehhToAhSv(2,2,3)=(0._dp,0._dp),AmpVertexhhToAhSv(2,2,3)& 
...
Complex(dp) :: AmpTreehhToChacFe(2,2,2,3),AmpWavehhToChacFe(2,2,2,3)=(0._dp,0._dp),AmpVertexhhToChacFe(2,2,2,3)& 
...
Complex(dp) :: AmpTreehhToChiFv(2,2,4,3),AmpWavehhToChiFv(2,2,4,3)=(0._dp,0._dp),AmpVertexhhToChiFv(2,2,4,3)& 
...
Complex(dp) :: AmpTreehhTohhSv(2,2,3),AmpWavehhTohhSv(2,2,3)=(0._dp,0._dp),AmpVertexhhTohhSv(2,2,3)& 
...
Complex(dp) :: AmpTreehhToHpmcSe(2,2,6),AmpWavehhToHpmcSe(2,2,6)=(0._dp,0._dp),AmpVertexhhToHpmcSe(2,2,6)& 
...
Complex(dp) :: AmpTreehhToSecVWm(2,2,6),AmpWavehhToSecVWm(2,2,6)=(0._dp,0._dp),AmpVertexhhToSecVWm(2,2,6)& 
...
Complex(dp) :: AmpTreehhToSvSv(2,3,3),AmpWavehhToSvSv(2,3,3)=(0._dp,0._dp),AmpVertexhhToSvSv(2,3,3)& 
...
Complex(dp) :: AmpTreehhToSvVP(2,2,3),AmpWavehhToSvVP(2,2,3)=(0._dp,0._dp),AmpVertexhhToSvVP(2,2,3)& 
...
Complex(dp) :: AmpTreehhToSvVZ(2,2,3),AmpWavehhToSvVZ(2,2,3)=(0._dp,0._dp),AmpVertexhhToSvVZ(2,2,3)& 
...
Else 
If (OSkinematics) Then 
  gP1Lhh(gt1,i4) = 2._dp*GammaTPS(MhhOS(gt1),MAhOS(gt2),MSvOS(gt3),helfactor*AmpSqhhToAhSv(gt1, gt2, gt3))
Else 
  gP1Lhh(gt1,i4) = 2._dp*GammaTPS(Mhh(gt1),MAh(gt2),MSv(gt3),helfactor*AmpSqhhToAhSv(gt1, gt2, gt3))
End if 
...
Else 
If (OSkinematics) Then 
  gP1Lhh(gt1,i4) = 2._dp*GammaTPS(MhhOS(gt1),MChaOS(gt2),MFeOS(gt3),helfactor*AmpSqhhToChacFe(gt1, gt2, gt3))
Else 
  gP1Lhh(gt1,i4) = 2._dp*GammaTPS(Mhh(gt1),MCha(gt2),MFe(gt3),helfactor*AmpSqhhToChacFe(gt1, gt2, gt3))
End if 
...
Else 
If (OSkinematics) Then 
  gP1Lhh(gt1,i4) = 1._dp/2._dp*GammaTPS(MhhOS(gt1),MChiOS(gt2),0._dp,helfactor*AmpSqhhToChiFv(gt1, gt2, gt3))
Else 
  gP1Lhh(gt1,i4) = 1._dp/2._dp*GammaTPS(Mhh(gt1),MChi(gt2),0._dp,helfactor*AmpSqhhToChiFv(gt1, gt2, gt3))
End if 
...
Else 
If (OSkinematics) Then 
  gP1Lhh(gt1,i4) = 2._dp*GammaTPS(MhhOS(gt1),MhhOS(gt2),MSvOS(gt3),helfactor*AmpSqhhTohhSv(gt1, gt2, gt3))
Else 
  gP1Lhh(gt1,i4) = 2._dp*GammaTPS(Mhh(gt1),Mhh(gt2),MSv(gt3),helfactor*AmpSqhhTohhSv(gt1, gt2, gt3))
End if 
...
Else 
If (OSkinematics) Then 
  gP1Lhh(gt1,i4) = 2._dp*GammaTPS(MhhOS(gt1),MHpmOS(gt2),MSeOS(gt3),helfactor*AmpSqhhToHpmcSe(gt1, gt2, gt3))
Else 
  gP1Lhh(gt1,i4) = 2._dp*GammaTPS(Mhh(gt1),MHpm(gt2),MSe(gt3),helfactor*AmpSqhhToHpmcSe(gt1, gt2, gt3))
End if 
...
Else 
If (OSkinematics) Then 
  gP1Lhh(gt1,i4) = 2._dp*GammaTPS(MhhOS(gt1),MSeOS(gt2),MVWmOS,helfactor*AmpSqhhToSecVWm(gt1, gt2))
Else 
  gP1Lhh(gt1,i4) = 2._dp*GammaTPS(Mhh(gt1),MSe(gt2),MVWm,helfactor*AmpSqhhToSecVWm(gt1, gt2))
End if 
...
Else 
If (OSkinematics) Then 
  gP1Lhh(gt1,i4) = 1._dp*GammaTPS(MhhOS(gt1),MSvOS(gt2),MSvOS(gt3),helfactor*AmpSqhhToSvSv(gt1, gt2, gt3))
Else 
  gP1Lhh(gt1,i4) = 1._dp*GammaTPS(Mhh(gt1),MSv(gt2),MSv(gt3),helfactor*AmpSqhhToSvSv(gt1, gt2, gt3))
End if 
...
Else 
If (OSkinematics) Then 
  gP1Lhh(gt1,i4) = 2._dp*GammaTPS(MhhOS(gt1),MSvOS(gt2),0._dp,helfactor*AmpSqhhToSvVP(gt1, gt2))
Else 
  gP1Lhh(gt1,i4) = 2._dp*GammaTPS(Mhh(gt1),MSv(gt2),MVP,helfactor*AmpSqhhToSvVP(gt1, gt2))
End if 
...
Else 
If (OSkinematics) Then 
  gP1Lhh(gt1,i4) = 2._dp*GammaTPS(MhhOS(gt1),MSvOS(gt2),MVZOS,helfactor*AmpSqhhToSvVZ(gt1, gt2))
Else 
  gP1Lhh(gt1,i4) = 2._dp*GammaTPS(Mhh(gt1),MSv(gt2),MVZ,helfactor*AmpSqhhToSvVZ(gt1, gt2))
End if 
