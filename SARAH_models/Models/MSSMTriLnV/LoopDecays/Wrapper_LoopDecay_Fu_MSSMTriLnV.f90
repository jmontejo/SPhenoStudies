...
Complex(dp) :: AmpTreeFuToFdcSe(2,3,3,6),AmpWaveFuToFdcSe(2,3,3,6)=(0._dp,0._dp),AmpVertexFuToFdcSe(2,3,3,6)& 
...
Complex(dp) :: AmpTreeFuTocFeSd(2,3,3,6),AmpWaveFuTocFeSd(2,3,3,6)=(0._dp,0._dp),AmpVertexFuTocFeSd(2,3,3,6)& 
...
Complex(dp) :: AmpTreeFuToFuSv(2,3,3,3),AmpWaveFuToFuSv(2,3,3,3)=(0._dp,0._dp),AmpVertexFuToFuSv(2,3,3,3)& 
...
Complex(dp) :: AmpTreeFuToFucSv(2,3,3,3),AmpWaveFuToFucSv(2,3,3,3)=(0._dp,0._dp),AmpVertexFuToFucSv(2,3,3,3)& 
...
Complex(dp) :: AmpTreeFuToFvSu(2,3,3,6),AmpWaveFuToFvSu(2,3,3,6)=(0._dp,0._dp),AmpVertexFuToFvSu(2,3,3,6)& 
...
If (OSkinematics) Then 
  AmpSum2FuToFdcSe = AmpTreeFuToFdcSe
  Call SquareAmp_FtoFS(MFuOS(gt1),MFdOS(gt2),MSeOS(gt3),AmpSumFuToFdcSe(:,gt1, gt2, gt3),AmpSum2FuToFdcSe(:,gt1, gt2, gt3),AmpSqFuToFdcSe(gt1, gt2, gt3)) 
  AmpSqTreeFuToFdcSe(gt1, gt2, gt3) = AmpSqFuToFdcSe(gt1, gt2, gt3)  
...
Else 
If (OSkinematics) Then 
  gP1LFu(gt1,i4) = 1._dp*GammaTPS(MFuOS(gt1),MFdOS(gt2),MSeOS(gt3),helfactor*AmpSqFuToFdcSe(gt1, gt2, gt3))
Else 
  gP1LFu(gt1,i4) = 1._dp*GammaTPS(MFu(gt1),MFd(gt2),MSe(gt3),helfactor*AmpSqFuToFdcSe(gt1, gt2, gt3))
End if 
...
If ((Abs(MRPFuToFdcSe(gt1, gt2, gt3)).gt.1.0E-20_dp).or.(Abs(MRGFuToFdcSe(gt1, gt2, gt3)).gt.1.0E-20_dp)) Then 
 If (.not.OnlyTreeLevelContributions) Then 
   If (DebugLoopDecays) Write(*,*) "real", phasespacefactor*0.5_dp*helfactor*(MRPFuToFdcSe(gt1, gt2, gt3) + MRGFuToFdcSe(gt1, gt2, gt3)) 
  gP1LFu(gt1,i4) = gP1LFu(gt1,i4) + phasespacefactor*0.5_dp*helfactor*(MRPFuToFdcSe(gt1, gt2, gt3) + MRGFuToFdcSe(gt1, gt2, gt3))
   If (DebugLoopDecays) Write(*,*) "sum",  gP1LFu(gt1,i4) 
  End if 
End if 
End if 
...
If (OSkinematics) Then 
  AmpSum2FuTocFeSd = AmpTreeFuTocFeSd
  Call SquareAmp_FtoFS(MFuOS(gt1),MFeOS(gt2),MSdOS(gt3),AmpSumFuTocFeSd(:,gt1, gt2, gt3),AmpSum2FuTocFeSd(:,gt1, gt2, gt3),AmpSqFuTocFeSd(gt1, gt2, gt3)) 
  AmpSqTreeFuTocFeSd(gt1, gt2, gt3) = AmpSqFuTocFeSd(gt1, gt2, gt3)  
...
Else 
If (OSkinematics) Then 
  gP1LFu(gt1,i4) = 1._dp*GammaTPS(MFuOS(gt1),MFeOS(gt2),MSdOS(gt3),helfactor*AmpSqFuTocFeSd(gt1, gt2, gt3))
Else 
  gP1LFu(gt1,i4) = 1._dp*GammaTPS(MFu(gt1),MFe(gt2),MSd(gt3),helfactor*AmpSqFuTocFeSd(gt1, gt2, gt3))
End if 
...
If ((Abs(MRPFuTocFeSd(gt1, gt2, gt3)).gt.1.0E-20_dp).or.(Abs(MRGFuTocFeSd(gt1, gt2, gt3)).gt.1.0E-20_dp)) Then 
 If (.not.OnlyTreeLevelContributions) Then 
   If (DebugLoopDecays) Write(*,*) "real", phasespacefactor*0.5_dp*helfactor*(MRPFuTocFeSd(gt1, gt2, gt3) + MRGFuTocFeSd(gt1, gt2, gt3)) 
  gP1LFu(gt1,i4) = gP1LFu(gt1,i4) + phasespacefactor*0.5_dp*helfactor*(MRPFuTocFeSd(gt1, gt2, gt3) + MRGFuTocFeSd(gt1, gt2, gt3))
   If (DebugLoopDecays) Write(*,*) "sum",  gP1LFu(gt1,i4) 
  End if 
End if 
End if 
...
Else 
If (OSkinematics) Then 
  gP1LFu(gt1,i4) = 1._dp*GammaTPS(MFuOS(gt1),MFuOS(gt2),MSvOS(gt3),helfactor*AmpSqFuToFuSv(gt1, gt2, gt3))
Else 
  gP1LFu(gt1,i4) = 1._dp*GammaTPS(MFu(gt1),MFu(gt2),MSv(gt3),helfactor*AmpSqFuToFuSv(gt1, gt2, gt3))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LFu(gt1,i4) = 1._dp*GammaTPS(MFuOS(gt1),MFuOS(gt2),MSvOS(gt3),helfactor*AmpSqFuToFucSv(gt1, gt2, gt3))
Else 
  gP1LFu(gt1,i4) = 1._dp*GammaTPS(MFu(gt1),MFu(gt2),MSv(gt3),helfactor*AmpSqFuToFucSv(gt1, gt2, gt3))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LFu(gt1,i4) = 1._dp*GammaTPS(MFuOS(gt1),0._dp,MSuOS(gt3),helfactor*AmpSqFuToFvSu(gt1, gt2, gt3))
Else 
  gP1LFu(gt1,i4) = 1._dp*GammaTPS(MFu(gt1),0._dp,MSu(gt3),helfactor*AmpSqFuToFvSu(gt1, gt2, gt3))
End if 
