...
Complex(dp) :: AmpTreeGluToFvVG(4,3),AmpWaveGluToFvVG(4,3)=(0._dp,0._dp),AmpVertexGluToFvVG(4,3)& 
...
Complex(dp) :: AmpTreeGluToGluSv(2,3),AmpWaveGluToGluSv(2,3)=(0._dp,0._dp),AmpVertexGluToGluSv(2,3)& 
...
Else 
If (OSkinematics) Then 
  gP1LGlu(gt1,i4) = 1._dp*GammaTPS(MGluOS,0._dp,0._dp,helfactor*AmpSqGluToFvVG(gt2))
Else 
  gP1LGlu(gt1,i4) = 1._dp*GammaTPS(MGlu,0._dp,MVG,helfactor*AmpSqGluToFvVG(gt2))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LGlu(gt1,i4) = 2._dp*GammaTPS(MGluOS,MGluOS,MSvOS(gt3),helfactor*AmpSqGluToGluSv(gt3))
Else 
  gP1LGlu(gt1,i4) = 2._dp*GammaTPS(MGlu,MGlu,MSv(gt3),helfactor*AmpSqGluToGluSv(gt3))
End if 
