...
Complex(dp) :: AmpTreeHpmToFvFe(2,2,3,3),AmpWaveHpmToFvFe(2,2,3,3)=(0._dp,0._dp),AmpVertexHpmToFvFe(2,2,3,3)& 
...
Complex(dp) :: AmpTreeHpmToAhSe(2,2,6),AmpWaveHpmToAhSe(2,2,6)=(0._dp,0._dp),AmpVertexHpmToAhSe(2,2,6)& 
...
Complex(dp) :: AmpTreeHpmToChaFv(2,2,2,3),AmpWaveHpmToChaFv(2,2,2,3)=(0._dp,0._dp),AmpVertexHpmToChaFv(2,2,2,3)& 
...
Complex(dp) :: AmpTreeHpmToChiFe(2,2,4,3),AmpWaveHpmToChiFe(2,2,4,3)=(0._dp,0._dp),AmpVertexHpmToChiFe(2,2,4,3)& 
...
Complex(dp) :: AmpTreeHpmTohhSe(2,2,6),AmpWaveHpmTohhSe(2,2,6)=(0._dp,0._dp),AmpVertexHpmTohhSe(2,2,6)& 
...
Complex(dp) :: AmpTreeHpmToHpmSv(2,2,3),AmpWaveHpmToHpmSv(2,2,3)=(0._dp,0._dp),AmpVertexHpmToHpmSv(2,2,3)& 
...
Complex(dp) :: AmpTreeHpmToHpmcSv(2,2,3),AmpWaveHpmToHpmcSv(2,2,3)=(0._dp,0._dp),AmpVertexHpmToHpmcSv(2,2,3)& 
...
Complex(dp) :: AmpTreeHpmToSeSv(2,6,3),AmpWaveHpmToSeSv(2,6,3)=(0._dp,0._dp),AmpVertexHpmToSeSv(2,6,3)& 
...
Complex(dp) :: AmpTreeHpmToSeVP(2,2,6),AmpWaveHpmToSeVP(2,2,6)=(0._dp,0._dp),AmpVertexHpmToSeVP(2,2,6)& 
...
Complex(dp) :: AmpTreeHpmToSeVZ(2,2,6),AmpWaveHpmToSeVZ(2,2,6)=(0._dp,0._dp),AmpVertexHpmToSeVZ(2,2,6)& 
...
Complex(dp) :: AmpTreeHpmToSvVWm(2,2,3),AmpWaveHpmToSvVWm(2,2,3)=(0._dp,0._dp),AmpVertexHpmToSvVWm(2,2,3)& 
...
Complex(dp) :: AmpTreeHpmTocSvVWm(2,2,3),AmpWaveHpmTocSvVWm(2,2,3)=(0._dp,0._dp),AmpVertexHpmTocSvVWm(2,2,3)& 
...
Else 
If (OSkinematics) Then 
  gP1LHpm(gt1,i4) = 1._dp*GammaTPS(MHpmOS(gt1),0._dp,MFeOS(gt3),helfactor*AmpSqHpmToFvFe(gt1, gt2, gt3))
Else 
  gP1LHpm(gt1,i4) = 1._dp*GammaTPS(MHpm(gt1),0._dp,MFe(gt3),helfactor*AmpSqHpmToFvFe(gt1, gt2, gt3))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LHpm(gt1,i4) = 1._dp*GammaTPS(MHpmOS(gt1),MAhOS(gt2),MSeOS(gt3),helfactor*AmpSqHpmToAhSe(gt1, gt2, gt3))
Else 
  gP1LHpm(gt1,i4) = 1._dp*GammaTPS(MHpm(gt1),MAh(gt2),MSe(gt3),helfactor*AmpSqHpmToAhSe(gt1, gt2, gt3))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LHpm(gt1,i4) = 1._dp*GammaTPS(MHpmOS(gt1),MChaOS(gt2),0._dp,helfactor*AmpSqHpmToChaFv(gt1, gt2, gt3))
Else 
  gP1LHpm(gt1,i4) = 1._dp*GammaTPS(MHpm(gt1),MCha(gt2),0._dp,helfactor*AmpSqHpmToChaFv(gt1, gt2, gt3))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LHpm(gt1,i4) = 1._dp*GammaTPS(MHpmOS(gt1),MChiOS(gt2),MFeOS(gt3),helfactor*AmpSqHpmToChiFe(gt1, gt2, gt3))
Else 
  gP1LHpm(gt1,i4) = 1._dp*GammaTPS(MHpm(gt1),MChi(gt2),MFe(gt3),helfactor*AmpSqHpmToChiFe(gt1, gt2, gt3))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LHpm(gt1,i4) = 1._dp*GammaTPS(MHpmOS(gt1),MhhOS(gt2),MSeOS(gt3),helfactor*AmpSqHpmTohhSe(gt1, gt2, gt3))
Else 
  gP1LHpm(gt1,i4) = 1._dp*GammaTPS(MHpm(gt1),Mhh(gt2),MSe(gt3),helfactor*AmpSqHpmTohhSe(gt1, gt2, gt3))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LHpm(gt1,i4) = 1._dp*GammaTPS(MHpmOS(gt1),MHpmOS(gt2),MSvOS(gt3),helfactor*AmpSqHpmToHpmSv(gt1, gt2, gt3))
Else 
  gP1LHpm(gt1,i4) = 1._dp*GammaTPS(MHpm(gt1),MHpm(gt2),MSv(gt3),helfactor*AmpSqHpmToHpmSv(gt1, gt2, gt3))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LHpm(gt1,i4) = 1._dp*GammaTPS(MHpmOS(gt1),MHpmOS(gt2),MSvOS(gt3),helfactor*AmpSqHpmToHpmcSv(gt1, gt2, gt3))
Else 
  gP1LHpm(gt1,i4) = 1._dp*GammaTPS(MHpm(gt1),MHpm(gt2),MSv(gt3),helfactor*AmpSqHpmToHpmcSv(gt1, gt2, gt3))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LHpm(gt1,i4) = 1._dp*GammaTPS(MHpmOS(gt1),MSeOS(gt2),MSvOS(gt3),helfactor*AmpSqHpmToSeSv(gt1, gt2, gt3))
Else 
  gP1LHpm(gt1,i4) = 1._dp*GammaTPS(MHpm(gt1),MSe(gt2),MSv(gt3),helfactor*AmpSqHpmToSeSv(gt1, gt2, gt3))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LHpm(gt1,i4) = 1._dp*GammaTPS(MHpmOS(gt1),MSeOS(gt2),0._dp,helfactor*AmpSqHpmToSeVP(gt1, gt2))
Else 
  gP1LHpm(gt1,i4) = 1._dp*GammaTPS(MHpm(gt1),MSe(gt2),MVP,helfactor*AmpSqHpmToSeVP(gt1, gt2))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LHpm(gt1,i4) = 1._dp*GammaTPS(MHpmOS(gt1),MSeOS(gt2),MVZOS,helfactor*AmpSqHpmToSeVZ(gt1, gt2))
Else 
  gP1LHpm(gt1,i4) = 1._dp*GammaTPS(MHpm(gt1),MSe(gt2),MVZ,helfactor*AmpSqHpmToSeVZ(gt1, gt2))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LHpm(gt1,i4) = 1._dp*GammaTPS(MHpmOS(gt1),MSvOS(gt2),MVWmOS,helfactor*AmpSqHpmToSvVWm(gt1, gt2))
Else 
  gP1LHpm(gt1,i4) = 1._dp*GammaTPS(MHpm(gt1),MSv(gt2),MVWm,helfactor*AmpSqHpmToSvVWm(gt1, gt2))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LHpm(gt1,i4) = 1._dp*GammaTPS(MHpmOS(gt1),MSvOS(gt2),MVWmOS,helfactor*AmpSqHpmTocSvVWm(gt1, gt2))
Else 
  gP1LHpm(gt1,i4) = 1._dp*GammaTPS(MHpm(gt1),MSv(gt2),MVWm,helfactor*AmpSqHpmTocSvVWm(gt1, gt2))
End if 
