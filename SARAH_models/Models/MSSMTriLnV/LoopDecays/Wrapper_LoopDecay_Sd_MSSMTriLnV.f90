...
! ------------------------------------------------------------------------------  
! File created at 10:08 on 20.4.2021   
! ----------------------------------------------------------------------  
...
Complex(dp) :: AmpTreeSdToFvFd(2,6,3,3),AmpWaveSdToFvFd(2,6,3,3)=(0._dp,0._dp),AmpVertexSdToFvFd(2,6,3,3)& 
...
Complex(dp) :: AmpTreeSdToFuFe(2,6,3,3),AmpWaveSdToFuFe(2,6,3,3)=(0._dp,0._dp),AmpVertexSdToFuFe(2,6,3,3)& 
...
Complex(dp) :: AmpTreeSdToSvSd(6,3,6),AmpWaveSdToSvSd(6,3,6)=(0._dp,0._dp),AmpVertexSdToSvSd(6,3,6)& 
...
Complex(dp) :: AmpTreeSdTocSvSd(6,3,6),AmpWaveSdTocSvSd(6,3,6)=(0._dp,0._dp),AmpVertexSdTocSvSd(6,3,6)& 
...
Complex(dp) :: AmpTreeSdToSuSe(6,6,6),AmpWaveSdToSuSe(6,6,6)=(0._dp,0._dp),AmpVertexSdToSuSe(6,6,6)& 
...
If (OSkinematics) Then 
  AmpSum2SdToFvFd = AmpTreeSdToFvFd
  Call SquareAmp_StoFF(MSdOS(gt1),0._dp,MFdOS(gt3),AmpSumSdToFvFd(:,gt1, gt2, gt3),AmpSum2SdToFvFd(:,gt1, gt2, gt3),AmpSqSdToFvFd(gt1, gt2, gt3)) 
  AmpSqTreeSdToFvFd(gt1, gt2, gt3) = AmpSqSdToFvFd(gt1, gt2, gt3)  
...
Else 
If (OSkinematics) Then 
  gP1LSd(gt1,i4) = 1._dp*GammaTPS(MSdOS(gt1),0._dp,MFdOS(gt3),helfactor*AmpSqSdToFvFd(gt1, gt2, gt3))
Else 
  gP1LSd(gt1,i4) = 1._dp*GammaTPS(MSd(gt1),0._dp,MFd(gt3),helfactor*AmpSqSdToFvFd(gt1, gt2, gt3))
End if 
...
If ((Abs(MRPSdToFvFd(gt1, gt2, gt3)).gt.1.0E-20_dp).or.(Abs(MRGSdToFvFd(gt1, gt2, gt3)).gt.1.0E-20_dp)) Then 
 If (.not.OnlyTreeLevelContributions) Then 
   If (DebugLoopDecays) Write(*,*) "real", phasespacefactor*0.5_dp*helfactor*(MRPSdToFvFd(gt1, gt2, gt3) + MRGSdToFvFd(gt1, gt2, gt3)) 
  gP1LSd(gt1,i4) = gP1LSd(gt1,i4) + phasespacefactor*0.5_dp*helfactor*(MRPSdToFvFd(gt1, gt2, gt3) + MRGSdToFvFd(gt1, gt2, gt3))
   If (DebugLoopDecays) Write(*,*) "sum",  gP1LSd(gt1,i4) 
  End if 
End if 
End if 
...
If (OSkinematics) Then 
  AmpSum2SdToFuFe = AmpTreeSdToFuFe
  Call SquareAmp_StoFF(MSdOS(gt1),MFuOS(gt2),MFeOS(gt3),AmpSumSdToFuFe(:,gt1, gt2, gt3),AmpSum2SdToFuFe(:,gt1, gt2, gt3),AmpSqSdToFuFe(gt1, gt2, gt3)) 
  AmpSqTreeSdToFuFe(gt1, gt2, gt3) = AmpSqSdToFuFe(gt1, gt2, gt3)  
...
Else 
If (OSkinematics) Then 
  gP1LSd(gt1,i4) = 1._dp*GammaTPS(MSdOS(gt1),MFuOS(gt2),MFeOS(gt3),helfactor*AmpSqSdToFuFe(gt1, gt2, gt3))
Else 
  gP1LSd(gt1,i4) = 1._dp*GammaTPS(MSd(gt1),MFu(gt2),MFe(gt3),helfactor*AmpSqSdToFuFe(gt1, gt2, gt3))
End if 
...
If ((Abs(MRPSdToFuFe(gt1, gt2, gt3)).gt.1.0E-20_dp).or.(Abs(MRGSdToFuFe(gt1, gt2, gt3)).gt.1.0E-20_dp)) Then 
 If (.not.OnlyTreeLevelContributions) Then 
   If (DebugLoopDecays) Write(*,*) "real", phasespacefactor*0.5_dp*helfactor*(MRPSdToFuFe(gt1, gt2, gt3) + MRGSdToFuFe(gt1, gt2, gt3)) 
  gP1LSd(gt1,i4) = gP1LSd(gt1,i4) + phasespacefactor*0.5_dp*helfactor*(MRPSdToFuFe(gt1, gt2, gt3) + MRGSdToFuFe(gt1, gt2, gt3))
   If (DebugLoopDecays) Write(*,*) "sum",  gP1LSd(gt1,i4) 
  End if 
End if 
End if 
...
If (OSkinematics) Then 
  AmpSum2SdToSvSd = AmpTreeSdToSvSd
  Call SquareAmp_StoSS(MSdOS(gt1),MSvOS(gt2),MSdOS(gt3),AmpSumSdToSvSd(gt1, gt2, gt3),AmpSum2SdToSvSd(gt1, gt2, gt3),AmpSqSdToSvSd(gt1, gt2, gt3)) 
  AmpSqTreeSdToSvSd(gt1, gt2, gt3) = AmpSqSdToSvSd(gt1, gt2, gt3)  
...
Else 
If (OSkinematics) Then 
  gP1LSd(gt1,i4) = 1._dp*GammaTPS(MSdOS(gt1),MSvOS(gt2),MSdOS(gt3),helfactor*AmpSqSdToSvSd(gt1, gt2, gt3))
Else 
  gP1LSd(gt1,i4) = 1._dp*GammaTPS(MSd(gt1),MSv(gt2),MSd(gt3),helfactor*AmpSqSdToSvSd(gt1, gt2, gt3))
End if 
...
If ((Abs(MRPSdToSvSd(gt1, gt2, gt3)).gt.1.0E-20_dp).or.(Abs(MRGSdToSvSd(gt1, gt2, gt3)).gt.1.0E-20_dp)) Then 
 If (.not.OnlyTreeLevelContributions) Then 
   If (DebugLoopDecays) Write(*,*) "real", phasespacefactor*0.5_dp*helfactor*(MRPSdToSvSd(gt1, gt2, gt3) + MRGSdToSvSd(gt1, gt2, gt3)) 
  gP1LSd(gt1,i4) = gP1LSd(gt1,i4) + phasespacefactor*0.5_dp*helfactor*(MRPSdToSvSd(gt1, gt2, gt3) + MRGSdToSvSd(gt1, gt2, gt3))
   If (DebugLoopDecays) Write(*,*) "sum",  gP1LSd(gt1,i4) 
  End if 
End if 
End if 
...
If (OSkinematics) Then 
  AmpSum2SdTocSvSd = AmpTreeSdTocSvSd
  Call SquareAmp_StoSS(MSdOS(gt1),MSvOS(gt2),MSdOS(gt3),AmpSumSdTocSvSd(gt1, gt2, gt3),AmpSum2SdTocSvSd(gt1, gt2, gt3),AmpSqSdTocSvSd(gt1, gt2, gt3)) 
  AmpSqTreeSdTocSvSd(gt1, gt2, gt3) = AmpSqSdTocSvSd(gt1, gt2, gt3)  
...
Else 
If (OSkinematics) Then 
  gP1LSd(gt1,i4) = 1._dp*GammaTPS(MSdOS(gt1),MSvOS(gt2),MSdOS(gt3),helfactor*AmpSqSdTocSvSd(gt1, gt2, gt3))
Else 
  gP1LSd(gt1,i4) = 1._dp*GammaTPS(MSd(gt1),MSv(gt2),MSd(gt3),helfactor*AmpSqSdTocSvSd(gt1, gt2, gt3))
End if 
...
If ((Abs(MRPSdTocSvSd(gt1, gt2, gt3)).gt.1.0E-20_dp).or.(Abs(MRGSdTocSvSd(gt1, gt2, gt3)).gt.1.0E-20_dp)) Then 
 If (.not.OnlyTreeLevelContributions) Then 
   If (DebugLoopDecays) Write(*,*) "real", phasespacefactor*0.5_dp*helfactor*(MRPSdTocSvSd(gt1, gt2, gt3) + MRGSdTocSvSd(gt1, gt2, gt3)) 
  gP1LSd(gt1,i4) = gP1LSd(gt1,i4) + phasespacefactor*0.5_dp*helfactor*(MRPSdTocSvSd(gt1, gt2, gt3) + MRGSdTocSvSd(gt1, gt2, gt3))
   If (DebugLoopDecays) Write(*,*) "sum",  gP1LSd(gt1,i4) 
  End if 
End if 
End if 
...
If (OSkinematics) Then 
  AmpSum2SdToSuSe = AmpTreeSdToSuSe
  Call SquareAmp_StoSS(MSdOS(gt1),MSuOS(gt2),MSeOS(gt3),AmpSumSdToSuSe(gt1, gt2, gt3),AmpSum2SdToSuSe(gt1, gt2, gt3),AmpSqSdToSuSe(gt1, gt2, gt3)) 
  AmpSqTreeSdToSuSe(gt1, gt2, gt3) = AmpSqSdToSuSe(gt1, gt2, gt3)  
...
Else 
If (OSkinematics) Then 
  gP1LSd(gt1,i4) = 1._dp*GammaTPS(MSdOS(gt1),MSuOS(gt2),MSeOS(gt3),helfactor*AmpSqSdToSuSe(gt1, gt2, gt3))
Else 
  gP1LSd(gt1,i4) = 1._dp*GammaTPS(MSd(gt1),MSu(gt2),MSe(gt3),helfactor*AmpSqSdToSuSe(gt1, gt2, gt3))
End if 
...
If ((Abs(MRPSdToSuSe(gt1, gt2, gt3)).gt.1.0E-20_dp).or.(Abs(MRGSdToSuSe(gt1, gt2, gt3)).gt.1.0E-20_dp)) Then 
 If (.not.OnlyTreeLevelContributions) Then 
   If (DebugLoopDecays) Write(*,*) "real", phasespacefactor*0.5_dp*helfactor*(MRPSdToSuSe(gt1, gt2, gt3) + MRGSdToSuSe(gt1, gt2, gt3)) 
  gP1LSd(gt1,i4) = gP1LSd(gt1,i4) + phasespacefactor*0.5_dp*helfactor*(MRPSdToSuSe(gt1, gt2, gt3) + MRGSdToSuSe(gt1, gt2, gt3))
   If (DebugLoopDecays) Write(*,*) "sum",  gP1LSd(gt1,i4) 
  End if 
End if 
End if 
