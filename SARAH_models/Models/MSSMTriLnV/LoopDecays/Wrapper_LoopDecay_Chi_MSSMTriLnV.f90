...
Complex(dp) :: AmpTreeChiToFvSv(2,4,3,3),AmpWaveChiToFvSv(2,4,3,3)=(0._dp,0._dp),AmpVertexChiToFvSv(2,4,3,3)& 
...
Complex(dp) :: AmpTreeChiToChacSe(2,4,2,6),AmpWaveChiToChacSe(2,4,2,6)=(0._dp,0._dp),AmpVertexChiToChacSe(2,4,2,6)& 
...
Complex(dp) :: AmpTreeChiToChiSv(2,4,4,3),AmpWaveChiToChiSv(2,4,4,3)=(0._dp,0._dp),AmpVertexChiToChiSv(2,4,4,3)& 
...
Complex(dp) :: AmpTreeChiToFecHpm(2,4,3,2),AmpWaveChiToFecHpm(2,4,3,2)=(0._dp,0._dp),AmpVertexChiToFecHpm(2,4,3,2)& 
...
Complex(dp) :: AmpTreeChiToFecVWm(4,4,3),AmpWaveChiToFecVWm(4,4,3)=(0._dp,0._dp),AmpVertexChiToFecVWm(4,4,3)& 
...
Complex(dp) :: AmpTreeChiToFvAh(2,4,3,2),AmpWaveChiToFvAh(2,4,3,2)=(0._dp,0._dp),AmpVertexChiToFvAh(2,4,3,2)& 
...
Complex(dp) :: AmpTreeChiToFvhh(2,4,3,2),AmpWaveChiToFvhh(2,4,3,2)=(0._dp,0._dp),AmpVertexChiToFvhh(2,4,3,2)& 
...
Complex(dp) :: AmpTreeChiToFvVP(4,4,3),AmpWaveChiToFvVP(4,4,3)=(0._dp,0._dp),AmpVertexChiToFvVP(4,4,3)& 
...
Complex(dp) :: AmpTreeChiToFvVZ(4,4,3),AmpWaveChiToFvVZ(4,4,3)=(0._dp,0._dp),AmpVertexChiToFvVZ(4,4,3)& 
...
If (OSkinematics) Then 
  AmpSum2ChiToFvSv = AmpTreeChiToFvSv
  Call SquareAmp_FtoFS(MChiOS(gt1),0._dp,MSvOS(gt3),AmpSumChiToFvSv(:,gt1, gt2, gt3),AmpSum2ChiToFvSv(:,gt1, gt2, gt3),AmpSqChiToFvSv(gt1, gt2, gt3)) 
  AmpSqTreeChiToFvSv(gt1, gt2, gt3) = AmpSqChiToFvSv(gt1, gt2, gt3)  
...
Else 
If (OSkinematics) Then 
  gP1LChi(gt1,i4) = 2._dp*GammaTPS(MChiOS(gt1),0._dp,MSvOS(gt3),helfactor*AmpSqChiToFvSv(gt1, gt2, gt3))
Else 
  gP1LChi(gt1,i4) = 2._dp*GammaTPS(MChi(gt1),0._dp,MSv(gt3),helfactor*AmpSqChiToFvSv(gt1, gt2, gt3))
End if 
...
If ((Abs(MRPChiToFvSv(gt1, gt2, gt3)).gt.1.0E-20_dp).or.(Abs(MRGChiToFvSv(gt1, gt2, gt3)).gt.1.0E-20_dp)) Then 
 If (.not.OnlyTreeLevelContributions) Then 
   If (DebugLoopDecays) Write(*,*) "real", phasespacefactor*1._dp*helfactor*(MRPChiToFvSv(gt1, gt2, gt3) + MRGChiToFvSv(gt1, gt2, gt3)) 
  gP1LChi(gt1,i4) = gP1LChi(gt1,i4) + phasespacefactor*1._dp*helfactor*(MRPChiToFvSv(gt1, gt2, gt3) + MRGChiToFvSv(gt1, gt2, gt3))
   If (DebugLoopDecays) Write(*,*) "sum",  gP1LChi(gt1,i4) 
  End if 
End if 
End if 
...
Else 
If (OSkinematics) Then 
  gP1LChi(gt1,i4) = 2._dp*GammaTPS(MChiOS(gt1),MChaOS(gt2),MSeOS(gt3),helfactor*AmpSqChiToChacSe(gt1, gt2, gt3))
Else 
  gP1LChi(gt1,i4) = 2._dp*GammaTPS(MChi(gt1),MCha(gt2),MSe(gt3),helfactor*AmpSqChiToChacSe(gt1, gt2, gt3))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LChi(gt1,i4) = 2._dp*GammaTPS(MChiOS(gt1),MChiOS(gt2),MSvOS(gt3),helfactor*AmpSqChiToChiSv(gt1, gt2, gt3))
Else 
  gP1LChi(gt1,i4) = 2._dp*GammaTPS(MChi(gt1),MChi(gt2),MSv(gt3),helfactor*AmpSqChiToChiSv(gt1, gt2, gt3))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LChi(gt1,i4) = 2._dp*GammaTPS(MChiOS(gt1),MFeOS(gt2),MHpmOS(gt3),helfactor*AmpSqChiToFecHpm(gt1, gt2, gt3))
Else 
  gP1LChi(gt1,i4) = 2._dp*GammaTPS(MChi(gt1),MFe(gt2),MHpm(gt3),helfactor*AmpSqChiToFecHpm(gt1, gt2, gt3))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LChi(gt1,i4) = 2._dp*GammaTPS(MChiOS(gt1),MFeOS(gt2),MVWmOS,helfactor*AmpSqChiToFecVWm(gt1, gt2))
Else 
  gP1LChi(gt1,i4) = 2._dp*GammaTPS(MChi(gt1),MFe(gt2),MVWm,helfactor*AmpSqChiToFecVWm(gt1, gt2))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LChi(gt1,i4) = 1._dp*GammaTPS(MChiOS(gt1),0._dp,MAhOS(gt3),helfactor*AmpSqChiToFvAh(gt1, gt2, gt3))
Else 
  gP1LChi(gt1,i4) = 1._dp*GammaTPS(MChi(gt1),0._dp,MAh(gt3),helfactor*AmpSqChiToFvAh(gt1, gt2, gt3))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LChi(gt1,i4) = 1._dp*GammaTPS(MChiOS(gt1),0._dp,MhhOS(gt3),helfactor*AmpSqChiToFvhh(gt1, gt2, gt3))
Else 
  gP1LChi(gt1,i4) = 1._dp*GammaTPS(MChi(gt1),0._dp,Mhh(gt3),helfactor*AmpSqChiToFvhh(gt1, gt2, gt3))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LChi(gt1,i4) = 1._dp*GammaTPS(MChiOS(gt1),0._dp,0._dp,helfactor*AmpSqChiToFvVP(gt1, gt2))
Else 
  gP1LChi(gt1,i4) = 1._dp*GammaTPS(MChi(gt1),0._dp,MVP,helfactor*AmpSqChiToFvVP(gt1, gt2))
End if 
...
Else 
If (OSkinematics) Then 
  gP1LChi(gt1,i4) = 1._dp*GammaTPS(MChiOS(gt1),0._dp,MVZOS,helfactor*AmpSqChiToFvVZ(gt1, gt2))
Else 
  gP1LChi(gt1,i4) = 1._dp*GammaTPS(MChi(gt1),0._dp,MVZ,helfactor*AmpSqChiToFvVZ(gt1, gt2))
End if 
